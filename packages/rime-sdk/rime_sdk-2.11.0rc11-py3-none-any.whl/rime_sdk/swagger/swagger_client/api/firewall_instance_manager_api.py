...
class FirewallInstanceManagerApi(object):
    ...
    def create_instance(self, body, **kwargs):  # noqa: E501
        ...
        Creates a new Firewall Instance with the desired user configuration. It will take time for the new instance to become available; use the `GetFirewallInstance` API to track the status of the deployment.  # noqa: E501
    ...
    def delete_instance(self, firewall_instance_id_uuid, **kwargs):  # noqa: E501
        ...
        Deletes a Firewall Instance from the cluster. Be careful with this API because it will interrupt in-flight validation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def delete_instance_with_http_info(self, firewall_instance_id_uuid, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1-beta/firewalls/{firewallInstanceId.uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_instance_with_http_info(self, firewall_instance_id_uuid, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1-beta/firewalls/{firewallInstanceId.uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_instance(self, body, firewall_instance_firewall_instance_id_uuid, **kwargs):  # noqa: E501
        ...
        Updates an existing FirewallInstance. This redeploys the firewall instance. The status will be REDEPLOYING until the new version of the firewall instance reaches READY.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param FirewallsFirewallInstanceFirewallInstanceIdUuidBody body: (required)
    ...
    def update_instance_with_http_info(self, body, firewall_instance_firewall_instance_id_uuid, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1-beta/firewalls/{firewallInstance.firewallInstanceId.uuid}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
