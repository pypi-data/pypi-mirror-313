...
# Apolo SDK/CLI 24.10.1 (2024-12-05)
...
- Balance is no longer stored on a cluster level, and was moved to an organization level, e.g.,
  ...
  Existing commands changes:
    ...
    - `add_org_cluster_credits` is not deprecated in a favor of an `add_org_credits`. ([#3137](https://github.com/neuro-inc/neuro-cli/issues/3137))
