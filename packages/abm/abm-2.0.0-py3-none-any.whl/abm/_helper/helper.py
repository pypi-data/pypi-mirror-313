...
necessary_dose_columns = {"route", "amounts", "amount_unit", "times", "time_unit"}
optional_dose_columns = {"durations", "duration_unit"}

necessary_time_columns = {"times", "times_unit"}

necessary_measurements_columns = {"time", "time_unit", "output", "measurement", "measurement_unit"}
necessary_fitting_parameter_columns = {"parameter", "unit", "value", "is_fit", "lower_bound", "upper_bound"}
