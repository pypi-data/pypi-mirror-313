...
class AddFOp(_ods_ir.OpView):
  ...
  def __init__(self, lhs, rhs, *, fastmath=None, denormal=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if denormal is not None: attributes["denormal"] = (denormal if (
        isinstance(denormal, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('Arith_DenormalModeAttr')) else
          _ods_ir.AttrBuilder.get('Arith_DenormalModeAttr')(denormal, context=_ods_context))
  ...
  @builtins.property
  def denormal(self):
    return self.operation.attributes["denormal"]

  @denormal.setter
  def denormal(self, value):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["denormal"] = value

  @builtins.property
  def result(self):
    return self.operation.results[0]

def addf(lhs, rhs, *, fastmath=None, denormal=None, loc=None, ip=None) -> _ods_ir.Value:
  return AddFOp(lhs=lhs, rhs=rhs, fastmath=fastmath, denormal=denormal, loc=loc, ip=ip).result
...
def divf(lhs, rhs, *, fastmath=None, denormal=None, loc=None, ip=None) -> _ods_ir.Value:
  return DivFOp(lhs=lhs, rhs=rhs, fastmath=fastmath, denormal=denormal, loc=loc, ip=ip).result
...
def maxnumf(lhs, rhs, *, fastmath=None, denormal=None, loc=None, ip=None) -> _ods_ir.Value:
  return MaxNumFOp(lhs=lhs, rhs=rhs, fastmath=fastmath, denormal=denormal, loc=loc, ip=ip).result
...
def maximumf(lhs, rhs, *, fastmath=None, denormal=None, loc=None, ip=None) -> _ods_ir.Value:
  return MaximumFOp(lhs=lhs, rhs=rhs, fastmath=fastmath, denormal=denormal, loc=loc, ip=ip).result
...
def minnumf(lhs, rhs, *, fastmath=None, denormal=None, loc=None, ip=None) -> _ods_ir.Value:
  return MinNumFOp(lhs=lhs, rhs=rhs, fastmath=fastmath, denormal=denormal, loc=loc, ip=ip).result
...
def minimumf(lhs, rhs, *, fastmath=None, denormal=None, loc=None, ip=None) -> _ods_ir.Value:
  return MinimumFOp(lhs=lhs, rhs=rhs, fastmath=fastmath, denormal=denormal, loc=loc, ip=ip).result
...
def mulf(lhs, rhs, *, fastmath=None, denormal=None, loc=None, ip=None) -> _ods_ir.Value:
  return MulFOp(lhs=lhs, rhs=rhs, fastmath=fastmath, denormal=denormal, loc=loc, ip=ip).result
...
class NegFOp(_ods_ir.OpView):
  ...
  def __init__(self, operand, *, fastmath=None, denormal=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def negf(operand, *, fastmath=None, denormal=None, loc=None, ip=None) -> _ods_ir.Value:
  return NegFOp(operand=operand, fastmath=fastmath, denormal=denormal, loc=loc, ip=ip).result
...
def remf(lhs, rhs, *, fastmath=None, denormal=None, loc=None, ip=None) -> _ods_ir.Value:
  return RemFOp(lhs=lhs, rhs=rhs, fastmath=fastmath, denormal=denormal, loc=loc, ip=ip).result
...
def subf(lhs, rhs, *, fastmath=None, denormal=None, loc=None, ip=None) -> _ods_ir.Value:
  return SubFOp(lhs=lhs, rhs=rhs, fastmath=fastmath, denormal=denormal, loc=loc, ip=ip).result
