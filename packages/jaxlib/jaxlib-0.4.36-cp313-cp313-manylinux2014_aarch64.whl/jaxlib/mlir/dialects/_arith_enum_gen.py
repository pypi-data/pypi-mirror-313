...
@register_attribute_builder("Arith_DenormalModeAttr")
def _arith_denormalmodeattr(x, context):
    return _ods_ir.Attribute.parse(f'#arith.denormal<{str(x)}>', context=context)
