...
class OZONbyDate:
    ...
    def get_transaction_page_count(self, date):
        try:
            ...
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: transactions. Ошибка: {e}.'
    ...
    def get_all_products(self, date):
        try:
            ...
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: products. Ошибка: {e}.'
            self.common.log_func(self.bot_token, self.chat_list, message, 3)
            return e
    ...
    def get_all_returns_fbo(self, date):
        try:
            ...
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: returns_fbo. Ошибка: {e}.'
            self.common.log_func(self.bot_token, self.chat_list, message, 3)
            return e
    ...
    def get_all_returns_fbs(self, date):
        try:
            ...
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: returns_fbs. Ошибка: {e}.'
            self.common.log_func(self.bot_token, self.chat_list, message, 3)
            return e
    ...
    def get_realization(self, date):
        ...
        if response.status_code == 200:
            ...
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: realization. Ошибка: {response.status_code}.'
            self.common.log_func(self.bot_token, self.chat_list, message, 3)
            return None
    ...
    def get_postings_fbo(self, date):
        try:
            ...
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: postings. Ошибка: {e}.'
            self.common.log_func(self.bot_token, self.chat_list, message, 3)
            return e
    ...
    def get_finance_details(self, date):
        try:
            ...
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: finance_details. Ошибка: {e}.'
            self.common.log_func(self.bot_token, self.chat_list, message, 3)
            return e
    ...
    def get_finance_cashflow(self, date):
        try:
            ...
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: finance_cashflow. Ошибка: {e}.'
            self.common.log_func(self.bot_token, self.chat_list, message, 3)
            return e
