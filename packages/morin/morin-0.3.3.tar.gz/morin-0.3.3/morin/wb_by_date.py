...
class WBbyDate:
    ...
    def create_ps_report(self, api_key, date1, date2):
        ...
        message = f'Имя: {self.addname}. Дата: {date1}-{date2}. Отчёт: paid_storage. Код: {code}.'
    ...
    def get_paid_storage(self, date):
        try:
            ...
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: paid_storage. Ошибка: {e}.'
    ...
    def get_orders(self, date):
        try:
            ...
            if code == '200':
                ...
                response.raise_for_status()
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: orders. Код: {code}'
            self.common.log_func(self.bot_token, self.chat_list, message, 1)
        except Exception as e:
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: orders. Ошибка: {e}.'
            self.common.log_func(self.bot_token, self.chat_list, message, 3)
            return e
    ...
    def get_incomes(self, date):
        try:
            ...
            if code == '200':
                ...
                response.raise_for_status()
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: incomes. Код: {code}'
            self.common.log_func(self.bot_token, self.chat_list, message, 1)
        except Exception as e:
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: incomes. Ошибка: {e}.'
            self.common.log_func(self.bot_token, self.chat_list, message, 3)
            return e
    ...
    def get_orders_changes(self, date):
        try:
            ...
            if code == '200':
                ...
                response.raise_for_status()
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: order_changes.  Код: {code}'
            self.common.log_func(self.bot_token, self.chat_list, message, 1)
        except Exception as e:
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: order_changes. Ошибка: {e}.'
            self.common.log_func(self.bot_token, self.chat_list, message, 3)
            return e
    ...
    def get_sales(self, date):
        try:
            ...
            if code == '200':
                ...
                response.raise_for_status()
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: sales. Код: {code}'
            self.common.log_func(self.bot_token, self.chat_list, message, 1)
        except Exception as e:
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: sales. Ошибка: {e}.'
            self.common.log_func(self.bot_token, self.chat_list, message, 3)
            return e
    ...
    def get_sales_changes(self, date):
        try:
            ...
            if code == '200':
                ...
                response.raise_for_status()
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: sales_changes. Код: {code}'
            self.common.log_func(self.bot_token, self.chat_list, message, 1)
        except Exception as e:
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: sales_changes. Ошибка: {e}.'
            self.common.log_func(self.bot_token, self.chat_list, message, 3)
            return e
    ...
    def get_realized(self, date):
        try:
            ...
            if code == '200':
                ...
                response.raise_for_status()
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: realized. Код: {code}'
            self.common.log_func(self.bot_token, self.chat_list, message, 1)
        except Exception as e:
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: realized. Ошибка: {e}.'
            self.common.log_func(self.bot_token, self.chat_list, message, 3)
            return e
    ...
    def get_stocks(self, date):
        try:
            ...
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: stocks. Ошибка: {e}.'
            self.common.log_func(self.bot_token, self.chat_list, message, 3)
            return e
    ...
    def get_nmreport(self, date):
        try:
            ...
            message = f'Имя: {self.addname}. Дата: {date}. Отчёт: nmreport. Ошибка: {e}.'
            self.common.log_func(self.bot_token, self.chat_list, message, 3)
            return e
