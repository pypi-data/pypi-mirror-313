...
setup(
  ...
  packages=find_packages(where="src"),  # Automatically finds 'src' directory
  package_dir={"": "src"},  # Root source directory
  version = '0.0.18',
  license='MIT',
  ...
  download_url = 'https://github.com/Yaseen549/pygrams/archive/refs/tags/v0.0.18.tar.gz',
