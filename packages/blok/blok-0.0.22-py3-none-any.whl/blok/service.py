...
def service(
    ...
    def decorator(cls):
        ...
        if not hasattr(cls, "as_dependency"):
            cls.as_dependency = lambda optional, default: Dependency(service=cls.__blok_meta__.identifier, optional=optional, description=cls.__blok_meta__.description, default=default)
