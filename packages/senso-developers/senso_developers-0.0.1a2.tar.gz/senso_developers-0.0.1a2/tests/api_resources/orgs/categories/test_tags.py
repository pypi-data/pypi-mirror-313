...
class TestTags:
    ...
    def test_method_create(self, client: SensoDevelopers) -> None:
        tag = client.orgs.categories.tags.create(
    ...
    def test_raw_response_create(self, client: SensoDevelopers) -> None:
        response = client.orgs.categories.tags.with_raw_response.create(
            category_id="category_id",
            org_id="org_id",
            name="name",
        )
    ...
    def test_streaming_response_create(self, client: SensoDevelopers) -> None:
        with client.orgs.categories.tags.with_streaming_response.create(
            category_id="category_id",
            org_id="org_id",
            name="name",
        ) as response:
    ...
    def test_path_params_create(self, client: SensoDevelopers) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.orgs.categories.tags.with_raw_response.create(
                category_id="category_id",
                org_id="",
                name="name",
            )
    ...
    def test_method_retrieve(self, client: SensoDevelopers) -> None:
        tag = client.orgs.categories.tags.retrieve(
            tag_id="tag_id",
            org_id="org_id",
            category_id="category_id",
        )
    ...
    def test_raw_response_retrieve(self, client: SensoDevelopers) -> None:
        response = client.orgs.categories.tags.with_raw_response.retrieve(
            tag_id="tag_id",
            org_id="org_id",
            category_id="category_id",
        )
    ...
    def test_streaming_response_retrieve(self, client: SensoDevelopers) -> None:
        with client.orgs.categories.tags.with_streaming_response.retrieve(
            tag_id="tag_id",
            org_id="org_id",
            category_id="category_id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: SensoDevelopers) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.orgs.categories.tags.with_raw_response.retrieve(
                tag_id="tag_id",
                org_id="",
                category_id="category_id",
            )
    ...
    def test_method_update(self, client: SensoDevelopers) -> None:
        tag = client.orgs.categories.tags.update(
            tag_id="tag_id",
            org_id="org_id",
            category_id="category_id",
        )
    ...
    def test_raw_response_update(self, client: SensoDevelopers) -> None:
        response = client.orgs.categories.tags.with_raw_response.update(
            tag_id="tag_id",
            org_id="org_id",
            category_id="category_id",
        )
    ...
    def test_streaming_response_update(self, client: SensoDevelopers) -> None:
        with client.orgs.categories.tags.with_streaming_response.update(
            tag_id="tag_id",
            org_id="org_id",
            category_id="category_id",
        ) as response:
    ...
    def test_path_params_update(self, client: SensoDevelopers) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.orgs.categories.tags.with_raw_response.update(
                tag_id="tag_id",
                org_id="",
                category_id="category_id",
            )
    ...
    def test_method_list(self, client: SensoDevelopers) -> None:
        tag = client.orgs.categories.tags.list(
            category_id="category_id",
            org_id="org_id",
        )
    ...
    def test_raw_response_list(self, client: SensoDevelopers) -> None:
        response = client.orgs.categories.tags.with_raw_response.list(
            category_id="category_id",
            org_id="org_id",
        )
    ...
    def test_streaming_response_list(self, client: SensoDevelopers) -> None:
        with client.orgs.categories.tags.with_streaming_response.list(
            category_id="category_id",
            org_id="org_id",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_list(self, client: SensoDevelopers) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.orgs.categories.tags.with_raw_response.list(
                category_id="category_id",
                org_id="",
            )
    ...
    def test_method_delete(self, client: SensoDevelopers) -> None:
        tag = client.orgs.categories.tags.delete(
            tag_id="tag_id",
            org_id="org_id",
            category_id="category_id",
        )
        assert_matches_type(Message, tag, path=["response"])

    @parametrize
    def test_raw_response_delete(self, client: SensoDevelopers) -> None:
        response = client.orgs.categories.tags.with_raw_response.delete(
            tag_id="tag_id",
            org_id="org_id",
            category_id="category_id",
        )
    ...
    def test_streaming_response_delete(self, client: SensoDevelopers) -> None:
        with client.orgs.categories.tags.with_streaming_response.delete(
            tag_id="tag_id",
            org_id="org_id",
            category_id="category_id",
        ) as response:
    ...
    def test_path_params_delete(self, client: SensoDevelopers) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.orgs.categories.tags.with_raw_response.delete(
                tag_id="tag_id",
                org_id="",
                category_id="category_id",
            )
...
class TestAsyncTags:
    ...
    async def test_method_create(self, async_client: AsyncSensoDevelopers) -> None:
        tag = await async_client.orgs.categories.tags.create(
            category_id="category_id",
            org_id="org_id",
            name="name",
        )
    ...
    async def test_raw_response_create(self, async_client: AsyncSensoDevelopers) -> None:
        response = await async_client.orgs.categories.tags.with_raw_response.create(
            category_id="category_id",
            org_id="org_id",
            name="name",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncSensoDevelopers) -> None:
        async with async_client.orgs.categories.tags.with_streaming_response.create(
            category_id="category_id",
            org_id="org_id",
            name="name",
        ) as response:
    ...
    async def test_path_params_create(self, async_client: AsyncSensoDevelopers) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.orgs.categories.tags.with_raw_response.create(
                category_id="category_id",
                org_id="",
                name="name",
            )
    ...
    async def test_method_retrieve(self, async_client: AsyncSensoDevelopers) -> None:
        tag = await async_client.orgs.categories.tags.retrieve(
            tag_id="tag_id",
            org_id="org_id",
            category_id="category_id",
        )
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncSensoDevelopers) -> None:
        response = await async_client.orgs.categories.tags.with_raw_response.retrieve(
            tag_id="tag_id",
            org_id="org_id",
            category_id="category_id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncSensoDevelopers) -> None:
        async with async_client.orgs.categories.tags.with_streaming_response.retrieve(
            tag_id="tag_id",
            org_id="org_id",
            category_id="category_id",
        ) as response:
    ...
    async def test_path_params_retrieve(self, async_client: AsyncSensoDevelopers) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.orgs.categories.tags.with_raw_response.retrieve(
                tag_id="tag_id",
                org_id="",
                category_id="category_id",
            )
    ...
    async def test_method_update(self, async_client: AsyncSensoDevelopers) -> None:
        tag = await async_client.orgs.categories.tags.update(
            tag_id="tag_id",
            org_id="org_id",
            category_id="category_id",
        )
    ...
    async def test_raw_response_update(self, async_client: AsyncSensoDevelopers) -> None:
        response = await async_client.orgs.categories.tags.with_raw_response.update(
            tag_id="tag_id",
            org_id="org_id",
            category_id="category_id",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncSensoDevelopers) -> None:
        async with async_client.orgs.categories.tags.with_streaming_response.update(
            tag_id="tag_id",
            org_id="org_id",
            category_id="category_id",
        ) as response:
    ...
    async def test_path_params_update(self, async_client: AsyncSensoDevelopers) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.orgs.categories.tags.with_raw_response.update(
                tag_id="tag_id",
                org_id="",
                category_id="category_id",
            )
    ...
    async def test_method_list(self, async_client: AsyncSensoDevelopers) -> None:
        tag = await async_client.orgs.categories.tags.list(
            category_id="category_id",
            org_id="org_id",
        )
        assert_matches_type(TagListResponse, tag, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncSensoDevelopers) -> None:
        response = await async_client.orgs.categories.tags.with_raw_response.list(
            category_id="category_id",
            org_id="org_id",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncSensoDevelopers) -> None:
        async with async_client.orgs.categories.tags.with_streaming_response.list(
            category_id="category_id",
            org_id="org_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_list(self, async_client: AsyncSensoDevelopers) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.orgs.categories.tags.with_raw_response.list(
                category_id="category_id",
                org_id="",
            )
    ...
    async def test_method_delete(self, async_client: AsyncSensoDevelopers) -> None:
        tag = await async_client.orgs.categories.tags.delete(
            tag_id="tag_id",
            org_id="org_id",
            category_id="category_id",
        )
    ...
    async def test_raw_response_delete(self, async_client: AsyncSensoDevelopers) -> None:
        response = await async_client.orgs.categories.tags.with_raw_response.delete(
            tag_id="tag_id",
            org_id="org_id",
            category_id="category_id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncSensoDevelopers) -> None:
        async with async_client.orgs.categories.tags.with_streaming_response.delete(
            tag_id="tag_id",
            org_id="org_id",
            category_id="category_id",
        ) as response:
    ...
    async def test_path_params_delete(self, async_client: AsyncSensoDevelopers) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.orgs.categories.tags.with_raw_response.delete(
                tag_id="tag_id",
                org_id="",
                category_id="category_id",
            )
