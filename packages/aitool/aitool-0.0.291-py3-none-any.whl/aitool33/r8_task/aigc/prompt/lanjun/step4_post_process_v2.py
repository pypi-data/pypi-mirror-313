...
input_file = [
    '/Users/bytedance/Downloads/prompts_rst_lanjun_t0.8_1205_p1.pkl',
    '/Users/bytedance/Downloads/prompts_rst_lanjun_t0.8_1205_p2.pkl',
]
...
for line in tqdm(data):
    ...
    for case in cases:
        ...
        rst_im.append(line[:-1] + [case] + [score_theme])
...
dump_excel(data, 'rst_lanjun_t0.8_1205_ori.xlsx')
dump_excel(rst_im, 'rst_lanjun_t0.8_1205_all.xlsx')
dump_excel(rst_im_clean, 'rst_lanjun_t0.8_1205.xlsx')
