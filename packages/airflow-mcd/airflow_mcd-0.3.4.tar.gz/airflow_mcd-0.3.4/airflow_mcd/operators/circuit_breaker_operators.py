...
class SimpleCircuitBreakerOperator(BaseMcdOperator):
    ...
    def execute(self, *args, **kwargs) -> None:
        ...
        try:
            in_breach = service.trigger_and_poll(rule_uuid=self.rule_uuid, namespace=self.namespace,
                                                 rule_name=self.rule_name, timeout_in_minutes=self.timeout_in_minutes)
