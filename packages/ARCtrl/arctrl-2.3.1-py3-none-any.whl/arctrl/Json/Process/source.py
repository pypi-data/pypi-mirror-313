...
def ROCrate_encoder(oa: Source) -> IEncodable:
    ...
    def _arrow2314(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2318(value_3: str, oa: Any=oa) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2314()), ("@type", list_1_1(singleton(ObjectExpr2315()))), ("additionalType", ObjectExpr2316()), try_include("name", _arrow2318, oa.Name), try_include_list_opt("characteristics", ROCrate_encoder_1, oa.Characteristics), ("@context", context_jsonvalue)]))
...
def _arrow2323(get: IGetters) -> Source:
    ...
    def _arrow2322(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow2320(), _arrow2321(), _arrow2322())


ROCrate_decoder: Decoder_1[Source] = object(_arrow2323)
...
def ISAJson_encoder(id_map: Any | None, oa: Source) -> IEncodable:
    def f(oa_1: Source, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2327(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2329(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2330(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2327, ROCrate_genID(oa_1)), try_include("name", _arrow2329, oa_1.Name), try_include_list_opt("characteristics", _arrow2330, oa_1.Characteristics)]))
    ...
    if id_map is not None:
        def _arrow2332(s_1: Source, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(s_1)

        return encode(_arrow2332, f, oa, id_map)
...
def _arrow2336(get: IGetters) -> Source:
    ...
    def _arrow2335(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow2333(), _arrow2334(), _arrow2335())


ISAJson_decoder: Decoder_1[Source] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2336)
