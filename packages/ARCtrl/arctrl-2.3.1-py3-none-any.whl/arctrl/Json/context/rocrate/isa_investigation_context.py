...
def _arrow1510(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1495()), ("Investigation", ObjectExpr1496()), ("identifier", ObjectExpr1497()), ("title", ObjectExpr1498()), ("additionalType", ObjectExpr1499()), ("description", ObjectExpr1500()), ("submissionDate", ObjectExpr1501()), ("publicReleaseDate", ObjectExpr1502()), ("publications", ObjectExpr1503()), ("people", ObjectExpr1504()), ("studies", ObjectExpr1505()), ("ontologySourceReferences", ObjectExpr1506()), ("comments", ObjectExpr1507()), ("filename", ObjectExpr1508())])
