...
def _arrow1653(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1637()), ("Publication", ObjectExpr1640()), ("pubMedID", ObjectExpr1642()), ("doi", ObjectExpr1645()), ("title", ObjectExpr1646()), ("status", ObjectExpr1649()), ("authorList", ObjectExpr1650()), ("comments", ObjectExpr1651())])
