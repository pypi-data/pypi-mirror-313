...
def directory_exists_async(path: str) -> Async[bool]:
    def _arrow3212(__unit: None=None, path: Any=path) -> Async[bool]:
        return singleton.Return(Path(path).is_dir())

    return singleton.Delay(_arrow3212)


def create_directory_async(path: str) -> Async[None]:
    def _arrow3213(__unit: None=None, path: Any=path) -> Async[None]:
...
def ensure_directory_async(path: str) -> Async[None]:
    def _arrow3215(__unit: None=None, path: Any=path) -> Async[None]:
        def _arrow3214(_arg: bool) -> Async[None]:
            return singleton.ReturnFrom(create_directory_async(path)) if (not _arg) else singleton.Zero()

        return singleton.Bind(directory_exists_async(path), _arrow3214)

    return singleton.Delay(_arrow3215)


def ensure_directory_of_file_async(file_path: str) -> Async[None]:
    def _arrow3216(__unit: None=None, file_path: Any=file_path) -> Async[None]:
...
def file_exists_async(path: str) -> Async[bool]:
    def _arrow3217(__unit: None=None, path: Any=path) -> Async[bool]:
...
def read_file_text_async(path: str) -> Async[str]:
    def _arrow3219(__unit: None=None, path: Any=path) -> Async[str]:
        def _arrow3218(__unit: None=None) -> str:
            with open(path, 'r', encoding='utf-8') as f: return f.read()

        return singleton.Return(_arrow3218())

    return singleton.Delay(_arrow3219)


def read_file_binary_async(path: str) -> Async[bytearray]:
    def _arrow3221(__unit: None=None, path: Any=path) -> Async[bytearray]:
        def _arrow3220(__unit: None=None) -> bytearray:
            with open(path, 'rb') as f: return f.read()

        return singleton.Return(_arrow3220())

    return singleton.Delay(_arrow3221)


def read_file_xlsx_async(path: str) -> Async[FsWorkbook]:
    def _arrow3222(__unit: None=None, path: Any=path) -> Async[FsWorkbook]:
...
def move_file_async(old_path: str, new_path: str) -> Async[None]:
    def _arrow3223(__unit: None=None, old_path: Any=old_path, new_path: Any=new_path) -> Async[None]:
...
def delete_file_async(path: str) -> Async[None]:
    def _arrow3224(__unit: None=None, path: Any=path) -> Async[None]:
        try:
            os.remove(path)
...
def write_file_text_async(path: str, text: str) -> Async[None]:
    def _arrow3226(__unit: None=None, path: Any=path, text: Any=text) -> Async[None]:
...
def write_file_binary_async(path: str, bytes: bytearray) -> Async[None]:
    def _arrow3227(__unit: None=None, path: Any=path, bytes: Any=bytes) -> Async[None]:
...
def write_file_xlsx_async(path: str, wb: FsWorkbook) -> Async[None]:
    def _arrow3228(__unit: None=None, path: Any=path, wb: Any=wb) -> Async[None]:
...
def get_sub_directories_async(path: str) -> Async[Array[str]]:
    def _arrow3229(__unit: None=None, path: Any=path) -> Async[Array[str]]:
...
def get_all_file_paths_async(directory_path: str) -> Async[Array[str]]:
    ...
    def _arrow3236(__unit: None=None, directory_path: Any=directory_path) -> Async[Array[str]]:
        def all_files(dirs: IEnumerable_1[str]) -> Async[IEnumerable_1[str]]:
            def _arrow3234(__unit: None=None, dirs: Any=dirs) -> Async[IEnumerable_1[str]]:
                def _arrow3233(_arg: Array[Array[str]]) -> Async[IEnumerable_1[str]]:
                    sub_files_1: IEnumerable_1[str] = concat(_arg)
                    def _arrow3232(_arg_1: Array[Array[str]]) -> Async[IEnumerable_1[str]]:
                        def _arrow3231(_arg_2: Array[IEnumerable_1[str]]) -> Async[IEnumerable_1[str]]:
                            sub_dir_contents_1: IEnumerable_1[str] = concat(_arg_2)
                            return singleton.Return(append(sub_dir_contents_1, sub_files_1))

                        return singleton.Bind(all(map_1(all_files, _arg_1)), _arrow3231)

                    return singleton.Bind(all(map_1(get_sub_directories_async, dirs)), _arrow3232)

                return singleton.Return(empty()) if is_empty(dirs) else singleton.Bind(all(map_1(get_sub_files_async, dirs)), _arrow3233)

            return singleton.Delay(_arrow3234)

        def _arrow3235(_arg_3: IEnumerable_1[str]) -> Async[Array[str]]:
        ...
        return singleton.Bind(all_files(to_enumerable([directory_path_1])), _arrow3235)

    return singleton.Delay(_arrow3236)


def rename_file_or_directory_async(old_path: str, new_path: str) -> Async[None]:
    def _arrow3239(__unit: None=None, old_path: Any=old_path, new_path: Any=new_path) -> Async[None]:
        def _arrow3238(_arg: bool) -> Async[None]:
            def _arrow3237(_arg_1: bool) -> Async[None]:
                if _arg:
            ...
            return singleton.Bind(directory_exists_async(old_path), _arrow3237)

        return singleton.Bind(file_exists_async(old_path), _arrow3238)

    return singleton.Delay(_arrow3239)


def delete_file_or_directory_async(path: str) -> Async[None]:
    def _arrow3242(__unit: None=None, path: Any=path) -> Async[None]:
        def _arrow3241(_arg: bool) -> Async[None]:
            def _arrow3240(_arg_1: bool) -> Async[None]:
                if _arg:
            ...
            return singleton.Bind(directory_exists_async(path), _arrow3240)

        return singleton.Bind(file_exists_async(path), _arrow3241)

    return singleton.Delay(_arrow3242)
