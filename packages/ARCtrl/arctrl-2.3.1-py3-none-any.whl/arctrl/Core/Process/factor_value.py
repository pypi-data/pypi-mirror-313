...
class FactorValue(Record):
    ...
    def PrintCompact(self, __unit: None=None) -> str:
        ...
        def _arrow651(__unit: None=None) -> str:
            category_1: str = category
            value_1: str = value
            return (category_1 + ":") + value_1

        return ("" if (value is None) else _arrow649()) if (category is None) else (_arrow650() if (value is None) else _arrow651())
...
FactorValue_reflection = _expr652
...
def FactorValue__SetCategory_ZDED3A0F(this: FactorValue, c: OntologyAnnotation) -> FactorValue:
    def _arrow653(__unit: None=None, this: Any=this, c: Any=c) -> Factor | None:
    ...
    return FactorValue(this.ID, _arrow653(), this.Value, this.Unit)
