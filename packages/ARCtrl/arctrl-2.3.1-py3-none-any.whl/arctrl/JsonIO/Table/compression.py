...
def encode(encoder: Callable[[Any, Any, Any, _A], IEncodable], obj: Any) -> IEncodable:
    ...
    oa_table: Any = Dictionary([], ObjectExpr3168())
    class ObjectExpr3169:
        @property
    ...
    cell_table: Any = Dictionary([], ObjectExpr3169())
...
def decode(decoder: Callable[[Array[str], Array[OntologyAnnotation], Array[CompositeCell]], __A]) -> Decoder_1[Any]:
    def _arrow3172(get: IGetters, decoder: Any=decoder) -> __B:
        ...
        def _arrow3171(__unit: None=None) -> Array[CompositeCell]:
