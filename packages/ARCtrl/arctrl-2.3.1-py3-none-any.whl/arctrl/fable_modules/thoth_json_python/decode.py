...
class ObjectExpr326(IDecoderHelpers_1[Any]):
...
Decode_helpers: IDecoderHelpers_1[Any] = ObjectExpr326()

def Decode_fromValue(decoder: Decoder_1[Any]) -> Callable[[Any], FSharpResult_2[_T, str]]:
    def _arrow330(value: Any=None, decoder: Any=decoder) -> FSharpResult_2[_T, str]:
