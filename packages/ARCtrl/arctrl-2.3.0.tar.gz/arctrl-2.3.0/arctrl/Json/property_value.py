...
def encoder(pv: IPropertyValue) -> IEncodable:
    ...
    if match_value_1 is None:
        ...
        if v.tag == 1:
            ...
            pattern_input_1 = (ObjectExpr1760(), None)
            ...
            pattern_input_1 = (ObjectExpr1762(), None)

        elif v.tag == 0:
            oa_1: OntologyAnnotation = v.fields[0]
            def _arrow1764(value_3: str, pv: Any=pv) -> IEncodable:
            ...
            def _arrow1767(value_5: str, pv: Any=pv) -> IEncodable:
            ...
            pattern_input_1 = (map(_arrow1764, oa_1.Name), map(_arrow1767, oa_1.TermAccessionNumber))
            ...
            pattern_input_1 = (ObjectExpr1768(), None)
    ...
    def _arrow1777(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1792(value_15: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1797(value_17: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1801(value_19: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1802(x: IEncodable, pv: Any=pv) -> IEncodable:
        return x

    def _arrow1804(x_1: IEncodable, pv: Any=pv) -> IEncodable:
        return x_1

    def _arrow1806(value_21: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1809(value_23: str, pv: Any=pv) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1777()), ("@type", ObjectExpr1778()), ("additionalType", _arrow1780()), try_include("alternateName", _arrow1784, pv.AlternateName()), try_include("measurementMethod", _arrow1788, pv.MeasurementMethod()), try_include("description", _arrow1792, pv.Description()), try_include("category", _arrow1797, pattern_input[0]), try_include("categoryCode", _arrow1801, pattern_input[1]), try_include("value", _arrow1802, pattern_input_1[0]), try_include("valueCode", _arrow1804, pattern_input_1[1]), try_include("unit", _arrow1806, pattern_input_2[0]), try_include("unitCode", _arrow1809, pattern_input_2[1]), ("@context", context_jsonvalue)]))
...
def decoder(create: Callable[[str | None, str | None, str | None, OntologyAnnotation | None, Value_4 | None, OntologyAnnotation | None], _T]) -> Decoder_1[Any]:
    def _arrow1826(get: IGetters, create: Any=create) -> _T:
        ...
        def _arrow1825(__unit: None=None) -> Value_4 | None:
            value: str | None
        ...
        return create(alternate_name, measurement_method, description, category, _arrow1825(), unit)

    return object(_arrow1826)
