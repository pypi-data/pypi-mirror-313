...
def _arrow1606(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1593()), ("additionalType", ObjectExpr1594()), ("ProcessParameterValue", ObjectExpr1595()), ("category", ObjectExpr1596()), ("categoryCode", ObjectExpr1597()), ("value", ObjectExpr1598()), ("valueCode", ObjectExpr1600()), ("unit", ObjectExpr1601()), ("unitCode", ObjectExpr1602())])
...
context_jsonvalue: IEncodable = _arrow1606()
