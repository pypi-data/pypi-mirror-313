...
def _arrow1548(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1534()), ("OntologyAnnotation", ObjectExpr1536()), ("annotationValue", ObjectExpr1538()), ("termSource", ObjectExpr1540()), ("termAccession", ObjectExpr1542()), ("comments", ObjectExpr1544())])
...
context_jsonvalue: IEncodable = _arrow1548()
