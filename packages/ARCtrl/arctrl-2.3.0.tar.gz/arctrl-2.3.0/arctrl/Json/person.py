...
def encoder(person: Person) -> IEncodable:
    ...
    def _arrow2064(value: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2068(value_2: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2072(value_4: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2074(value_6: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2076(value_8: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2078(value_10: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2080(value_12: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2082(value_14: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2084(value_16: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2085(oa: OntologyAnnotation, person: Any=person) -> IEncodable:
        return OntologyAnnotation_encoder(oa)

    def _arrow2086(comment: Comment, person: Any=person) -> IEncodable:
        return encoder_1(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("firstName", _arrow2064, person.FirstName), try_include("lastName", _arrow2068, person.LastName), try_include("midInitials", _arrow2072, person.MidInitials), try_include("orcid", _arrow2074, person.ORCID), try_include("email", _arrow2076, person.EMail), try_include("phone", _arrow2078, person.Phone), try_include("fax", _arrow2080, person.Fax), try_include("address", _arrow2082, person.Address), try_include("affiliation", _arrow2084, person.Affiliation), try_include_seq("roles", _arrow2085, person.Roles), try_include_seq("comments", _arrow2086, person.Comments)]))
...
def _arrow2099(get: IGetters) -> Person:
    ...
    def _arrow2093(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("phone", string)

    def _arrow2094(__unit: None=None) -> str | None:
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("fax", string)

    def _arrow2095(__unit: None=None) -> str | None:
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("address", string)

    def _arrow2096(__unit: None=None) -> str | None:
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("affiliation", string)

    def _arrow2097(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow2098(__unit: None=None) -> Array[Comment] | None:
        arg_21: Decoder_1[Array[Comment]] = resize_array(decoder_1)
        object_arg_10: IOptionalGetter = get.Optional
        return object_arg_10.Field("comments", arg_21)

    return Person(_arrow2088(), _arrow2089(), _arrow2090(), _arrow2091(), _arrow2092(), _arrow2093(), _arrow2094(), _arrow2095(), _arrow2096(), _arrow2097(), _arrow2098())


decoder: Decoder_1[Person] = object(_arrow2099)
...
def ROCrate_Affiliation_encoder(affiliation: str) -> IEncodable:
    ...
    def _arrow2106(__unit: None=None, affiliation: Any=affiliation) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = of_array([("@type", ObjectExpr2104()), ("@id", _arrow2106()), ("name", ObjectExpr2107()), ("@context", context_jsonvalue)])
...
def _arrow2109(get: IGetters) -> str:
    object_arg: IRequiredGetter = get.Required
    return object_arg.Field("name", string)


ROCrate_Affiliation_decoder: Decoder_1[str] = object(_arrow2109)
...
def ROCrate_encoder(oa: Person) -> IEncodable:
    ...
    def _arrow2113(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2116(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2118(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2120(value_6: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2122(value_8: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2124(value_10: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2126(value_12: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2128(value_14: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2130(value_16: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2131(affiliation: str, oa: Any=oa) -> IEncodable:
        return ROCrate_Affiliation_encoder(affiliation)

    def _arrow2132(oa_1: OntologyAnnotation, oa: Any=oa) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow2133(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoderDisambiguatingDescription(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2113()), ("@type", ObjectExpr2114()), try_include("orcid", _arrow2116, oa.ORCID), try_include("firstName", _arrow2118, oa.FirstName), try_include("lastName", _arrow2120, oa.LastName), try_include("midInitials", _arrow2122, oa.MidInitials), try_include("email", _arrow2124, oa.EMail), try_include("phone", _arrow2126, oa.Phone), try_include("fax", _arrow2128, oa.Fax), try_include("address", _arrow2130, oa.Address), try_include("affiliation", _arrow2131, oa.Affiliation), try_include_seq("roles", _arrow2132, oa.Roles), try_include_seq("comments", _arrow2133, oa.Comments), ("@context", context_jsonvalue_1)]))
...
def _arrow2146(get: IGetters) -> Person:
    ...
    def _arrow2142(__unit: None=None) -> str | None:
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("address", string)
    ...
    def _arrow2144(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    return Person(_arrow2135(), _arrow2136(), _arrow2137(), _arrow2138(), _arrow2139(), _arrow2140(), _arrow2141(), _arrow2142(), _arrow2143(), _arrow2144(), _arrow2145())


ROCrate_decoder: Decoder_1[Person] = object(_arrow2146)
...
def ROCrate_encodeAuthorListString(author_list: str) -> IEncodable:
    def encode_single(name: str, author_list: Any=author_list) -> IEncodable:
        ...
        def _arrow2150(value_1: str, name: Any=name) -> IEncodable:
        ...
        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@type", ObjectExpr2148()), try_include("name", _arrow2150, name), ("@context", context_minimal_json_value)]))
...
def _arrow2154(get: IGetters) -> str:
    def _arrow2153(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("name", string)

    return default_arg(_arrow2153(), "")
...
def ISAJson_encoder(id_map: Any | None, person: Person) -> IEncodable:
    def f(person_1: Person, id_map: Any=id_map, person: Any=person) -> IEncodable:
        ...
        def _arrow2158(value: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2160(value_2: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2162(value_4: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2164(value_6: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2166(value_8: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2168(value_10: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2170(value_12: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2172(value_14: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2174(value_16: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2175(oa: OntologyAnnotation, person_1: Any=person_1) -> IEncodable:
            return OntologyAnnotation_encoder(oa)

        def _arrow2176(comment: Comment, person_1: Any=person_1) -> IEncodable:
            return encoder_1(comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2158, ROCrate_genID(person_2)), try_include("firstName", _arrow2160, person_2.FirstName), try_include("lastName", _arrow2162, person_2.LastName), try_include("midInitials", _arrow2164, person_2.MidInitials), try_include("email", _arrow2166, person_2.EMail), try_include("phone", _arrow2168, person_2.Phone), try_include("fax", _arrow2170, person_2.Fax), try_include("address", _arrow2172, person_2.Address), try_include("affiliation", _arrow2174, person_2.Affiliation), try_include_seq("roles", _arrow2175, person_2.Roles), try_include_seq("comments", _arrow2176, person_2.Comments)]))
    ...
    if id_map is not None:
        def _arrow2178(p_1: Person, id_map: Any=id_map, person: Any=person) -> str:
            return ROCrate_genID(p_1)

        return encode(_arrow2178, f, person, id_map)
...
def _arrow2196(get: IGetters) -> Person:
    ...
    def _arrow2194(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    return Person_setOrcidFromComments(Person(None, _arrow2181(), _arrow2184(), _arrow2186(), _arrow2187(), _arrow2188(), _arrow2189(), _arrow2190(), _arrow2191(), _arrow2194(), _arrow2195()))


ISAJson_decoder: Decoder_1[Person] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2196)
