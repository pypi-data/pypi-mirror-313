...
def bool_1(value: YAMLElement) -> bool:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: bool = False
        def _arrow423(__unit: None=None, value: Any=value) -> bool:
            return out_arg

        def _arrow425(v_1: bool, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_2(v.Value, FSharpRef(_arrow423, _arrow425)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def map(key_decoder: Callable[[str], _A], value_decoder: Callable[[YAMLElement], _B], value: YAMLElement) -> Any:
    if value.tag == 3:
        ...
        return of_list(map_1(mapping, value.fields[0]), ObjectExpr428())
...
def dict_1(key_decoder: Callable[[str], _A], value_decoder: Callable[[YAMLElement], _B], value: YAMLElement) -> Any:
    if value.tag == 3:
        ...
        return Dictionary(of_seq(map_1(mapping, value.fields[0]), ObjectExpr429()), ObjectExpr431())
...
def datetime(value: YAMLElement) -> Any:
    ...
    if pattern_matching_result == 0:
        ...
        def _arrow432(__unit: None=None, value: Any=value) -> Any:
            return out_arg

        def _arrow433(v_1: Any, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_3(v.Value, FSharpRef(_arrow432, _arrow433)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def datetime_offset(value: YAMLElement) -> Any:
    ...
    if pattern_matching_result == 0:
        ...
        def _arrow434(__unit: None=None, value: Any=value) -> Any:
            return out_arg

        def _arrow435(v_1: Any, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_4(v.Value, FSharpRef(_arrow434, _arrow435)), out_arg)
        if match_value[0]:
            return match_value[1]
...
class Getter:
    def __init__(self, ele: YAMLElement) -> None:
        def _arrow452(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr451(IRequiredGetter):
        ...
        self.required: IRequiredGetter = _arrow452()
        def _arrow454(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr453(IOptionalGetter):
            ...
            return ObjectExpr453()

        self.optional: IOptionalGetter = _arrow454()
        def _arrow456(__unit: None=None) -> IMultipleOptionalGetter:
            _this_2: Any = self
            class ObjectExpr455(IMultipleOptionalGetter):
        ...
        self.multiple_optional: IMultipleOptionalGetter = _arrow456()
        def _arrow459(__unit: None=None) -> IOverflowGetter:
            _this_3: Any = self
            class ObjectExpr458(IOverflowGetter):
        ...
        self.overflow: IOverflowGetter = _arrow459()
