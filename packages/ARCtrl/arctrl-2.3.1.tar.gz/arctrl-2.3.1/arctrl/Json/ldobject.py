...
def generic_encoder(obj: Any=None) -> IEncodable:
    if str(type(obj)) == "<class \'str\'>":
        ...
        class ObjectExpr2723(IEncodable):
            def Encode(self, helpers_4: IEncoderHelpers_1[Any], obj: Any=obj) -> Any:
                return helpers_4.encode_null()

        return ObjectExpr2723()

    elif is_iterable(obj):
        def _arrow2727(__unit: None=None, obj: Any=obj) -> IEnumerable_1[IEncodable]:
            def _arrow2724(__unit: None=None) -> IEnumerator[Any]:
                return get_enumerator(obj)

            def _arrow2725(enumerator: IEnumerator[Any]) -> bool:
                return enumerator.System_Collections_IEnumerator_MoveNext()

            def _arrow2726(enumerator_1: IEnumerator[Any]) -> Any:
                return enumerator_1.System_Collections_IEnumerator_get_Current()

            return map(generic_encoder, enumerate_from_functions(_arrow2724, _arrow2725, _arrow2726))

        return list_1(to_list(delay(_arrow2727)))
...
def encoder(obj: LDObject) -> IEncodable:
    ...
    def _arrow2736(__unit: None=None, obj: Any=obj) -> IEnumerable_1[tuple[str, IEncodable]]:
        def _arrow2729(__unit: None=None) -> IEncodable:
            value: str = obj.Id
        ...
        def _arrow2735(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
            ...
            def _arrow2734(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
                def _arrow2733(__unit: None=None) -> IEncodable:
                ...
                return singleton(("additionalType", _arrow2733())) if (obj.AdditionalType is not None) else empty()

            return append(singleton(("@type", _arrow2731())), delay(_arrow2734))

        return append(singleton(("@id", _arrow2729())), delay(_arrow2735))

    values = append(to_list(delay(_arrow2736)), source_2)
...
def get_decoder(expect_object: bool) -> Decoder_1[Any]:
    def decode(expect_object_1: bool, expect_object: Any=expect_object) -> Decoder_1[Any]:
        class ObjectExpr2740(Decoder_1[LDObject]):
            def Decode(self, helpers: IDecoderHelpers_1[Any], value: Any, expect_object_1: Any=expect_object_1) -> FSharpResult_2[LDObject, tuple[str, ErrorReason_1[__A_]]]:
                if helpers.is_object(value):
                    ...
                    def _arrow2738(__unit: None=None) -> str:
                        object_arg_1: IRequiredGetter = get.Required
                        return object_arg_1.Field("@id", string)

                    o: LDObject = LDObject(_arrow2738(), t)
        ...
        decode_object: Decoder_1[LDObject] = ObjectExpr2740()
        class ObjectExpr2742(Decoder_1[Array[Any]]):
                    ...
                    def folder(acc: FSharpResult_2[Array[Any], tuple[str, ErrorReason_1[__A_]]], value_2: __A_) -> FSharpResult_2[Array[Any], tuple[str, ErrorReason_1[__A_]]]:
                        ...
                        if acc.tag == 0:
                            ...
                            if match_value_1.tag == 0:
                                ...
                                def _arrow2741(__unit: None=None, acc: Any=acc, value_2: Any=value_2) -> tuple[str, ErrorReason_1[__A_]]:
                                ...
                                return FSharpResult_2(1, _arrow2741())
        ...
        resize_array: Decoder_1[Array[Any]] = ObjectExpr2742()
        if expect_object_1:
            def _arrow2743(value_4: LDObject, expect_object_1: Any=expect_object_1) -> Any:
                return value_4

            return map_1(_arrow2743, decode_object)

        else: 
            def _arrow2745(value_5: LDObject, expect_object_1: Any=expect_object_1) -> Any:
                return value_5

            def _arrow2746(value_6: Array[Any], expect_object_1: Any=expect_object_1) -> Any:
                return value_6

            def _arrow2747(value_7: str, expect_object_1: Any=expect_object_1) -> Any:
                return value_7

            def _arrow2748(value_8: int, expect_object_1: Any=expect_object_1) -> Any:
                return value_8

            def _arrow2749(value_9: Decimal, expect_object_1: Any=expect_object_1) -> Any:
                return value_9

            return one_of(of_array([map_1(_arrow2745, decode_object), map_1(_arrow2746, resize_array), map_1(_arrow2747, string), map_1(_arrow2748, int_1), map_1(_arrow2749, decimal)]))


    return decode(expect_object)


def _arrow2750(value: Any=None) -> LDObject:
    return value


decoder: Decoder_1[LDObject] = map_1(_arrow2750, get_decoder(True))
