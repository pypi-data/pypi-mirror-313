...
def encoder(study: ArcStudy) -> IEncodable:
    ...
    def _arrow2800(__unit: None=None, study: Any=study) -> IEncodable:
    ...
    def _arrow2805(value_1: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2809(value_3: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2812(value_5: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2815(value_7: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2816(oa: Publication, study: Any=study) -> IEncodable:
        return encoder_5(oa)

    def _arrow2817(person: Person, study: Any=study) -> IEncodable:
        return encoder_6(person)

    def _arrow2818(oa_1: OntologyAnnotation, study: Any=study) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2819(table: ArcTable, study: Any=study) -> IEncodable:
        return encoder_7(table)

    def _arrow2820(dm: DataMap, study: Any=study) -> IEncodable:
        return encoder_8(dm)

    def _arrow2822(value_9: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2823(comment: Comment, study: Any=study) -> IEncodable:
        return encoder_9(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2800()), try_include("Title", _arrow2805, study.Title), try_include("Description", _arrow2809, study.Description), try_include("SubmissionDate", _arrow2812, study.SubmissionDate), try_include("PublicReleaseDate", _arrow2815, study.PublicReleaseDate), try_include_seq("Publications", _arrow2816, study.Publications), try_include_seq("Contacts", _arrow2817, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow2818, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow2819, study.Tables), try_include("DataMap", _arrow2820, study.DataMap), try_include_seq("RegisteredAssayIdentifiers", _arrow2822, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow2823, study.Comments)]))
...
def _arrow2862(get: IGetters) -> ArcStudy:
    ...
    return ArcStudy(_arrow2834(), _arrow2836(), _arrow2838(), _arrow2840(), _arrow2842(), _arrow2846(), _arrow2850(), _arrow2851(), _arrow2857(), _arrow2858(), _arrow2859(), _arrow2861())


decoder: Decoder_1[ArcStudy] = object(_arrow2862)
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, study: ArcStudy) -> IEncodable:
    ...
    def _arrow2866(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        value: str = study.Identifier
    ...
    def _arrow2871(value_1: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2876(value_3: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2879(value_5: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2883(value_7: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2884(oa: Publication, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_5(oa)

    def _arrow2886(person: Person, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_6(person)

    def _arrow2888(oa_1: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2889(table: ArcTable, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_compressed_1(string_table, oa_table, cell_table, table)

    def _arrow2892(dm: DataMap, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_compressed_2(string_table, oa_table, cell_table, dm)

    def _arrow2894(value_9: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2895(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_9(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2866()), try_include("Title", _arrow2871, study.Title), try_include("Description", _arrow2876, study.Description), try_include("SubmissionDate", _arrow2879, study.SubmissionDate), try_include("PublicReleaseDate", _arrow2883, study.PublicReleaseDate), try_include_seq("Publications", _arrow2884, study.Publications), try_include_seq("Contacts", _arrow2886, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow2888, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow2889, study.Tables), try_include("DataMap", _arrow2892, study.DataMap), try_include_seq("RegisteredAssayIdentifiers", _arrow2894, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow2895, study.Comments)]))
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcStudy]:
    def _arrow2938(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcStudy:
        ...
        def _arrow2917(__unit: None=None) -> Array[Publication] | None:
            arg_11: Decoder_1[Array[Publication]] = resize_array(decoder_2)
            object_arg_5: IOptionalGetter = get.Optional
            return object_arg_5.Field("Publications", arg_11)

        def _arrow2920(__unit: None=None) -> Array[Person] | None:
            arg_13: Decoder_1[Array[Person]] = resize_array(decoder_3)
            object_arg_6: IOptionalGetter = get.Optional
            return object_arg_6.Field("Contacts", arg_13)

        def _arrow2923(__unit: None=None) -> Array[OntologyAnnotation] | None:
            arg_15: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_decoder)
            object_arg_7: IOptionalGetter = get.Optional
            return object_arg_7.Field("StudyDesignDescriptors", arg_15)

        def _arrow2928(__unit: None=None) -> Array[ArcTable] | None:
            arg_17: Decoder_1[Array[ArcTable]] = resize_array(decoder_compressed_1(string_table, oa_table, cell_table))
            object_arg_8: IOptionalGetter = get.Optional
            return object_arg_8.Field("Tables", arg_17)

        def _arrow2930(__unit: None=None) -> DataMap | None:
            arg_19: Decoder_1[DataMap] = decoder_compressed_2(string_table, oa_table, cell_table)
            object_arg_9: IOptionalGetter = get.Optional
            return object_arg_9.Field("DataMap", arg_19)

        def _arrow2933(__unit: None=None) -> Array[str] | None:
            arg_21: Decoder_1[Array[str]] = resize_array(string)
            object_arg_10: IOptionalGetter = get.Optional
            return object_arg_10.Field("RegisteredAssayIdentifiers", arg_21)
        ...
        return ArcStudy(_arrow2907(), _arrow2908(), _arrow2910(), _arrow2911(), _arrow2914(), _arrow2917(), _arrow2920(), _arrow2923(), _arrow2928(), _arrow2930(), _arrow2933(), _arrow2936())

    return object(_arrow2938)
...
def ROCrate_encoder(assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    ...
    def _arrow2947(__unit: None=None, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2954(__unit: None=None, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2956(value_4: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2961(value_6: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2964(value_8: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2966(oa: OntologyAnnotation, assays: Any=assays, s: Any=s) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa)

    def _arrow2970(value_10: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2974(value_12: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2975(oa_1: Publication, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_1(oa_1)

    def _arrow2976(oa_2: Person, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_2(oa_2)

    def _arrow2978(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[Process], IEncodable]:
        study_name: str | None = s.Identifier
        def _arrow2977(oa_3: Process) -> IEncodable:
            return ROCrate_encoder_3(study_name, None, oa_3)

        return _arrow2977

    def _arrow2982(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[ArcAssay], IEncodable]:
        study_name_1: str | None = s.Identifier
        def _arrow2981(a_1: ArcAssay) -> IEncodable:
            return ROCrate_encoder_4(study_name_1, a_1)

        return _arrow2981

    def _arrow2983(comment: Comment, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_5(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2947()), ("@type", list_1_1(singleton(ObjectExpr2949()))), ("additionalType", ObjectExpr2952()), ("identifier", _arrow2954()), try_include("filename", _arrow2956, file_name), try_include("title", _arrow2961, s.Title), try_include("description", _arrow2964, s.Description), try_include_seq("studyDesignDescriptors", _arrow2966, s.StudyDesignDescriptors), try_include("submissionDate", _arrow2970, s.SubmissionDate), try_include("publicReleaseDate", _arrow2974, s.PublicReleaseDate), try_include_seq("publications", _arrow2975, s.Publications), try_include_seq("people", _arrow2976, s.Contacts), try_include_list("processSequence", _arrow2978(), processes), try_include_seq("assays", _arrow2982(), assays_1), try_include_seq("comments", _arrow2983, s.Comments), ("@context", context_jsonvalue)]))
...
def _arrow3015(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    def _arrow2990(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("filename", string)

    identifier: str = default_arg(bind(Study_tryIdentifierFromFileName, _arrow2990()), create_missing_identifier())
    ...
    def _arrow3006(__unit: None=None) -> Array[Publication] | None:
    ...
    def _arrow3011(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow3014(__unit: None=None) -> Array[Comment] | None:
        arg_22: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoder_5)
        object_arg_10: IOptionalGetter = get.Optional
        return object_arg_10.Field("comments", arg_22)

    return (ArcStudy(identifier, _arrow2999(), _arrow3000(), _arrow3001(), _arrow3004(), _arrow3006(), _arrow3008(), _arrow3011(), tables, None, assay_identifiers, _arrow3014()), default_arg(assays, empty()))


ROCrate_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = object(_arrow3015)
...
def ISAJson_encoder(id_map: Any | None, assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    def f(s_1: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> IEncodable:
        ...
        def _arrow3024(ps: FSharpList[Process], s_1: Any=s_1) -> IEncodable:
            return encoder_12(id_map, ps)

        encoded_materials: tuple[str, IEncodable | None] = try_include("materials", _arrow3024, Option_fromValueWithDefault(empty(), processes))
        encoded_protocols: tuple[str, IEncodable | None]
        value_5: FSharpList[Protocol] = get_protocols(processes)
        def _arrow3027(__unit: None=None, s_1: Any=s_1) -> Callable[[Protocol], IEncodable]:
            study_name: str | None = s_1.Identifier
            def _arrow3026(oa_1: Protocol) -> IEncodable:
                return ISAJson_encoder_1(study_name, None, None, id_map, oa_1)

            return _arrow3026

        encoded_protocols = try_include_list("protocols", _arrow3027(), value_5)
        ...
        def _arrow3033(__unit: None=None, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3040(__unit: None=None, s_1: Any=s_1) -> IEncodable:
            value_8: str = study.Identifier
            class ObjectExpr3039(IEncodable):
                def Encode(self, helpers_2: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_2.encode_string(value_8)

            return ObjectExpr3039()

        def _arrow3044(value_9: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3047(value_11: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3051(value_13: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3053(value_15: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3054(oa_2: Publication, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_2)

        def _arrow3055(person_2: Person, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, person_2)

        def _arrow3056(oa_3: OntologyAnnotation, s_1: Any=s_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_3)

        def _arrow3058(__unit: None=None, s_1: Any=s_1) -> Callable[[Process], IEncodable]:
            study_name_1: str | None = s_1.Identifier
            def _arrow3057(oa_4: Process) -> IEncodable:
                return ISAJson_encoder_4(study_name_1, None, id_map, oa_4)

            return _arrow3057

        def _arrow3060(__unit: None=None, s_1: Any=s_1) -> Callable[[ArcAssay], IEncodable]:
            study_name_2: str | None = s_1.Identifier
            def _arrow3059(a_2: ArcAssay) -> IEncodable:
                return ISAJson_encoder_5(study_name_2, id_map, a_2)

            return _arrow3059

        def _arrow3061(comment: Comment, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_6(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow3033()), ("filename", ObjectExpr3037()), ("identifier", _arrow3040()), try_include("title", _arrow3044, study.Title), try_include("description", _arrow3047, study.Description), try_include("submissionDate", _arrow3051, study.SubmissionDate), try_include("publicReleaseDate", _arrow3053, study.PublicReleaseDate), try_include_seq("publications", _arrow3054, study.Publications), try_include_seq("people", _arrow3055, study.Contacts), try_include_seq("studyDesignDescriptors", _arrow3056, study.StudyDesignDescriptors), encoded_protocols, encoded_materials, try_include_list("processSequence", _arrow3058(), processes), try_include_seq("assays", _arrow3060(), assays_1), encoded_factors, encoded_characteristics, encoded_units, try_include_seq("comments", _arrow3061, study.Comments)]))
    ...
    if id_map is not None:
        def _arrow3063(s_2: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> str:
            return ROCrate_genID(s_2)

        return encode(_arrow3063, f, s, id_map)
...
def _arrow3074(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    ...
    def def_thunk(__unit: None=None) -> str:
        ...
        return default_arg(bind(Study_tryIdentifierFromFileName, _arrow3065()), create_missing_identifier())

    identifier: str = default_arg_with(_arrow3064(), def_thunk)
    ...
    def _arrow3067(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
    ...
    def _arrow3071(__unit: None=None) -> Array[Publication] | None:
        arg_21: Decoder_1[Array[Publication]] = resize_array(ISAJson_decoder_4)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("publications", arg_21)

    def _arrow3072(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    return (ArcStudy(identifier, _arrow3067(), _arrow3068(), _arrow3069(), _arrow3070(), _arrow3071(), None if (len(persons) == 0) else persons, _arrow3072(), tables, None, assay_identifiers, _arrow3073()), default_arg(assays, empty()))


ISAJson_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow3074)
