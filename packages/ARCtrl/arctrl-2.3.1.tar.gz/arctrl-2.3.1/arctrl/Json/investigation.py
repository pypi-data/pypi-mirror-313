...
def encoder(inv: ArcInvestigation) -> IEncodable:
    ...
    def _arrow2759(__unit: None=None, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2761(value_1: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2763(value_3: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2765(value_5: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2767(value_7: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2768(osr: OntologySourceReference, inv: Any=inv) -> IEncodable:
        return encoder_1(osr)

    def _arrow2769(oa: Publication, inv: Any=inv) -> IEncodable:
        return encoder_2(oa)

    def _arrow2770(person: Person, inv: Any=inv) -> IEncodable:
        return encoder_3(person)

    def _arrow2771(assay: ArcAssay, inv: Any=inv) -> IEncodable:
        return encoder_4(assay)

    def _arrow2772(study: ArcStudy, inv: Any=inv) -> IEncodable:
        return encoder_5(study)

    def _arrow2774(value_9: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2775(comment: Comment, inv: Any=inv) -> IEncodable:
        return encoder_6(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2759()), try_include("Title", _arrow2761, inv.Title), try_include("Description", _arrow2763, inv.Description), try_include("SubmissionDate", _arrow2765, inv.SubmissionDate), try_include("PublicReleaseDate", _arrow2767, inv.PublicReleaseDate), try_include_seq("OntologySourceReferences", _arrow2768, inv.OntologySourceReferences), try_include_seq("Publications", _arrow2769, inv.Publications), try_include_seq("Contacts", _arrow2770, inv.Contacts), try_include_seq("Assays", _arrow2771, inv.Assays), try_include_seq("Studies", _arrow2772, inv.Studies), try_include_seq("RegisteredStudyIdentifiers", _arrow2774, inv.RegisteredStudyIdentifiers), try_include_seq("Comments", _arrow2775, inv.Comments)]))
...
def _arrow2803(get: IGetters) -> ArcInvestigation:
    def _arrow2777(__unit: None=None) -> str:
    ...
    return ArcInvestigation(_arrow2777(), _arrow2782(), _arrow2785(), _arrow2786(), _arrow2787(), _arrow2789(), _arrow2792(), _arrow2793(), _arrow2794(), _arrow2797(), _arrow2798(), _arrow2801())


decoder: Decoder_1[ArcInvestigation] = object(_arrow2803)
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, inv: ArcInvestigation) -> IEncodable:
    ...
    def _arrow2813(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        value: str = inv.Identifier
    ...
    def _arrow2825(value_1: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2828(value_3: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2831(value_5: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2837(value_7: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2839(osr: OntologySourceReference, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_1(osr)

    def _arrow2841(oa: Publication, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_2(oa)

    def _arrow2844(person: Person, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_3(person)

    def _arrow2847(assay: ArcAssay, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_compressed_1(string_table, oa_table, cell_table, assay)

    def _arrow2849(study: ArcStudy, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_compressed_2(string_table, oa_table, cell_table, study)

    def _arrow2853(value_9: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2855(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_6(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2813()), try_include("Title", _arrow2825, inv.Title), try_include("Description", _arrow2828, inv.Description), try_include("SubmissionDate", _arrow2831, inv.SubmissionDate), try_include("PublicReleaseDate", _arrow2837, inv.PublicReleaseDate), try_include_seq("OntologySourceReferences", _arrow2839, inv.OntologySourceReferences), try_include_seq("Publications", _arrow2841, inv.Publications), try_include_seq("Contacts", _arrow2844, inv.Contacts), try_include_seq("Assays", _arrow2847, inv.Assays), try_include_seq("Studies", _arrow2849, inv.Studies), try_include_seq("RegisteredStudyIdentifiers", _arrow2853, inv.RegisteredStudyIdentifiers), try_include_seq("Comments", _arrow2855, inv.Comments)]))
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcInvestigation]:
    def _arrow2891(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcInvestigation:
        def _arrow2867(__unit: None=None) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("Identifier", string)
        ...
        def _arrow2874(__unit: None=None) -> Array[OntologySourceReference] | None:
            arg_11: Decoder_1[Array[OntologySourceReference]] = resize_array(decoder_3)
            object_arg_5: IOptionalGetter = get.Optional
            return object_arg_5.Field("OntologySourceReferences", arg_11)

        def _arrow2877(__unit: None=None) -> Array[Publication] | None:
            arg_13: Decoder_1[Array[Publication]] = resize_array(decoder_4)
            object_arg_6: IOptionalGetter = get.Optional
            return object_arg_6.Field("Publications", arg_13)

        def _arrow2880(__unit: None=None) -> Array[Person] | None:
            arg_15: Decoder_1[Array[Person]] = resize_array(decoder_5)
            object_arg_7: IOptionalGetter = get.Optional
            return object_arg_7.Field("Contacts", arg_15)

        def _arrow2881(__unit: None=None) -> Array[ArcAssay] | None:
            arg_17: Decoder_1[Array[ArcAssay]] = resize_array(decoder_compressed_1(string_table, oa_table, cell_table))
            object_arg_8: IOptionalGetter = get.Optional
            return object_arg_8.Field("Assays", arg_17)

        def _arrow2885(__unit: None=None) -> Array[ArcStudy] | None:
            arg_19: Decoder_1[Array[ArcStudy]] = resize_array(decoder_compressed_2(string_table, oa_table, cell_table))
            object_arg_9: IOptionalGetter = get.Optional
            return object_arg_9.Field("Studies", arg_19)

        def _arrow2887(__unit: None=None) -> Array[str] | None:
            arg_21: Decoder_1[Array[str]] = resize_array(string)
            object_arg_10: IOptionalGetter = get.Optional
            return object_arg_10.Field("RegisteredStudyIdentifiers", arg_21)

        def _arrow2890(__unit: None=None) -> Array[Comment] | None:
            arg_23: Decoder_1[Array[Comment]] = resize_array(decoder_8)
            object_arg_11: IOptionalGetter = get.Optional
            return object_arg_11.Field("Comments", arg_23)

        return ArcInvestigation(_arrow2867(), _arrow2868(), _arrow2869(), _arrow2872(), _arrow2873(), _arrow2874(), _arrow2877(), _arrow2880(), _arrow2881(), _arrow2885(), _arrow2887(), _arrow2890())

    return object(_arrow2891)
...
def ROCrate_encoder(oa: ArcInvestigation) -> IEncodable:
    ...
    def _arrow2900(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2905(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2913(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2919(value_5: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2922(value_7: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2927(value_9: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2932(value_11: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2934(osr: OntologySourceReference, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(osr)

    def _arrow2939(oa_1: Publication, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_2(oa_1)

    def _arrow2940(oa_2: Person, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_3(oa_2)

    def _arrow2941(s: ArcStudy, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_4(None, s)

    def _arrow2942(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_5(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2900()), ("@type", ObjectExpr2901()), ("additionalType", ObjectExpr2902()), ("identifier", _arrow2905()), ("filename", _arrow2913()), try_include("title", _arrow2919, oa.Title), try_include("description", _arrow2922, oa.Description), try_include("submissionDate", _arrow2927, oa.SubmissionDate), try_include("publicReleaseDate", _arrow2932, oa.PublicReleaseDate), try_include_seq("ontologySourceReferences", _arrow2934, oa.OntologySourceReferences), try_include_seq("publications", _arrow2939, oa.Publications), try_include_seq("people", _arrow2940, oa.Contacts), try_include_seq("studies", _arrow2941, oa.Studies), try_include_seq("comments", _arrow2942, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2972(get: IGetters) -> ArcInvestigation:
    identifier: str
    ...
    def _arrow2948(__unit: None=None) -> FSharpList[tuple[ArcStudy, FSharpList[ArcAssay]]] | None:
    ...
    pattern_input: tuple[FSharpList[ArcStudy], FSharpList[FSharpList[ArcAssay]]] = unzip(default_arg(_arrow2948(), empty()))
    studies_raw: FSharpList[ArcStudy] = pattern_input[0]
    def projection(a: ArcAssay) -> str:
        return a.Identifier

    class ObjectExpr2951:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow2950(x: str, y: str) -> bool:
                return x == y
    ...
    assays: Array[ArcAssay] = list(distinct_by(projection, concat(pattern_input[1]), ObjectExpr2951()))
    ...
    def _arrow2958(__unit: None=None) -> str | None:
        object_arg_3: IOptionalGetter = get.Optional
    ...
    def _arrow2965(__unit: None=None) -> Array[OntologySourceReference] | None:
    ...
    def _arrow2967(__unit: None=None) -> Array[Publication] | None:
        arg_15: Decoder_1[Array[Publication]] = resize_array(ROCrate_decoder_3)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("publications", arg_15)

    def _arrow2968(__unit: None=None) -> Array[Person] | None:
        arg_17: Decoder_1[Array[Person]] = resize_array(ROCrate_decoder_4)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("people", arg_17)

    def _arrow2971(__unit: None=None) -> Array[Comment] | None:
        arg_19: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoder_5)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return ArcInvestigation(identifier, _arrow2957(), _arrow2958(), _arrow2960(), _arrow2962(), _arrow2965(), _arrow2967(), _arrow2968(), assays, studies, study_identifiers, _arrow2971())


ROCrate_decoder: Decoder_1[ArcInvestigation] = object(_arrow2972)
...
def ROCrate_encodeRoCrate(oa: ArcInvestigation) -> IEncodable:
    ...
    def _arrow2985(value: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2987(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2988(oa_1: ArcInvestigation, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder(oa_1)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@type", _arrow2985, "CreativeWork"), try_include("@id", _arrow2987, "ro-crate-metadata.json"), try_include("about", _arrow2988, oa), ("conformsTo", conforms_to_jsonvalue), ("@context", context_jsonvalue_1)]))
...
def ISAJson_encoder(id_map: Any | None, inv: ArcInvestigation) -> IEncodable:
    ...
    def _arrow2996(__unit: None=None, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2998(__unit: None=None, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3003(__unit: None=None, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3007(value_3: str, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        class ObjectExpr3005(IEncodable):
            def Encode(self, helpers_3: IEncoderHelpers_1[Any]) -> Any:
                return helpers_3.encode_string(value_3)

        return ObjectExpr3005()

    def _arrow3010(value_5: str, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3013(value_7: str, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3017(value_9: str, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow3018(osr: OntologySourceReference, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_1(id_map, osr)

    def _arrow3019(oa: Publication, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_2(id_map, oa)

    def _arrow3020(person: Person, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_3(id_map, person)

    def _arrow3021(s: ArcStudy, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_4(id_map, None, s)

    def _arrow3022(comment: Comment, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_5(id_map, comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2996()), ("filename", _arrow2998()), ("identifier", _arrow3003()), try_include("title", _arrow3007, inv.Title), try_include("description", _arrow3010, inv.Description), try_include("submissionDate", _arrow3013, inv.SubmissionDate), try_include("publicReleaseDate", _arrow3017, inv.PublicReleaseDate), try_include_seq("ontologySourceReferences", _arrow3018, inv.OntologySourceReferences), try_include_seq("publications", _arrow3019, inv.Publications), try_include_seq("people", _arrow3020, inv.Contacts), try_include_seq("studies", _arrow3021, inv.Studies), try_include_seq("comments", _arrow3022, inv.Comments)]))
...
def _arrow3049(get: IGetters) -> ArcInvestigation:
    identifer: str
    match_value: str | None
    object_arg: IOptionalGetter = get.Optional
    match_value = object_arg.Field("identifier", string)
    identifer = create_missing_identifier() if (match_value is None) else match_value
    def _arrow3025(__unit: None=None) -> FSharpList[tuple[ArcStudy, FSharpList[ArcAssay]]] | None:
        arg_3: Decoder_1[FSharpList[tuple[ArcStudy, FSharpList[ArcAssay]]]] = list_1_1(ISAJson_decoder_1)
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("studies", arg_3)

    pattern_input: tuple[FSharpList[ArcStudy], FSharpList[FSharpList[ArcAssay]]] = unzip(default_arg(_arrow3025(), empty()))
    studies_raw: FSharpList[ArcStudy] = pattern_input[0]
    def projection(a: ArcAssay) -> str:
        return a.Identifier

    class ObjectExpr3029:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow3028(x: str, y: str) -> bool:
                return x == y
    ...
    assays: Array[ArcAssay] = list(distinct_by(projection, concat(pattern_input[1]), ObjectExpr3029()))
    studies: Array[ArcStudy] = list(studies_raw)
    def mapping(a_1: ArcStudy) -> str:
        return a_1.Identifier
    ...
    def _arrow3041(__unit: None=None) -> Array[OntologySourceReference] | None:
        arg_13: Decoder_1[Array[OntologySourceReference]] = resize_array(ISAJson_decoder_2)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("ontologySourceReferences", arg_13)

    def _arrow3042(__unit: None=None) -> Array[Publication] | None:
        arg_15: Decoder_1[Array[Publication]] = resize_array(ISAJson_decoder_3)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("publications", arg_15)

    def _arrow3045(__unit: None=None) -> Array[Person] | None:
        arg_17: Decoder_1[Array[Person]] = resize_array(ISAJson_decoder_4)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("people", arg_17)

    def _arrow3048(__unit: None=None) -> Array[Comment] | None:
        arg_19: Decoder_1[Array[Comment]] = resize_array(ISAJson_decoder_5)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return ArcInvestigation(identifer, _arrow3034(), _arrow3035(), _arrow3036(), _arrow3038(), _arrow3041(), _arrow3042(), _arrow3045(), assays, studies, study_identifiers, _arrow3048())


ISAJson_decoder: Decoder_1[ArcInvestigation] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow3049)
