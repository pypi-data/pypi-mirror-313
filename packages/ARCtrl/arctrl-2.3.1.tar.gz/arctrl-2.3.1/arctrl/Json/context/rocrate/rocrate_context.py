...
def _arrow1673(__unit: None=None) -> IEncodable:
    class ObjectExpr1670(IEncodable):
        def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
            return helpers.encode_string("https://w3id.org/ro/crate/1.1")

    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("@id", ObjectExpr1670())])
    ...
    return ObjectExpr1672()


conforms_to_jsonvalue: IEncodable = _arrow1673()

def _arrow1682(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1676()), ("arc", ObjectExpr1677()), ("CreativeWork", ObjectExpr1678()), ("about", ObjectExpr1679()), ("conformsTo", ObjectExpr1680())])
...
context_jsonvalue: IEncodable = _arrow1682()
