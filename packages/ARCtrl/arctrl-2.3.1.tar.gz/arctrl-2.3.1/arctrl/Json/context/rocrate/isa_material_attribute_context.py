...
def _arrow1494(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1487()), ("arc", ObjectExpr1488()), ("MaterialAttribute", ObjectExpr1489()), ("ArcMaterialAttribute", ObjectExpr1490()), ("characteristicType", ObjectExpr1491())])
    ...
    return ObjectExpr1493()


context_jsonvalue: IEncodable = _arrow1494()
