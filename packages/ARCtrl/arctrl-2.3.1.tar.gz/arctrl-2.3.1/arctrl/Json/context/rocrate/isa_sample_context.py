...
def _arrow1644(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1629()), ("bio", ObjectExpr1630()), ("Sample", ObjectExpr1633()), ("name", ObjectExpr1635()), ("additionalProperties", ObjectExpr1638())])
...
context_jsonvalue: IEncodable = _arrow1644()
