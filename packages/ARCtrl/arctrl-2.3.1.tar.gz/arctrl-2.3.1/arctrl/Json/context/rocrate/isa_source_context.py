...
def _arrow1648(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1631()), ("bio", ObjectExpr1634()), ("Source", ObjectExpr1636()), ("name", ObjectExpr1639()), ("characteristics", ObjectExpr1641())])
    ...
    return ObjectExpr1647()


context_jsonvalue: IEncodable = _arrow1648()
