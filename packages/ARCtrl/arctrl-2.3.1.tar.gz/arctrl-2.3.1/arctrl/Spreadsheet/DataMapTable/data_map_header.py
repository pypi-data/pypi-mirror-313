...
def ActivePattern_ontologyAnnotationFromFsCells(tsr_col: int | None, tan_col: int | None, cells: FSharpList[FsCell]) -> OntologyAnnotation:
    ...
    def _arrow1299(i: int, tsr_col: Any=tsr_col, tan_col: Any=tan_col, cells: Any=cells) -> str:
        return item(i, cell_values)

    tsr: str | None = map_1(_arrow1299, tsr_col)
    def _arrow1300(i_1: int, tsr_col: Any=tsr_col, tan_col: Any=tan_col, cells: Any=cells) -> str:
        return item(i_1, cell_values)

    tan: str | None = map_1(_arrow1300, tan_col)
...
def to_fs_cells(comment_keys: FSharpList[str]) -> FSharpList[FsCell]:
    def _arrow1333(__unit: None=None, comment_keys: Any=comment_keys) -> IEnumerable_1[FsCell]:
        def _arrow1332(__unit: None=None) -> IEnumerable_1[FsCell]:
            def _arrow1331(__unit: None=None) -> IEnumerable_1[FsCell]:
                def _arrow1330(__unit: None=None) -> IEnumerable_1[FsCell]:
                    def _arrow1329(__unit: None=None) -> IEnumerable_1[FsCell]:
                        def _arrow1328(__unit: None=None) -> IEnumerable_1[FsCell]:
                            ...
                            return append(to_enumerable([FsCell("Generated By")]), delay(_arrow1327))

                        return append(to_enumerable([FsCell("Description")]), delay(_arrow1328))

                    return append(to_enumerable([FsCell("Object Type"), FsCell("Term Source REF"), FsCell("Term Accession Number")]), delay(_arrow1329))

                return append(to_enumerable([FsCell("Unit"), FsCell("Term Source REF"), FsCell("Term Accession Number")]), delay(_arrow1330))

            return append(to_enumerable([FsCell("Explication"), FsCell("Term Source REF"), FsCell("Term Accession Number")]), delay(_arrow1331))

        return append(to_enumerable([FsCell("Data"), FsCell("Data Format"), FsCell("Data Selector Format")]), delay(_arrow1332))

    return to_list(delay(_arrow1333))
