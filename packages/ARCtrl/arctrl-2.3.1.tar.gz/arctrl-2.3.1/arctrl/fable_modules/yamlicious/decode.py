...
def int_1(value: YAMLElement) -> int:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: int = 0
        def _arrow447(__unit: None=None, value: Any=value) -> int:
            return out_arg

        def _arrow448(v_1: int, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1 or 0

        match_value = (try_parse(v.Value, 511, False, 32, FSharpRef(_arrow447, _arrow448)), out_arg)
        if match_value[0]:
...
def float_1(value: YAMLElement) -> float:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: float = 0.0
        def _arrow449(__unit: None=None, value: Any=value) -> float:
            return out_arg

        def _arrow450(v_1: float, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_1(v.Value, FSharpRef(_arrow449, _arrow450)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def bool_1(value: YAMLElement) -> bool:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: bool = False
        def _arrow451(__unit: None=None, value: Any=value) -> bool:
            return out_arg

        def _arrow452(v_1: bool, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_2(v.Value, FSharpRef(_arrow451, _arrow452)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def map(key_decoder: Callable[[str], _A], value_decoder: Callable[[YAMLElement], _B], value: YAMLElement) -> Any:
    if value.tag == 3:
        ...
        return of_list(map_1(mapping, value.fields[0]), ObjectExpr453())
...
def dict_1(key_decoder: Callable[[str], _A], value_decoder: Callable[[YAMLElement], _B], value: YAMLElement) -> Any:
    if value.tag == 3:
        ...
        return Dictionary(of_seq(map_1(mapping, value.fields[0]), ObjectExpr454()), ObjectExpr455())
...
def datetime(value: YAMLElement) -> Any:
    ...
    if pattern_matching_result == 0:
        ...
        def _arrow456(__unit: None=None, value: Any=value) -> Any:
            return out_arg

        def _arrow457(v_1: Any, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_3(v.Value, FSharpRef(_arrow456, _arrow457)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def datetime_offset(value: YAMLElement) -> Any:
    ...
    if pattern_matching_result == 0:
        ...
        def _arrow458(__unit: None=None, value: Any=value) -> Any:
            return out_arg

        def _arrow459(v_1: Any, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_4(v.Value, FSharpRef(_arrow458, _arrow459)), out_arg)
        if match_value[0]:
            return match_value[1]
...
class Getter:
    def __init__(self, ele: YAMLElement) -> None:
        def _arrow462(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr461(IRequiredGetter):
            ...
            return ObjectExpr461()

        self.required: IRequiredGetter = _arrow462()
        def _arrow464(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr463(IOptionalGetter):
            ...
            return ObjectExpr463()

        self.optional: IOptionalGetter = _arrow464()
        def _arrow466(__unit: None=None) -> IMultipleOptionalGetter:
            _this_2: Any = self
            class ObjectExpr465(IMultipleOptionalGetter):
            ...
            return ObjectExpr465()

        self.multiple_optional: IMultipleOptionalGetter = _arrow466()
        def _arrow468(__unit: None=None) -> IOverflowGetter:
            _this_3: Any = self
            class ObjectExpr467(IOverflowGetter):
            ...
            return ObjectExpr467()

        self.overflow: IOverflowGetter = _arrow468()
