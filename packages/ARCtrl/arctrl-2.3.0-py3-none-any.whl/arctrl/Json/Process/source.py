...
def ROCrate_encoder(oa: Source) -> IEncodable:
    ...
    def _arrow2315(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2319(value_3: str, oa: Any=oa) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2315()), ("@type", list_1_1(singleton(ObjectExpr2316()))), ("additionalType", ObjectExpr2317()), try_include("name", _arrow2319, oa.Name), try_include_list_opt("characteristics", ROCrate_encoder_1, oa.Characteristics), ("@context", context_jsonvalue)]))
...
def _arrow2324(get: IGetters) -> Source:
    ...
    def _arrow2323(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow2321(), _arrow2322(), _arrow2323())


ROCrate_decoder: Decoder_1[Source] = object(_arrow2324)
...
def ISAJson_encoder(id_map: Any | None, oa: Source) -> IEncodable:
    def f(oa_1: Source, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2328(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2330(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2331(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2328, ROCrate_genID(oa_1)), try_include("name", _arrow2330, oa_1.Name), try_include_list_opt("characteristics", _arrow2331, oa_1.Characteristics)]))
    ...
    if id_map is not None:
        def _arrow2333(s_1: Source, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(s_1)

        return encode(_arrow2333, f, oa, id_map)
...
def _arrow2337(get: IGetters) -> Source:
    ...
    def _arrow2336(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow2334(), _arrow2335(), _arrow2336())


ISAJson_decoder: Decoder_1[Source] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2337)
