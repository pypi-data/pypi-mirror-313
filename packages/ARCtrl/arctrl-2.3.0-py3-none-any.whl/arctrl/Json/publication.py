...
def encoder(oa: Publication) -> IEncodable:
    ...
    def _arrow1985(value: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1988(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1992(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1996(value_6: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1997(oa_1: OntologyAnnotation, oa: Any=oa) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow1998(comment: Comment, oa: Any=oa) -> IEncodable:
        return encoder_1(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("pubMedID", _arrow1985, oa.PubMedID), try_include("doi", _arrow1988, oa.DOI), try_include("authorList", _arrow1992, oa.Authors), try_include("title", _arrow1996, oa.Title), try_include("status", _arrow1997, oa.Status), try_include_seq("comments", _arrow1998, oa.Comments)]))
...
def _arrow2006(get: IGetters) -> Publication:
    ...
    def _arrow2004(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("status", OntologyAnnotation_decoder)

    def _arrow2005(__unit: None=None) -> Array[Comment] | None:
        arg_11: Decoder_1[Array[Comment]] = resize_array(decoder_2)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("comments", arg_11)

    return Publication(_arrow2000(), _arrow2001(), _arrow2002(), _arrow2003(), _arrow2004(), _arrow2005())


decoder: Decoder_1[Publication] = object(_arrow2006)
...
def ROCrate_encoder(oa: Publication) -> IEncodable:
    ...
    def _arrow2010(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    class ObjectExpr2011(IEncodable):
        def Encode(self, helpers_1: IEncoderHelpers_1[Any], oa: Any=oa) -> Any:
            return helpers_1.encode_string("Publication")

    def _arrow2013(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2015(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2016(author_list: str, oa: Any=oa) -> IEncodable:
        return ROCrate_encodeAuthorListString(author_list)

    def _arrow2018(value_6: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2019(oa_1: OntologyAnnotation, oa: Any=oa) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow2020(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoderDisambiguatingDescription(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2010()), ("@type", ObjectExpr2011()), try_include("pubMedID", _arrow2013, oa.PubMedID), try_include("doi", _arrow2015, oa.DOI), try_include("authorList", _arrow2016, oa.Authors), try_include("title", _arrow2018, oa.Title), try_include("status", _arrow2019, oa.Status), try_include_seq("comments", _arrow2020, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2028(get: IGetters) -> Publication:
    ...
    def _arrow2026(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_4: IOptionalGetter = get.Optional
    ...
    return Publication(_arrow2022(), _arrow2023(), _arrow2024(), _arrow2025(), _arrow2026(), _arrow2027())


ROCrate_decoder: Decoder_1[Publication] = object(_arrow2028)
...
def ISAJson_encoder(id_map: Any | None, oa: Publication) -> IEncodable:
    ...
    def _arrow2032(value: str, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2034(value_2: str, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2036(value_4: str, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2038(value_6: str, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2039(oa_1: OntologyAnnotation, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2040(comment: Comment, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        return ISAJson_encoder_1(id_map, comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("pubMedID", _arrow2032, oa.PubMedID), try_include("doi", _arrow2034, oa.DOI), try_include("authorList", _arrow2036, oa.Authors), try_include("title", _arrow2038, oa.Title), try_include("status", _arrow2039, oa.Status), try_include_seq("comments", _arrow2040, oa.Comments)]))
