...
def _arrow1419(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1405()), ("additionalType", ObjectExpr1406()), ("alternateName", ObjectExpr1407()), ("measurementMethod", ObjectExpr1408()), ("description", ObjectExpr1410()), ("category", ObjectExpr1411()), ("categoryCode", ObjectExpr1412()), ("value", ObjectExpr1413()), ("valueCode", ObjectExpr1414()), ("unit", ObjectExpr1415()), ("unitCode", ObjectExpr1416()), ("comments", ObjectExpr1417())])
