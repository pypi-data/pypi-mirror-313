...
def _arrow1583(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1558()), ("Person", ObjectExpr1559()), ("orcid", ObjectExpr1560()), ("firstName", ObjectExpr1561()), ("lastName", ObjectExpr1562()), ("midInitials", ObjectExpr1564()), ("email", ObjectExpr1566()), ("address", ObjectExpr1568()), ("phone", ObjectExpr1571()), ("fax", ObjectExpr1572()), ("comments", ObjectExpr1574()), ("roles", ObjectExpr1576()), ("affiliation", ObjectExpr1578())])
...
context_jsonvalue: IEncodable = _arrow1583()
...
def _arrow1591(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1585()), ("Person", ObjectExpr1586()), ("name", ObjectExpr1589())])
...
context_minimal_json_value: IEncodable = _arrow1591()
