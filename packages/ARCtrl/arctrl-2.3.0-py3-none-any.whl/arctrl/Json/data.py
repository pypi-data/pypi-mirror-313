...
def encoder(d: Data) -> IEncodable:
    ...
    def _arrow1900(value: str, d: Any=d) -> IEncodable:
    ...
    def _arrow1902(value_2: str, d: Any=d) -> IEncodable:
    ...
    def _arrow1904(value_4: str, d: Any=d) -> IEncodable:
    ...
    def _arrow1906(value_6: str, d: Any=d) -> IEncodable:
    ...
    def _arrow1907(comment: Comment, d: Any=d) -> IEncodable:
        return encoder_1(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow1900, d.ID), try_include("name", _arrow1902, d.Name), try_include("dataType", ISAJson_encoder_1, d.DataType), try_include("format", _arrow1904, d.Format), try_include("selectorFormat", _arrow1906, d.SelectorFormat), try_include_seq("comments", _arrow1907, d.Comments)]))
...
def _arrow1915(get: IGetters) -> Data:
    ...
    def _arrow1911(__unit: None=None) -> DataFile | None:
    ...
    def _arrow1914(__unit: None=None) -> Array[Comment] | None:
        arg_11: Decoder_1[Array[Comment]] = resize_array(decoder_1)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("comments", arg_11)

    return Data(_arrow1909(), _arrow1910(), _arrow1911(), _arrow1912(), _arrow1913(), _arrow1914())


decoder: Decoder_1[Data] = object(_arrow1915)
...
def compressed_encoder(string_table: Any, d: Data) -> IEncodable:
    ...
    def _arrow1917(s: str, string_table: Any=string_table, d: Any=d) -> IEncodable:
        return encode_string(string_table, s)

    def _arrow1918(s_1: str, string_table: Any=string_table, d: Any=d) -> IEncodable:
        return encode_string(string_table, s_1)

    def _arrow1919(s_2: str, string_table: Any=string_table, d: Any=d) -> IEncodable:
        return encode_string(string_table, s_2)

    def _arrow1920(s_3: str, string_table: Any=string_table, d: Any=d) -> IEncodable:
        return encode_string(string_table, s_3)

    def _arrow1921(comment: Comment, string_table: Any=string_table, d: Any=d) -> IEncodable:
        return encoder_1(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("i", _arrow1917, d.ID), try_include("n", _arrow1918, d.Name), try_include("d", ISAJson_encoder_1, d.DataType), try_include("f", _arrow1919, d.Format), try_include("s", _arrow1920, d.SelectorFormat), try_include_seq("c", _arrow1921, d.Comments)]))
...
def compressed_decoder(string_table: Array[str]) -> Decoder_1[Data]:
    def _arrow1929(get: IGetters, string_table: Any=string_table) -> Data:
        ...
        def _arrow1925(__unit: None=None) -> DataFile | None:
            object_arg_2: IOptionalGetter = get.Optional
        ...
        return Data(_arrow1923(), _arrow1924(), _arrow1925(), _arrow1926(), _arrow1927(), _arrow1928())
...
def ROCrate_encoder(oa: Data) -> IEncodable:
    ...
    def _arrow1933(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1936(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1937(value_4: DataFile, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(value_4)

    def _arrow1939(value_5: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1941(value_7: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1942(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_2(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1933()), ("@type", list_1_1(singleton(ObjectExpr1934()))), try_include("name", _arrow1936, oa.Name), try_include("type", _arrow1937, oa.DataType), try_include("encodingFormat", _arrow1939, oa.Format), try_include("usageInfo", _arrow1941, oa.SelectorFormat), try_include_seq("comments", _arrow1942, oa.Comments), ("@context", context_jsonvalue)]))
    class ObjectExpr1943(IEncodable):
    ...
    return ObjectExpr1943()


def _arrow1950(get: IGetters) -> Data:
    ...
    def _arrow1946(__unit: None=None) -> DataFile | None:
        object_arg_2: IOptionalGetter = get.Optional
    ...
    def _arrow1949(__unit: None=None) -> Array[Comment] | None:
        arg_11: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoder_2)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("comments", arg_11)

    return Data(_arrow1944(), _arrow1945(), _arrow1946(), _arrow1947(), _arrow1948(), _arrow1949())


ROCrate_decoder: Decoder_1[Data] = object(_arrow1950)
...
def ISAJson_encoder(id_map: Any | None, oa: Data) -> IEncodable:
    def f(oa_1: Data, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow1954(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1956(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1957(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow1954, ROCrate_genID(oa_1)), try_include("name", _arrow1956, oa_1.Name), try_include("type", ISAJson_encoder_1, oa_1.DataType), try_include_seq("comments", _arrow1957, oa_1.Comments)]))
        ...
        return ObjectExpr1958()

    if id_map is not None:
        def _arrow1959(d_1: Data, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(d_1)

        return encode(_arrow1959, f, oa, id_map)
...
def _arrow1964(get: IGetters) -> Data:
    ...
    def _arrow1962(__unit: None=None) -> DataFile | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("type", ISAJson_decoder_1)

    def _arrow1963(__unit: None=None) -> Array[Comment] | None:
        arg_7: Decoder_1[Array[Comment]] = resize_array(ISAJson_decoder_2)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("comments", arg_7)

    return Data(_arrow1960(), _arrow1961(), _arrow1962(), None, None, _arrow1963())


ISAJson_decoder: Decoder_1[Data] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow1964)
