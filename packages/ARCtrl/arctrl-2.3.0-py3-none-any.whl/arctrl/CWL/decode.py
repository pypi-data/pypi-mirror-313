...
def _arrow522(value_1: YAMLElement) -> OutputBinding:
    def getter(get: IGetters) -> OutputBinding:
        def _arrow521(__unit: None=None, get: Any=get) -> str | None:
            object_arg: IOptionalGetter = get.Optional
            return object_arg.Field("glob", string)

        return OutputBinding(_arrow521())

    return object(getter, value_1)


Decode_outputBindingGlobDecoder: Callable[[YAMLElement], OutputBinding] = _arrow522

def _arrow523(value: YAMLElement) -> OutputBinding | None:
...
Decode_outputBindingDecoder: Callable[[YAMLElement], OutputBinding | None] = _arrow523
...
def _arrow541(value_2: YAMLElement) -> Array[CWLOutput]:
...
def Decode_resourceRequirementDecoder(get: IGetters) -> ResourceRequirementInstance:
    ...
    def _arrow562(__unit: None=None, get: Any=get) -> YAMLElement | None:
    ...
    def _arrow563(__unit: None=None, get: Any=get) -> YAMLElement | None:
    ...
    def _arrow564(__unit: None=None, get: Any=get) -> YAMLElement | None:
    ...
    return ResourceRequirementInstance__ctor_D76FC00(some(_arrow555()), some(_arrow556()), some(_arrow557()), some(_arrow558()), some(_arrow561()), some(_arrow562()), some(_arrow563()), some(_arrow564()))
...
def Decode_schemaDefRequirementDecoder(get: IGetters) -> Array[SchemaDefRequirementType]:
    ...
    def _arrow566(__unit: None=None, get: Any=get) -> Array[Any]:
        object_arg: IRequiredGetter = get.Required
        def arg_1(value_2: YAMLElement) -> Array[Any]:
            def decoder(value: YAMLElement, value_2: Any=value_2) -> Any:
                ...
                def _arrow565(value_1: YAMLElement, value: Any=value) -> str:
                    return string(value_1)

                return map_1(key_decoder, _arrow565, value)

            return resizearray(decoder, value_2)

        return object_arg.Field("types", arg_1)

    return ResizeArray_map(f, _arrow566())
...
def _arrow567(value_2: YAMLElement) -> Array[Requirement]:
...
Decode_requirementArrayDecoder: Callable[[YAMLElement], Array[Requirement]] = _arrow567

def _arrow568(value: YAMLElement) -> Array[Requirement] | None:
...
Decode_requirementsDecoder: Callable[[YAMLElement], Array[Requirement] | None] = _arrow568

def _arrow569(value: YAMLElement) -> Array[Requirement] | None:
    def getter(get: IGetters) -> Array[Requirement] | None:
        object_arg: IOptionalGetter = get.Optional
...
Decode_hintsDecoder: Callable[[YAMLElement], Array[Requirement] | None] = _arrow569

def _arrow574(value_5: YAMLElement) -> InputBinding | None:
...
Decode_inputBindingDecoder: Callable[[YAMLElement], InputBinding | None] = _arrow574

def _arrow581(value_1: YAMLElement) -> Array[CWLInput]:
    def getter(get: IGetters) -> Array[CWLInput]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow580(__unit: None=None, get: Any=get) -> IEnumerable_1[CWLInput]:
            def _arrow579(key: str) -> IEnumerable_1[CWLInput]:
                value: YAMLElement = get_item_from_dict(dict_1, key)
                ...
                def _arrow578(__unit: None=None) -> IEnumerable_1[CWLInput]:
                    def _expr576():
                        set_optional_property("optional", True, input)
                        return empty_1()

                    def _arrow577(__unit: None=None) -> IEnumerable_1[CWLInput]:
                        return singleton(input)

                    return append(_expr576() if pattern_input[1] else empty_1(), delay(_arrow577))

                return append(_expr575() if (input_binding is not None) else empty_1(), delay(_arrow578))

            return collect(_arrow579, dict_1.keys())

        return list(to_array(delay(_arrow580)))

    return object(getter, value_1)


Decode_inputArrayDecoder: Callable[[YAMLElement], Array[CWLInput]] = _arrow581

def _arrow582(value: YAMLElement) -> Array[CWLInput] | None:
...
Decode_inputsDecoder: Callable[[YAMLElement], Array[CWLInput] | None] = _arrow582

def _arrow584(value_2: YAMLElement) -> Array[str] | None:
    def getter(get: IGetters) -> Array[str] | None:
        object_arg: IOptionalGetter = get.Optional
        def arg_1(value: YAMLElement, get: Any=get) -> Array[str]:
            def _arrow583(value_1: YAMLElement, value: Any=value) -> str:
                return string(value_1)

            return resizearray(_arrow583, value)
...
Decode_baseCommandDecoder: Callable[[YAMLElement], Array[str] | None] = _arrow584

def _arrow585(value_1: YAMLElement) -> str:
...
Decode_versionDecoder: Callable[[YAMLElement], str] = _arrow585

def _arrow586(value_1: YAMLElement) -> str:
    def getter(get: IGetters) -> str:
        object_arg: IRequiredGetter = get.Required
        def arg_1(value: YAMLElement, get: Any=get) -> str:
            return string(value)
...
Decode_classDecoder: Callable[[YAMLElement], str] = _arrow586

def Decode_stringOptionFieldDecoder(field: str) -> Callable[[YAMLElement], str | None]:
    def _arrow587(value_1: YAMLElement, field: Any=field) -> str | None:
...
def Decode_stringFieldDecoder(field: str) -> Callable[[YAMLElement], str]:
    def _arrow588(value_1: YAMLElement, field: Any=field) -> str:
        def getter(get: IGetters) -> str:
            object_arg: IRequiredGetter = get.Required
            def arg_1(value: YAMLElement, get: Any=get) -> str:
                return string(value)
...
def _arrow592(value_1: YAMLElement) -> Array[StepInput]:
    def getter(get: IGetters) -> Array[StepInput]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow591(__unit: None=None, get: Any=get) -> IEnumerable_1[StepInput]:
            def _arrow590(key: str) -> IEnumerable_1[StepInput]:
                value: YAMLElement = get_item_from_dict(dict_1, key)
                def _arrow589(__unit: None=None) -> str | None:
                ...
                return singleton(StepInput(key, _arrow589(), Decode_stringOptionFieldDecoder("default")(value), Decode_stringOptionFieldDecoder("valueFrom")(value)))
...
Decode_inputStepDecoder: Callable[[YAMLElement], Array[StepInput]] = _arrow592

def _arrow594(value_2: YAMLElement) -> Array[str]:
    def getter(get: IGetters) -> Array[str]:
        object_arg: IRequiredGetter = get.Required
        def arg_1(value: YAMLElement, get: Any=get) -> Array[str]:
            def _arrow593(value_1: YAMLElement, value: Any=value) -> str:
                return string(value_1)

            return resizearray(_arrow593, value)
...
Decode_outputStepsDecoder: Callable[[YAMLElement], Array[str]] = _arrow594

def _arrow602(value_1: YAMLElement) -> Array[WorkflowStep]:
    def getter(get: IGetters) -> Array[WorkflowStep]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow601(__unit: None=None, get: Any=get) -> IEnumerable_1[WorkflowStep]:
            def _arrow600(key: str) -> IEnumerable_1[WorkflowStep]:
                value: YAMLElement = get_item_from_dict(dict_1, key)
                run: str = Decode_stringFieldDecoder("run")(value)
                def _arrow595(get_1: IGetters) -> Array[StepInput]:
                    object_arg: IRequiredGetter = get_1.Required
                    return object_arg.Field("in", Decode_inputStepDecoder)

                inputs: Array[StepInput] = object(_arrow595, value)
                ...
                def _arrow599(__unit: None=None) -> IEnumerable_1[WorkflowStep]:
                    def _expr597():
                        wf_step.Hints = hints
                        return empty_1()

                    def _arrow598(__unit: None=None) -> IEnumerable_1[WorkflowStep]:
                        return singleton(wf_step)

                    return append(_expr597() if (hints is not None) else empty_1(), delay(_arrow598))

                return append(_expr596() if (requirements is not None) else empty_1(), delay(_arrow599))

            return collect(_arrow600, dict_1.keys())

        return list(to_array(delay(_arrow601)))

    return object(getter, value_1)


Decode_stepArrayDecoder: Callable[[YAMLElement], Array[WorkflowStep]] = _arrow602

def _arrow603(value: YAMLElement) -> Array[WorkflowStep]:
    def getter(get: IGetters) -> Array[WorkflowStep]:
        object_arg: IRequiredGetter = get.Required
...
Decode_stepsDecoder: Callable[[YAMLElement], Array[WorkflowStep]] = _arrow603
