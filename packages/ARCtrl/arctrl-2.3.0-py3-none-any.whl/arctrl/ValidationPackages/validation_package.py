        ...
        def _arrow2887(__unit: None=None) -> IEnumerable_1[str]:
            def _arrow2886(__unit: None=None) -> IEnumerable_1[str]:
                def _arrow2885(__unit: None=None) -> IEnumerable_1[str]:
                    ...
                    return append(singleton((" Version = " + value_1(this.Version)) + "") if (this.version is not None) else empty(), delay(_arrow2884))

                return append(singleton((" Name = " + this.Name) + ""), delay(_arrow2885))

            return append(singleton("{"), delay(_arrow2886))

        return join("\n", to_list(delay(_arrow2887)))
...
ValidationPackage_reflection = _expr2893
