...
def Process_getCharacteristicValues_763471FF(p: Process) -> FSharpList[MaterialAttributeValue]:
    ...
    return List_distinct(append(Process_getInputCharacteristicValues_763471FF(p), Process_getOutputCharacteristicValues_763471FF(p)), ObjectExpr699())
...
def Process_getCharacteristics_763471FF(p: Process) -> FSharpList[MaterialAttribute]:
    ...
    return List_distinct(choose(chooser, Process_getCharacteristicValues_763471FF(p)), ObjectExpr701())
...
def Process_getFactors_763471FF(p: Process) -> FSharpList[Factor]:
    ...
    return List_distinct(choose(chooser, Process_getFactorValues_763471FF(p)), ObjectExpr705())
...
def Process_getSources_763471FF(p: Process) -> FSharpList[Source]:
    ...
    return List_distinct(choose(chooser, default_arg(p.Inputs, empty())), ObjectExpr708())
...
def Process_getData_763471FF(p: Process) -> FSharpList[Data]:
    ...
    return List_distinct(append(choose(chooser, default_arg(p.Inputs, empty())), choose(chooser_1, default_arg(p.Outputs, empty()))), ObjectExpr710())
...
def Process_getSamples_763471FF(p: Process) -> FSharpList[Sample]:
    ...
    return List_distinct(append(choose(chooser, default_arg(p.Inputs, empty())), choose(chooser_1, default_arg(p.Outputs, empty()))), ObjectExpr713())
...
def Process_getMaterials_763471FF(p: Process) -> FSharpList[Material]:
    ...
    return List_distinct(append(choose(chooser, default_arg(p.Inputs, empty())), choose(chooser_1, default_arg(p.Outputs, empty()))), ObjectExpr714())
