...
from diff_cover_shopee import DESCRIPTION, VERSION
from diff_cover_shopee.config_parser import Tool, get_config
from diff_cover_shopee.diff_reporter import GitDiffReporter
from diff_cover_shopee.git_diff import GitDiffFileTool, GitDiffTool
from diff_cover_shopee.git_path import GitPathTool
from diff_cover_shopee.report_generator import (
    HtmlReportGenerator,
    JsonReportGenerator,
    MarkdownReportGenerator,
    StringReportGenerator,
)
from diff_cover_shopee.violationsreporters.violations_reporter import (
...
def parse_coverage_args(argv):
    ...
    parser.add_argument("--version", action="version", version=f"diff-cover-shopee {VERSION}")
