...
class MetaData(_message.Message):
    __slots__ = ("description", "max", "min", "unit", "size", "isRaw", "factor", "offset", "sender", "receiver", "cycleTime", "startValue", "multiplex", "e2e", "groups", "frameId")
    ...
    frameId: int
    def __init__(self, description: _Optional[str] = ..., max: _Optional[float] = ..., min: _Optional[float] = ..., unit: _Optional[str] = ..., size: _Optional[int] = ..., isRaw: bool = ..., factor: _Optional[float] = ..., offset: _Optional[float] = ..., sender: _Optional[_Iterable[str]] = ..., receiver: _Optional[_Iterable[str]] = ..., cycleTime: _Optional[float] = ..., startValue: _Optional[float] = ..., multiplex: _Optional[_Union[Multiplex, _Mapping]] = ..., e2e: _Optional[_Union[E2e, _Mapping]] = ..., groups: _Optional[_Iterable[_Union[Group, _Mapping]]] = ..., frameId: _Optional[int] = ...) -> None: ...
