...
class Ui_win_new_user(object):
    ...
    def retranslateUi(self, win_new_user):
        win_new_user.setWindowTitle(QCoreApplication.translate("win_new_user",
                                                               u"\u041d\u043e\u0432\u044b\u0439 \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044c",
                                                               None))
        self.groupBox_6.setTitle("")
        self.label.setText(QCoreApplication.translate("win_new_user",
                                                      u"* - \u043e\u0431\u044f\u0437\u0430\u0442\u0435\u043b\u044c\u043d\u043e\u0435 \u0437\u043d\u0430\u0447\u0435\u043d\u0438\u0435",
                                                      None))
        self.label_55.setText(
            QCoreApplication.translate("win_new_user", u"\u041f\u043e\u043b\u043d\u043e\u0435 \u0438\u043c\u044f*",
                                       None))
        # if QT_CONFIG(tooltip)
        self.le_fullname.setToolTip("")
        # endif // QT_CONFIG(tooltip)
        self.le_fullname.setText("")
        self.le_fullname.setPlaceholderText(QCoreApplication.translate("win_new_user",
                                                                       u"\u0418\u0432\u0430\u043d\u043e\u0432 \u0418\u0432\u0430\u043d \u0418\u0432\u0430\u043d\u043e\u0432\u0438\u0447",
                                                                       None))
        self.label_57.setText(QCoreApplication.translate("win_new_user",
                                                         u"\u0421\u0438\u0441\u0442\u0435\u043c\u043d\u043e\u0435 \u0438\u043c\u044f*",
                                                         None))
        # if QT_CONFIG(tooltip)
        ...
        self.label_2.setText(
            QCoreApplication.translate("win_new_user", u"\u041e\u0441\u043d\u043e\u0432\u043d\u043e\u0439 IP*", None))
        self.le_ip.setText("")
        self.le_ip.setPlaceholderText(QCoreApplication.translate("win_new_user", u"255.255.255.255", None))
        self.label_56.setText(
            QCoreApplication.translate("win_new_user", u"\u041f\u0430\u0440\u043e\u043b\u044c*", None))
        ...
        self.label_60.setText(QCoreApplication.translate("win_new_user",
                                                         u"\u041a\u043e\u043c\u043c\u0435\u043d\u0442\u0430\u0440\u0438\u0439",
                                                         None))
        # if QT_CONFIG(tooltip)
        ...
        self.le_comment.setPlaceholderText(QCoreApplication.translate("win_new_user",
                                                                      u"\u042d\u043d\u0435\u0440\u0433\u043e\u0440\u0435\u0441\u0443\u0440\u0441, \u044e\u0440\u0438\u0441\u0442",
                                                                      None))
        self.label_61.setText(
            QCoreApplication.translate("win_new_user", u"\u0421\u0442\u0430\u0442\u0443\u0441*", None))
        self.cb_active.setText(
            QCoreApplication.translate("win_new_user", u"\u0410\u043a\u0442\u0438\u0432\u0435\u043d", None))
    # retranslateUi
