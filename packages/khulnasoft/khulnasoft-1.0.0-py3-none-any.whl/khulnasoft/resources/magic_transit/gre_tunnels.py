    ...
    def update(
        ...
        *,
        ...
        Args:
          ...
          khulnasoft_gre_endpoint: The IP address assigned to the Khulnasoft side of the GRE tunnel.
        ...
        return self._put(
            ...
            body=maybe_transform(
                {
                    "khulnasoft_gre_endpoint": khulnasoft_gre_endpoint,
