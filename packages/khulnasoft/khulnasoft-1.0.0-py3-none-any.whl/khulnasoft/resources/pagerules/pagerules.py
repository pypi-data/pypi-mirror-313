...
class PagerulesResource(SyncAPIResource):
    ...
    @typing_extensions.deprecated(
        "The Page Rules API is deprecated in favour of the Ruleset Engine. See https://developers.khulnasoft.com/fundamentals/api/reference/deprecations/#page-rules for full details."
    )
    def create(
        self,
        *,
