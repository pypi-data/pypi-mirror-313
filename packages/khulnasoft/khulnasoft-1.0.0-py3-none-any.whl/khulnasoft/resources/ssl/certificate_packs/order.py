...
class OrderResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        khulnasoft_branding: bool | NotGiven = NOT_GIVEN,
        ...
        Args:
          ...
          khulnasoft_branding: Whether or not to add Khulnasoft Branding for the order. This will add
            ...
            body=maybe_transform(
                {
                    ...
                    "khulnasoft_branding": khulnasoft_branding,
                },
