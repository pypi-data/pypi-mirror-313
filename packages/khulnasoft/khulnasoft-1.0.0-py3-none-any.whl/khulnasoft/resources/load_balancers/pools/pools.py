    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          notification_email: This field is now deprecated. It has been moved to Khulnasoft's Centralized
    ...
    def update(
        ...
        *,
        ...
        Args:
          ...
          check_regions: A list of regions from which to run health checks. Null means every Khulnasoft
              data center.
