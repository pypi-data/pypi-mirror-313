    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          name: Human readable widget name. Not unique. Khulnasoft suggests that you set this to
          ...
          bot_fight_mode: If bot_fight_mode is set to `true`, Khulnasoft issues computationally expensive
              challenges in response to malicious bots (ENT only).

          clearance_level: If Turnstile is embedded on a Khulnasoft site and the widget should grant
              challenge clearance, this setting can determine the clearance level to be set

          offlabel: Do not show any Khulnasoft branding on the widget (ENT only).
