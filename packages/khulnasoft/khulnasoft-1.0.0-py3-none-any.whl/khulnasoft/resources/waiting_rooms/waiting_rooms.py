    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          cookie_suffix: Appends a '\\__' + a custom suffix to the end of Khulnasoft Waiting Room's cookie
          ...
          session_duration: Lifetime of a cookie (in minutes) set by Khulnasoft for users who get access to
