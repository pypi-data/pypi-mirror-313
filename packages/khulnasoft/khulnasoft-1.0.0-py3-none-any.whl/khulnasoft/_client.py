...
class Khulnasoft(SyncAPIClient):
    ...
    with_raw_response: KhulnasoftWithRawResponse
    with_streaming_response: KhulnasoftWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous khulnasoft client instance.

        This automatically infers the following arguments from their corresponding environment variables if they are not provided:
        - `api_token` from `KHULNASOFT_API_TOKEN`
        - `api_key` from `KHULNASOFT_API_KEY`
        - `api_email` from `KHULNASOFT_EMAIL`
        - `user_service_key` from `KHULNASOFT_API_USER_SERVICE_KEY`
        """
        if api_token is None:
            api_token = os.environ.get("KHULNASOFT_API_TOKEN")
        ...
        if user_service_key is None:
            user_service_key = os.environ.get("KHULNASOFT_API_USER_SERVICE_KEY")
        self.user_service_key = user_service_key

        if base_url is None:
            base_url = os.environ.get("KHULNASOFT_BASE_URL")
        if base_url is None:
            base_url = f"https://api.khulnasoft.com/client/v4"
        ...
        self.with_raw_response = KhulnasoftWithRawResponse(self)
        self.with_streaming_response = KhulnasoftWithStreamedResponse(self)
...
class AsyncKhulnasoft(AsyncAPIClient):
    ...
    with_raw_response: AsyncKhulnasoftWithRawResponse
    with_streaming_response: AsyncKhulnasoftWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async khulnasoft client instance.
        ...
        self.with_raw_response = AsyncKhulnasoftWithRawResponse(self)
        self.with_streaming_response = AsyncKhulnasoftWithStreamedResponse(self)
...
class KhulnasoftWithRawResponse:
    def __init__(self, client: Khulnasoft) -> None:
...
class AsyncKhulnasoftWithRawResponse:
    def __init__(self, client: AsyncKhulnasoft) -> None:
...
class KhulnasoftWithStreamedResponse:
    def __init__(self, client: Khulnasoft) -> None:
...
class AsyncKhulnasoftWithStreamedResponse:
    def __init__(self, client: AsyncKhulnasoft) -> None:
