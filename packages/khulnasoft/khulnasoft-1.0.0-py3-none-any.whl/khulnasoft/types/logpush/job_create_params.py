...
class JobCreateParams(TypedDict, total=False):
    ...
    Please use `max_upload_*` parameters instead. The frequency at which Khulnasoft
    ...
    Not unique. Khulnasoft suggests that you set this to a meaningful string, like
