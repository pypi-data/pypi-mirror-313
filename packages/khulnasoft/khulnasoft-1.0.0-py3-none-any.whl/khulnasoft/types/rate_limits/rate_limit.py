...
class Action(BaseModel):
    ...
    the zone. This object is optional. Notes: If you omit this object, Khulnasoft
    will use the default HTML error page. If "mode" is "challenge",
    "managed_challenge", or "js_challenge", Khulnasoft will use the zone challenge
...
class RateLimit(BaseModel):
    ...
    If the count exceeds the configured threshold within this period, Khulnasoft
