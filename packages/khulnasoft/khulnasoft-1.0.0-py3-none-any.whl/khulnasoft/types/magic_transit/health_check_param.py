...
class HealthCheckParam(TypedDict, total=False):
    ...
    result comes back to Khulnasoft via the open Internet, or bidirectional where
    ...
    healthchecks as the interface_address (not assigned to the Khulnasoft side of
