...
class OrderCreateResponse(BaseModel):
    ...
    khulnasoft_branding: Optional[bool] = None
    """Whether or not to add Khulnasoft Branding for the order.

    This will add sni.khulnasoftssl.com as the Common Name if set true.
    """
