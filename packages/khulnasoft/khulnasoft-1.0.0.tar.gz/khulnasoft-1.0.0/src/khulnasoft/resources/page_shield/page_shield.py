...
class PageShieldResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        use_khulnasoft_reporting_endpoint: bool | NotGiven = NOT_GIVEN,
        ...
        Args:
          ...
          use_khulnasoft_reporting_endpoint: When true, CSP reports will be sent to
        ...
        return self._put(
            ...
            body=maybe_transform(
                {
                    "enabled": enabled,
                    "use_khulnasoft_reporting_endpoint": use_khulnasoft_reporting_endpoint,
