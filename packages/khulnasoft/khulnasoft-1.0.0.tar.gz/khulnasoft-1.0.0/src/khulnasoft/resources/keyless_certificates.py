    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          port: The keyless SSL port used to communicate between Khulnasoft and the client's
              Keyless SSL server.
          ...
          tunnel: Configuration for using Keyless SSL through a Khulnasoft Tunnel
