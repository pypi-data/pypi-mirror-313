...
from khulnasoft.types.speed import Trend, PageListResponse
...
class TestPages:
    ...
    @parametrize
    def test_method_trend(self, client: Khulnasoft) -> None:
    ...
    @pytest.mark.skip(reason="TODO: investigate broken test")
    @parametrize
    def test_method_trend_with_all_params(self, client: Khulnasoft) -> None:
        page = client.speed.pages.trend(
            url="example.com",
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            device_type="DESKTOP",
    ...
    @pytest.mark.skip(reason="TODO: investigate broken test")
    @parametrize
    def test_raw_response_trend(self, client: Khulnasoft) -> None:
    ...
    @pytest.mark.skip(reason="TODO: investigate broken test")
    @parametrize
    def test_streaming_response_trend(self, client: Khulnasoft) -> None:
    ...
    @pytest.mark.skip(reason="TODO: investigate broken test")
    @parametrize
    def test_path_params_trend(self, client: Khulnasoft) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
...
class TestAsyncPages:
    ...
    @pytest.mark.skip(reason="TODO: investigate broken test")
    @parametrize
    async def test_method_trend(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @pytest.mark.skip(reason="TODO: investigate broken test")
    @parametrize
    async def test_method_trend_with_all_params(self, async_client: AsyncKhulnasoft) -> None:
        page = await async_client.speed.pages.trend(
            url="example.com",
            zone_id="023e105f4ecef8ad9ca31a8372d0c353",
            device_type="DESKTOP",
    ...
    @pytest.mark.skip(reason="TODO: investigate broken test")
    @parametrize
    async def test_raw_response_trend(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @pytest.mark.skip(reason="TODO: investigate broken test")
    @parametrize
    async def test_streaming_response_trend(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @pytest.mark.skip(reason="TODO: investigate broken test")
    @parametrize
    async def test_path_params_trend(self, async_client: AsyncKhulnasoft) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
