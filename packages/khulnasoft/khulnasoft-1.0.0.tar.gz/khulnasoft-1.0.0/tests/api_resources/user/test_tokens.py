...
class TestTokens:
            ...
            policies=[
                {
                    ...
                    "permission_groups": [{}, {}],
                    "resources": {
                        "com.khulnasoft.api.account.zone.22b1de5f1c0e4b3ea97bb1e963b06a43": "*",
                        "com.khulnasoft.api.account.zone.eb78d65290b24279ba6f44721b3ea3c4": "*",
                    },
                },
                {
                    "effect": "allow",
                    ...
                    "permission_groups": [
                        {
                            "meta": {
                                ...
                                "scopes": "com.khulnasoft.api.account",
                            }
                        },
                        {
                            "meta": {
    ...
    @parametrize
    def test_method_verify(self, client: Khulnasoft) -> None:
        token = client.user.tokens.verify()
        assert_matches_type(Optional[TokenVerifyResponse], token, path=["response"])

    @parametrize
    def test_raw_response_verify(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_streaming_response_verify(self, client: Khulnasoft) -> None:
...
class TestAsyncTokens:
    ...
    @parametrize
    async def test_method_verify(self, async_client: AsyncKhulnasoft) -> None:
        token = await async_client.user.tokens.verify()
        assert_matches_type(Optional[TokenVerifyResponse], token, path=["response"])

    @parametrize
    async def test_raw_response_verify(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_streaming_response_verify(self, async_client: AsyncKhulnasoft) -> None:
