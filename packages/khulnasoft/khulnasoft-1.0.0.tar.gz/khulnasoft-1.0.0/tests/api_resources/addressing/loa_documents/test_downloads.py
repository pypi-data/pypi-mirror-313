...
class TestDownloads:
    ...
    @pytest.mark.skip(
        reason="TODO: address broken spotlight error - https://github.com/khulnasoft/khulnasoft-typescript/actions/runs/9456639475/job/26048931174?pr=498#step:5:489"
    )
    @parametrize
