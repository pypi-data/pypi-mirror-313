...
class TestOwnership:
    ...
    @pytest.mark.skip(reason="TODO: investigate broken test")
    @parametrize
    def test_method_validate_with_all_params(self, client: Khulnasoft) -> None:
        ownership = client.logpush.ownership.validate(
            destination_conf="s3://mybucket/logs?region=us-west-2",
            ownership_challenge="00000000000000000000",
            account_id="account_id",
...
class TestAsyncOwnership:
    ...
    @pytest.mark.skip(reason="TODO: investigate broken test")
    @parametrize
    async def test_method_validate_with_all_params(self, async_client: AsyncKhulnasoft) -> None:
        ownership = await async_client.logpush.ownership.validate(
            destination_conf="s3://mybucket/logs?region=us-west-2",
            ownership_challenge="00000000000000000000",
            account_id="account_id",
