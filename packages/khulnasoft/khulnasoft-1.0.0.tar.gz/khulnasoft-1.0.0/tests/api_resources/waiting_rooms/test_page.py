...
class TestPage:
    ...
    @parametrize
    def test_method_preview(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_raw_response_preview(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_streaming_response_preview(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_path_params_preview(self, client: Khulnasoft) -> None:
...
class TestAsyncPage:
    ...
    @parametrize
    async def test_method_preview(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_raw_response_preview(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_streaming_response_preview(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_path_params_preview(self, async_client: AsyncKhulnasoft) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
