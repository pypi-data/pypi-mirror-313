...
class TestActivationCheck:
    ...
    @parametrize
    def test_method_trigger(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_raw_response_trigger(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_streaming_response_trigger(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_path_params_trigger(self, client: Khulnasoft) -> None:
...
class TestAsyncActivationCheck:
    ...
    @parametrize
    async def test_method_trigger(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_raw_response_trigger(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_streaming_response_trigger(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_path_params_trigger(self, async_client: AsyncKhulnasoft) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
