...
class TestPagerduty:
    ...
    @pytest.mark.skip(
        reason="prism errors - https://github.com/khulnasoft/khulnasoft-python/actions/runs/9327225061/job/25676826349?pr=482#step:5:4285"
    )
    @parametrize
    ...
    @parametrize
    def test_method_link(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_raw_response_link(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_streaming_response_link(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_path_params_link(self, client: Khulnasoft) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
...
class TestAsyncPagerduty:
    ...
    @parametrize
    async def test_method_link(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_raw_response_link(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_streaming_response_link(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_path_params_link(self, async_client: AsyncKhulnasoft) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
