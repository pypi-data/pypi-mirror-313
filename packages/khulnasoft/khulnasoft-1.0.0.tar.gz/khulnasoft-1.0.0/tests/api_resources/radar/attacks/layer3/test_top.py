...
class TestTop:
    ...
    @parametrize
    def test_method_attacks(self, client: Khulnasoft) -> None:
        top = client.radar.attacks.layer3.top.attacks()
        assert_matches_type(TopAttacksResponse, top, path=["response"])

    @parametrize
    def test_method_attacks_with_all_params(self, client: Khulnasoft) -> None:
        top = client.radar.attacks.layer3.top.attacks(
    ...
    @parametrize
    def test_raw_response_attacks(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_streaming_response_attacks(self, client: Khulnasoft) -> None:
...
class TestAsyncTop:
    ...
    @parametrize
    async def test_method_attacks(self, async_client: AsyncKhulnasoft) -> None:
        top = await async_client.radar.attacks.layer3.top.attacks()
        assert_matches_type(TopAttacksResponse, top, path=["response"])

    @parametrize
    async def test_method_attacks_with_all_params(self, async_client: AsyncKhulnasoft) -> None:
        top = await async_client.radar.attacks.layer3.top.attacks(
            continent=["string", "string", "string"],
            date_end=[
                parse_datetime("2019-12-27T18:11:19.117Z"),
    ...
    @parametrize
    async def test_raw_response_attacks(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_streaming_response_attacks(self, async_client: AsyncKhulnasoft) -> None:
