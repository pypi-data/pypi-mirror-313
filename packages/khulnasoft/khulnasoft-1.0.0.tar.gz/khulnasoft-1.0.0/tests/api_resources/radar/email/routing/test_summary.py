...
class TestSummary:
    ...
    @parametrize
    def test_method_encrypted(self, client: Khulnasoft) -> None:
        summary = client.radar.email.routing.summary.encrypted()
        assert_matches_type(SummaryEncryptedResponse, summary, path=["response"])

    @parametrize
    def test_method_encrypted_with_all_params(self, client: Khulnasoft) -> None:
        summary = client.radar.email.routing.summary.encrypted(
            arc=["PASS", "NONE", "FAIL"],
            date_end=[
                parse_datetime("2019-12-27T18:11:19.117Z"),
    ...
    @parametrize
    def test_raw_response_encrypted(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_streaming_response_encrypted(self, client: Khulnasoft) -> None:
...
class TestAsyncSummary:
    ...
    @parametrize
    async def test_method_encrypted(self, async_client: AsyncKhulnasoft) -> None:
        summary = await async_client.radar.email.routing.summary.encrypted()
        assert_matches_type(SummaryEncryptedResponse, summary, path=["response"])

    @parametrize
    async def test_method_encrypted_with_all_params(self, async_client: AsyncKhulnasoft) -> None:
        summary = await async_client.radar.email.routing.summary.encrypted(
            arc=["PASS", "NONE", "FAIL"],
            date_end=[
                parse_datetime("2019-12-27T18:11:19.117Z"),
    ...
    @parametrize
    async def test_raw_response_encrypted(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_streaming_response_encrypted(self, async_client: AsyncKhulnasoft) -> None:
