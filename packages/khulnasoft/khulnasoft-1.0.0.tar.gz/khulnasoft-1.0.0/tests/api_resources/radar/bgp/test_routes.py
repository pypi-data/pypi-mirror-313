...
class TestRoutes:
    ...
    @parametrize
    def test_method_moas(self, client: Khulnasoft) -> None:
        route = client.radar.bgp.routes.moas()
        assert_matches_type(RouteMoasResponse, route, path=["response"])

    @parametrize
    def test_method_moas_with_all_params(self, client: Khulnasoft) -> None:
        route = client.radar.bgp.routes.moas(
            format="JSON",
            invalid_only=True,
            origin=0,
    ...
    @parametrize
    def test_raw_response_moas(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_streaming_response_moas(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_method_pfx2as(self, client: Khulnasoft) -> None:
        route = client.radar.bgp.routes.pfx2as()
        assert_matches_type(RoutePfx2asResponse, route, path=["response"])

    @parametrize
    def test_method_pfx2as_with_all_params(self, client: Khulnasoft) -> None:
        route = client.radar.bgp.routes.pfx2as(
            format="JSON",
    ...
    @parametrize
    def test_raw_response_pfx2as(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_streaming_response_pfx2as(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_method_stats(self, client: Khulnasoft) -> None:
        route = client.radar.bgp.routes.stats()
        assert_matches_type(RouteStatsResponse, route, path=["response"])

    @parametrize
    def test_method_stats_with_all_params(self, client: Khulnasoft) -> None:
        route = client.radar.bgp.routes.stats(
            asn=174,
            format="JSON",
            location="US",
    ...
    @parametrize
    def test_raw_response_stats(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_streaming_response_stats(self, client: Khulnasoft) -> None:
...
class TestAsyncRoutes:
    ...
    @parametrize
    async def test_method_moas(self, async_client: AsyncKhulnasoft) -> None:
        route = await async_client.radar.bgp.routes.moas()
        assert_matches_type(RouteMoasResponse, route, path=["response"])

    @parametrize
    async def test_method_moas_with_all_params(self, async_client: AsyncKhulnasoft) -> None:
        route = await async_client.radar.bgp.routes.moas(
            format="JSON",
            invalid_only=True,
            origin=0,
    ...
    @parametrize
    async def test_raw_response_moas(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_streaming_response_moas(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_method_pfx2as(self, async_client: AsyncKhulnasoft) -> None:
        route = await async_client.radar.bgp.routes.pfx2as()
        assert_matches_type(RoutePfx2asResponse, route, path=["response"])

    @parametrize
    async def test_method_pfx2as_with_all_params(self, async_client: AsyncKhulnasoft) -> None:
        route = await async_client.radar.bgp.routes.pfx2as(
            format="JSON",
            longest_prefix_match=True,
            origin=0,
    ...
    @parametrize
    async def test_raw_response_pfx2as(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_streaming_response_pfx2as(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_method_stats(self, async_client: AsyncKhulnasoft) -> None:
        route = await async_client.radar.bgp.routes.stats()
        assert_matches_type(RouteStatsResponse, route, path=["response"])

    @parametrize
    async def test_method_stats_with_all_params(self, async_client: AsyncKhulnasoft) -> None:
        route = await async_client.radar.bgp.routes.stats(
            asn=174,
            format="JSON",
            location="US",
    ...
    @parametrize
    async def test_raw_response_stats(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_streaming_response_stats(self, async_client: AsyncKhulnasoft) -> None:
