...
class TestDatasets:
    ...
    @parametrize
    def test_method_download(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_method_download_with_all_params(self, client: Khulnasoft) -> None:
        dataset = client.radar.datasets.download(
            dataset_id=3,
            format="JSON",
        )
    ...
    @parametrize
    def test_raw_response_download(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_streaming_response_download(self, client: Khulnasoft) -> None:
...
class TestAsyncDatasets:
    ...
    @parametrize
    async def test_method_download(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_method_download_with_all_params(self, async_client: AsyncKhulnasoft) -> None:
        dataset = await async_client.radar.datasets.download(
            dataset_id=3,
            format="JSON",
        )
    ...
    @parametrize
    async def test_raw_response_download(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_streaming_response_download(self, async_client: AsyncKhulnasoft) -> None:
