...
from khulnasoft.types.storage import Schema, Components
...
class TestAnalytics:
    ...
    @parametrize
    def test_method_stored(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_method_stored_with_all_params(self, client: Khulnasoft) -> None:
        analytics = client.storage.analytics.stored(
            account_id="023e105f4ecef8ad9ca31a8372d0c353",
            query={
    ...
    @parametrize
    def test_raw_response_stored(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_streaming_response_stored(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_path_params_stored(self, client: Khulnasoft) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
...
class TestAsyncAnalytics:
    ...
    @parametrize
    async def test_method_stored(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_method_stored_with_all_params(self, async_client: AsyncKhulnasoft) -> None:
        analytics = await async_client.storage.analytics.stored(
            account_id="023e105f4ecef8ad9ca31a8372d0c353",
            query={
                "dimensions": ["namespaceId"],
    ...
    @parametrize
    async def test_raw_response_stored(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_streaming_response_stored(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_path_params_stored(self, async_client: AsyncKhulnasoft) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
