...
class TestIPSECTunnels:
    ...
    def test_method_create(self, client: Khulnasoft) -> None:
        ipsec_tunnel = client.magic_transit.ipsec_tunnels.create(
            ...
            khulnasoft_endpoint="203.0.113.1",
    ...
    @parametrize
    def test_method_psk_generate(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_raw_response_psk_generate(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_streaming_response_psk_generate(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_path_params_psk_generate(self, client: Khulnasoft) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
...
class TestAsyncIPSECTunnels:
    ...
    @parametrize
    async def test_method_psk_generate(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_raw_response_psk_generate(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_streaming_response_psk_generate(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_path_params_psk_generate(self, async_client: AsyncKhulnasoft) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
