...
class TestRoutes:
    ...
    @parametrize
    def test_method_empty(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_raw_response_empty(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_streaming_response_empty(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_path_params_empty(self, client: Khulnasoft) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
...
class TestAsyncRoutes:
    ...
    @parametrize
    async def test_method_empty(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_raw_response_empty(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_streaming_response_empty(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_path_params_empty(self, async_client: AsyncKhulnasoft) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
