...
from khulnasoft.types.challenges import (
    Widget,
    WidgetListResponse,
)
...
class TestWidgets:
    ...
    def test_method_create(self, client: Khulnasoft) -> None:
        widget = client.challenges.widgets.create(
            ...
            domains=["203.0.113.1", "khulnasoft.com", "blog.example.com"],
            mode="invisible",
            name="blog.khulnasoft.com login form",
        )
    ...
    @parametrize
    def test_method_rotate_secret(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_method_rotate_secret_with_all_params(self, client: Khulnasoft) -> None:
        widget = client.challenges.widgets.rotate_secret(
            sitekey="0x4AAF00AAAABn0R22HWm-YUc",
            account_id="023e105f4ecef8ad9ca31a8372d0c353",
    ...
    @parametrize
    def test_raw_response_rotate_secret(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_streaming_response_rotate_secret(self, client: Khulnasoft) -> None:
    ...
    @parametrize
    def test_path_params_rotate_secret(self, client: Khulnasoft) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
...
class TestAsyncWidgets:
    ...
    @parametrize
    async def test_method_rotate_secret(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_method_rotate_secret_with_all_params(self, async_client: AsyncKhulnasoft) -> None:
        widget = await async_client.challenges.widgets.rotate_secret(
            sitekey="0x4AAF00AAAABn0R22HWm-YUc",
            account_id="023e105f4ecef8ad9ca31a8372d0c353",
            invalidate_immediately=True,
    ...
    @parametrize
    async def test_raw_response_rotate_secret(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_streaming_response_rotate_secret(self, async_client: AsyncKhulnasoft) -> None:
    ...
    @parametrize
    async def test_path_params_rotate_secret(self, async_client: AsyncKhulnasoft) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
