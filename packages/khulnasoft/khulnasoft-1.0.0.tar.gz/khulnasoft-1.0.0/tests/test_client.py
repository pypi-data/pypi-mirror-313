...
from khulnasoft import Khulnasoft, AsyncKhulnasoft, APIResponseValidationError
from khulnasoft._types import Omit
from khulnasoft._models import BaseModel, FinalRequestOptions
from khulnasoft._constants import RAW_RESPONSE_HEADER
from khulnasoft._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from khulnasoft._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Khulnasoft | AsyncKhulnasoft) -> int:
...
class TestKhulnasoft:
    client = Khulnasoft(base_url=base_url, api_key=api_key, api_email=api_email, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "khulnasoft/_legacy_response.py",
                        "khulnasoft/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "khulnasoft/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        client2 = Khulnasoft(base_url=base_url, api_key=None, api_email=None, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, client: Khulnasoft) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(KHULNASOFT_BASE_URL="http://localhost:5000/from/env"):
            client = Khulnasoft(api_key=api_key, api_email=api_email, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Khulnasoft) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Khulnasoft) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Khulnasoft) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = Khulnasoft(base_url=base_url, api_key=api_key, api_email=api_email, _strict_response_validation=False)
    ...
    @mock.patch("khulnasoft._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
...
class TestAsyncKhulnasoft:
    client = AsyncKhulnasoft(base_url=base_url, api_key=api_key, api_email=api_email, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        client2 = AsyncKhulnasoft(base_url=base_url, api_key=None, api_email=None, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncKhulnasoft) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(KHULNASOFT_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncKhulnasoft(api_key=api_key, api_email=api_email, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncKhulnasoft) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncKhulnasoft) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncKhulnasoft) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
