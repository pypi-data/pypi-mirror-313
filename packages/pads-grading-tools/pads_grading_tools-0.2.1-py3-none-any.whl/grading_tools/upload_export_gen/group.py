...
def join_and_export(output_file: str, grading_column: str, feedback_column: str, naming_dictionary: NamingDictionary,
    ...
    # update
    updated_df.loc[:, naming_dictionary.MOODLE_GRADING_COL] = stringified_scores_col
    if feedback_column:
        updated_df.loc[:, naming_dictionary.MOODLE_FEEDBACK_COL] = updated_df[feedback_column]
