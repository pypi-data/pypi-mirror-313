...
def complete_file_path(file_path: str, default_file_name: str | None = None, default_extension: str | None = None) -> PathLike[str]:
...
def read_moodle_groups_csv(file_name: str | PathLike[str]) -> pd.DataFrame:
