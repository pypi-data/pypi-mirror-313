...
import re
from typing import Dict, Any, Iterable, Literal, NamedTuple, TypeGuard, Union, get_args
...
class _GetRunResponse(BaseModel):
    ...
    pod_phase: Literal["Pending", "Running", "Succeeded", "Failed", "Unknown"] = Field(
        alias="podPhase"
    )
...
class RunStatus(ABC):
    ...
    def name(self) -> StatusName:
        ...
        pod_phase_map: Dict[str, StatusName] = {
            "Pending": "NOT STARTED",
            "Running": "RUNNING",
            "Succeeded": "DONE",
            "Failed": "ERROR",
        ...
        # call API endpoint for that run
        ...
        if response_payload["runs"][0]["podPhase"] is None:
            return "NOT STARTED"
        return pod_phase_map[response_payload["runs"][0]["podPhase"]]
