...
class AbMediaCompute3(RootModel[Union[AbMediaCompute, AbMediaCompute5]]):
    root: Union[AbMediaCompute, AbMediaCompute5]


class AbMediaComputeOrUnknown(RootModel[Optional[AbMediaCompute3]]):
    root: Optional[AbMediaCompute3]
