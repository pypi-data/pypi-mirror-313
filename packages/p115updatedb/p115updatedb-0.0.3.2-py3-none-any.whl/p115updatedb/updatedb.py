...
def diff_dir(
    ...
    if tree:
        count, ancestors, seen, data_it = iterdir(client, id, first_page_size=128, payload={"show_dir": 0})
    else:
        count, ancestors, seen, data_it = iterdir(client, id, first_page_size=16)
