...
class StepsBlockProcessor(BlockProcessor):
    ...
    def run(self, parent, blocks):
        ...
        # Join the content and convert it to HTML, removing any <ol> elements
        markdown_content = ''.join(content)
        # Ensure we don't have any <ol> tags in the content
        markdown_content = markdown_content.replace("<ol>", "").replace("</ol>", "")
