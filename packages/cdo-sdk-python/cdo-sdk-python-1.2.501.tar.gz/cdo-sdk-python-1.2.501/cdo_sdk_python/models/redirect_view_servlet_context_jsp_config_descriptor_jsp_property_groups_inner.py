...
class RedirectViewServletContextJspConfigDescriptorJspPropertyGroupsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["errorOnUndeclaredNamespace", "trimDirectiveWhitespaces", "isXml", "includePreludes", "includeCodas", "pageEncoding", "elIgnored", "deferredSyntaxAllowedAsLiteral", "scriptingInvalid", "buffer", "defaultContentType", "urlPatterns"]
