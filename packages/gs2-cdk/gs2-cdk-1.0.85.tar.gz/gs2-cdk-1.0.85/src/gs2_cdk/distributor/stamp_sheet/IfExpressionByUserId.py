...
class IfExpressionByUserId(ConsumeAction):
    ...
    def __init__(
        ...
        true_actions: Optional[List[ConsumeAction]] = None,
        false_actions: Optional[List[ConsumeAction]] = None,
        ...
        properties["trueActions"] = true_actions
        properties["falseActions"] = false_actions
