...
![alt text](media/api-key-create.png)
...
# or return_type='url' -> returns a link to the translated file keeping original file's layout:
response = client.translate_file_request(
...
![alt text](media/api-key-usage.png)
