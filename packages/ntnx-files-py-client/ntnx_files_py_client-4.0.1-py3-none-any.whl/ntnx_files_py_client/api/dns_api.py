...
class DnsApi(object):
    ...
    def list_dns_records(self, fileServerExtId, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """List DNS records

        >>> response = api.list_dns_records(fileServerExtId, (optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_dns_records(fileServerExtId, async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_files_py_client.models.files.v4.config.ListDnsRecordsApiResponse`.
        ...
        if ('fileServerExtId' not in params or params['fileServerExtId'] is None):
            raise ValueError("Missing the required parameter `fileServerExtId` when calling `list_dns_records`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/files/v4.0/config/file-servers/{fileServerExtId}/dns-records', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='files.v4.config.ListDnsRecordsApiResponse',  # noqa: E501
    ...
    def revise_dns_records(self, extId, body, **kwargs):  # noqa: E501
        """Revise DNS records on DNS server

        >>> response = api.revise_dns_records(extId, body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.revise_dns_records(extId, body, async_req=True)
        >>> result = thread.get()

        :param extId: The external identifier of the file server.
        :type extId:
            :class:`str`, required
        :param body: Model for updating DNS records on the DNS server.
        :type body:
            :class:`~ntnx_files_py_client.models.files.v4.config.DnsRecordSpec`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::

                           async_req=True
        :return: An instance of class :class:`~ntnx_files_py_client.models.files.v4.config.ReviseDnsRecordsApiResponse`.
        ...
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `revise_dns_records`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `revise_dns_records`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/files/v4.0/config/file-servers/{extId}/$actions/revise-dns-records', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='files.v4.config.ReviseDnsRecordsApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
    ...
    def verify_dns_records(self, extId, body=None, **kwargs):  # noqa: E501
        """Verify DNS records of file server on the DNS server

        >>> response = api.verify_dns_records(extId, (optional) body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.verify_dns_records(extId, async_req=True)
        >>> result = thread.get()

        :param extId: The external identifier of the file server.
        :type extId:
            :class:`str`, required
        :param body: Model to verify DNS records on the DNS server.
        :type body:
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_files_py_client.models.files.v4.config.VerifyDnsRecordsApiResponse`.
        ...
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `verify_dns_records`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/files/v4.0/config/file-servers/{extId}/$actions/verify-dns-records', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='files.v4.config.VerifyDnsRecordsApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
