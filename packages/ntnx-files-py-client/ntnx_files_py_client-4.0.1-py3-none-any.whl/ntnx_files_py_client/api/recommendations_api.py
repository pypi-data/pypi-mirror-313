...
class RecommendationsApi(object):
    ...
    def delete_recommendation_by_id(self, fileServerExtId, extId, **kwargs):  # noqa: E501
        """Delete recommendation

        >>> response = api.delete_recommendation_by_id(fileServerExtId, extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.delete_recommendation_by_id(fileServerExtId, extId, async_req=True)
        >>> result = thread.get()

        :param fileServerExtId: The external identifier of the file server.
        :type fileServerExtId:
            :class:`str`, required
        :param extId: The external identifier of the recommendation.
        :type extId:
            :class:`str`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_files_py_client.models.files.v4.config.DeleteRecommendationApiResponse`.
        ...
        if ('fileServerExtId' not in params or params['fileServerExtId'] is None):
            raise ValueError("Missing the required parameter `fileServerExtId` when calling `delete_recommendation_by_id`")  # noqa: E501
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `delete_recommendation_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/files/v4.0/config/file-servers/{fileServerExtId}/recommendations/{extId}', 'DELETE',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='files.v4.config.DeleteRecommendationApiResponse',  # noqa: E501
    ...
    def get_recommendation_by_id(self, fileServerExtId, extId, **kwargs):  # noqa: E501
        """Get recommendation

        >>> response = api.get_recommendation_by_id(fileServerExtId, extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_recommendation_by_id(fileServerExtId, extId, async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_files_py_client.models.files.v4.config.GetRecommendationApiResponse`.
        ...
        # verify the required parameter 'fileServerExtId' is set
        if ('fileServerExtId' not in params or params['fileServerExtId'] is None):
            raise ValueError("Missing the required parameter `fileServerExtId` when calling `get_recommendation_by_id`")  # noqa: E501
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/files/v4.0/config/file-servers/{fileServerExtId}/recommendations/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='files.v4.config.GetRecommendationApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
    ...
    def list_recommendations(self, fileServerExtId, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        """List recommendations

        >>> response = api.list_recommendations(fileServerExtId, (optional) _page, (optional) _limit, (optional) _filter, (optional) _orderby, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_recommendations(fileServerExtId, async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_files_py_client.models.files.v4.config.ListRecommendationsApiResponse`.
        ...
        # verify the required parameter 'fileServerExtId' is set
        if ('fileServerExtId' not in params or params['fileServerExtId'] is None):
            raise ValueError("Missing the required parameter `fileServerExtId` when calling `list_recommendations`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/files/v4.0/config/file-servers/{fileServerExtId}/recommendations', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='files.v4.config.ListRecommendationsApiResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
