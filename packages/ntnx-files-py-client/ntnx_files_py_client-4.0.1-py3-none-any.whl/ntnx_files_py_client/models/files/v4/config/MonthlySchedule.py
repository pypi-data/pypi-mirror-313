...
class MonthlySchedule(object):
    ...
    :param days_of_month: (:attr:`days_of_month`) A list of the days of the month on which snapshots should be taken.
    :type days_of_month: required
    ...
    def __init__(self, days_of_month=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'files.v4.config.MonthlySchedule'
