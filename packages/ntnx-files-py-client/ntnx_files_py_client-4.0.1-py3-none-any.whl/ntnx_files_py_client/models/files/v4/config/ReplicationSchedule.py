...
from ntnx_files_py_client.models.files.v4.config.ScheduleInterval import ScheduleInterval  # noqa: F401,E501
...
class ReplicationSchedule(object):
    ...
    :param frequency: (:attr:`frequency`) The frequency at which data should be copied from source to target path. RPO (Integer values are multiplied by schedule type to get the next scheduled replication time).
    ...
    :param start_time: (:attr:`start_time`) Time of the day, the policy will be started. If the value not set, the policy will be applicable immediately.
    :type start_time: 
    ...
    swagger_types = {
        'frequency': 'int',
        'schedule_interval': 'files.v4.config.ScheduleInterval',
        'start_time': 'datetime',
    ...
    def __init__(self, frequency=None, schedule_interval=None, start_time=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'files.v4.config.ReplicationSchedule'
    ...
    def frequency(self, frequency):
        ...
        if frequency is not None and frequency > 2147483647:  # noqa: E501
    ...
    def schedule_interval(self):
        ...
        :type:
            :class:`~ntnx_files_py_client.models.files.v4.config.ScheduleInterval`
        """  # noqa: E501
