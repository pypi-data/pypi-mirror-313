...
class ClientDetails(object):
    ...
    :param port: (:attr:`port`) Client port.
    :type port: 
    
     min=1, max=65536
    :param is_backup: (:attr:`is_backup`) The flag that defines whether the client IP is a backup server or not. (**Default** False)
    :type is_backup: 
    ...
    def __init__(self, address=None, port=None, is_backup=False, *args, **kwargs):  # noqa: E501
        self.__address = None
        self.__port = None
    ...
    def _initialize_object_type(self):
        return 'files.v4.config.ClientDetails'
