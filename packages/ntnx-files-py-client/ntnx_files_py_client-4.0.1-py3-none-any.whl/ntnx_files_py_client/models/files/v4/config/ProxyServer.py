...
class ProxyServer(object):
    ...
    :param url: (:attr:`url`) HTTP proxy server URL.
    :type url: 
    ...
    def __init__(self, url=None, credential=None, *args, **kwargs):  # noqa: E501
        self.__url = None
    ...
    def _initialize_object_type(self):
        return 'files.v4.config.ProxyServer'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ProxyServer, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProxyServer):
            return False
