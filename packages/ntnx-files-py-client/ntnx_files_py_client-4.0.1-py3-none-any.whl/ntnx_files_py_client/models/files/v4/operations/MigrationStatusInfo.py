...
class MigrationStatusInfo(object):
    ...
    def __init__(self, status=None, status_msg=None, *args, **kwargs):  # noqa: E501
        self.__status = None
    ...
    def _initialize_object_type(self):
        return 'files.v4.operations.MigrationStatusInfo'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(MigrationStatusInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MigrationStatusInfo):
            return False
