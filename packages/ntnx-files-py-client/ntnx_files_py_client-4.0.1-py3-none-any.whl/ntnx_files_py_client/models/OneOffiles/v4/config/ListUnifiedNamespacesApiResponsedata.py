...
class ListUnifiedNamespacesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<files.v4.config.UnifiedNamespace>': 'list[files.v4.config.UnifiedNamespace]',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.ListUnifiedNamespacesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListUnifiedNamespacesApiResponsedata.discriminator_value_class_map.values():
            return list(ListUnifiedNamespacesApiResponsedata.discriminator_value_class_map.keys())[list(ListUnifiedNamespacesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListUnifiedNamespacesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListUnifiedNamespacesApiResponsedata):
            return False
