...
class GetFileServerApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.config.FileServer': 'files.v4.config.FileServer',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.GetFileServerApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetFileServerApiResponsedata.discriminator_value_class_map.values():
            return list(GetFileServerApiResponsedata.discriminator_value_class_map.keys())[list(GetFileServerApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetFileServerApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetFileServerApiResponsedata):
            return False
