...
class ListRansomwareConfigsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<files.v4.config.RansomwareConfig>': 'list[files.v4.config.RansomwareConfig]',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.ListRansomwareConfigsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListRansomwareConfigsApiResponsedata.discriminator_value_class_map.values():
            return list(ListRansomwareConfigsApiResponsedata.discriminator_value_class_map.keys())[list(ListRansomwareConfigsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListRansomwareConfigsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRansomwareConfigsApiResponsedata):
            return False
