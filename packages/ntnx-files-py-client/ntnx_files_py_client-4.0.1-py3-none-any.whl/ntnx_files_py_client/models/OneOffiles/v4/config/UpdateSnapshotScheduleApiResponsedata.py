...
class UpdateSnapshotScheduleApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<files.v4.error.AppMessage>': 'list[files.v4.error.AppMessage]',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.UpdateSnapshotScheduleApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateSnapshotScheduleApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateSnapshotScheduleApiResponsedata.discriminator_value_class_map.keys())[list(UpdateSnapshotScheduleApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateSnapshotScheduleApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateSnapshotScheduleApiResponsedata):
            return False
