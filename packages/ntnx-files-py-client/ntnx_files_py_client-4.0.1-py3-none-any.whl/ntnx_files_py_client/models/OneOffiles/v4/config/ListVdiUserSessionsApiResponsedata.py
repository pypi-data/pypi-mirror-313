...
class ListVdiUserSessionsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<files.v4.config.VdiUserSession>': 'list[files.v4.config.VdiUserSession]',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.ListVdiUserSessionsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListVdiUserSessionsApiResponsedata.discriminator_value_class_map.values():
            return list(ListVdiUserSessionsApiResponsedata.discriminator_value_class_map.keys())[list(ListVdiUserSessionsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListVdiUserSessionsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListVdiUserSessionsApiResponsedata):
            return False
