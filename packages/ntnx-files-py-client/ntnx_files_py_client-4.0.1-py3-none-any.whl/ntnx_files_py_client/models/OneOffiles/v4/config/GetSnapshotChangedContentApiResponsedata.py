...
class GetSnapshotChangedContentApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.config.SnapshotChangedContent': 'files.v4.config.SnapshotChangedContent',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.GetSnapshotChangedContentApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetSnapshotChangedContentApiResponsedata.discriminator_value_class_map.values():
            return list(GetSnapshotChangedContentApiResponsedata.discriminator_value_class_map.keys())[list(GetSnapshotChangedContentApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetSnapshotChangedContentApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetSnapshotChangedContentApiResponsedata):
            return False
