...
class FixInfectedFileApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.FixInfectedFileApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in FixInfectedFileApiResponsedata.discriminator_value_class_map.values():
            return list(FixInfectedFileApiResponsedata.discriminator_value_class_map.keys())[list(FixInfectedFileApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(FixInfectedFileApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FixInfectedFileApiResponsedata):
            return False
