...
class GetEmailConfigApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.config.EmailConfig': 'files.v4.config.EmailConfig',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.GetEmailConfigApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetEmailConfigApiResponsedata.discriminator_value_class_map.values():
            return list(GetEmailConfigApiResponsedata.discriminator_value_class_map.keys())[list(GetEmailConfigApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetEmailConfigApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetEmailConfigApiResponsedata):
            return False
