...
class DownloadUserMappingsApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.DownloadUserMappingsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DownloadUserMappingsApiResponsedata.discriminator_value_class_map.values():
            return list(DownloadUserMappingsApiResponsedata.discriminator_value_class_map.keys())[list(DownloadUserMappingsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DownloadUserMappingsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DownloadUserMappingsApiResponsedata):
            return False
