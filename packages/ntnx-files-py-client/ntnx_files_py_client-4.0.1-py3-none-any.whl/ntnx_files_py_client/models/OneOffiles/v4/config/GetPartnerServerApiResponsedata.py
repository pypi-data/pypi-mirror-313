...
class GetPartnerServerApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.config.PartnerServer': 'files.v4.config.PartnerServer',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.GetPartnerServerApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetPartnerServerApiResponsedata.discriminator_value_class_map.values():
            return list(GetPartnerServerApiResponsedata.discriminator_value_class_map.keys())[list(GetPartnerServerApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetPartnerServerApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetPartnerServerApiResponsedata):
            return False
