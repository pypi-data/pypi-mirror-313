...
class ListQuotaPoliciesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<files.v4.config.QuotaPolicy>': 'list[files.v4.config.QuotaPolicy]',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.ListQuotaPoliciesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListQuotaPoliciesApiResponsedata.discriminator_value_class_map.values():
            return list(ListQuotaPoliciesApiResponsedata.discriminator_value_class_map.keys())[list(ListQuotaPoliciesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListQuotaPoliciesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListQuotaPoliciesApiResponsedata):
            return False
