...
class UpdateVdiUserSessionApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.UpdateVdiUserSessionApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateVdiUserSessionApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateVdiUserSessionApiResponsedata.discriminator_value_class_map.keys())[list(UpdateVdiUserSessionApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateVdiUserSessionApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateVdiUserSessionApiResponsedata):
            return False
