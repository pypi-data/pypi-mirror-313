...
class GetQuotaPolicyApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.config.QuotaPolicy': 'files.v4.config.QuotaPolicy',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.GetQuotaPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetQuotaPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(GetQuotaPolicyApiResponsedata.discriminator_value_class_map.keys())[list(GetQuotaPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetQuotaPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetQuotaPolicyApiResponsedata):
            return False
