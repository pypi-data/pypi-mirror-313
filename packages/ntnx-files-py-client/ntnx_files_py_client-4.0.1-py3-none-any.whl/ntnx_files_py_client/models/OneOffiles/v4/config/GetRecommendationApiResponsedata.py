...
class GetRecommendationApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.config.Recommendation': 'files.v4.config.Recommendation',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.GetRecommendationApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetRecommendationApiResponsedata.discriminator_value_class_map.values():
            return list(GetRecommendationApiResponsedata.discriminator_value_class_map.keys())[list(GetRecommendationApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetRecommendationApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetRecommendationApiResponsedata):
            return False
