...
class ListInfectedFilesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<files.v4.config.InfectedFile>': 'list[files.v4.config.InfectedFile]',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.ListInfectedFilesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListInfectedFilesApiResponsedata.discriminator_value_class_map.values():
            return list(ListInfectedFilesApiResponsedata.discriminator_value_class_map.keys())[list(ListInfectedFilesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListInfectedFilesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListInfectedFilesApiResponsedata):
            return False
