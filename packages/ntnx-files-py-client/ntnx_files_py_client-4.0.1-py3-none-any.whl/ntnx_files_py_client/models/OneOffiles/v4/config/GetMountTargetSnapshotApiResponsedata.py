...
class GetMountTargetSnapshotApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.config.Snapshot': 'files.v4.config.Snapshot',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.GetMountTargetSnapshotApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetMountTargetSnapshotApiResponsedata.discriminator_value_class_map.values():
            return list(GetMountTargetSnapshotApiResponsedata.discriminator_value_class_map.keys())[list(GetMountTargetSnapshotApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetMountTargetSnapshotApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetMountTargetSnapshotApiResponsedata):
            return False
