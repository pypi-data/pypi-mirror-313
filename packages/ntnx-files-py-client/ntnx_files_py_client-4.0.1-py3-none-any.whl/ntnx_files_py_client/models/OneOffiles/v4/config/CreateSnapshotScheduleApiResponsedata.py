...
class CreateSnapshotScheduleApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.config.SnapshotSchedule': 'files.v4.config.SnapshotSchedule',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.CreateSnapshotScheduleApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateSnapshotScheduleApiResponsedata.discriminator_value_class_map.values():
            return list(CreateSnapshotScheduleApiResponsedata.discriminator_value_class_map.keys())[list(CreateSnapshotScheduleApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateSnapshotScheduleApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateSnapshotScheduleApiResponsedata):
            return False
