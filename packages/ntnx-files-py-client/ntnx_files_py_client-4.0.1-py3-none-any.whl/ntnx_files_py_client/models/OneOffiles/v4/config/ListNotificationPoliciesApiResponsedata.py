...
class ListNotificationPoliciesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<files.v4.config.NotificationPolicy>': 'list[files.v4.config.NotificationPolicy]',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.ListNotificationPoliciesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListNotificationPoliciesApiResponsedata.discriminator_value_class_map.values():
            return list(ListNotificationPoliciesApiResponsedata.discriminator_value_class_map.keys())[list(ListNotificationPoliciesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListNotificationPoliciesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListNotificationPoliciesApiResponsedata):
            return False
