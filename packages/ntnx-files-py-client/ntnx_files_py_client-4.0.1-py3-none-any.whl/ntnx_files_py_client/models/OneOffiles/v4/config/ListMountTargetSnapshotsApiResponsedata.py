...
class ListMountTargetSnapshotsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<files.v4.config.Snapshot>': 'list[files.v4.config.Snapshot]',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.ListMountTargetSnapshotsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListMountTargetSnapshotsApiResponsedata.discriminator_value_class_map.values():
            return list(ListMountTargetSnapshotsApiResponsedata.discriminator_value_class_map.keys())[list(ListMountTargetSnapshotsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListMountTargetSnapshotsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListMountTargetSnapshotsApiResponsedata):
            return False
