...
class AntivirusServerStatsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.stats.AntivirusStats': 'files.v4.stats.AntivirusStats',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.stats.AntivirusServerStatsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in AntivirusServerStatsApiResponsedata.discriminator_value_class_map.values():
            return list(AntivirusServerStatsApiResponsedata.discriminator_value_class_map.keys())[list(AntivirusServerStatsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AntivirusServerStatsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AntivirusServerStatsApiResponsedata):
            return False
