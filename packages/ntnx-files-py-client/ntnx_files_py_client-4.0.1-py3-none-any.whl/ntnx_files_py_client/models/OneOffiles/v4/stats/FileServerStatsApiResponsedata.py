...
class FileServerStatsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.stats.FileServerStats': 'files.v4.stats.FileServerStats',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.stats.FileServerStatsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in FileServerStatsApiResponsedata.discriminator_value_class_map.values():
            return list(FileServerStatsApiResponsedata.discriminator_value_class_map.keys())[list(FileServerStatsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(FileServerStatsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileServerStatsApiResponsedata):
            return False
