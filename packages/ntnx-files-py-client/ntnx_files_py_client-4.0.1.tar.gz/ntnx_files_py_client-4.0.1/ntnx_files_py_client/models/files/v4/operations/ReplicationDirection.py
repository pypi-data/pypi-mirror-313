...
class ReplicationDirection(object):
    ...
    def _initialize_object_type(self):
        return 'files.v4.operations.ReplicationDirection'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ReplicationDirection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReplicationDirection):
            return False
