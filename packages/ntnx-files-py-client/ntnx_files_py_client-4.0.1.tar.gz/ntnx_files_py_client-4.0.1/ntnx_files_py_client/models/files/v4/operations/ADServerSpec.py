...
class ADServerSpec(object):
    ...
    def __init__(self, credential=None, preferred_domain_controller=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'files.v4.operations.ADServerSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ADServerSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ADServerSpec):
            return False
