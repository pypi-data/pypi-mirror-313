...
class MountTargetStats(ExternalizableAbstractModel):
    ...
    :param tiering_latency_ms: (:attr:`tiering_latency_ms`) The average tiering access latency metric for put operation in milliseconds.
    :type tiering_latency_ms: 
    
    
    :param used_bytes: (:attr:`used_bytes`) Disk space in bytes used by the mount target.
    :type used_bytes: 
    ...
    swagger_types = {
        ...
        'tiering_latency_ms': 'list[common.v1.stats.TimeIntValuePair]',
        'used_bytes': 'list[common.v1.stats.TimeIntValuePair]',
        'ext_id': 'str',
    ...
    attribute_map = {
        ...
        'tiering_latency_ms': 'tieringLatencyMs',
    ...
    def __init__(self, number_of_files=None, number_of_connections=None, average_latency_us=None, read_latency_us=None, write_latency_us=None, metadata_latency_us=None, average_throughput_bps=None, write_throughput_bps=None, read_throughput_bps=None, average_iops=None, write_iops=None, read_iops=None, metadata_iops=None, snapshot_used_bytes=None, dataset_space_used_bytes=None, tiering_latency_ms=None, used_bytes=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        ...
        self.__tiering_latency_ms = None
        self.__used_bytes = None
        ...
        if tiering_latency_ms is not None:
            self.__tiering_latency_ms = tiering_latency_ms
        if used_bytes is not None:
            self.__used_bytes = used_bytes

    def _initialize_object_type(self):
        return 'files.v4.stats.MountTargetStats'
    ...
    def tiering_latency_ms(self):
        ...
        :type:
             list[ :class:`~ntnx_files_py_client.models.common.v1.stats.TimeIntValuePair` ]
        """  # noqa: E501
        return self.__tiering_latency_ms

    @tiering_latency_ms.setter
    def tiering_latency_ms(self, tiering_latency_ms):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(MountTargetStats, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MountTargetStats):
            return False
