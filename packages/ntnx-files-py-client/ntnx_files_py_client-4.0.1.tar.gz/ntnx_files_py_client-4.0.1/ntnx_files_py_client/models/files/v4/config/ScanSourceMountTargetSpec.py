...
class ScanSourceMountTargetSpec(object):

    """Mount target for migration source.

    :param path: (:attr:`path`) Name of the source mount target. Only the mount target name is stored in the database after discovery, but to scan you can specify the mount target name with path, in this case name including path is stored in DB.
    :type path: required
    ...
    def __init__(self, path=None, protocol=None, *args, **kwargs):  # noqa: E501
        self.__path = None
    ...
    def _initialize_object_type(self):
        return 'files.v4.config.ScanSourceMountTargetSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ScanSourceMountTargetSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ScanSourceMountTargetSpec):
            return False
