...
from ntnx_files_py_client.models.files.v4.config.BackupAccessType import BackupAccessType  # noqa: F401,E501
from ntnx_files_py_client.models.files.v4.config.OperationType import OperationType  # noqa: F401,E501

class BackupServerAccessControlBlock(object):
    ...
    :param mount_target_ext_id: (:attr:`mount_target_ext_id`) Mount target external identifier for the partner server.
    ...
    swagger_types = {
        ...
        'access_type': 'files.v4.config.BackupAccessType',
        'mount_target_ext_id': 'str',
        'operation_type': 'files.v4.config.OperationType',
    ...
    def __init__(self, address=None, access_type=None, mount_target_ext_id=None, operation_type=None, *args, **kwargs):  # noqa: E501
        self.__address = None
    ...
    def _initialize_object_type(self):
        return 'files.v4.config.BackupServerAccessControlBlock'
    ...
    def access_type(self):
        ...
        :type:
            :class:`~ntnx_files_py_client.models.files.v4.config.BackupAccessType`
        """  # noqa: E501
    ...
    def operation_type(self):
        ...
        :type:
            :class:`~ntnx_files_py_client.models.files.v4.config.OperationType`
        """  # noqa: E501
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(BackupServerAccessControlBlock, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BackupServerAccessControlBlock):
            return False
