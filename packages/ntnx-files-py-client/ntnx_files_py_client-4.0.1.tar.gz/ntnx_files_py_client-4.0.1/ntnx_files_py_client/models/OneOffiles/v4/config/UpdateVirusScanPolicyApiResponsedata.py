...
class UpdateVirusScanPolicyApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.UpdateVirusScanPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateVirusScanPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateVirusScanPolicyApiResponsedata.discriminator_value_class_map.keys())[list(UpdateVirusScanPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateVirusScanPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateVirusScanPolicyApiResponsedata):
            return False
