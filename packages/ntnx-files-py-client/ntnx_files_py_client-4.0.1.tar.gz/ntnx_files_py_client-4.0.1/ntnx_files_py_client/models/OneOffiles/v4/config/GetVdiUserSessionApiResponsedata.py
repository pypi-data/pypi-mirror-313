...
class GetVdiUserSessionApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.config.VdiUserSession': 'files.v4.config.VdiUserSession',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.GetVdiUserSessionApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetVdiUserSessionApiResponsedata.discriminator_value_class_map.values():
            return list(GetVdiUserSessionApiResponsedata.discriminator_value_class_map.keys())[list(GetVdiUserSessionApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetVdiUserSessionApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetVdiUserSessionApiResponsedata):
            return False
