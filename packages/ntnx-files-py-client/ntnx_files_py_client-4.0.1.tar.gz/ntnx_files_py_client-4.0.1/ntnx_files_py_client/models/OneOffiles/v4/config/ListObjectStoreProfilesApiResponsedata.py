...
class ListObjectStoreProfilesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<files.v4.config.ObjectStoreProfile>': 'list[files.v4.config.ObjectStoreProfile]',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.ListObjectStoreProfilesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListObjectStoreProfilesApiResponsedata.discriminator_value_class_map.values():
            return list(ListObjectStoreProfilesApiResponsedata.discriminator_value_class_map.keys())[list(ListObjectStoreProfilesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListObjectStoreProfilesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListObjectStoreProfilesApiResponsedata):
            return False
