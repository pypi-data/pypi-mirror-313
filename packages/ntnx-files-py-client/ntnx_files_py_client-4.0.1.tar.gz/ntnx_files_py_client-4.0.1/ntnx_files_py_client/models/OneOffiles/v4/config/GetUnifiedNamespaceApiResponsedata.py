...
class GetUnifiedNamespaceApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.config.UnifiedNamespace': 'files.v4.config.UnifiedNamespace',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.GetUnifiedNamespaceApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetUnifiedNamespaceApiResponsedata.discriminator_value_class_map.values():
            return list(GetUnifiedNamespaceApiResponsedata.discriminator_value_class_map.keys())[list(GetUnifiedNamespaceApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetUnifiedNamespaceApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetUnifiedNamespaceApiResponsedata):
            return False
