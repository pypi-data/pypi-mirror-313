...
class ComputeSnapshotChangeApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.ComputeSnapshotChangeApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ComputeSnapshotChangeApiResponsedata.discriminator_value_class_map.values():
            return list(ComputeSnapshotChangeApiResponsedata.discriminator_value_class_map.keys())[list(ComputeSnapshotChangeApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ComputeSnapshotChangeApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ComputeSnapshotChangeApiResponsedata):
            return False
