...
class ListMountTargetsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<files.v4.config.MountTarget>': 'list[files.v4.config.MountTarget]',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.ListMountTargetsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListMountTargetsApiResponsedata.discriminator_value_class_map.values():
            return list(ListMountTargetsApiResponsedata.discriminator_value_class_map.keys())[list(ListMountTargetsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListMountTargetsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListMountTargetsApiResponsedata):
            return False
