...
class GetAntivirusServerApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.config.AntivirusServer': 'files.v4.config.AntivirusServer',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.GetAntivirusServerApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetAntivirusServerApiResponsedata.discriminator_value_class_map.values():
            return list(GetAntivirusServerApiResponsedata.discriminator_value_class_map.keys())[list(GetAntivirusServerApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetAntivirusServerApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetAntivirusServerApiResponsedata):
            return False
