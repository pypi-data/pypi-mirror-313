...
class GetObjectStoreProfileApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.config.ObjectStoreProfile': 'files.v4.config.ObjectStoreProfile',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.GetObjectStoreProfileApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetObjectStoreProfileApiResponsedata.discriminator_value_class_map.values():
            return list(GetObjectStoreProfileApiResponsedata.discriminator_value_class_map.keys())[list(GetObjectStoreProfileApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetObjectStoreProfileApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetObjectStoreProfileApiResponsedata):
            return False
