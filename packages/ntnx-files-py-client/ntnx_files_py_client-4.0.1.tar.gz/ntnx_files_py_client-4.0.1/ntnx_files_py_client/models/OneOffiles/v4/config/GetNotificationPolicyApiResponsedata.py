...
class GetNotificationPolicyApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.config.NotificationPolicy': 'files.v4.config.NotificationPolicy',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.GetNotificationPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetNotificationPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(GetNotificationPolicyApiResponsedata.discriminator_value_class_map.keys())[list(GetNotificationPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetNotificationPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetNotificationPolicyApiResponsedata):
            return False
