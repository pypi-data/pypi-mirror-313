...
class GetTieringConfigurationApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.config.TierConfiguration': 'files.v4.config.TierConfiguration',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.GetTieringConfigurationApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetTieringConfigurationApiResponsedata.discriminator_value_class_map.values():
            return list(GetTieringConfigurationApiResponsedata.discriminator_value_class_map.keys())[list(GetTieringConfigurationApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetTieringConfigurationApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetTieringConfigurationApiResponsedata):
            return False
