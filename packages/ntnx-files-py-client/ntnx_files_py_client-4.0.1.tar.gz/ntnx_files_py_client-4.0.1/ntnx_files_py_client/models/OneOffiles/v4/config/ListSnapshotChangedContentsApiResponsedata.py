...
class ListSnapshotChangedContentsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<files.v4.config.SnapshotChangedContent>': 'list[files.v4.config.SnapshotChangedContent]',
        'files.v4.error.ErrorResponse': 'files.v4.error.ErrorResponse'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.ListSnapshotChangedContentsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListSnapshotChangedContentsApiResponsedata.discriminator_value_class_map.values():
            return list(ListSnapshotChangedContentsApiResponsedata.discriminator_value_class_map.keys())[list(ListSnapshotChangedContentsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListSnapshotChangedContentsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSnapshotChangedContentsApiResponsedata):
            return False
