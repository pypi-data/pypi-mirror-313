...
class ListSnapshotSchedulesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<files.v4.config.SnapshotSchedule>': 'list[files.v4.config.SnapshotSchedule]',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.ListSnapshotSchedulesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListSnapshotSchedulesApiResponsedata.discriminator_value_class_map.values():
            return list(ListSnapshotSchedulesApiResponsedata.discriminator_value_class_map.keys())[list(ListSnapshotSchedulesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListSnapshotSchedulesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSnapshotSchedulesApiResponsedata):
            return False
