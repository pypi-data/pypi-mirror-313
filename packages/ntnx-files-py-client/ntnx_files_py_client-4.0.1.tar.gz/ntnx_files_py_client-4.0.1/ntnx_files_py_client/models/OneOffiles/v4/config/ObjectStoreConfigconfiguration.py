...
class ObjectStoreConfigconfiguration(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.config.AWSConfig': 'files.v4.config.AWSConfig',
        'files.v4.config.AzureConfig': 'files.v4.config.AzureConfig'
    }

    ONE_OF_ITEM_DISCRIMINATOR_NAME = '$configurationItemDiscriminator'
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.ObjectStoreConfigconfiguration'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ObjectStoreConfigconfiguration.discriminator_value_class_map.values():
            return list(ObjectStoreConfigconfiguration.discriminator_value_class_map.keys())[list(ObjectStoreConfigconfiguration.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ObjectStoreConfigconfiguration, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ObjectStoreConfigconfiguration):
            return False
