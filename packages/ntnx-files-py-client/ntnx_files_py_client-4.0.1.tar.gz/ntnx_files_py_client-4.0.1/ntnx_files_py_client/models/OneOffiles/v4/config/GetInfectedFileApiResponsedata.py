...
class GetInfectedFileApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.config.InfectedFile': 'files.v4.config.InfectedFile',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.GetInfectedFileApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetInfectedFileApiResponsedata.discriminator_value_class_map.values():
            return list(GetInfectedFileApiResponsedata.discriminator_value_class_map.keys())[list(GetInfectedFileApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetInfectedFileApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetInfectedFileApiResponsedata):
            return False
