...
class GetReplicationPolicyApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'files.v4.config.ReplicationPolicy': 'files.v4.config.ReplicationPolicy',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.GetReplicationPolicyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetReplicationPolicyApiResponsedata.discriminator_value_class_map.values():
            return list(GetReplicationPolicyApiResponsedata.discriminator_value_class_map.keys())[list(GetReplicationPolicyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetReplicationPolicyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetReplicationPolicyApiResponsedata):
            return False
