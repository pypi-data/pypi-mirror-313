...
class ListPartnerServersApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<files.v4.config.PartnerServer>': 'list[files.v4.config.PartnerServer]',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.ListPartnerServersApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListPartnerServersApiResponsedata.discriminator_value_class_map.values():
            return list(ListPartnerServersApiResponsedata.discriminator_value_class_map.keys())[list(ListPartnerServersApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListPartnerServersApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListPartnerServersApiResponsedata):
            return False
