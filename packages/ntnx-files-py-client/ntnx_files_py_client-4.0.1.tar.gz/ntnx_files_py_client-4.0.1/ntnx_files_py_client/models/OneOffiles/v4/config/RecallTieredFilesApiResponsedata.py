...
class RecallTieredFilesApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.RecallTieredFilesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RecallTieredFilesApiResponsedata.discriminator_value_class_map.values():
            return list(RecallTieredFilesApiResponsedata.discriminator_value_class_map.keys())[list(RecallTieredFilesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RecallTieredFilesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecallTieredFilesApiResponsedata):
            return False
