...
class UploadUserMappingsApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.UploadUserMappingsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UploadUserMappingsApiResponsedata.discriminator_value_class_map.values():
            return list(UploadUserMappingsApiResponsedata.discriminator_value_class_map.keys())[list(UploadUserMappingsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UploadUserMappingsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadUserMappingsApiResponsedata):
            return False
