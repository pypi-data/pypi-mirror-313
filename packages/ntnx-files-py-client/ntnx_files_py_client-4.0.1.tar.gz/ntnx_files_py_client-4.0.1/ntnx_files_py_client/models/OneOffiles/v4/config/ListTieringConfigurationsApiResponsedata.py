...
class ListTieringConfigurationsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<files.v4.config.TierConfiguration>': 'list[files.v4.config.TierConfiguration]',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.ListTieringConfigurationsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListTieringConfigurationsApiResponsedata.discriminator_value_class_map.values():
            return list(ListTieringConfigurationsApiResponsedata.discriminator_value_class_map.keys())[list(ListTieringConfigurationsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListTieringConfigurationsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTieringConfigurationsApiResponsedata):
            return False
