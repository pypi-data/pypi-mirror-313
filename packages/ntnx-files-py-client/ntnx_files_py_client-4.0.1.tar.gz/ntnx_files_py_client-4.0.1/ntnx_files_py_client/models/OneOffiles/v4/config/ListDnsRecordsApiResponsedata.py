...
class ListDnsRecordsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<files.v4.config.DnsRecord>': 'list[files.v4.config.DnsRecord]',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.ListDnsRecordsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListDnsRecordsApiResponsedata.discriminator_value_class_map.values():
            return list(ListDnsRecordsApiResponsedata.discriminator_value_class_map.keys())[list(ListDnsRecordsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListDnsRecordsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListDnsRecordsApiResponsedata):
            return False
