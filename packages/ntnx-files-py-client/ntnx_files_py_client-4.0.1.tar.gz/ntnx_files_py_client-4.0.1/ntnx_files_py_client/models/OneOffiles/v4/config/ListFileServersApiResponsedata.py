...
class ListFileServersApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<files.v4.config.FileServer>': 'list[files.v4.config.FileServer]',
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.ListFileServersApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListFileServersApiResponsedata.discriminator_value_class_map.values():
            return list(ListFileServersApiResponsedata.discriminator_value_class_map.keys())[list(ListFileServersApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListFileServersApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListFileServersApiResponsedata):
            return False
