...
class DisableWormLegalHoldApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOffiles.v4.config.DisableWormLegalHoldApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DisableWormLegalHoldApiResponsedata.discriminator_value_class_map.values():
            return list(DisableWormLegalHoldApiResponsedata.discriminator_value_class_map.keys())[list(DisableWormLegalHoldApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DisableWormLegalHoldApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DisableWormLegalHoldApiResponsedata):
            return False
