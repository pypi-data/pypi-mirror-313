...
double YeoJohnsonTransformation::logDensityTransformed(vector<double>& params, double transData, double data, double leftCensThresh)
{
...
double YeoJohnsonTransformation::logJacobianTransformed(vector<double>& params, double transData, double data, double leftCensThresh)
{
...
vector<double> YeoJohnsonTransformation::getParams() {

    vector<double> params = {m_transLambda, m_scale, m_shift};
