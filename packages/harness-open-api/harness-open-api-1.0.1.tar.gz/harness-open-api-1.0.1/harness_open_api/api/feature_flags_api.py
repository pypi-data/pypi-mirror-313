...
class FeatureFlagsApi(object):
    ...
    def put_feature_flag(self, account_identifier, org_identifier, project_identifier, identifier, **kwargs):  # noqa: E501
        """Updates a Feature Flag  # noqa: E501

        Updates a Feature Flag in the Project  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_feature_flag(account_identifier, org_identifier, project_identifier, identifier, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_feature_flag_with_http_info(account_identifier, org_identifier, project_identifier, identifier, **kwargs)  # noqa: E501
        else:
            (data) = self.put_feature_flag_with_http_info(account_identifier, org_identifier, project_identifier, identifier, **kwargs)  # noqa: E501
            return data

    def put_feature_flag_with_http_info(self, account_identifier, org_identifier, project_identifier, identifier, **kwargs):  # noqa: E501
        """Updates a Feature Flag  # noqa: E501

        Updates a Feature Flag in the Project  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_feature_flag_with_http_info(account_identifier, org_identifier, project_identifier, identifier, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['account_identifier', 'org_identifier', 'project_identifier', 'identifier', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_feature_flag" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'account_identifier' is set
        if ('account_identifier' not in params or
                params['account_identifier'] is None):
            raise ValueError("Missing the required parameter `account_identifier` when calling `put_feature_flag`")  # noqa: E501
        # verify the required parameter 'org_identifier' is set
        if ('org_identifier' not in params or
                params['org_identifier'] is None):
            raise ValueError("Missing the required parameter `org_identifier` when calling `put_feature_flag`")  # noqa: E501
        # verify the required parameter 'project_identifier' is set
        if ('project_identifier' not in params or
                params['project_identifier'] is None):
            raise ValueError("Missing the required parameter `project_identifier` when calling `put_feature_flag`")  # noqa: E501
        # verify the required parameter 'identifier' is set
        if ('identifier' not in params or
                params['identifier'] is None):
            raise ValueError("Missing the required parameter `identifier` when calling `put_feature_flag`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/cf/admin/features/{identifier}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
