...
class CloudCostAutoStoppingRulesApi(object):
    ...
    def cool_down_autostopping_rule(self, body, account_identifier, account_id, rule_id, **kwargs):  # noqa: E501
        ...
        :param str account_identifier: Account Identifier for the Entity (required)
        :param str account_id: Account Identifier for the Entity (required)
        :param float rule_id: ID of the AutoStopping rule you want to cool down (required)
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def warm_up_autostopping_rule(self, body, account_identifier, account_id, rule_id, **kwargs):  # noqa: E501
        """Warm up an AutoStopping Rule  # noqa: E501

        Warm up resources under an Autostopping rule  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.warm_up_autostopping_rule(body, account_identifier, account_id, rule_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param WarmUpOption body: Warm Up Options (required)
        :param str account_identifier: Account Identifier for the Entity (required)
        :param str account_id: Account Identifier for the Entity (required)
        :param float rule_id: ID of the AutoStopping rule which you want to warm up (required)
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.warm_up_autostopping_rule_with_http_info(body, account_identifier, account_id, rule_id, **kwargs)  # noqa: E501
        else:
            (data) = self.warm_up_autostopping_rule_with_http_info(body, account_identifier, account_id, rule_id, **kwargs)  # noqa: E501
            return data

    def warm_up_autostopping_rule_with_http_info(self, body, account_identifier, account_id, rule_id, **kwargs):  # noqa: E501
        """Warm up an AutoStopping Rule  # noqa: E501

        Warm up resources under an Autostopping rule  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.warm_up_autostopping_rule_with_http_info(body, account_identifier, account_id, rule_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method warm_up_autostopping_rule" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `warm_up_autostopping_rule`")  # noqa: E501
        # verify the required parameter 'account_identifier' is set
        if ('account_identifier' not in params or
                params['account_identifier'] is None):
            raise ValueError("Missing the required parameter `account_identifier` when calling `warm_up_autostopping_rule`")  # noqa: E501
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params or
                params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `warm_up_autostopping_rule`")  # noqa: E501
        # verify the required parameter 'rule_id' is set
        if ('rule_id' not in params or
                params['rule_id'] is None):
            raise ValueError("Missing the required parameter `rule_id` when calling `warm_up_autostopping_rule`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/gateway/lw/api/accounts/{account_id}/autostopping/rules/{rule_id}/warmup', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
