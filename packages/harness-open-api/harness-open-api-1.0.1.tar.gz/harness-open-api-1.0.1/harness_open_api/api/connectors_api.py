...
class ConnectorsApi(object):
    ...
    def create_connector_with_http_info(self, body, account_identifier, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'account_identifier', 'branch', 'repo_identifier', 'root_folder', 'file_path', 'commit_msg', 'is_new_branch', 'base_branch', 'connector_ref', 'store_type', 'repo_name', 'is_harness_code_repo']  # noqa: E501
    ...
    def list_connector_by_fqn(self, body, account_identifier, **kwargs):  # noqa: E501
        ...
        Lists all Connectors for an Account by Fully Qualified Name (FQN) with a limit of max 1000 FQNs per request.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param list[str] body: A list of connectors' FQNs as strings. A maximum of 1000 FQNs are allowed. (required)
        :param str account_identifier: Account Identifier for the Entity. (required)
    ...
    def update_connector_with_http_info(self, body, account_identifier, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'account_identifier', 'branch', 'repo_identifier', 'root_folder', 'file_path', 'commit_msg', 'last_object_id', 'resolved_conflict_commit_id', 'base_branch', 'connector_ref', 'last_commit_id', 'is_new_branch', 'is_harness_code_repo']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
