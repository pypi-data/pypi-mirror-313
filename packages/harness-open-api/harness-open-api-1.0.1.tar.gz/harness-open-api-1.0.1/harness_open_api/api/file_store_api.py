...
class FileStoreApi(object):
    ...
    def get_file_content_using_scoped_file_path_v2(self, **kwargs):  # noqa: E501
        """Get file content of scopedFilePathV2  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_file_content_using_scoped_file_path_v2(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str body: The scoped file path reference
        :param str account_identifier: Account Identifier for the Entity.
        :param str org_identifier: Organization Identifier for the Entity.
        :param str project_identifier: Project Identifier for the Entity.
        :return: ResponseDTOString
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_file_content_using_scoped_file_path_v2_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_file_content_using_scoped_file_path_v2_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_file_content_using_scoped_file_path_v2_with_http_info(self, **kwargs):  # noqa: E501
        """Get file content of scopedFilePathV2  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_file_content_using_scoped_file_path_v2_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_file_content_using_scoped_file_path_v2" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/ng/api/file-store/files/content', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
