...
class RolloutsApi(object):
    ...
    def rollouts_service_get_rollout_status(self, agent_identifier, request_name, **kwargs):  # noqa: E501
        """rollouts_service_get_rollout_status  # noqa: E501

        Get current status for the given Rollout resource  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rollouts_service_get_rollout_status(agent_identifier, request_name, async_req=True)
        >>> result = thread.get()
        ...
        :return: V1RolloutInfo
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.rollouts_service_get_rollout_status_with_http_info(agent_identifier, request_name, **kwargs)  # noqa: E501
        else:
            (data) = self.rollouts_service_get_rollout_status_with_http_info(agent_identifier, request_name, **kwargs)  # noqa: E501
            return data

    def rollouts_service_get_rollout_status_with_http_info(self, agent_identifier, request_name, **kwargs):  # noqa: E501
        """rollouts_service_get_rollout_status  # noqa: E501

        Get current status for the given Rollout resource  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rollouts_service_get_rollout_status_with_http_info(agent_identifier, request_name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method rollouts_service_get_rollout_status" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('agent_identifier' not in params or
            ...
            raise ValueError("Missing the required parameter `agent_identifier` when calling `rollouts_service_get_rollout_status`")  # noqa: E501
        # verify the required parameter 'request_name' is set
        if ('request_name' not in params or
                params['request_name'] is None):
            raise ValueError("Missing the required parameter `request_name` when calling `rollouts_service_get_rollout_status`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/gitops/api/v1/agents/{agentIdentifier}/applications/{request.name}/rollouts/status', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='V1RolloutInfo',  # noqa: E501
