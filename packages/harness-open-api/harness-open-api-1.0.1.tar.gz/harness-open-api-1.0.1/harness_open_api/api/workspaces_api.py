...
class WorkspacesApi(object):
    ...
    def workspaces_clone_workspace(self, body, harness_account, org, project, workspace, **kwargs):  # noqa: E501
        """clone-workspace workspaces  # noqa: E501
        ...
        :param CloneWorkspaceRequestBody body: (required)
    ...
    def workspaces_create_data(self, pipeline_id, stage_id, pipeline_execution_id, pipeline_stage_id, provisioner_type, data_type, org, project, workspace, harness_account, **kwargs):  # noqa: E501
        """create-data workspaces  # noqa: E501
    ...
    def workspaces_create_data_with_http_info(self, pipeline_id, stage_id, pipeline_execution_id, pipeline_stage_id, provisioner_type, data_type, org, project, workspace, harness_account, **kwargs):  # noqa: E501
        ...
        all_params = ['pipeline_id', 'stage_id', 'pipeline_execution_id', 'pipeline_stage_id', 'provisioner_type', 'data_type', 'org', 'project', 'workspace', 'harness_account', 'policy_action']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='WorkspaceDataInfo',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def workspaces_create_speculative_plan(self, org, project, workspace, harness_account, **kwargs):  # noqa: E501
        """create-speculative-plan workspaces  # noqa: E501

        Create a speculative plan for a workspace.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.workspaces_create_speculative_plan(org, project, workspace, harness_account, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str org: Org is the organisation identifier. (required)
        :param str project: Project is the project identifier. (required)
        :param str workspace: The workspace associated with the speculative plan. (required)
        :param str harness_account: Account is the internal customer account ID. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.workspaces_create_speculative_plan_with_http_info(org, project, workspace, harness_account, **kwargs)  # noqa: E501
        else:
            (data) = self.workspaces_create_speculative_plan_with_http_info(org, project, workspace, harness_account, **kwargs)  # noqa: E501
            return data

    def workspaces_create_speculative_plan_with_http_info(self, org, project, workspace, harness_account, **kwargs):  # noqa: E501
        """create-speculative-plan workspaces  # noqa: E501

        Create a speculative plan for a workspace.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.workspaces_create_speculative_plan_with_http_info(org, project, workspace, harness_account, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method workspaces_create_speculative_plan" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'org' is set
        if ('org' not in params or
                params['org'] is None):
            raise ValueError("Missing the required parameter `org` when calling `workspaces_create_speculative_plan`")  # noqa: E501
        # verify the required parameter 'project' is set
        if ('project' not in params or
                params['project'] is None):
            raise ValueError("Missing the required parameter `project` when calling `workspaces_create_speculative_plan`")  # noqa: E501
        # verify the required parameter 'workspace' is set
        if ('workspace' not in params or
                params['workspace'] is None):
            raise ValueError("Missing the required parameter `workspace` when calling `workspaces_create_speculative_plan`")  # noqa: E501
        # verify the required parameter 'harness_account' is set
        if ('harness_account' not in params or
                params['harness_account'] is None):
            raise ValueError("Missing the required parameter `harness_account` when calling `workspaces_create_speculative_plan`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/iacm/api/orgs/{org}/projects/{project}/workspaces/{workspace}/speculative-plans', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='SpeculativePlan',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def workspaces_create_workspace(self, body, harness_account, org, project, **kwargs):  # noqa: E501
        """create-workspace workspaces  # noqa: E501
        ...
        :param async_req bool
        :param Workspace2 body: (required)
        :param str harness_account: Account is the internal customer account ID. (required)
        :param str org: Org is the organisation identifier. (required)
        :param str project: Project is the project identifier. (required)
        :return: WorkspacesCreateWorkspaceResponseBody
    ...
    def workspaces_destroy_workspace(self, org, project, identifier, harness_account, **kwargs):  # noqa: E501
        """destroy-workspace workspaces  # noqa: E501
    ...
    def workspaces_download_speculative_plan(self, org, project, workspace, id, harness_account, **kwargs):  # noqa: E501
        """download-speculative-plan workspaces  # noqa: E501

        Download the source code diff for the speculative plan.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.workspaces_download_speculative_plan(org, project, workspace, id, harness_account, async_req=True)
        >>> result = thread.get()
        ...
        :param str id: The ID of the speculative plan. (required)
        :param str harness_account: Account is the internal customer account ID. (required)
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.workspaces_download_speculative_plan_with_http_info(org, project, workspace, id, harness_account, **kwargs)  # noqa: E501
        else:
            (data) = self.workspaces_download_speculative_plan_with_http_info(org, project, workspace, id, harness_account, **kwargs)  # noqa: E501
            return data

    def workspaces_download_speculative_plan_with_http_info(self, org, project, workspace, id, harness_account, **kwargs):  # noqa: E501
        """download-speculative-plan workspaces  # noqa: E501

        Download the source code diff for the speculative plan.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.workspaces_download_speculative_plan_with_http_info(org, project, workspace, id, harness_account, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method workspaces_download_speculative_plan" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'org' is set
        if ('org' not in params or
                params['org'] is None):
            raise ValueError("Missing the required parameter `org` when calling `workspaces_download_speculative_plan`")  # noqa: E501
        # verify the required parameter 'project' is set
        if ('project' not in params or
                params['project'] is None):
            raise ValueError("Missing the required parameter `project` when calling `workspaces_download_speculative_plan`")  # noqa: E501
        # verify the required parameter 'workspace' is set
        if ('workspace' not in params or
                params['workspace'] is None):
            raise ValueError("Missing the required parameter `workspace` when calling `workspaces_download_speculative_plan`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `workspaces_download_speculative_plan`")  # noqa: E501
        # verify the required parameter 'harness_account' is set
        if ('harness_account' not in params or
                params['harness_account'] is None):
            raise ValueError("Missing the required parameter `harness_account` when calling `workspaces_download_speculative_plan`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/iacm/api/orgs/{org}/projects/{project}/workspaces/{workspace}/speculative-plans/{id}/download', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def workspaces_evaluate_data(self, policy_action, org, project, workspace, id, harness_account, **kwargs):  # noqa: E501
        """evaluate-data workspaces  # noqa: E501
    ...
    def workspaces_execute_speculative_plan(self, org, project, workspace, id, harness_account, **kwargs):  # noqa: E501
        """execute-speculative-plan workspaces  # noqa: E501

        Execute the speculative plan  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.workspaces_execute_speculative_plan(org, project, workspace, id, harness_account, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.workspaces_execute_speculative_plan_with_http_info(org, project, workspace, id, harness_account, **kwargs)  # noqa: E501
        else:
            (data) = self.workspaces_execute_speculative_plan_with_http_info(org, project, workspace, id, harness_account, **kwargs)  # noqa: E501
            return data

    def workspaces_execute_speculative_plan_with_http_info(self, org, project, workspace, id, harness_account, **kwargs):  # noqa: E501
        """execute-speculative-plan workspaces  # noqa: E501

        Execute the speculative plan  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.workspaces_execute_speculative_plan_with_http_info(org, project, workspace, id, harness_account, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method workspaces_execute_speculative_plan" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'org' is set
        if ('org' not in params or
                params['org'] is None):
            raise ValueError("Missing the required parameter `org` when calling `workspaces_execute_speculative_plan`")  # noqa: E501
        # verify the required parameter 'project' is set
        if ('project' not in params or
                params['project'] is None):
            raise ValueError("Missing the required parameter `project` when calling `workspaces_execute_speculative_plan`")  # noqa: E501
        # verify the required parameter 'workspace' is set
        if ('workspace' not in params or
                params['workspace'] is None):
            raise ValueError("Missing the required parameter `workspace` when calling `workspaces_execute_speculative_plan`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `workspaces_execute_speculative_plan`")  # noqa: E501
        # verify the required parameter 'harness_account' is set
        if ('harness_account' not in params or
                params['harness_account'] is None):
            raise ValueError("Missing the required parameter `harness_account` when calling `workspaces_execute_speculative_plan`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/iacm/api/orgs/{org}/projects/{project}/workspaces/{workspace}/speculative-plans/{id}/execute', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def workspaces_find_speculative_plan(self, org, project, workspace, id, harness_account, **kwargs):  # noqa: E501
        """find-speculative-plan workspaces  # noqa: E501

        Find speculative plan  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.workspaces_find_speculative_plan(org, project, workspace, id, harness_account, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.workspaces_find_speculative_plan_with_http_info(org, project, workspace, id, harness_account, **kwargs)  # noqa: E501
        else:
            (data) = self.workspaces_find_speculative_plan_with_http_info(org, project, workspace, id, harness_account, **kwargs)  # noqa: E501
            return data

    def workspaces_find_speculative_plan_with_http_info(self, org, project, workspace, id, harness_account, **kwargs):  # noqa: E501
        """find-speculative-plan workspaces  # noqa: E501

        Find speculative plan  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.workspaces_find_speculative_plan_with_http_info(org, project, workspace, id, harness_account, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method workspaces_find_speculative_plan" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'org' is set
        if ('org' not in params or
                params['org'] is None):
            raise ValueError("Missing the required parameter `org` when calling `workspaces_find_speculative_plan`")  # noqa: E501
        # verify the required parameter 'project' is set
        if ('project' not in params or
                params['project'] is None):
            raise ValueError("Missing the required parameter `project` when calling `workspaces_find_speculative_plan`")  # noqa: E501
        # verify the required parameter 'workspace' is set
        if ('workspace' not in params or
                params['workspace'] is None):
            raise ValueError("Missing the required parameter `workspace` when calling `workspaces_find_speculative_plan`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `workspaces_find_speculative_plan`")  # noqa: E501
        # verify the required parameter 'harness_account' is set
        if ('harness_account' not in params or
                params['harness_account'] is None):
            raise ValueError("Missing the required parameter `harness_account` when calling `workspaces_find_speculative_plan`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/iacm/api/orgs/{org}/projects/{project}/workspaces/{workspace}/speculative-plans/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def workspaces_force_unlock_workspace(self, org, project, identifier, harness_account, **kwargs):  # noqa: E501
        """force-unlock-workspace workspaces  # noqa: E501
    ...
    def workspaces_list_data(self, org, project, workspace, harness_account, **kwargs):  # noqa: E501
        """list-data workspaces  # noqa: E501
    ...
    def workspaces_list_pipelines(self, org, project, workspace, harness_account, **kwargs):  # noqa: E501
        """list-pipelines workspaces  # noqa: E501
    ...
    def workspaces_list_pipelines_with_http_info(self, org, project, workspace, harness_account, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ScopedPipelines2',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def workspaces_list_resources(self, org, project, identifier, harness_account, **kwargs):  # noqa: E501
        """list-resources workspaces  # noqa: E501
    ...
    def workspaces_list_resources_with_http_info(self, org, project, identifier, harness_account, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='HarnessIacmResources',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def workspaces_list_workspaces(self, org, project, harness_account, **kwargs):  # noqa: E501
        """list-workspaces workspaces  # noqa: E501
    ...
    def workspaces_list_workspaces_with_http_info(self, org, project, harness_account, **kwargs):  # noqa: E501
        ...
        all_params = ['org', 'project', 'harness_account', 'limit', 'page', 'search_term', 'sort', 'status']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def workspaces_send_event(self, body, harness_account, org, project, workspace, **kwargs):  # noqa: E501
        """send-event workspaces  # noqa: E501
        ...
        :param async_req bool
        :param WorkspaceEvent2 body: (required)
        :param str harness_account: Account is the internal customer account ID. (required)
        :param str org: Org is the organisation identifier. (required)
        :param str project: Project is the project identifier. (required)
    ...
    def workspaces_show_data(self, org, project, workspace, id, harness_account, **kwargs):  # noqa: E501
        """show-data workspaces  # noqa: E501
    ...
    def workspaces_show_workspace(self, org, project, identifier, harness_account, **kwargs):  # noqa: E501
        """show-workspace workspaces  # noqa: E501
    ...
    def workspaces_update_workspace(self, body, harness_account, org, project, identifier, **kwargs):  # noqa: E501
        """update-workspace workspaces  # noqa: E501
        ...
        :param async_req bool
        :param WorkspaceUpdate2 body: (required)
        :param str harness_account: Account is the internal customer account ID. (required)
        :param str org: Org is the organisation identifier. (required)
        :param str project: Project is the project identifier. (required)
    ...
    def workspaces_update_workspace_with_http_info(self, body, harness_account, org, project, identifier, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='UpdateWorkspaceResponseBody',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def workspaces_upload_speculative_plan(self, org, project, workspace, id, harness_account, content_digest, **kwargs):  # noqa: E501
        """upload-speculative-plan workspaces  # noqa: E501

        Upload the source code diff for the speculative plan.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.workspaces_upload_speculative_plan(org, project, workspace, id, harness_account, content_digest, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.workspaces_upload_speculative_plan_with_http_info(org, project, workspace, id, harness_account, content_digest, **kwargs)  # noqa: E501
        else:
            (data) = self.workspaces_upload_speculative_plan_with_http_info(org, project, workspace, id, harness_account, content_digest, **kwargs)  # noqa: E501
            return data

    def workspaces_upload_speculative_plan_with_http_info(self, org, project, workspace, id, harness_account, content_digest, **kwargs):  # noqa: E501
        """upload-speculative-plan workspaces  # noqa: E501

        Upload the source code diff for the speculative plan.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.workspaces_upload_speculative_plan_with_http_info(org, project, workspace, id, harness_account, content_digest, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['org', 'project', 'workspace', 'id', 'harness_account', 'content_digest']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method workspaces_upload_speculative_plan" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'org' is set
        if ('org' not in params or
                params['org'] is None):
            raise ValueError("Missing the required parameter `org` when calling `workspaces_upload_speculative_plan`")  # noqa: E501
        # verify the required parameter 'project' is set
        if ('project' not in params or
                params['project'] is None):
            raise ValueError("Missing the required parameter `project` when calling `workspaces_upload_speculative_plan`")  # noqa: E501
        # verify the required parameter 'workspace' is set
        if ('workspace' not in params or
                params['workspace'] is None):
            raise ValueError("Missing the required parameter `workspace` when calling `workspaces_upload_speculative_plan`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `workspaces_upload_speculative_plan`")  # noqa: E501
        # verify the required parameter 'harness_account' is set
        if ('harness_account' not in params or
                params['harness_account'] is None):
            raise ValueError("Missing the required parameter `harness_account` when calling `workspaces_upload_speculative_plan`")  # noqa: E501
        # verify the required parameter 'content_digest' is set
        if ('content_digest' not in params or
                params['content_digest'] is None):
            raise ValueError("Missing the required parameter `content_digest` when calling `workspaces_upload_speculative_plan`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/iacm/api/orgs/{org}/projects/{project}/workspaces/{workspace}/speculative-plans/{id}/upload', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
