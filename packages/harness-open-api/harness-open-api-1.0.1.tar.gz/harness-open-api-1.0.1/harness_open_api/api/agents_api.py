...
class AgentsApi(object):
    ...
    def agent_service_for_server_delete_with_http_info(self, identifier, **kwargs):  # noqa: E501
        ...
        all_params = ['identifier', 'account_identifier', 'project_identifier', 'org_identifier', 'name', 'type', 'tags', 'search_term', 'page_size', 'page_index', 'scope', 'dr_identifier', 'sort_by', 'sort_order', 'metadata_only', 'ignore_scope', 'connected_status', 'health_status']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def agent_service_for_server_get_deploy_helm_chart_with_http_info(self, agent_identifier, **kwargs):  # noqa: E501
        ...
        all_params = ['agent_identifier', 'account_identifier', 'org_identifier', 'project_identifier', 'namespace', 'disaster_recovery_identifier', 'skip_crds', 'ca_data', 'proxy_http', 'proxy_https', 'proxy_username', 'proxy_password', 'proxy_skip_ssl_verify']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def agent_service_for_server_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['account_identifier', 'project_identifier', 'org_identifier', 'identifier', 'name', 'type', 'tags', 'search_term', 'page_size', 'page_index', 'scope', 'dr_identifier', 'sort_by', 'sort_order', 'metadata_only', 'ignore_scope', 'connected_status', 'health_status']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
