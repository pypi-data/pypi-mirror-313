...
class OidcIdTokenCustomAttributesStructure(object):
    ...
    def __init__(self, account_id=None, organization_id=None, project_id=None, pipeline_id=None, environment_id=None, environment_type=None, connector_id=None, connector_name=None, service_id=None, service_name=None, triggered_by_name=None, trigger_by_email=None, stage_type=None, step_type=None, context=None):  # noqa: E501
