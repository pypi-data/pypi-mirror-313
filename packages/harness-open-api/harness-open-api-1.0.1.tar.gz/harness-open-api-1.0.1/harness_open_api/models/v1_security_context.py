...
class V1SecurityContext(object):
    ...
    def __init__(self, capabilities=None, privileged=None, se_linux_options=None, windows_options=None, run_as_user=None, run_as_group=None, run_as_non_root=None, read_only_root_filesystem=None, allow_privilege_escalation=None, proc_mount=None, seccomp_profile=None):  # noqa: E501
