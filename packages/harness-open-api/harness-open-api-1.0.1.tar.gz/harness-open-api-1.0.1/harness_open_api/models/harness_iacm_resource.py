...
class HarnessIacmResource(object):
    ...
    def __init__(self, attributes=None, drift_attributes=None, drift_status=None, module=None, name=None, provider=None, sensitive_attributes=None, type=None):  # noqa: E501
