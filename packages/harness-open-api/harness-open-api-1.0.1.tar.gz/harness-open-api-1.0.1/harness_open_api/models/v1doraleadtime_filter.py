...
class V1doraleadtimeFilter(object):
    ...
    def __init__(self, ratings=None, calculation=None, work_items_type=None, jira_issue_types=None, limit_to_only_applicable_data=None, integration_ids=None, jira_issue_resolved_at=None):  # noqa: E501
