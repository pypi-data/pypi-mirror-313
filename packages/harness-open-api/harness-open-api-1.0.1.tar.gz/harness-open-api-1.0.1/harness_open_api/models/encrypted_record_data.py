...
class EncryptedRecordData(object):
    ...
    def __init__(self, uuid=None, name=None, path=None, parameters=None, encryption_key=None, encrypted_value=None, kms_id=None, encryption_type=None, backup_encrypted_value=None, backup_encryption_key=None, backup_kms_id=None, backup_encryption_type=None, base64_encoded=None, additional_metadata=None):  # noqa: E501
