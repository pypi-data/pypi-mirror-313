...
class ClustersClusterConfig(object):
    ...
    def __init__(self, username=None, password=None, bearer_token=None, tls_client_config=None, aws_auth_config=None, exec_provider_config=None, cluster_connection_type=None, role_arn=None, aws_cluster_name=None):  # noqa: E501
