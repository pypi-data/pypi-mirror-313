...
class ServiceDescriptorProto(object):
    ...
    def __init__(self, unknown_fields=None, name=None, initialized=None, options=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, options_or_builder=None, name_bytes=None, method_list=None, method_count=None, method_or_builder_list=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, memoized_serialized_size=None):  # noqa: E501
