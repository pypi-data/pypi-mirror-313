...
class IssuedBy(object):
    ...
    def __init__(self, issue_time=None, manual_issuer=None, adviser_issuer=None, timeout_issuer=None, trigger_issuer=None, system_issuer=None):  # noqa: E501
        ...
        if system_issuer is not None:
            self.system_issuer = system_issuer
    ...
    @property
    def system_issuer(self):
        """Gets the system_issuer of this IssuedBy.  # noqa: E501


        :return: The system_issuer of this IssuedBy.  # noqa: E501
        :rtype: SystemIssuer
        """
        return self._system_issuer

    @system_issuer.setter
    def system_issuer(self, system_issuer):
        """Sets the system_issuer of this IssuedBy.


        :param system_issuer: The system_issuer of this IssuedBy.  # noqa: E501
        :type: SystemIssuer
        """

        self._system_issuer = system_issuer
