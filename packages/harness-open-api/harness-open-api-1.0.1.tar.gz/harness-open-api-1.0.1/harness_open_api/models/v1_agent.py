...
class V1Agent(object):
    ...
    swagger_types = {
        ...
        'scope': 'V1AgentScope',
        'disaster_recovery_node': 'V1DisasterRecoveryNode',
        'is_plg': 'bool',
    ...
    attribute_map = {
        ...
        'scope': 'scope',
        'disaster_recovery_node': 'disasterRecoveryNode',
        'is_plg': 'isPLG',
        'operator': 'operator'
    }

    def __init__(self, account_identifier=None, project_identifier=None, org_identifier=None, identifier=None, name=None, metadata=None, description=None, type=None, created_at=None, last_modified_at=None, tags=None, health=None, credentials=None, version=None, upgrade_available=None, scope=None, disaster_recovery_node=None, is_plg=None, operator=None):  # noqa: E501
        ...
        self._scope = None
        self._disaster_recovery_node = None
        self._is_plg = None
        self._operator = None
        ...
        if scope is not None:
            self.scope = scope
        if disaster_recovery_node is not None:
            self.disaster_recovery_node = disaster_recovery_node
        if is_plg is not None:
            self.is_plg = is_plg
    ...
    @property
    def disaster_recovery_node(self):
        """Gets the disaster_recovery_node of this V1Agent.  # noqa: E501


        :return: The disaster_recovery_node of this V1Agent.  # noqa: E501
        :rtype: V1DisasterRecoveryNode
        """
        return self._disaster_recovery_node

    @disaster_recovery_node.setter
    def disaster_recovery_node(self, disaster_recovery_node):
        """Sets the disaster_recovery_node of this V1Agent.


        :param disaster_recovery_node: The disaster_recovery_node of this V1Agent.  # noqa: E501
        :type: V1DisasterRecoveryNode
        """

        self._disaster_recovery_node = disaster_recovery_node

    @property
    def is_plg(self):
        """Gets the is_plg of this V1Agent.  # noqa: E501

        Indicates if the agent is for PLG.  # noqa: E501

        :return: The is_plg of this V1Agent.  # noqa: E501
        :rtype: bool
        """
        return self._is_plg

    @is_plg.setter
    def is_plg(self, is_plg):
        """Sets the is_plg of this V1Agent.

        Indicates if the agent is for PLG.  # noqa: E501

        :param is_plg: The is_plg of this V1Agent.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def operator(self):
        """Gets the operator of this V1Agent.  # noqa: E501


        :return: The operator of this V1Agent.  # noqa: E501
        :rtype: V1AgentOperator
        """
        return self._operator

    @operator.setter
    def operator(self, operator):
        """Sets the operator of this V1Agent.


        :param operator: The operator of this V1Agent.  # noqa: E501
