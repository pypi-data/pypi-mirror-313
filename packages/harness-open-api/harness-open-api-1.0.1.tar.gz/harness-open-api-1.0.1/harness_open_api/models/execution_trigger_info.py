...
class ExecutionTriggerInfo(object):
    ...
    def __init__(self, unknown_fields=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, trigger_type_value=None, trigger_type=None, triggered_by=None, triggered_by_or_builder=None, is_rerun=None, rerun_info=None, rerun_info_or_builder=None, build_info=None, build_info_or_builder=None, initialized=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, memoized_serialized_size=None):  # noqa: E501
