...
class SubRuleExecutionDetails(object):
    ...
    def __init__(self, policy_name=None, execution_log_path=None, resource_count=None, execution_log_bucket_type=None, execution_type=None, execution_status=None, bq_data_ingestion_status=None, error_message=None, execution_completed_at=None, resource_type=None, action_type=None, cost_computed=None, cost=None):  # noqa: E501
