...
class FieldDescriptorProtoOrBuilder(object):
    ...
    def __init__(self, name=None, type_name=None, type=None, default_value=None, number=None, label=None, options=None, default_value_bytes=None, extendee_bytes=None, type_name_bytes=None, options_or_builder=None, name_bytes=None, json_name=None, proto3_optional=None, oneof_index=None, extendee=None, json_name_bytes=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, unknown_fields=None, default_instance_for_type=None, initialized=None):  # noqa: E501
