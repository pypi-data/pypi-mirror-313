...
class V1AgentYamlQuery(object):
    ...
    def __init__(self, account_identifier=None, org_identifier=None, project_identifier=None, agent_identifier=None, namespace=None, disaster_recovery_identifier=None, skip_crds=None, ca_data=None, proxy=None):  # noqa: E501
