...
class GcrArtifactTriggerSpec(object):
    ...
    def __init__(self, connector_ref=None, event_conditions=None, meta_data_conditions=None, jexl_condition=None, registry_hostname=None, image_path=None, tag=None):  # noqa: E501
