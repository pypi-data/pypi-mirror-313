...
class EntityDetails(object):
    ...
    def __init__(self, is_valid=None, error_metadata=None, entity_metadata=None, identifier=None, org=None, project=None, entity_type=None, entity_url=None, branch=None):  # noqa: E501
