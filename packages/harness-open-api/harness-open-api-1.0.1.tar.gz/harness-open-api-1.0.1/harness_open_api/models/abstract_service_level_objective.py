...
class AbstractServiceLevelObjective(object):
    ...
    def __init__(self, org_identifier=None, project_identifier=None, identifier=None, name=None, description=None, tags=None, user_journey_refs=None, slo_target=None, type=None, spec=None, notification_rule_refs=None, error_budget_calculation_period=None, error_budget_calculation_validity=None):  # noqa: E501
