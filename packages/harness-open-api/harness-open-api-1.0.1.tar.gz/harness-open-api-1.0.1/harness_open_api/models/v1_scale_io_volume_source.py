...
class V1ScaleIOVolumeSource(object):
    ...
    def __init__(self, gateway=None, system=None, secret_ref=None, ssl_enabled=None, protection_domain=None, storage_pool=None, storage_mode=None, volume_name=None, fs_type=None, read_only=None):  # noqa: E501
