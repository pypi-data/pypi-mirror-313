...
class AsyncExecutableResponseOrBuilder(object):
    ...
    def __init__(self, log_keys_list=None, log_keys_count=None, units_list=None, units_count=None, status=None, timeout=None, status_value=None, callback_ids_list=None, callback_ids_count=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, unknown_fields=None, default_instance_for_type=None, initialized=None):  # noqa: E501
