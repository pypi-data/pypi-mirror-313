...
class FeatureSetOrBuilder(object):
    ...
    def __init__(self, enum_type=None, field_presence=None, repeated_field_encoding=None, message_encoding=None, utf8_validation=None, json_format=None, default_instance_for_type=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, unknown_fields=None, initialized=None):  # noqa: E501
