...
class V1KayentaMetric(object):
    ...
    def __init__(self, address=None, application=None, canary_config_name=None, metrics_account_name=None, configuration_account_name=None, storage_account_name=None, threshold=None, scopes=None):  # noqa: E501
