...
class SkipTaskExecutableResponseOrBuilder(object):
    ...
    def __init__(self, message=None, message_bytes=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, unknown_fields=None, default_instance_for_type=None, initialized=None):  # noqa: E501
