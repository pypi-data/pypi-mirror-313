...
class PipelineExecutionSummary(object):
    ...
    def __init__(self, pipeline_identifier=None, org_identifier=None, project_identifier=None, plan_execution_id=None, name=None, yaml_version=None, status=None, tags=None, labels=None, execution_trigger_info=None, execution_error_info=None, governance_metadata=None, failure_info=None, retry_execution_metadata=None, module_info=None, layout_node_map=None, modules=None, starting_node_id=None, start_ts=None, end_ts=None, created_at=None, can_retry=None, can_re_execute=None, show_retry_history=None, is_retried_execution=None, run_sequence=None, successful_stages_count=None, running_stages_count=None, failed_stages_count=None, total_stages_count=None, git_details=None, store_type=None, connector_ref=None, execution_input_configured=None, is_stages_execution=None, parent_stage_info=None, stages_executed=None, stages_executed_names=None, allow_stage_executions=None, aborted_by=None, execution_mode=None, notes_exist_for_plan_execution_id=None, should_use_simplified_key=None, stages_execution=None, retried_execution=None):  # noqa: E501
