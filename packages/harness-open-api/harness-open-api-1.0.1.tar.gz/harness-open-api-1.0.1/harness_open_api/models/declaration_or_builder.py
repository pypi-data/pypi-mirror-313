...
class DeclarationOrBuilder(object):
    ...
    def __init__(self, type=None, number=None, full_name=None, reserved=None, full_name_bytes=None, repeated=None, type_bytes=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, unknown_fields=None, default_instance_for_type=None, initialized=None):  # noqa: E501
