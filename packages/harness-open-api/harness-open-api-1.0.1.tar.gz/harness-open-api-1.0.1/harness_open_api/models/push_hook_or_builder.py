...
class PushHookOrBuilder(object):
    ...
    def __init__(self, ref=None, commits_count=None, commits_or_builder_list=None, ref_bytes=None, after_bytes=None, commit_or_builder=None, base_ref=None, base_ref_bytes=None, before_bytes=None, repo_or_builder=None, sender_or_builder=None, repo=None, after=None, sender=None, commits_list=None, commit=None, before=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, unknown_fields=None, default_instance_for_type=None, initialized=None):  # noqa: E501
