...
class FieldDescriptorProto(object):
    ...
    def __init__(self, unknown_fields=None, name=None, type_name=None, type=None, default_value=None, number=None, label=None, initialized=None, options=None, default_value_bytes=None, extendee_bytes=None, type_name_bytes=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, options_or_builder=None, name_bytes=None, json_name=None, proto3_optional=None, oneof_index=None, extendee=None, json_name_bytes=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, memoized_serialized_size=None):  # noqa: E501
