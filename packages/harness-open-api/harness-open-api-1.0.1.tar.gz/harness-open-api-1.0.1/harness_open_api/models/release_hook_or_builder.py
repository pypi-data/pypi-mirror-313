...
class ReleaseHookOrBuilder(object):
    ...
    def __init__(self, release_or_builder=None, action_value=None, repo_or_builder=None, sender_or_builder=None, repo=None, action=None, sender=None, release=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, unknown_fields=None, default_instance_for_type=None, initialized=None):  # noqa: E501
