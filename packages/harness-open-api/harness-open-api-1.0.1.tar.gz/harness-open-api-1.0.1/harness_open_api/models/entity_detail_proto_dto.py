...
class EntityDetailProtoDTO(object):
    ...
    def __init__(self, unknown_fields=None, name=None, type=None, entity_git_metadata=None, input_set_ref=None, infra_def_ref=None, trigger_ref=None, type_value=None, identifier_ref_or_builder=None, input_set_ref_or_builder=None, template_ref_or_builder=None, infra_def_ref_or_builder=None, trigger_ref_or_builder=None, entity_git_metadata_or_builder=None, entity_ref_case=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, name_bytes=None, identifier_ref=None, template_ref=None, initialized=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, memoized_serialized_size=None):  # noqa: E501
