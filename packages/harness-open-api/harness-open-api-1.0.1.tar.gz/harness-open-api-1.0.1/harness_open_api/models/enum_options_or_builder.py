...
class EnumOptionsOrBuilder(object):
    ...
    def __init__(self, features=None, deprecated=None, features_or_builder=None, uninterpreted_option_list=None, uninterpreted_option_count=None, uninterpreted_option_or_builder_list=None, deprecated_legacy_json_field_conflicts=None, allow_alias=None, default_instance_for_type=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, unknown_fields=None, initialized=None):  # noqa: E501
