...
class Exemption(object):
    ...
    def __init__(self, approver_id=None, can_approve_for=None, can_reject=False, created=None, expiration=None, id=None, issue_id=None, last_modified=None, link=None, org_id=None, pending_changes=None, pipeline_id=None, project_id=None, reason=None, requester_id=None, scope=None, status='Pending', target_id=None, type=None):  # noqa: E501
    ...
    def can_approve_for(self, can_approve_for):
        ...
        :type: list[str]
        """
        allowed_values = ["ACCOUNT", "ORG", "PROJECT", "PIPELINE"]  # noqa: E501
