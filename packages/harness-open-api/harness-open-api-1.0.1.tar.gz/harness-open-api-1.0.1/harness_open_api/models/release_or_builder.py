...
class ReleaseOrBuilder(object):
    ...
    def __init__(self, tag=None, created_or_builder=None, link_bytes=None, title_bytes=None, draft=None, prerelease=None, published=None, published_or_builder=None, tag_bytes=None, description=None, created=None, description_bytes=None, title=None, link=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, unknown_fields=None, default_instance_for_type=None, initialized=None):  # noqa: E501
