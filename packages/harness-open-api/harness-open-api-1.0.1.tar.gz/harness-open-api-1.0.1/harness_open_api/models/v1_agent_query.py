...
class V1AgentQuery(object):
    ...
    def __init__(self, account_identifier=None, project_identifier=None, org_identifier=None, identifier=None, name=None, type=None, tags=None, search_term=None, page_size=None, page_index=None, scope=None, filter=None, dr_identifier=None, sort_by=None, sort_order=None, metadata_only=None, ignore_scope=None, connected_status=None, health_status=None):  # noqa: E501
