...
class Commit(object):
    ...
    def __init__(self, unknown_fields=None, message=None, link_bytes=None, sha_bytes=None, author_or_builder=None, committer_or_builder=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, message_bytes=None, link=None, sha=None, committer=None, author=None, initialized=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, memoized_serialized_size=None):  # noqa: E501
