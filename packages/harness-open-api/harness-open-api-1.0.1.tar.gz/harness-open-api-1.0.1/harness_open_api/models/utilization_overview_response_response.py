...
class UtilizationOverviewResponseResponse(object):
    ...
    def __init__(self, overall_percentage=None, overall_managed_percentage=None, overall_unmanaged_percentage=None, reservations=None, savings_plans=None):  # noqa: E501
