...
class SourceCodeInfoOrBuilder(object):
    ...
    def __init__(self, location_count=None, location_or_builder_list=None, location_list=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, unknown_fields=None, default_instance_for_type=None, initialized=None):  # noqa: E501
