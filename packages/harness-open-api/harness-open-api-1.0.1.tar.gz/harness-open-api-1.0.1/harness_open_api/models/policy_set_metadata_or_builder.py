...
class PolicySetMetadataOrBuilder(object):
    ...
    def __init__(self, description=None, status=None, identifier_bytes=None, status_bytes=None, account_id=None, account_id_bytes=None, org_id=None, org_id_bytes=None, project_id=None, project_id_bytes=None, created=None, policy_set_id_bytes=None, deny=None, policy_metadata_list=None, policy_metadata_count=None, policy_metadata_or_builder_list=None, policy_set_name=None, policy_set_name_bytes=None, description_bytes=None, policy_set_id=None, identifier=None, all_fields=None, descriptor_for_type=None, unknown_fields=None, default_instance_for_type=None, initialization_error_string=None, initialized=None):  # noqa: E501
