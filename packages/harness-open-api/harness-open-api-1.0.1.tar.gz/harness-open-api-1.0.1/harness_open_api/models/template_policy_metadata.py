...
class TemplatePolicyMetadata(object):
    ...
    def __init__(self, unknown_fields=None, severity=None, initialized=None, identifier=None, status=None, error=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, identifier_bytes=None, policy_id_bytes=None, policy_name=None, policy_name_bytes=None, severity_bytes=None, deny_messages_list=None, deny_messages_count=None, status_bytes=None, account_id=None, account_id_bytes=None, org_id=None, org_id_bytes=None, project_id=None, project_id_bytes=None, created=None, updated=None, error_bytes=None, policy_id=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, memoized_serialized_size=None):  # noqa: E501
