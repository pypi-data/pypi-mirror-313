...
class Location(object):
    ...
    def __init__(self, unknown_fields=None, leading_detached_comments_list=None, path_list=None, path_count=None, span_list=None, span_count=None, leading_comments=None, leading_comments_bytes=None, trailing_comments=None, trailing_comments_bytes=None, leading_detached_comments_count=None, initialized=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, memoized_serialized_size=None):  # noqa: E501
