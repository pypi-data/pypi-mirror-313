...
class V1RolloutReplicaSetInfo(object):
    ...
    def __init__(self, metadata=None, status=None, icon=None, revision=None, stable=None, canary=None, active=None, preview=None, replicas=None, available=None, template=None, scale_down_deadline=None, images=None, pods=None, ping=None, pong=None):  # noqa: E501
