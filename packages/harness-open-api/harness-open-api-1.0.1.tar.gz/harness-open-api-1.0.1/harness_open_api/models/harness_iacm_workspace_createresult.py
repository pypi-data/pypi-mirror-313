...
class HarnessIacmWorkspaceCreateresult(object):
    ...
    def __init__(self, account=None, backend_locked=False, budget=None, cost_breakdown_json=None, cost_diff_json=None, cost_estimation_enabled=False, created=None, default_pipelines=None, description=None, environment_variables=None, identifier=None, name=None, org=None, policy_evaluation=None, project=None, provider_connector=None, provisioner=None, provisioner_data=None, provisioner_version='latest', repository=None, repository_branch=None, repository_commit=None, repository_connector=None, repository_path='', repository_sha=None, status=None, terraform_plan_json=None, terraform_state=None, terraform_state_json=None, terraform_variable_files=None, terraform_variables=None, updated=None):  # noqa: E501
