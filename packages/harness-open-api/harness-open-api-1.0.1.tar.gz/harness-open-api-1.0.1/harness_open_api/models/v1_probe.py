...
class V1Probe(object):
    ...
    def __init__(self, handler=None, initial_delay_seconds=None, timeout_seconds=None, period_seconds=None, success_threshold=None, failure_threshold=None, termination_grace_period_seconds=None):  # noqa: E501
