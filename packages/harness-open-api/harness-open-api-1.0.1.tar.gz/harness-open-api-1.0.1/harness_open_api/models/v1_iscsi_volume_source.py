...
class V1ISCSIVolumeSource(object):
    ...
    def __init__(self, target_portal=None, iqn=None, lun=None, iscsi_interface=None, fs_type=None, read_only=None, portals=None, chap_auth_discovery=None, chap_auth_session=None, secret_ref=None, initiator_name=None):  # noqa: E501
