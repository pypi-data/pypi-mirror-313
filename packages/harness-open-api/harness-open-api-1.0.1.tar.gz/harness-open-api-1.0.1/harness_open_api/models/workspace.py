...
class Workspace(object):
    ...
    def __init__(self, account=None, budget=None, cost_breakdown_json=None, cost_diff_json=None, cost_estimation_enabled=False, default_pipelines=None, description=None, environment_variables=None, identifier=None, name=None, org=None, project=None, provider_connector=None, provisioner=None, provisioner_version='latest', repository=None, repository_branch=None, repository_commit=None, repository_connector=None, repository_path='', repository_sha=None, terraform_plan_json=None, terraform_state=None, terraform_state_json=None, terraform_variable_files=None, terraform_variables=None):  # noqa: E501
