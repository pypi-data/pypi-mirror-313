...
class TypesPullReq(object):
    ...
    def __init__(self, author=None, closed=None, created=None, description=None, edited=None, is_draft=None, labels=None, merge_base_sha=None, merge_check_status=None, merge_conflicts=None, merge_method=None, merge_target_sha=None, merged=None, merger=None, number=None, rebase_check_status=None, rebase_conflicts=None, source_branch=None, source_repo_id=None, source_sha=None, state=None, stats=None, target_branch=None, target_repo_id=None, title=None, updated=None):  # noqa: E501
