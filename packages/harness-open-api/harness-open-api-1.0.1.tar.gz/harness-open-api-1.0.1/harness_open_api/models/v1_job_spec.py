...
class V1JobSpec(object):
    ...
    def __init__(self, parallelism=None, completions=None, active_deadline_seconds=None, pod_failure_policy=None, backoff_limit=None, selector=None, manual_selector=None, template=None, ttl_seconds_after_finished=None, completion_mode=None, suspend=None):  # noqa: E501
