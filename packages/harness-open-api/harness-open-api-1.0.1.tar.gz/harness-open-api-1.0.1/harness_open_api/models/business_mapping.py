...
class BusinessMapping(object):
    ...
    swagger_types = {
        ...
        'cost_targets_with_uuid': 'list[CostTarget]'
    }
    ...
    attribute_map = {
        ...
        'cost_targets_with_uuid': 'costTargetsWithUUID'
    }

    def __init__(self, uuid=None, name=None, account_id=None, cost_targets=None, shared_costs=None, unallocated_cost=None, data_sources=None, created_at=None, last_updated_at=None, created_by=None, last_updated_by=None, cost_targets_with_uuid=None):  # noqa: E501
        ...
        self._cost_targets_with_uuid = None
        ...
        if cost_targets_with_uuid is not None:
            self.cost_targets_with_uuid = cost_targets_with_uuid
    ...
    @property
    def cost_targets_with_uuid(self):
        """Gets the cost_targets_with_uuid of this BusinessMapping.  # noqa: E501


        :return: The cost_targets_with_uuid of this BusinessMapping.  # noqa: E501
        :rtype: list[CostTarget]
        """
        return self._cost_targets_with_uuid

    @cost_targets_with_uuid.setter
    def cost_targets_with_uuid(self, cost_targets_with_uuid):
        """Sets the cost_targets_with_uuid of this BusinessMapping.


        :param cost_targets_with_uuid: The cost_targets_with_uuid of this BusinessMapping.  # noqa: E501
        :type: list[CostTarget]
        """

        self._cost_targets_with_uuid = cost_targets_with_uuid
