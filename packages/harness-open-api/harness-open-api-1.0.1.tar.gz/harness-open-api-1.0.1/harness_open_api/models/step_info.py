...
class StepInfo(object):
    ...
    def __init__(self, baseline_variant=None, scan_id=None, scan_tool=None, stage_id=None, step_id=None, target_id=None, target_name=None, target_type=None, target_variant=None):  # noqa: E501
