...
class V1TopologySpreadConstraint(object):
    ...
    def __init__(self, max_skew=None, topology_key=None, when_unsatisfiable=None, label_selector=None, min_domains=None, node_affinity_policy=None, node_taints_policy=None, match_label_keys=None):  # noqa: E501
