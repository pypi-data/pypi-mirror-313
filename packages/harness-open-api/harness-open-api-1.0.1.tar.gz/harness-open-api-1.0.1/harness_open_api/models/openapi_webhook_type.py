...
class OpenapiWebhookType(object):
    ...
    def __init__(self, created=None, created_by=None, description=None, display_name=None, enabled=None, has_secret=None, id=None, identifier=None, insecure=None, latest_execution_result=None, parent_id=None, parent_type=None, triggers=None, updated=None, url=None, version=None):  # noqa: E501
