...
class CreateExemptionRequestBody(object):
    ...
    def __init__(self, expiration=None, issue_id=None, link=None, pending_changes=None, pipeline_id=None, reason=None, requester_id=None, target_id=None, type=None):  # noqa: E501
