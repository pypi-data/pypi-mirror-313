...
class V1PodSecurityContext(object):
    ...
    def __init__(self, se_linux_options=None, windows_options=None, run_as_user=None, run_as_group=None, run_as_non_root=None, supplemental_groups=None, fs_group=None, sysctls=None, fs_group_change_policy=None, seccomp_profile=None):  # noqa: E501
