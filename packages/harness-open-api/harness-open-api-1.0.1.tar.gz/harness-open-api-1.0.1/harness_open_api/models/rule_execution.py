...
class RuleExecution(object):
    ...
    def __init__(self, uuid=None, account_id=None, job_id=None, rule_enforcement_identifier=None, rule_enforcement_name=None, rule_identifier=None, rule_name=None, ootb=None, rule_pack_identifier=None, cloud_provider=None, is_dry_run=None, target_account=None, target_regions=None, execution_log_path=None, resource_count=None, execution_log_bucket_type=None, execution_type=None, execution_status=None, execution_completed_at=None, org_identifier=None, project_identifier=None, created_at=None, last_updated_at=None, error_message=None, resource_type=None, action_type=None, cost_computed=None, cost=None, cost_type=None, bq_data_ingestion_status=None, ttl=None, is_multi_policy_rule=False, sub_rule_execution_details=None, ootb=None):  # noqa: E501
