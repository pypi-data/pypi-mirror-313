...
class IssueForExemptionResult(object):
    ...
    def __init__(self, baseline_variant_id=None, created=None, details=None, exemption_id=None, harness_augmentation=None, id=None, key=None, num_occurrences=None, occurrence_id=None, occurrences=None, occurrences_pagination=None, product_id=None, severity=None, severity_code=None, status=None, subproduct=None, target_id=None, target_name=None, target_type=None, target_variant_id=None, target_variant_name=None, targets=None, title=None, type=None):  # noqa: E501
