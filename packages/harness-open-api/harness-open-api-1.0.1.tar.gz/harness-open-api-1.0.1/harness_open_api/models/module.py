...
class Module(object):
    ...
    def __init__(self, account=None, description=None, name=None, repository=None, repository_branch=None, repository_commit=None, repository_connector=None, repository_path='', system=None, tags=None):  # noqa: E501
