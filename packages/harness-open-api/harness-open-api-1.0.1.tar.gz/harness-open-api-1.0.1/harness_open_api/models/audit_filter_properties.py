...
class AuditFilterProperties(object):
    ...
    def __init__(self, scopes=None, resources=None, include_child_scopes=True, modules=None, actions=None, environments=None, principals=None, static_filter=None, start_time=None, end_time=None, tags=None, filter_type=None):  # noqa: E501
