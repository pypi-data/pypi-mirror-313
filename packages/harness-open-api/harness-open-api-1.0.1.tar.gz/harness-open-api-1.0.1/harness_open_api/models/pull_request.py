...
class PullRequest(object):
    ...
    def __init__(self, unknown_fields=None, target=None, ref=None, number=None, source=None, base=None, commits_count=None, commits_or_builder_list=None, ref_bytes=None, created_or_builder=None, updated_or_builder=None, link_bytes=None, sha_bytes=None, author_or_builder=None, target_bytes=None, merge_sha=None, merge_sha_bytes=None, title_bytes=None, body_bytes=None, source_bytes=None, fork=None, fork_bytes=None, base_or_builder=None, head_or_builder=None, labels_list=None, labels_count=None, labels_or_builder_list=None, head=None, body=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, created=None, updated=None, title=None, link=None, sha=None, closed=None, merged=None, commits_list=None, author=None, initialized=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, memoized_serialized_size=None):  # noqa: E501
