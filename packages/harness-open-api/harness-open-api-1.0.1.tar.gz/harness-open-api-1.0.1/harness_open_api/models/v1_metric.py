...
class V1Metric(object):
    ...
    def __init__(self, name=None, interval=None, initial_delay=None, count=None, success_condition=None, failure_condition=None, failure_limit=None, inconclusive_limit=None, consecutive_error_limit=None, provider=None):  # noqa: E501
