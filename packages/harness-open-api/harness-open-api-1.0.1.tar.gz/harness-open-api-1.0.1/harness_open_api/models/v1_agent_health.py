...
class V1AgentHealth(object):
    ...
    swagger_types = {
        ...
        'argo_app_set_controller': 'V1AgentComponentHealth'
    }
    ...
    attribute_map = {
        ...
        'argo_app_set_controller': 'argoAppSetController'
    }

    def __init__(self, last_heartbeat=None, argo_repo_server=None, argo_app_controller=None, argo_redis_server=None, harness_gitops_agent=None, connection_status=None, argo_app_set_controller=None):  # noqa: E501
        ...
        self._argo_app_set_controller = None
        ...
        if argo_app_set_controller is not None:
            self.argo_app_set_controller = argo_app_set_controller
    ...
    @property
    def argo_app_set_controller(self):
        """Gets the argo_app_set_controller of this V1AgentHealth.  # noqa: E501


        :return: The argo_app_set_controller of this V1AgentHealth.  # noqa: E501
        :rtype: V1AgentComponentHealth
        """
        return self._argo_app_set_controller

    @argo_app_set_controller.setter
    def argo_app_set_controller(self, argo_app_set_controller):
        """Sets the argo_app_set_controller of this V1AgentHealth.


        :param argo_app_set_controller: The argo_app_set_controller of this V1AgentHealth.  # noqa: E501
        :type: V1AgentComponentHealth
        """

        self._argo_app_set_controller = argo_app_set_controller
