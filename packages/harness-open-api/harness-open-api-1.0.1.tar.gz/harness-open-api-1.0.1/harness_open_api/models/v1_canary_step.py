...
class V1CanaryStep(object):
    ...
    def __init__(self, set_weight=None, pause=None, experiment=None, analysis=None, set_canary_scale=None, set_header_route=None, set_mirror_route=None):  # noqa: E501
