...
class PlanExecution(object):
    ...
    def __init__(self, uuid=None, created_at=None, plan_id=None, setup_abstractions=None, valid_until=None, status=None, start_ts=None, end_ts=None, metadata=None, governance_metadata=None, trigger_header=None, trigger_json_payload=None, expression_functor_token=None, trigger_payload=None, stage_expression_values_map=None, stages_execution_metadata=None, processed_yaml=None, post_execution_rollback_infos=None, last_updated_at=None, version=None, next_iteration=None, ambiance=None, node_type=None, node_id=None):  # noqa: E501
