...
class StrategyMetadataOrBuilder(object):
    ...
    def __init__(self, matrix_metadata_or_builder=None, for_metadata_or_builder=None, identifier_post_fix_bytes=None, metadata_case=None, current_iteration=None, total_iterations=None, matrix_metadata=None, for_metadata=None, identifier_post_fix=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, unknown_fields=None, default_instance_for_type=None, initialized=None):  # noqa: E501
