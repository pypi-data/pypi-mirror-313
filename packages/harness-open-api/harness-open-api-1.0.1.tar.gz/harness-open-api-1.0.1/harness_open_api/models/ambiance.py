...
class Ambiance(object):
    ...
    def __init__(self, unknown_fields=None, levels_count=None, plan_execution_id_bytes=None, levels_or_builder_list=None, setup_abstractions_count=None, metadata_or_builder=None, plan_id_bytes=None, stage_execution_id_bytes=None, original_stage_execution_id_for_rollback_mode=None, original_stage_execution_id_for_rollback_mode_bytes=None, metadata=None, start_ts=None, plan_execution_id=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, setup_abstractions=None, setup_abstractions_map=None, plan_id=None, stage_execution_id=None, levels_list=None, expression_functor_token=None, initialized=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, memoized_serialized_size=None):  # noqa: E501
