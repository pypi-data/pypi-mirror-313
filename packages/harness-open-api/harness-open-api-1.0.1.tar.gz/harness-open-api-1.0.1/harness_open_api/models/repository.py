...
class Repository(object):
    ...
    def __init__(self, unknown_fields=None, name=None, id=None, created_or_builder=None, updated_or_builder=None, perm=None, perm_or_builder=None, branch_bytes=None, clone_bytes=None, clone_ssh_bytes=None, link_bytes=None, namespace_bytes=None, private=None, branch=None, namespace=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, name_bytes=None, created=None, updated=None, id_bytes=None, link=None, clone=None, clone_ssh=None, initialized=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, memoized_serialized_size=None):  # noqa: E501
