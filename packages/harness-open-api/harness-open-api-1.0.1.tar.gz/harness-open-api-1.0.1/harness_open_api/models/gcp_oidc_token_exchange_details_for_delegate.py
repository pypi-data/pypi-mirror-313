...
class GcpOidcTokenExchangeDetailsForDelegate(object):
    ...
    def __init__(self, oidc_id_token=None, oidc_access_token_sts_endpoint=None, oidc_access_token_iam_sa_endpoint=None, gcp_service_account_email=None, oidc_workload_access_token_request_structure=None, oidc_chartmuseum_gcp_config_structure=None, id_token_expiry_time=None):  # noqa: E501
