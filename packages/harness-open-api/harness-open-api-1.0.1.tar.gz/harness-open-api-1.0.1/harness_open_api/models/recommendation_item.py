...
class RecommendationItem(object):
    ...
    def __init__(self, id=None, cluster_name=None, namespace=None, resource_name=None, monthly_saving=None, monthly_cost=None, is_valid=None, last_processed_at=None, resource_type=None, recommendation_state=None, jira_connector_ref=None, jira_issue_key=None, jira_status=None, servicenow_connector_ref=None, servicenow_issue_key=None, servicenow_issue_status=None, recommendation_details=None, perspective_id=None, perspective_name=None, cloud_provider=None, governance_rule_id=None, target_region=None):  # noqa: E501
