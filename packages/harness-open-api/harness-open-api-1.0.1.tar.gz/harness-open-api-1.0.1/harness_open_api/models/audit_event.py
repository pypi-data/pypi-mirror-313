...
class AuditEvent(object):
    ...
    def __init__(self, audit_id=None, insert_id=None, resource_scope=None, http_request_info=None, request_metadata=None, timestamp=None, authentication_info=None, module=None, environment=None, resource=None, action=None, audit_event_data=None, internal_info=None):  # noqa: E501
    ...
    def module(self, module):
        ...
        allowed_values = ["CD", "CI", "CV", "CF", "CE", "STO", "CHAOS", "SRM", "IACM", "CET", "IDP", "CODE", "SSCA", "CORE", "PMS", "TEMPLATESERVICE", "GOVERNANCE", "PLATFORM", "SEI"]  # noqa: E501
