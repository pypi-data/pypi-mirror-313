...
class V1RolloutInfo(object):
    ...
    def __init__(self, metadata=None, status=None, message=None, icon=None, strategy=None, step=None, set_weight=None, actual_weight=None, ready=None, current=None, desired=None, updated=None, available=None, restarted_at=None, generation=None, replica_sets=None, experiments=None, analysis_runs=None, containers=None, steps=None, canary_revision=None, canary_images=None, preview_images=None, stable_images=None):  # noqa: E501
