...
class GitSyncSettings(object):
    ...
    def __init__(self, project_identifier=None, org_identifier=None, execute_on_delegate=None, is_git_simplification_enabled=None, is_enabled_only_for_ff=None, enabled_only_for_ff=None, git_simplification_enabled=None):  # noqa: E501
