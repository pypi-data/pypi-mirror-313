...
class TriggeredByOrBuilder(object):
    ...
    def __init__(self, uuid=None, identifier_bytes=None, extra_info_count=None, extra_info=None, extra_info_map=None, trigger_identifier=None, trigger_identifier_bytes=None, trigger_name=None, trigger_name_bytes=None, uuid_bytes=None, identifier=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, unknown_fields=None, default_instance_for_type=None, initialized=None):  # noqa: E501
