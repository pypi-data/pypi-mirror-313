...
class V1PersistentVolumeClaimSpec(object):
    ...
    def __init__(self, access_modes=None, selector=None, resources=None, volume_name=None, storage_class_name=None, volume_mode=None, data_source=None, data_source_ref=None):  # noqa: E501
