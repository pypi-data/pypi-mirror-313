...
class ExtensionRangeOptions(object):
    ...
    def __init__(self, unknown_fields=None, verification=None, declaration_or_builder_list=None, declaration_count=None, declaration_list=None, initialized=None, features=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, features_or_builder=None, uninterpreted_option_list=None, uninterpreted_option_count=None, uninterpreted_option_or_builder_list=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, all_fields_raw=None, memoized_serialized_size=None):  # noqa: E501
