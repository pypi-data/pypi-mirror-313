...
class PipelineExecutionOutline(object):
    ...
    def __init__(self, account_identifier=None, org_identifier=None, project_identifier=None, pipeline_identifier=None, plan_execution_id=None, name=None, starting_node_id=None, status=None, failure_info=None, stages_map=None, modules=None, start_ts=None, end_ts=None, created_at=None, last_updated_at=None, runtime_input_yaml=None):  # noqa: E501
