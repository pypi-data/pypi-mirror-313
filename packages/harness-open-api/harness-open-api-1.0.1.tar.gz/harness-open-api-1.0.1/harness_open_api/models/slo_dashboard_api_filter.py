...
class SLODashboardApiFilter(object):
    ...
    def __init__(self, user_journey_identifiers=None, monitored_service_identifier=None, target_types=None, error_budget_risks=None, search_filter=None, type=None, slo_target_filter_dto=None, composite_slo_identifier=None, evaluation_type=None, evaluation_types=None, child_resource=None, env_identifiers=None):  # noqa: E501
    ...
    def evaluation_types(self):
        """Gets the evaluation_types of this SLODashboardApiFilter.  # noqa: E501


        :return: The evaluation_types of this SLODashboardApiFilter.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def evaluation_types(self, evaluation_types):
        """Sets the evaluation_types of this SLODashboardApiFilter.


        :param evaluation_types: The evaluation_types of this SLODashboardApiFilter.  # noqa: E501
        :type: list[str]
        """
        allowed_values = ["Window", "Request", "MetricLess"]  # noqa: E501
        if not set(evaluation_types).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `evaluation_types` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(evaluation_types) - set(allowed_values))),  # noqa: E501
                        ", ".join(map(str, allowed_values)))
            )
