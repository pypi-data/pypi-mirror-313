...
class EntityGitMetadataOrBuilder(object):
    ...
    def __init__(self, branch_bytes=None, repo_bytes=None, branch=None, repo=None, all_fields=None, descriptor_for_type=None, unknown_fields=None, default_instance_for_type=None, initialization_error_string=None, initialized=None):  # noqa: E501
