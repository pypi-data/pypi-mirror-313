...
class EnumReservedRange(object):
    ...
    def __init__(self, unknown_fields=None, initialized=None, start=None, end=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, memoized_serialized_size=None):  # noqa: E501
