...
class EnumDescriptorProto(object):
    ...
    def __init__(self, unknown_fields=None, name=None, initialized=None, options=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, reserved_range_list=None, reserved_name_list=None, options_or_builder=None, name_bytes=None, reserved_range_count=None, reserved_range_or_builder_list=None, reserved_name_count=None, value_count=None, value_or_builder_list=None, value_list=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, memoized_serialized_size=None):  # noqa: E501
