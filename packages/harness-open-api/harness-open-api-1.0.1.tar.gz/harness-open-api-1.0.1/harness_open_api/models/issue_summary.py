...
class IssueSummary(object):
    ...
    def __init__(self, exemption_id=None, id=None, key=None, override=None, scan_id=None, severity=None, severity_code=None, status=None, target_variant_name=None, title=None, type=None):  # noqa: E501
