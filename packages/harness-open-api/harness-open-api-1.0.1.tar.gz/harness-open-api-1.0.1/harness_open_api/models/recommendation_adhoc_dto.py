...
'AwsRecommendationAdhocDTO': 'AwsRecommendationAdhocDTO'    }
    ...
    def __init__(self, target_info=None, role_info=None, role_id=None, tenant_info=None, cloud_connector_id=None, is_gov_cloud_connector=None, type=None):  # noqa: E501
