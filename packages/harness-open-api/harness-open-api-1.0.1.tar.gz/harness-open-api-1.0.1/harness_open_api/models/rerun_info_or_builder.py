...
class RerunInfoOrBuilder(object):
    ...
    def __init__(self, root_trigger_type=None, prev_execution_id=None, prev_execution_id_bytes=None, prev_trigger_type_value=None, prev_trigger_type=None, root_trigger_type_value=None, root_execution_id=None, root_execution_id_bytes=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, unknown_fields=None, default_instance_for_type=None, initialized=None):  # noqa: E501
