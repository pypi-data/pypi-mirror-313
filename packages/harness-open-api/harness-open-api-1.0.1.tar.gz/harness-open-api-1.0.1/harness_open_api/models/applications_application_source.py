...
class ApplicationsApplicationSource(object):
    ...
    def __init__(self, repo_url=None, path=None, target_revision=None, helm=None, kustomize=None, ksonnet=None, directory=None, plugin=None, chart=None, ref=None):  # noqa: E501
    ...
    @property
    def ref(self):
        """Gets the ref of this ApplicationsApplicationSource.  # noqa: E501

        Ref is reference to another source within sources field. This field will not be used if used with a `source` tag.  # noqa: E501

        :return: The ref of this ApplicationsApplicationSource.  # noqa: E501
        :rtype: str
        """
        return self._ref
    ...
    @ref.setter
    def ref(self, ref):
        """Sets the ref of this ApplicationsApplicationSource.

        Ref is reference to another source within sources field. This field will not be used if used with a `source` tag.  # noqa: E501

        :param ref: The ref of this ApplicationsApplicationSource.  # noqa: E501
        :type: str
        """
