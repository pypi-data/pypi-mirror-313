...
class GovernanceMetadata2(object):
    ...
    def __init__(self, unknown_fields=None, message=None, id=None, type=None, timestamp=None, status=None, action=None, entity=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, type_bytes=None, message_bytes=None, status_bytes=None, account_id=None, account_id_bytes=None, org_id=None, org_id_bytes=None, project_id=None, project_id_bytes=None, created=None, deny=None, details_list=None, id_bytes=None, details_count=None, details_or_builder_list=None, entity_bytes=None, action_bytes=None, initialized=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, memoized_serialized_size=None):  # noqa: E501
