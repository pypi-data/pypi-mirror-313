...
class V1PodSpec(object):
    ...
    def __init__(self, volumes=None, init_containers=None, containers=None, ephemeral_containers=None, restart_policy=None, termination_grace_period_seconds=None, active_deadline_seconds=None, dns_policy=None, node_selector=None, service_account_name=None, service_account=None, automount_service_account_token=None, node_name=None, host_network=None, host_pid=None, host_ipc=None, share_process_namespace=None, security_context=None, image_pull_secrets=None, hostname=None, subdomain=None, affinity=None, scheduler_name=None, tolerations=None, host_aliases=None, priority_class_name=None, priority=None, dns_config=None, readiness_gates=None, runtime_class_name=None, enable_service_links=None, preemption_policy=None, overhead=None, topology_spread_constraints=None, set_hostname_as_fqdn=None, os=None, host_users=None, scheduling_gates=None, resource_claims=None):  # noqa: E501
