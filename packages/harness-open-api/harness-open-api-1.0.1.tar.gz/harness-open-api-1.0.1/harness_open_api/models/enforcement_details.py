...
class EnforcementDetails(object):
    ...
    def __init__(self, enforcement_name=None, schedule=None, description=None, accounts=None, regions=None, rule_ids=None, rule_set_ids=None, is_dry_run=None, is_enabled=None, execution_timezone=None, cloud_provider=None, created_at=None, last_updated_at=None, created_by=None, last_updated_by=None, account_id_and_names=None):  # noqa: E501
