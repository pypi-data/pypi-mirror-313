...
class ExtensionRangeOrBuilder(object):
    ...
    def __init__(self, options=None, start=None, end=None, options_or_builder=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, unknown_fields=None, default_instance_for_type=None, initialized=None):  # noqa: E501
