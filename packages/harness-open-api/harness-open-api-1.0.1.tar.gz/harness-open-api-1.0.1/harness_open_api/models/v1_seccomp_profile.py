...
class V1SeccompProfile(object):
    ...
    def __init__(self, type=None, localhost_profile=None):  # noqa: E501
        """V1SeccompProfile - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    def type(self):
        ...
        Localhost - a profile defined in a file on the node should be used. RuntimeDefault - the container runtime default profile should be used. Unconfined - no profile should be applied. +unionDiscriminator  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1SeccompProfile, dict):
