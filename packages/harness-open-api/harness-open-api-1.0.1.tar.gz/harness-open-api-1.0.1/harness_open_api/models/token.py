...
class Token(object):
    ...
    attribute_map = {
        ...
        'ssh_key_usage': 'sshKeyUsage'
    }

    def __init__(self, identifier=None, name=None, valid_from=None, valid_to=None, scheduled_expire_time=None, valid=None, account_identifier=None, project_identifier=None, org_identifier=None, api_key_identifier=None, parent_identifier=None, api_key_type=None, description=None, tags=None, ssh_key_content=None, ssh_key_usage=None):  # noqa: E501
        ...
        if tags is not None:
            self.tags = tags
        if ssh_key_content is not None:
            self.ssh_key_content = ssh_key_content
        if ssh_key_usage is not None:
            self.ssh_key_usage = ssh_key_usage
    ...
    def api_key_identifier(self, api_key_identifier):
        ...
        :type: str
        """
        if api_key_identifier is None:
            raise ValueError("Invalid value for `api_key_identifier`, must not be `None`")  # noqa: E501
    ...
    def api_key_type(self, api_key_type):
        ...
        :type: str
        """
        allowed_values = ["USER", "SERVICE_ACCOUNT", "SSH_KEY"]  # noqa: E501
    ...
    @property
    def ssh_key_content(self):
        """Gets the ssh_key_content of this Token.  # noqa: E501

        SSH key content from a public key, this is only present if API_KEY Type is SSH_KEY  # noqa: E501

        :return: The ssh_key_content of this Token.  # noqa: E501
        :rtype: str
        """
        return self._ssh_key_content

    @ssh_key_content.setter
    def ssh_key_content(self, ssh_key_content):
        """Sets the ssh_key_content of this Token.

        SSH key content from a public key, this is only present if API_KEY Type is SSH_KEY  # noqa: E501

        :param ssh_key_content: The ssh_key_content of this Token.  # noqa: E501
        :type: str
        """
    ...
    def ssh_key_usage(self):
        """Gets the ssh_key_usage of this Token.  # noqa: E501

        SSH key Usage: SSH keys can be used to authenticate or sign  # noqa: E501

        :return: The ssh_key_usage of this Token.  # noqa: E501
        :rtype: list[str]
        """
        return self._ssh_key_usage

    @ssh_key_usage.setter
    def ssh_key_usage(self, ssh_key_usage):
        """Sets the ssh_key_usage of this Token.

        SSH key Usage: SSH keys can be used to authenticate or sign  # noqa: E501

        :param ssh_key_usage: The ssh_key_usage of this Token.  # noqa: E501
        :type: list[str]
        """
        allowed_values = ["AUTH", "SIGN"]  # noqa: E501
        if not set(ssh_key_usage).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `ssh_key_usage` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(ssh_key_usage) - set(allowed_values))),  # noqa: E501
                        ", ".join(map(str, allowed_values)))
            )

        self._ssh_key_usage = ssh_key_usage
