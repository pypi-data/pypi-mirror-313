...
class HrepocredsRepoCreds(object):
    ...
    def __init__(self, url=None, username=None, password=None, ssh_private_key=None, tls_client_cert_data=None, tls_client_cert_key=None, github_app_private_key=None, github_app_id=None, github_app_installation_id=None, github_app_enterprise_base_url=None, enable_oci=None, type=None, name=None):  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this HrepocredsRepoCreds.  # noqa: E501


        :return: The name of this HrepocredsRepoCreds.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this HrepocredsRepoCreds.


        :param name: The name of this HrepocredsRepoCreds.  # noqa: E501
        :type: str
        """
