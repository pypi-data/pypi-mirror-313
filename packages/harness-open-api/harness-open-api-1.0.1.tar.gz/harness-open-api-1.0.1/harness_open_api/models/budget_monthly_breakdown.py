...
class BudgetMonthlyBreakdown(object):
    ...
    attribute_map = {
        ...
        'forecast_cost_configured': 'forecastCostConfigured'
    }

    def __init__(self, budget_breakdown=None, budget_monthly_amount=None, actual_monthly_cost=None, forecast_monthly_cost=None, yearly_last_period_cost=None, forecast_cost_configured=None):  # noqa: E501
        ...
        self._forecast_cost_configured = None
        ...
        if forecast_cost_configured is not None:
            self.forecast_cost_configured = forecast_cost_configured
    ...
    @property
    def forecast_cost_configured(self):
        """Gets the forecast_cost_configured of this BudgetMonthlyBreakdown.  # noqa: E501

        Indicates whether forecast cost has been ingested by the user  # noqa: E501

        :return: The forecast_cost_configured of this BudgetMonthlyBreakdown.  # noqa: E501
        :rtype: bool
        """
        return self._forecast_cost_configured

    @forecast_cost_configured.setter
    def forecast_cost_configured(self, forecast_cost_configured):
        """Sets the forecast_cost_configured of this BudgetMonthlyBreakdown.

        Indicates whether forecast cost has been ingested by the user  # noqa: E501

        :param forecast_cost_configured: The forecast_cost_configured of this BudgetMonthlyBreakdown.  # noqa: E501
        :type: bool
        """

        self._forecast_cost_configured = forecast_cost_configured
