...
class VaultConnector(ConnectorConfig):
    ...
    def __init__(self, auth_token=None, base_path=None, vault_url=None, renewal_interval_minutes=None, secret_engine_manually_configured=None, secret_engine_name=None, app_role_id=None, app_role_path=None, secret_id=None, secret_engine_version=None, delegate_selectors=None, namespace=None, sink_path=None, use_vault_agent=None, use_aws_iam=None, aws_region=None, vault_aws_iam_role=None, use_k8s_auth=None, vault_k8s_auth_role=None, service_account_token_path=None, k8s_auth_endpoint=None, renew_app_role_token=None, enable_cache=None, ignore_test_connection=None, read_only=None, default=None, access_type=None, ng_certificate_ref=None, xvault_aws_iam_server_id=None, *args, **kwargs):  # noqa: E501
