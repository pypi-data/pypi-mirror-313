...
import six
from harness_open_api.models.notification_rule_condition_spec import NotificationRuleConditionSpec  # noqa: F401,E501
...
class ErrorTrackingConditionSpec(NotificationRuleConditionSpec):
    ...
    def error_tracking_event_types(self, error_tracking_event_types):
        ...
        :type: list[str]
        """
        allowed_values = ["Exceptions", "LogErrors", "HttpErrors", "CustomErrors", "TimeoutErrors", "SwallowedExceptions", "CaughtExceptions", "UncaughtExceptions", "LogWarnings"]  # noqa: E501
