...
class Account(object):
    ...
    def __init__(self, identifier=None, name=None, company_name=None, account_type=None, account_status=None, cluster=None, default_experience=None, authentication_mechanism=None, service_account_config=None, created_at=None, expiry_time=None, ring_name=None, subdomain_url=None, session_timeout_in_minutes=None, public_access_enabled=None, absolute_session_timeout_in_minutes=None, two_factor_admin_enforced=None, oauth_enabled=None, next_gen_enabled=None, product_led=None, harness_support_access_allowed=None, cross_generation_access_enabled=None, canny_username_abbreviation_enabled=None):  # noqa: E501
