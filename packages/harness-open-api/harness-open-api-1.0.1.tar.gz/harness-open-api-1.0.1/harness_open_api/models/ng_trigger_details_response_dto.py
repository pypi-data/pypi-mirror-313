...
class NGTriggerDetailsResponseDTO(object):
    ...
    def __init__(self, name=None, identifier=None, description=None, type=None, trigger_status=None, last_trigger_execution_details=None, webhook_details=None, build_details=None, tags=None, executions=None, yaml=None, webhook_url=None, webhook_curl_command=None, registration_status=None, enabled=None, is_pipeline_input_outdated=None, yaml_version=None, pipeline_input_outdated=None):  # noqa: E501
