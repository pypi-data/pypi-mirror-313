...
class V1PodFailurePolicyRule(object):
    ...
    def __init__(self, action=None, on_exit_codes=None, on_pod_conditions=None):  # noqa: E501
        """V1PodFailurePolicyRule - a model defined in Swagger"""  # noqa: E501
        self._action = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1PodFailurePolicyRule, dict):
