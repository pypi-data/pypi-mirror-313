...
class OrgUsersBody(object):
    ...
    def __init__(self, id=None, org_uuid=None, full_name=None, email=None, integration_user_ids=None, additional_fields=None, version=None, created_at=None, updated_at=None, dynamic_column_aggs_region=None):  # noqa: E501
