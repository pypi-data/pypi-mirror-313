...
class RerunInfo(object):
    ...
    def __init__(self, unknown_fields=None, root_trigger_type=None, prev_execution_id=None, prev_execution_id_bytes=None, prev_trigger_type_value=None, prev_trigger_type=None, root_trigger_type_value=None, serialized_size=None, parser_for_type=None, default_instance_for_type=None, root_execution_id=None, root_execution_id_bytes=None, initialized=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, memoized_serialized_size=None):  # noqa: E501
