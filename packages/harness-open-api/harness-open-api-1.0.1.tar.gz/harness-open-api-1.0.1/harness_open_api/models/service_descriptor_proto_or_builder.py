...
class ServiceDescriptorProtoOrBuilder(object):
    ...
    def __init__(self, name=None, options=None, options_or_builder=None, name_bytes=None, method_list=None, method_count=None, method_or_builder_list=None, all_fields=None, descriptor_for_type=None, initialization_error_string=None, unknown_fields=None, default_instance_for_type=None, initialized=None):  # noqa: E501
