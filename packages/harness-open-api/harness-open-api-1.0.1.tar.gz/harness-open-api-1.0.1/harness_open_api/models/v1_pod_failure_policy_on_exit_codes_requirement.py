...
class V1PodFailurePolicyOnExitCodesRequirement(object):
    ...
    def __init__(self, container_name=None, operator=None, values=None):  # noqa: E501
        """V1PodFailurePolicyOnExitCodesRequirement - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1PodFailurePolicyOnExitCodesRequirement, dict):
