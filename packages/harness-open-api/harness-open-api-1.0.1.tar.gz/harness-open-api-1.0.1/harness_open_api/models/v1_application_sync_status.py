...
class V1ApplicationSyncStatus(object):
    ...
    def __init__(self, account_identifier=None, project_identifier=None, org_identifier=None, agent_identifier=None, application_name=None, created_at=None, last_modified_at=None, operation_state=None, req_identifier=None, last_known_revision_id=None, synced_by=None, auto_sync_count=None):  # noqa: E501
        ...
        if auto_sync_count is not None:
    ...
    @property
    def auto_sync_count(self):
        """Gets the auto_sync_count of this V1ApplicationSyncStatus.  # noqa: E501


        :return: The auto_sync_count of this V1ApplicationSyncStatus.  # noqa: E501
        :rtype: int
        """
        return self._auto_sync_count

    @auto_sync_count.setter
    def auto_sync_count(self, auto_sync_count):
        """Sets the auto_sync_count of this V1ApplicationSyncStatus.


        :param auto_sync_count: The auto_sync_count of this V1ApplicationSyncStatus.  # noqa: E501
        :type: int
        """

        self._auto_sync_count = auto_sync_count
