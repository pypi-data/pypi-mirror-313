...
from harness_open_api.api.file_store_api import FileStoreApi  # noqa: E501
...
class TestFileStoreApi(unittest.TestCase):
    ...
    def test_get_file_content_using_scoped_file_path_v2(self):
        """Test case for get_file_content_using_scoped_file_path_v2
