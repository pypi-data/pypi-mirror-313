...
from mtmaisdk.clients.rest.models.create_tenant_blog_request import CreateTenantBlogRequest
...
from mtmaisdk.clients.rest.models.tenant_blog_list import TenantBlogList
...
class TenantApi:
    ...
    @validate_call
    async def tenant_blog_create(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        create_tenant_blog_request: Annotated[CreateTenantBlogRequest, Field(description="The tenant invite to create")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Creates a new tenant blog

        :param tenant: The tenant id (required)
        :type tenant: str
        :param create_tenant_blog_request: The tenant invite to create (required)
        :type create_tenant_blog_request: CreateTenantBlogRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._tenant_blog_create_serialize(
            tenant=tenant,
            create_tenant_blog_request=create_tenant_blog_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def tenant_blog_create_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        create_tenant_blog_request: Annotated[CreateTenantBlogRequest, Field(description="The tenant invite to create")],
        _request_timeout: Union[
    ...
    @validate_call
    async def tenant_blog_create_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        create_tenant_blog_request: Annotated[CreateTenantBlogRequest, Field(description="The tenant invite to create")],
        _request_timeout: Union[
    ...
    def _tenant_blog_create_serialize(
        self,
        tenant,
        create_tenant_blog_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if create_tenant_blog_request is not None:
            _body_params = create_tenant_blog_request
