...
class DefaultApi:
    ...
    async def chat_toolcall(
        ...
        _param = self._chat_toolcall_serialize(
    ...
    @validate_call
    async def chat_toolcall_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def chat_toolcall_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _chat_toolcall_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/tool/call',
