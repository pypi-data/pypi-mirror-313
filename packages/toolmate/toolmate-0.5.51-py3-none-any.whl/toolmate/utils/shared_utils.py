...
def getOllamaServerClient(server="tool"):
    if server=="chat" and config.ollamaChatServer_host == "127.0.0.1" and not config.ollamaChatHost_localIp and not isServerAlive(config.ollamaChatServer_host, config.ollamaChatServer_port):
        config.ollamaChatHost_localIp = True
    elif server=="tool" and config.ollamaToolServer_host == "127.0.0.1" and not config.ollamaToolHost_localIp and not isServerAlive(config.ollamaToolServer_host, config.ollamaToolServer_port):
        config.ollamaToolHost_localIp = True
