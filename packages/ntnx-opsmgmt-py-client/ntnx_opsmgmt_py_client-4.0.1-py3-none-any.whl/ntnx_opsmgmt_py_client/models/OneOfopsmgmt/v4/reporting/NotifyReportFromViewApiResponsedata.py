...
class NotifyReportFromViewApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.reporting.NotifyReportFromViewApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in NotifyReportFromViewApiResponsedata.discriminator_value_class_map.values():
            return list(NotifyReportFromViewApiResponsedata.discriminator_value_class_map.keys())[list(NotifyReportFromViewApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NotifyReportFromViewApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NotifyReportFromViewApiResponsedata):
            return False
