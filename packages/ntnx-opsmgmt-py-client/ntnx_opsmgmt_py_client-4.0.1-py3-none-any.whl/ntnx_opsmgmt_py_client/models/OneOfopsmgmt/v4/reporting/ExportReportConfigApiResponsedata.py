...
class ExportReportConfigApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'opsmgmt.v4.reporting.FileWrapper': 'opsmgmt.v4.reporting.FileWrapper',
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.reporting.ExportReportConfigApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ExportReportConfigApiResponsedata.discriminator_value_class_map.values():
            return list(ExportReportConfigApiResponsedata.discriminator_value_class_map.keys())[list(ExportReportConfigApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ExportReportConfigApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExportReportConfigApiResponsedata):
            return False
