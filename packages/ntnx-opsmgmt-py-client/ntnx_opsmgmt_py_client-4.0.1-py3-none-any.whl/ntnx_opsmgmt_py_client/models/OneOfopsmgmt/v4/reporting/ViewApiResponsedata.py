...
class ViewApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'opsmgmt.v4.reporting.View': 'opsmgmt.v4.reporting.View',
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.reporting.ViewApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ViewApiResponsedata.discriminator_value_class_map.values():
            return list(ViewApiResponsedata.discriminator_value_class_map.keys())[list(ViewApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ViewApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ViewApiResponsedata):
            return False
