...
class GenerateReportFromViewApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.reporting.GenerateReportFromViewApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GenerateReportFromViewApiResponsedata.discriminator_value_class_map.values():
            return list(GenerateReportFromViewApiResponsedata.discriminator_value_class_map.keys())[list(GenerateReportFromViewApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GenerateReportFromViewApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GenerateReportFromViewApiResponsedata):
            return False
