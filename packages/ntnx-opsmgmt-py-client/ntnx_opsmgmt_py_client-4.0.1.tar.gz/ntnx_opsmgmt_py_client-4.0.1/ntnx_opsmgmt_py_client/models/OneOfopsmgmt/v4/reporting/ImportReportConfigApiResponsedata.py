...
class ImportReportConfigApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'opsmgmt.v4.reporting.ImportExportParams': 'opsmgmt.v4.reporting.ImportExportParams',
    ...
    def _initialize_object_type(self):
        return 'OneOfopsmgmt.v4.reporting.ImportReportConfigApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ImportReportConfigApiResponsedata.discriminator_value_class_map.values():
            return list(ImportReportConfigApiResponsedata.discriminator_value_class_map.keys())[list(ImportReportConfigApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ImportReportConfigApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ImportReportConfigApiResponsedata):
            return False
