...
class AdminService(object):
    ...
    def ProxyPKIAuthenticate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/xgt.AdminService/ProxyPKIAuthenticate',
            AdminService__pb2.AuthenticateRequest.SerializeToString,
            AdminService__pb2.AuthenticateResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def IsAdmin(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/xgt.AdminService/IsAdmin',
