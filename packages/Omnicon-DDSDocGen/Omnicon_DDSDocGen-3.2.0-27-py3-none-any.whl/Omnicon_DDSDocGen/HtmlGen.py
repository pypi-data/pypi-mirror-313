...
class HtmlGen(DocGenInterface.DocGenInterface):
    ...
    def add_doc_title_page(self, title: str, new_version: str, time: str, origin_version: str,
        ...
        if origin_version != "":
            ...
            header_info_comparison_origin_title = self.soup.find('h2', {'id': 'header-info-comparison-origin-title'})
            ...
            header_info_comparison_new_title = self.soup.find('h2', {'id': 'header-info-comparison-new-title'})
