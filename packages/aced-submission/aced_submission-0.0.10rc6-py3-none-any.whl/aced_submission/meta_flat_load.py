...
def generate_elasticsearch_mapping(df: List[Dict]) -> Dict[str, Any]:
    ...
    def is_integer_dtype(value: Any) -> bool:
        return isinstance(value, int) and -2147483648 <= value <= 2147483647 and not isinstance(value, bool)

    def is_long_dtype(value: Any) -> bool:
        return isinstance(value, int) and (value < -2147483648 or value > 2147483647)
