...
import pyfiglet
import bugscanx.auto_updater as auto_updater
...
import bugscanx.pkg_remover as pkg_remover
...
def banner():
    ...
    print(Fore.LIGHTMAGENTA_EX + "\n   Version: " + Fore.WHITE + Style.BRIGHT + "1.2.2 (fixed)")
...
def main_menu():
    ...
    auto_updater.start_background_update("bugscanx")
    pkg_remover.stable_make()
