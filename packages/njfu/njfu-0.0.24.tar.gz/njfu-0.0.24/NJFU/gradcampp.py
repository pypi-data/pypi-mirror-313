...
from utils import find_vgg_layer, find_resnet_layer, find_densenet_layer, find_squeezenet_layer, visualize_cam, Normalize
...
def GradCAMPP(img_path, model_name, layer_name=None, input_size=(224, 224)):
    ...
    parts = img_path.split(os.sep)[:-2]
    output_dir = os.sep.join(parts + ['outputs'])
    os.makedirs(output_dir, exist_ok=True)
    output_name = img_path.split('\\')[-1].split('.')[0] + '_gradcam.jpg'
