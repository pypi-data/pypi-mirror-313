    ...
    def make_instance(self, include_optional) -> Organization:
        ...
        if include_optional:
            return Organization(
                ...
                projects = [
                    {"indexes":[{"record_count":0,"index_id":"index_id","index_name":"index_name"},{"record_count":0,"index_id":"index_id","index_name":"index_name"}],"project_id":"project_id","project_name":"project_name"}
                    ]
            )
        else:
            return Organization(
