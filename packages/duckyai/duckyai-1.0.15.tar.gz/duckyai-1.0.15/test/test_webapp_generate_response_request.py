...
class TestWebappGenerateResponseRequest(unittest.TestCase):
    """WebappGenerateResponseRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebappGenerateResponseRequest:
        """Test WebappGenerateResponseRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebappGenerateResponseRequest`
        """
        model = WebappGenerateResponseRequest()
        if include_optional:
            return WebappGenerateResponseRequest(
    ...
    def testWebappGenerateResponseRequest(self):
        """Test WebappGenerateResponseRequest"""
