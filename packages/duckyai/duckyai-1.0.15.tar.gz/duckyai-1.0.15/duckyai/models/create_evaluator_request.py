...
class CreateEvaluatorRequest(BaseModel):
    ...
    prompt: Optional[StrictStr] = Field(default=None, description="The prompt used by the evaluator. Accepts \"target\" and \"candidate\" variables.")
    __properties: ClassVar[List[str]] = ["evaluator_name", "prompt"]
