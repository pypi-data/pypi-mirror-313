...
class UpdateEvaluatorRequest(BaseModel):
    ...
    """ # noqa: E501
    evaluator_name: Optional[StrictStr] = Field(default=None, description="The updated name of the evaluator (optional)")
    prompt: Optional[StrictStr] = Field(default=None, description="The updated prompt of the evaluator (optional)")
