...
class CreateApiKeyRequest(BaseModel):
    ...
    CreateApiKeyRequest
    """ # noqa: E501
    key_name: StrictStr = Field(description="A descriptive name for the API key")
    project_id: StrictStr = Field(description="The ID of the project to create the API key for")
    __properties: ClassVar[List[str]] = ["key_name", "project_id"]
