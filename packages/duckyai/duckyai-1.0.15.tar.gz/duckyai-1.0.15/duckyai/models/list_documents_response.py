...
class ListDocumentsResponse(BaseModel):
    ...
    chunks: List[Chunk]
    next_cursor: Optional[StrictStr] = Field(default=None, description="The cursor to use for pagination")
    __properties: ClassVar[List[str]] = ["documents", "chunks", "next_cursor"]
