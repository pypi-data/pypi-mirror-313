...
class DeletePromptTemplateResponse(BaseModel):
    ...
    """ # noqa: E501
    template_id: Optional[StrictStr] = Field(default=None, description="The ID of the deleted prompt template")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeletePromptTemplateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeletePromptTemplateResponse from a dict"""
        if obj is None:
            return None
