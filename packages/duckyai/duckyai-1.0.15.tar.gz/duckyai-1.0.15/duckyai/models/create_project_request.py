...
class CreateProjectRequest(BaseModel):
    ...
    """ # noqa: E501
    organization_id: StrictStr = Field(description="The ID of the organization to create the project for")
    project_name: StrictStr = Field(description="The name of the project")
    __properties: ClassVar[List[str]] = ["organization_id", "project_name"]
