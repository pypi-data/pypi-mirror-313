...
class ExplainabilityLayer:
    ...
    def plots_feature_importance(self, figsize: tuple = (7, 10),
    ...
    def plots_prediction_errors(self, figsize: tuple = (13, 3),
                                save_path: str = None) -> None:
    ...
    def shap_summary_plot(self, save_path: str = None) -> None:
    ...
    def shap_waterfall_plot(self, row_index: int,
                            save_path: str = None) -> None:
        ...
        shap.waterfall_plot(explanation, max_display=50, show=not save_path)
