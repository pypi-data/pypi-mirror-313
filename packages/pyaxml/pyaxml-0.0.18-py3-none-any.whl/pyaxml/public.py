...
_public_res: dict[str, dict] | None = None
        ...
        with open(xmlfile, "r", encoding="utf-8") as fp:
            ...
            for element in _xml.getElementsByTagName("public"):
                ...
                if element.getAttribute("id") == "":
                    ...
                    ID_ = int(element.getAttribute("id"), 16)
                if _type not in _public_res:
                    _public_res[_type] = {}
                _public_res[_type][_name] = ID_
    else:
        raise ValueError("need to copy the sdk/platforms/android-?/data/res/values/public.xml here")
