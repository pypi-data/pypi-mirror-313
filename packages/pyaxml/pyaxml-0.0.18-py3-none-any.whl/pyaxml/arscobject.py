...
from pyaxml.arsctype import ARSCResTableConfig, ARSCResTableEntry, ARSCResTypeSpec, ARSCResTypeType
...
class ARSC:
    ...
    def get_id(self, package: str, rid: int) -> tuple[str | None, str | None, int | None]:
        """get id
    ...
    def get_resource_xml_name(self, r_id: int, package: Union[str, None] = None) -> str | None:
    ...
    def get_type_configs(self, package_name: str, type_name: str | None = None) -> "dict[str, axml_pb2.ARSCResTableConfig]":
    ...
    def get_res_configs(self, rid: int, config: str | None = None, fallback: bool = True) -> "list[tuple[ARSCResTableConfig, ARSCResTableEntry]]":
    ...
    class ResourceResolver:
        ...
        def resolve(self, res_id: int) -> list:
            ...
            :return: a list of tuples of (ARSCResTableConfig, str)
            """
            result : "list[str | tuple[ARSCResTableConfig, list] | None]" = []
            self._resolve_into_result(result, res_id, self.wanted_config)
            return result

        def _resolve_into_result(self, result : "list[str | tuple[ARSCResTableConfig, list] | None]", res_id, config) -> None:
            # First: Get all candidates
            configs : "list[tuple[ARSCResTableConfig, ARSCResTableEntry]]" = self.resources.get_res_configs(res_id, config)
        ...
        def put_ate_value(self, result: "list[str | tuple[ARSCResTableConfig, list] | None]", ate: axml_pb2.ARSCResTableEntry, config : "ARSCResTableConfig | None") -> None:
            """
            ...
            """
            if ate.is_complex():
                complex_array : "list[str | tuple[ARSCResTableConfig, list] | None]" = []
        ...
        def put_item_value(self, result: list[str | tuple[ARSCResTableConfig, list] | None], item, config, parent, complex_: bool) -> None:
            """
