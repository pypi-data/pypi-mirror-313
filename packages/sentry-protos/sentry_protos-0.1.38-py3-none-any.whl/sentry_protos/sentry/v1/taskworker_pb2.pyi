...
class SetTaskStatusRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_fetch_next", b"_fetch_next", "_fetch_next_namespace", b"_fetch_next_namespace", "fetch_next", b"fetch_next", "fetch_next_namespace", b"fetch_next_namespace"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_fetch_next", b"_fetch_next", "_fetch_next_namespace", b"_fetch_next_namespace", "fetch_next", b"fetch_next", "fetch_next_namespace", b"fetch_next_namespace", "id", b"id", "status", b"status"]) -> None: ...
    @typing.overload
