...
class SparkMagicBase(Magics):
    ...
    @staticmethod
    def _validate_spark_conf_user(spark_conf_user: dict) -> str:
        disallowed_conf = ["driverMemory", "executorMemory", "executorCores", "numExecutors"]
        for conf_key in disallowed_conf:
            if conf_key in spark_conf_user:
                return f"You don't have permission to override '{disallowed_conf}'"
        return ""