...
def load_model_config(config_path):
    ...
    """
    with importlib.resources.open_text("fpvad", "pyannote_v2.json") as f:
        configs = json.load(f)
    return configs
...
class VAD:
    def __init__(self, model_config_path="fpvad/pyannote_v2.json", checkpoint_path="ERI_VAD.pth" , device=None):
