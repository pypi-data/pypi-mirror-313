...
def load_model_config(config_path):
    ...
    """
    json_path = pkg_resources.resource_filename("fanvad", "pyannote_v2.json")
...
class VAD:
    def __init__(self, model_config_path="pyannote_v2.json", checkpoint_path="ERI_VAD.pth" , device=None):
