...
#with open("archive/requirements.txt") as f:
...
setup(name = 'querycraft',
      ...
      entry_points = {'console_scripts': ['pgsql-sbs = querycraft.sqlsbspgsql:main',
                                          'sqlite-sbs = querycraft.sqlsbssqlite:main',
                                          'mysql-sbs = querycraft.sqlsbsmysql:main' ]},
