...
# Lire les dépendances depuis old-requirements.txt
#with open("old-requirements.txt") as f:
...
setup(name = 'querycraft',
      ...
      entry_points = {'console_scripts': ['pgsql-sbs = scripts.sqlsbspgsql:main','sqlite-sbs = scripts.sqlsbssqlite:main']},
