...
def dbConnectArgs(parser, defaultPort, defaultHost='localhost', defaultUser='desmontils-e', verbose=False):
    ...
    parser.add_argument('-u', '--user', help='database user', default=defaultUser)  # 'desmontils-e')
    parser.add_argument('-p', '--password', help='database password', default='')
    parser.add_argument('--host', help='database host', default=defaultHost)  # 'localhost')
    parser.add_argument('--port', help='database port', default=defaultPort)  # '5432')
