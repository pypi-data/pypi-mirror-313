...
class TestEditFileResponse:
    def test_mixed_edits(self):
        ...
        assert "To remove" in result.thinking
        assert "PostCSS." in result.thinking
    ...
    def test_mixed_edits_streaming(self):
        ...
        assert "To update" in last_valid_result.thinking
        assert "file's integrity." in last_valid_result.thinking
