...
from squadai.agents.cache.cache_handler import CacheHandler
from squadai.agents.tools_handler import ToolsHandler
from squadai.tools import BaseTool
from squadai.tools.base_tool import Tool
from squadai.utilities import I18N, Logger, RPMController
from squadai.utilities.config import process_config
...
class BaseAgent(ABC, BaseModel):
    ...
    def validate_tools(cls, tools: List[Any]) -> List[BaseTool]:
        ...
        processed_tools = []
        for tool in tools:
            if isinstance(tool, BaseTool) or True:
