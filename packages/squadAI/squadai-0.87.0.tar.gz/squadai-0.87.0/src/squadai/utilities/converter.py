...
from squadai.agents.agent_builder.utilities.base_output_converter import OutputConverter
...
class Converter(OutputConverter):
    ...
    def _create_instructor(self):
        ...
        from squadai.utilities import InternalInstructor
    ...
    def _convert_with_instructions(self):
        """Create a chain."""
        from squadai.utilities.crew_pydantic_output_parser import (
