...
class TestUpdateStepResult(unittest.TestCase):
    """UpdateStepResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateStepResult:
        """Test UpdateStepResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateStepResult`
        """
        model = UpdateStepResult()
        if include_optional:
