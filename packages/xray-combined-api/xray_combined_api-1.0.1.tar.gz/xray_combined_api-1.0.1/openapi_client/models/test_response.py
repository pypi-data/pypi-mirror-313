...
class TestResponse(BaseModel):
    ...
    TestResponse
    """ # noqa: E501
    tests: Optional[List[TestResponseTestsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tests": [TestResponseTestsInner.from_dict(_item) for _item in obj["tests"]] if obj.get("tests") is not None else None
        })
        return _obj
