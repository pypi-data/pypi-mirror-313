...
class XrayJsonImportExecutionTestsInnerStepsInner(BaseModel):
    """
    XrayJsonImportExecutionTestsInnerStepsInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["status", "comment", "evidences", "actualResult"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of XrayJsonImportExecutionTestsInnerStepsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of XrayJsonImportExecutionTestsInnerStepsInner from a dict"""
        if obj is None:
            return None
