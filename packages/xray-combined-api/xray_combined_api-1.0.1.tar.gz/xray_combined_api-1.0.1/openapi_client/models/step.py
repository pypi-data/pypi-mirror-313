...
class Step(BaseModel):
    ...
    test_call_step: Optional[StrictBool] = Field(default=None, alias="testCallStep")
    __properties: ClassVar[List[str]] = ["id", "index", "fields", "attachments", "testCallStep"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "testCallStep": obj.get("testCallStep")
        })
        return _obj
