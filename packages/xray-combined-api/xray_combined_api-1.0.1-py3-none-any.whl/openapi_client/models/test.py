...
class Test(BaseModel):
    ...
    precondition: Optional[List[TestPreconditionInner]] = None
    type: Optional[StrictStr] = None
    status: Optional[StrictStr] = None
    definition: Optional[TestDefinition] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "precondition": [TestPreconditionInner.from_dict(_item) for _item in obj["precondition"]] if obj.get("precondition") is not None else None,
            "type": obj.get("type"),
            "status": obj.get("status"),
            "definition": TestDefinition.from_dict(obj["definition"]) if obj.get("definition") is not None else None
        })
        return _obj
