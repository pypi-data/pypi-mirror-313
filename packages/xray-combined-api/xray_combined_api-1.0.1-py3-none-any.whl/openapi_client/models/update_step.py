...
class UpdateStep(BaseModel):
    ...
    attachments: Optional[UpdateStepAttachments] = None
    __properties: ClassVar[List[str]] = ["fields", "attachments"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateStep from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateStep from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "attachments": UpdateStepAttachments.from_dict(obj["attachments"]) if obj.get("attachments") is not None else None
        })
        return _obj
