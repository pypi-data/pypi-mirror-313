        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "19. MUST ALWAYS prioritize small, reusable components before building main/global files. For example:\n"
                    ...
                    "        3. Organisms:\n"
                    "           - Header components (before main layout)\n"
                    "           - Footer components (before main layout)\n"
                    "           - Sidebar components\n"
                    "           - Form groups\n"
                    "           - Navigation bars\n"
