...
class IdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            "project_root/\n"
            "├── styles/\n"
            "│   ├── reset.css            # CSS reset/normalize - REQUIRED\n"
            "│   ├── variables.css        # CSS custom properties - REQUIRED\n"
            "│   ├── typography.css       # Font styles, sizes, weights - REQUIRED\n"
            "│   ├── utilities.css        # Helper classes - REQUIRED\n"
            "│   └── main.css            # Main site styles - REQUIRED\n"
            "├── css/                    # DEDICATED CSS FILES - MANDATORY\n"
            "│   ├── index.css           # Styles for index.html - REQUIRED\n"
            "│   ├── home.css            # Styles for home.html - REQUIRED\n"
            "│   ├── about.css           # Styles for about.html - REQUIRED\n"
            "│   └── contact.css         # Styles for contact.html - REQUIRED\n"
            "├── index.html              # MUST link: reset.css, variables.css, typography.css, utilities.css, main.css, index.css\n"
            "├── home.html               # MUST link: reset.css, variables.css, typography.css, utilities.css, main.css, home.css\n"
            "├── about.html              # MUST link: reset.css, variables.css, typography.css, utilities.css, main.css, about.css\n"
            "└── contact.html            # MUST link: reset.css, variables.css, typography.css, utilities.css, main.css, contact.css\n\n"
            "2. React/Next.js Structure - MANDATORY RULES:\n"
            "src/\n"
            "├── styles/\n"
            "│   ├── globals.css           # Global styles - REQUIRED\n"
            "│   ├── variables.css         # CSS variables - REQUIRED\n"
            "│   └── main.css             # Main styles - REQUIRED\n"
            "├── components/              # EACH component MUST have its own CSS module\n"
            "│   ├── Button/\n"
            "│   │   ├── Button.tsx       # Component file\n"
            "│   │   └── Button.module.css # REQUIRED dedicated styles\n"
            "│   └── Card/\n"
            "│       ├── Card.tsx         # Component file\n"
            "│       └── Card.module.css   # REQUIRED dedicated styles\n"
            "├── pages/                   # EACH page MUST have its own CSS module\n"
            "│   ├── index.tsx            # Main page\n"
            "│   ├── index.module.css     # REQUIRED dedicated styles for index\n"
            "│   ├── Home/\n"
            "│   │   ├── index.tsx\n"
            "│   │   └── Home.module.css   # REQUIRED dedicated styles\n"
            "│   └── About/\n"
            "│       ├── index.tsx\n"
            "│       └── About.module.css  # REQUIRED dedicated styles\n\n"
            "3. Vue.js Structure - MANDATORY RULES:\n"
            "src/\n"
            "├── assets/\n"
            "│   └── styles/\n"
            "│       ├── global.scss       # Global styles - REQUIRED\n"
            "│       └── variables.scss    # SCSS variables - REQUIRED\n"
            "├── components/              # EACH component MUST have scoped styles\n"
            "│   ├── BaseButton/\n"
            "│   │   ├── BaseButton.vue    # MUST include <style scoped>\n"
            "│   │   └── styles.scss       # REQUIRED dedicated styles\n"
            "│   └── BaseCard/\n"
            "│       ├── BaseCard.vue      # MUST include <style scoped>\n"
            "│       └── styles.scss       # REQUIRED dedicated styles\n"
            "├── views/                   # EACH view MUST have its own styles\n"
            "│   ├── Home.vue             # MUST include <style scoped>\n"
            "│   └── About.vue            # MUST include <style scoped>\n\n"
            "4. Angular Structure - MANDATORY RULES:\n"
            "src/\n"
            "├── styles/\n"
            "│   ├── _variables.scss      # SCSS variables - REQUIRED\n"
            "│   └── styles.scss          # Global styles - REQUIRED\n"
            "├── app/\n"
            "│   ├── components/          # EACH component MUST have its own styles\n"
            "│   │   ├── button/\n"
            "│   │   │   ├── button.component.ts\n"
            "│   │   │   └── button.component.scss # REQUIRED dedicated styles\n"
            "│   │   └── card/\n"
            "│   │       ├── card.component.ts\n"
            "│   │       └── card.component.scss   # REQUIRED dedicated styles\n"
            "│   └── pages/               # EACH page MUST have its own styles\n"
            "│       └── home/\n"
            "│           ├── home.component.ts\n"
            "│           └── home.component.scss   # REQUIRED dedicated styles\n\n"
            "5. Svelte Structure - MANDATORY RULES:\n"
            "src/\n"
            "├── styles/\n"
            "│   ├── global.css           # Global styles - REQUIRED\n"
            "│   └── theme.css           # Theme variables - REQUIRED\n"
            "├── components/             # EACH component MUST have styles\n"
            "│   ├── Button.svelte        # MUST include <style>\n"
            "│   └── Card.svelte         # MUST include <style>\n"
            "└── routes/                 # EACH route MUST have styles\n"
            "    ├── home/\n"
            "    │   └── +page.svelte    # MUST include <style>\n"
            "    └── about/\n"
            "        └── +page.svelte    # MUST include <style>\n\n"
            "UNIVERSAL STYLING RULES - MANDATORY FOR ALL TECH STACKS:\n"
            "1. Pure HTML/CSS Rules:\n"
            "   - EVERY HTML file MUST have its own dedicated CSS file\n"
            "   - EVERY HTML file MUST link to ALL global styles AND its dedicated CSS\n"
            "   - NO HTML file can share CSS files with other HTML files\n"
            "   - Global styles MUST be imported in specific order\n"
            "   - Page-specific CSS MUST be imported last\n"
            "   - CSS imports MUST use correct relative paths\n"
