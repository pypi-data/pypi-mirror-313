...
class ShortIdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            "     * Heading fonts with sizes (e.g., Roboto 32px/24px/20px)\n"
            "     * Body text fonts with sizes (e.g., Open Sans 16px/14px)\n"
            "     * Caption/label fonts with sizes (e.g., Lato 12px)\n"
            ...
            "     * Body text sizes (default: 16px, small: 14px)\n"
            "     * Label/caption sizes (12px, 10px)\n"
            "     * Font families and weights for each size\n"
