    ...
    async def get_coding_request(self, file, techStack):
        ...
        if is_svg:
            ...
            user_prompt += (
                ...
                "  • Style Integration & Hierarchy:\n"
                "    - Global styles:\n"
                "      • Import core variables, mixins, functions first\n"
                "      • Load global resets and base styles\n"
                "      • Define design tokens and theme variables\n"
                "    - Feature/module styles:\n"
                "      • Import shared feature-specific styles\n"
                "      • Define module-level variables and mixins\n"
                "      • Maintain consistent module namespacing\n"
                "    - Component styles:\n"
                "      • Import component-specific styles last\n"
                "      • Follow BEM/SMACSS naming conventions\n"
                "      • Use scoped styles when needed\n"
                "    - Style organization:\n"
                "      • Group related styles logically\n"
                "      • Use proper cascade and specificity\n"
                "      • Maintain clear style dependencies\n"
                "    - Cross-cutting concerns:\n"
                "      • Handle theme variations consistently\n"
                "      • Manage responsive styles properly\n"
                "      • Support RTL/internationalization\n"
