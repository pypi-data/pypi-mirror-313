...
class IdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            "│   │   └── home.js               # Page-specific integration\n"
            "│   └── products/\n"
            "│       ├── products.html\n"
            "│       ├── products.css          # Page-specific styles\n"
            "│       └── products.js           # Page-specific integration\n"
            ...
            "1. HTML/CSS Projects:\n"
            "   - Each component MUST have a .js file for integration\n"
            "   - Use jQuery/vanilla JS for component loading\n"
            "   - Handle component lifecycle and events\n"
            "   - Manage component state and interactions\n"
            "   - Follow consistent integration patterns\n\n"
            "2. React/Vue/Angular Projects:\n"
            "   - Use framework-specific component architecture\n"
            "   - Implement proper component lifecycle methods\n"
            "   - Handle component communication via props/events\n"
            "   - Follow framework conventions for state management\n"
            "   - Include component testing files\n\n"
            "3. Other Frameworks:\n"
            "   - Follow framework-specific best practices\n"
            "   - Use recommended component patterns\n"
            "   - Implement proper error boundaries\n"
            "   - Include necessary configuration files\n"
            "   - Add framework-specific testing setup\n\n"
            "STYLING RULES:\n"
