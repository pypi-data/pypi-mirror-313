        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "        - Dedicated style files (e.g., about.css, contact.css) MUST NEVER be implemented before their corresponding HTML files.\n"
