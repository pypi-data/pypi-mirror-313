...
class BugPlanner:
    ...
    def initial_setup(self, role):
        ...
        prompt = (
            f"You are a senior bug analysis agent. Analyze the project files and provide a focused bug fix plan. Follow these guidelines:\n\n"
    ...
    async def get_bugFixed_suggest_request(self, bug_logs, all_file_contents, overview, file_attachments=None, focused_files=None):
        ...
        error_prompt = (
            ...
            "- Full file paths (from project root) that need changes\n"
