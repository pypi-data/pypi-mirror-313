        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "11. CRITICAL: Apply the lead-follow principle across all relevant stacks (e.g., models, views, controllers, HTML, CSS, JS). Create a separate group for a 'lead' file within each relevant stack. The lead file must be implemented first and defines the structure, patterns, and conventions for that stack.\n"
                    "12. REQUIRED: Group 'follower' files from the same stack together when they can be executed concurrently without needing context from other stacks.\n"
                    ...
                    "    - Frontend:\n"
                    "        - Small component HTML files MUST be implemented before any main HTML files (index.html, main.html, etc).\n"
                    "        - Small component CSS files MUST be implemented before any main CSS files (global.css, main.css, etc).\n"
                    "        - Small component JS files MUST be implemented before any main JS files (main.js, app.js, etc).\n"
                    "        - One main HTML file MUST be implemented after all small components but before other main HTML files.\n"
                    "        - One main CSS file MUST be implemented after all small components but before other main CSS files.\n"
                    ...
                    "        1. Small Component HTML Files MUST be implemented first:\n"
                    "           - Button templates\n"
                    "           - Form input templates\n"
                    "           - Card templates\n"
                    "           - Navigation item templates\n"
                    "        2. Main HTML Files MUST come after ALL small components:\n"
                    "           - index.html\n"
                    "           - main.html\n"
                    "           - app.html\n"
                    "    - CSS Styling Second:\n"
                    "        1. Small Component Styles MUST be implemented first:\n"
                    "           - button.css\n"
                    "           - form.css\n"
                    "           - card.css\n"
                    "           - nav.css\n"
                    "        2. Main Style Files MUST come after ALL small components:\n"
                    "           - global.css\n"
                    "           - main.css\n"
                    "           - style.css\n"
                    "    - JavaScript Third:\n"
                    "        1. Small Component Scripts MUST be implemented first:\n"
                    "           - button.js\n"
                    "           - form.js\n"
                    "           - card.js\n"
                    "           - nav.js\n"
                    "        2. Main Script Files MUST come after ALL small components:\n"
                    "           - main.js\n"
                    "           - app.js\n"
                    "           - index.js\n"
                    "Response Format:\n"
