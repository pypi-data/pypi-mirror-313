...
class IdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            "UI-Related Files - MANDATORY STYLING AND CONNECTION RULES:\n"
            "CRITICAL: Every UI file MUST have its own dedicated style file, JavaScript connector, AND reusable components, regardless of tech stack:\n\n"
            "1. HTML/CSS Projects:\n"
            "Example structure:\n"
            "src/\n"
            ...
            "│   │   └── navbar.js             # Navigation connector script\n"
            "│   ├── header/\n"
            "│   │   ├── header.html           # Header component\n"
            "│   │   ├── header.css            # Header styles\n"
            "│   │   └── header.js             # Header connector script\n"
            "│   ├── footer/\n"
            "│   │   ├── footer.html           # Footer component\n"
            "│   │   ├── footer.css            # Footer styles\n"
            "│   │   └── footer.js             # Footer connector script\n"
            "│   ├── button/\n"
            "│   │   ├── button.html           # Reusable button component\n"
            "│   │   ├── button.css            # Button styles\n"
            "│   │   └── button.js             # Button connector script\n"
            "│   └── card/\n"
            "│       ├── card.html             # Reusable card component\n"
            "│       ├── card.css              # Card styles\n"
            "│       └── card.js               # Card connector script\n"
            "├── pages/\n"
            "│   ├── home/\n"
            "│   │   ├── home.html\n"
            "│   │   ├── home.css              # Page-specific styles\n"
            "│   │   └── home.js               # Page-specific script\n"
            "│   └── products/\n"
            "│       ├── products.html\n"
            "│       ├── products.css          # Page-specific styles\n"
            "│       └── products.js           # Page-specific script\n"
            ...
            "│   │   │   └── Button.utils.ts   # Button utilities/connectors\n"
            "│   │   ├── Card/\n"
            "│   │   │   ├── Card.tsx\n"
            "│   │   │   ├── Card.module.css   # Reusable card styles\n"
            "│   │   │   └── Card.utils.ts     # Card utilities/connectors\n"
            "│   │   └── Input/\n"
            "│   │       ├── Input.tsx\n"
            "│   │       ├── Input.module.css  # Reusable input styles\n"
            "│   │       └── Input.utils.ts    # Input utilities/connectors\n"
            "│   ├── layout/                   # Layout components\n"
            "│   │   ├── Header/\n"
            "│   │   │   ├── Header.tsx\n"
            "│   │   │   ├── Header.module.css # Header styles\n"
            "│   │   │   └── Header.utils.ts   # Header utilities/connectors\n"
            "│   │   ├── Footer/\n"
            "│   │   │   ├── Footer.tsx\n"
            "│   │   │   ├── Footer.module.css # Footer styles\n"
            "│   │   │   └── Footer.utils.ts   # Footer utilities/connectors\n"
            "│   │   └── Navbar/\n"
            "│   │       ├── Navbar.tsx\n"
            "│   │       ├── Navbar.module.css # Navbar styles\n"
            "│   │       └── Navbar.utils.ts   # Navbar utilities/connectors\n"
            "├── pages/\n"
            "│   ├── Dashboard/\n"
            "│   │   ├── Dashboard.tsx\n"
            "│   │   ├── Dashboard.module.css  # Page-specific styles\n"
            "│   │   └── Dashboard.utils.ts    # Page-specific utilities\n"
            "│   └── Profile/\n"
            "│       ├── Profile.tsx\n"
            "│       ├── Profile.module.css    # Page-specific styles\n"
            "│       └── Profile.utils.ts      # Page-specific utilities\n"
            "├── assets/                       # All image and media files\n"
            "│   ├── images/                   # Organized by feature/component\n"
            "│   │   ├── logos/\n"
            "│   │   ├── icons/\n"
            ...
            "└── styles/\n"
            "    └── global.css                # Global styles only\n\n"
            "STYLING AND CONNECTION RULES:\n"
            "1. NEVER combine styles or scripts for multiple components/pages in one file\n"
            "2. ALWAYS create dedicated style and connector files for each:\n"
            "   - Page/View\n"
            ...
            "7. Connector scripts MUST:\n"
            "   - Handle component initialization\n"
            "   - Manage component-specific events\n"
            "   - Provide integration methods\n"
