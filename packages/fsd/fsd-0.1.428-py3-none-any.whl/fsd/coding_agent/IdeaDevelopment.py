...
class IdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            "3. Integration/connector files based on tech stack\n\n"
            "Tech Stack-Specific Integration Requirements:\n\n"
            "1. HTML/CSS Projects:\n"
            "Example structure:\n"
            "src/\n"
            ...
            "│   │   └── navbar.js             # Integration script\n"
            "│   ├── header/\n"
            "│   │   ├── header.html           # Header component\n"
            "│   │   ├── header.css            # Header styles\n"
            "│   │   └── header.js             # Integration script\n"
            "│   ├── footer/\n"
            "│   │   ├── footer.html           # Footer component\n"
            "│   │   ├── footer.css            # Footer styles\n"
            "│   │   └── footer.js             # Integration script\n"
            "│   ├── button/\n"
            "│   │   ├── button.html           # Reusable button component\n"
            "│   │   ├── button.css            # Button styles\n"
            "│   │   └── button.js             # Integration script\n"
            "│   └── card/\n"
            "│       ├── card.html             # Reusable card component\n"
            "│       ├── card.css              # Card styles\n"
            "│       └── card.js               # Integration script\n"
            "├── pages/\n"
            "│   ├── home/\n"
            "│   │   ├── home.html\n"
            ...
            "├── js/\n"
            "│   └── component-loader.js       # Central component integration\n"
            "└── styles/\n"
            ...
            "│   ├── HomeView.vue\n"
            "│   └── AboutView.vue\n"
            "└── plugins/                      # Component registration\n"
            "    └── components.js\n\n"
            "4. Angular Projects:\n"
            "src/\n"
            "├── app/\n"
            ...
            "│   │       └── card.component.scss\n"
            "│   ├── shared/\n"
            "│   │   └── components.module.ts  # Shared component module\n"
            "│   └── pages/\n"
            "│       └── home/\n"
            "│           ├── home.component.ts\n"
            "│           ├── home.component.html\n"
            ...
            "src/\n"
            "├── components/\n"
            "│   ├── Button.svelte             # Component with styles\n"
            "│   ├── Card.svelte\n"
            "│   └── Nav.svelte\n"
            "├── routes/\n"
            "│   ├── +page.svelte\n"
            "│   └── about/+page.svelte\n"
            "└── app.html\n\n"
            "INTEGRATION REQUIREMENTS BY TECH STACK:\n\n"
            "1. HTML/CSS/JS:\n"
            "- MUST use JavaScript integration files (component-loader.js)\n"
            "- Components MUST be loaded dynamically\n"
            "- Handle component state and interactions\n"
            "- Manage component lifecycle\n\n"
            "2. React:\n"
            "- Use index.ts/tsx for clean exports\n"
            "- Implement proper component composition\n"
            "- Handle prop drilling or context\n"
            "- Manage component lifecycle\n\n"
            "3. Vue.js:\n"
            "- Register components globally or locally\n"
            "- Use plugins for component management\n"
