    ...
    async def get_coding_request(self, file, techStack):
        ...
        if is_svg:
            ...
            user_prompt += (
                ...
                "      * Import styles: import styles from '@/styles/Header.module.css'\n"
                "      * Use proper layout structure in _app.js/_app.tsx\n"
                "      * Implement component composition with props drilling or context\n"
                ...
                "        ```\n"
                "    - Vue/Nuxt:\n"
                "      * Import components using Vue.component or app.component\n"
                "      * Register globally in plugins/components.js\n"
                "      * Use layouts with <Nuxt /> component\n"
                ...
                "          const menuItems = this.element.querySelectorAll('.nav-item');\n"
                ...
                "          const component = new module.default(target);\n"
                ...
                "    - iOS (Swift):\n"
                "      ```swift\n"
                "      // Load child view controller\n"
                "      if let headerVC = UIStoryboard(name: \"Main\", bundle: nil)\n"
                "          .instantiateViewController(withIdentifier: \"HeaderVC\") as? HeaderViewController {\n"
                "        addChild(headerVC)\n"
                "        headerVC.view.frame = headerContainer.bounds\n"
                "        headerContainer.addSubview(headerVC.view)\n"
                ...
                "          const html = await ipcRenderer.invoke('load-component', component)\n"
