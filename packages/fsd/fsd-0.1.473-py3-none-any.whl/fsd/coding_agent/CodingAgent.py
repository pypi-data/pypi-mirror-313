    ...
    async def get_coding_request(self, file, techStack):
        ...
        if is_svg:
            ...
            specialized_prompt = (
                ...
                "    - Add appropriate sticky/fixed positioning\n"
                "    - Include minimal scroll effects\n"
                "    - Ensure mobile-friendly navigation\n"
                "    - Apply modest transparency effects\n"
                "    - Keep interactions smooth but conservative\n"
                "    - Add search when contextually appropriate\n"
