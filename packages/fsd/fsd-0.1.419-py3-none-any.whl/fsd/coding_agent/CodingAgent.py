    ...
    async def get_coding_request(self, file, techStack):
        ...
        if is_svg:
            ...
            user_prompt += (
                ...
                "  • Product Cards/Lists:\n"
                "    - Web: Grid/List views, lazy loading\n"
                "    - Mobile: RecyclerView, UICollectionView\n"
                "    - Desktop: DataGrid, ListView\n"
                "  • Forms/Input:\n"
                "    - Web: Form validation, input masking\n"
                "    - Mobile: Input fields, pickers\n"
                "    - Desktop: Input controls, validation\n"
                "  • Modals/Dialogs:\n"
                "    - Web: Modal windows, popups\n"
                "    - Mobile: Alert dialogs, bottom sheets\n"
                "    - Desktop: Dialog windows, alerts\n"
                "- CRITICAL: Component Integration Requirements:\n"
                "  • MUST integrate ALL components specified in development plan\n"
