        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "12. ABSOLUTELY MANDATORY: HTML/CSS Separation:\n"
                    "    - HTML and its corresponding CSS file MUST NEVER be in the same group\n"
                    "    - HTML file MUST be implemented before its CSS\n"
                    "    - Example:\n"
                    "      Group 1: button.html\n"
                    "      Group 2: button.css\n"
                    "      Group 3: card.html\n"
