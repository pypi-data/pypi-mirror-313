        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "21. ABSOLUTELY CRITICAL: Group ordering for frontend MUST follow this strict hierarchy:\n"
                    "    1. Atomic Component Groups:\n"
                    "       - Button styles and components\n"
                    "       - Input field styles and components\n"
                    "       - Typography styles\n"
                    "       - Color variables and tokens\n"
                    "       - Icon components\n"
                    "    2. Molecular Component Groups:\n"
                    "       - Form groups\n"
                    "       - Card components\n"
                    "       - Navigation items\n"
                    "       - Search components\n"
                    "    3. Organism Component Groups:\n"
                    "       - Header components\n"
                    "       - Footer components\n"
                    "       - Sidebar components\n"
                    "       - Navigation bars\n"
                    ...
                    "       - Layout templates\n"
                    "       - Grid systems\n"
                    "    5. ONLY AFTER ALL COMPONENTS - Main/Global Groups:\n"
