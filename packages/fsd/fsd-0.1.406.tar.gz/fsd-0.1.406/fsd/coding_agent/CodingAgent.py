    ...
    async def get_coding_request(self, file, techStack):
        ...
        if is_svg:
            ...
            user_prompt += (
                ...
                "- CRITICAL: Component Integration & Path Resolution:\n"
                "  • Web Frameworks:\n"
                ...
                "    - High DPI assets\n"
                "- CRITICAL: Existing Component Integration:\n"
                "  • MUST integrate ALL existing components from technical plans:\n"
                "    - Headers/Navigation components\n"
                "    - Footer components\n"
                "    - Sidebar/Drawer components\n"
                "    - Any other shared/common components\n"
                "  • Link components properly:\n"
                "    - Use correct import paths\n"
                "    - Follow existing component patterns\n"
                "    - Maintain component hierarchy\n"
                "  • Style integration:\n"
                "    - Link correct CSS/style files for each component\n"
                ...
                "    - Dynamic imports\n"
                "    - Import correct .css/.scss files\n"
                "  • Vue/Nuxt:\n"
                "    - layouts/ directory usage\n"
                "    - Nested router-view\n"
                "    - Middleware integration\n"
                "    - Link .vue style blocks\n"
                "  • Angular:\n"
                "    - Module organization\n"
                ...
                "    - State persistence\n"
                "    - CSS/style bundling\n"
                "- CRITICAL: Style File Integration:\n"
                "  • Each component/page MUST link to its dedicated style file:\n"
                "    - HTML -> correct .css file\n"
                "    - React -> component .css/.scss\n"
                "    - Vue -> scoped styles\n"
                "    - Angular -> component styles\n"
                "  • Follow existing style patterns:\n"
                "    - Use established class naming\n"
                "    - Match existing selectors\n"
                "    - Maintain specificity levels\n"
                ...
                "- ONLY implement features specified in technical plans\n"
                "- DO NOT add functionality outside of plans\n"
                "- Follow existing codebase style and patterns\n"
                "- Maintain consistency with example context\n"
            )
