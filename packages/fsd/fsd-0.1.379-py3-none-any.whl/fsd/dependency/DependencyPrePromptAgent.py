        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "install_plan: Briefly outline dependency installation steps. Translate non-English requests. For pipeline 2, specify the tool (e.g., CocoaPods, npm, pip). Use bash markdown for commands.\n"
                    ...
                    "JSON format:\n"
                    "{\n"
                    '    "install_plan": "Brief installation steps",\n'
                    '    "pipeline": "0, 1, or 2",\n'
                    '    "explainer": ""\n'
                    "}\n\n"
                    "Ensure proper JSON formatting without extra text. Focus on dependency management. Use markdown for bash commands:\n"
                    "```bash\n"
