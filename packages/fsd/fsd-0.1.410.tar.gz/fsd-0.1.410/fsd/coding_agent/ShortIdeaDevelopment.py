...
class ShortIdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            "FOR EACH FILE TO BE WORKED ON:\n"
            "1. Current State (for existing files):\n"
            "   - Describe current content, structure, and functionality\n"
            "   - List existing components, functions, or features\n"
            "   - Note any dependencies or imports\n\n"
            "2. Required Changes/Additions:\n"
            "   - Detail exact modifications needed\n"
            "   - List new components/functions to add\n"
            "   - Specify new dependencies required\n"
            "   - Describe integration points with other files\n\n"
            "3. Implementation Details:\n"
            "   - Outline component structure and hierarchy\n"
            "   - Specify state management requirements\n"
            "   - Detail data flow and interactions\n"
            "   - List all props/parameters needed\n"
