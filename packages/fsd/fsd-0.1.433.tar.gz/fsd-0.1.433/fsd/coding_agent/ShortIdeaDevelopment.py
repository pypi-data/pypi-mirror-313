...
class ShortIdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            "│       └── products.js           # Page-specific functionality\n"
            "└── styles/\n"
            ...
            "│   │   │   └── Button.utils.ts   # Button utilities/helpers\n"
            "│   │   ├── Card/\n"
            "│   │   │   ├── Card.tsx\n"
            "│   │   │   ├── Card.module.css   # Reusable card styles\n"
            "│   │   │   └── Card.utils.ts     # Card utilities/helpers\n"
            "│   │   └── Input/\n"
            "│   │       ├── Input.tsx\n"
            "│   │       ├── Input.module.css  # Reusable input styles\n"
            "│   │       └── Input.utils.ts    # Input utilities/helpers\n"
            "│   ├── layout/                   # Layout components\n"
            "│   │   ├── Header/\n"
            "│   │   │   ├── Header.tsx\n"
            "│   │   │   ├── Header.module.css # Header styles\n"
            "│   │   │   └── Header.utils.ts   # Header utilities/helpers\n"
            "│   │   ├── Footer/\n"
            "│   │   │   ├── Footer.tsx\n"
            "│   │   │   ├── Footer.module.css # Footer styles\n"
            "│   │   │   └── Footer.utils.ts   # Footer utilities/helpers\n"
            "│   │   └── Navbar/\n"
            "│   │       ├── Navbar.tsx\n"
            "│   │       ├── Navbar.module.css # Navbar styles\n"
            "│   │       └── Navbar.utils.ts   # Navbar utilities/helpers\n"
            "├── pages/\n"
            "│   ├── Dashboard/\n"
            "│   │   ├── Dashboard.tsx\n"
            "│   │   ├── Dashboard.module.css  # Page-specific styles\n"
            "│   │   └── Dashboard.utils.ts    # Dashboard utilities/helpers\n"
            "│   └── Profile/\n"
            "│       ├── Profile.tsx\n"
            "│       ├── Profile.module.css    # Page-specific styles\n"
            "│       └── Profile.utils.ts      # Profile utilities/helpers\n"
            "└── styles/\n"
            "    └── global.css                # Global styles only\n\n"
            "STYLING RULES:\n"
