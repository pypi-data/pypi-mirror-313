...
class IdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            "├── index.html              # Each HTML file links to:\n"
            "├── home.html               # 1. All global styles\n"
            "├── about.html              # 2. Its specific CSS file\n"
            "└── contact.html            # 3. Must have dedicated CSS\n\n"
            "2. React/Next.js Structure:\n"
            "src/\n"
            "├── styles/\n"
            ...
            "├── pages/\n"
            "│   ├── index/               # Index page must have its own styles\n"
            "│   │   ├── index.tsx\n"
            ...
            "├── components/\n"
            "│   ├── BaseButton/\n"
            "│   │   ├── BaseButton.vue    # <style scoped>\n"
            "│   │   └── styles.scss       # Component styles\n"
            "│   └── BaseCard/\n"
            "│       ├── BaseCard.vue      # <style scoped>\n"
            "│       └── styles.scss       # Component styles\n"
            "├── views/\n"
            "│   ├── Index/               # Index view must have styles\n"
            "│   │   ├── Index.vue\n"
            "│   │   └── styles.scss      # Index styles\n"
            "│   └── Home/\n"
            "│       ├── Home.vue\n"
            "│       └── styles.scss      # Home styles\n\n"
            "4. Angular Structure:\n"
            "src/\n"
            "├── styles/\n"
            ...
            "│   │       └── card.component.scss\n"
            "│   └── pages/\n"
            "│       ├── index/           # Index page must have styles\n"
            "│       │   ├── index.component.ts\n"
            ...
            "├── components/\n"
            "│   ├── Button.svelte        # <style> in component\n"
            "│   └── Card.svelte         # <style> in component\n"
            "└── routes/\n"
            "    ├── +page.svelte        # Index route with <style>\n"
            "    ├── home/\n"
            "    │   └── +page.svelte    # <style> in component\n"
            "    └── about/\n"
            "        └── +page.svelte    # <style> in component\n\n"
            "UNIVERSAL STYLING RULES:\n"
            "1. Pure HTML/CSS Rules:\n"
            "   - EVERY HTML file needs its own CSS file (including index.html)\n"
            "   - Global styles shared across all pages\n"
            "   - Use CSS custom properties for theming\n"
            "   - Maintain flat file structure\n"
            "   - Follow semantic HTML structure\n"
            "   - Use CSS cascade effectively\n"
