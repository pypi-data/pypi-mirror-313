...
class CodingAgent:
    ...
    async def get_coding_request(self, file, techStack):
        ...
        if is_svg:
            ...
            specialized_prompt = (
                "As a world-class web developer:\n"
                "- Use semantic HTML5 elements appropriately:\n"
                "  • <header>, <nav>, <main>, <article>, <section>, <aside>, <footer>\n"
                "  • <figure>, <figcaption> for images and captions\n"
                "  • <time> for dates and timestamps\n"
                "  • <mark>, <strong>, <em> for text emphasis\n"
                "- Ensure proper document structure and hierarchy:\n"
                "  • Single <h1> per page, proper heading levels\n" 
                "  • Logical content grouping and nesting\n"
                "  • Clear visual and semantic hierarchy\n"
                "- Implement comprehensive accessibility features:\n"
                "  • ARIA landmarks, labels, roles and states\n"
                "  • Skip navigation links and keyboard focus\n"
                "  • Alt text for images and aria-label for icons\n"
                "  • Proper form labels and error handling\n"
                "  • Color contrast and text resizing support\n"
                "- Create responsive layouts with proper meta tags:\n"
                ...
                "- Follow modern component architecture:\n"
            ...
            specialized_prompt = (
                "As a world-class CSS developer:\n"
            ...
            specialized_prompt = (
                "As a world-class JavaScript/React developer:\n"
            ...
            specialized_prompt = (
                "As a world-class TypeScript/Angular developer:\n"
            ...
            specialized_prompt = (
                "As a world-class Python developer:\n"
                "- Follow strict PEP guidelines:\n"
                "  • PEP 8 style guide\n"
                "  • PEP 484 type hints\n"
            ...
            specialized_prompt = (
                "As a world-class Rust/Tauri developer:\n"
            ...
            specialized_prompt = (
                "As a world-class Data Science developer:\n"
            ...
            specialized_prompt = f"As a world-class {techStack} developer:\n"
