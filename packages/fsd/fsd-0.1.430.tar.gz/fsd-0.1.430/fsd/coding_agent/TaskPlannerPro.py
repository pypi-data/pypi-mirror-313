        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "12. ABSOLUTELY MANDATORY: Core-Before-Style Rule:\n"
                    "    - ONLY global theme/variables CSS files can be implemented first\n"
                    "    - For ALL other frontend components:\n"
                    "      1. Core file (HTML, React, Vue, etc.) MUST be implemented BEFORE its style file\n"
                    "      2. Core and style files MUST be in separate groups\n"
                    "      3. NO EXCEPTIONS to this ordering\n"
                    "    Examples:\n"
                    "    - Basic HTML/CSS:\n"
                    "      Group 1: theme.css, variables.css (global styles only)\n"
                    "      Group 2: button.html, input.html\n"
                    "      Group 3: button.css, input.css\n"
                    "      Group 4: card.html, modal.html\n"
                    "      Group 5: card.css, modal.css\n"
                    "    - React Components:\n"
                    "      Group 1: theme.scss (global styles only)\n"
                    "      Group 2: Button.jsx, Input.jsx\n"
                    "      Group 3: Button.module.scss, Input.module.scss\n"
                    "      Group 4: Card.jsx, Modal.jsx\n"
                    "      Group 5: Card.module.scss, Modal.module.scss\n"
                    "    - Vue Components:\n"
                    "      Group 1: theme.scss (global styles only)\n"
                    "      Group 2: Button.vue (template & script), Input.vue (template & script)\n"
                    "      Group 3: Button.vue (style), Input.vue (style)\n"
                    "      Group 4: Card.vue (template & script), Modal.vue (template & script)\n"
                    "      Group 5: Card.vue (style), Modal.vue (style)\n"
                    "    - Angular Components:\n"
                    "      Group 1: theme.scss (global styles only)\n"
                    "      Group 2: button.component.html, input.component.html\n"
                    "      Group 3: button.component.scss, input.component.scss\n"
                    "      Group 4: card.component.html, modal.component.html\n"
                    "      Group 5: card.component.scss, modal.component.scss\n"
                    ...
                    "           - variables.css\n"
                    "           - theme.css\n"
                    "    - Component Structure Second:\n"
                    "        1. Small Component HTML Files:\n"
                    "           - button.html\n"
                    "           - input.html\n"
                    "           - card.html\n"
                    "        2. Small Component CSS Files:\n"
                    "           - button.css\n"
                    "           - input.css\n"
                    "           - card.css\n"
                    "        3. Main Component HTML Files:\n"
                    "           - header.html\n"
                    "           - footer.html\n"
                    "           - nav.html\n"
                    "        4. Main Component CSS Files:\n"
                    "           - header.css\n"
                    "           - footer.css\n"
                    "           - nav.css\n"
                    "    - Page Structure Third:\n"
                    "        1. Page HTML Files:\n"
                    "           - index.html\n"
                    "           - main.html\n"
                    "           - app.html\n"
                    ...
                    "           - app.js\n"
                    "           - index.js\n"
                    "22. STRICTLY ENFORCED CORE-BEFORE-STYLE RULE:\n"
                    "    - Frontend (No Exceptions):\n"
                    "        Group 1: theme.css, variables.css (ONLY global styles)\n"
                    "        Group 2: button.html, card.html, modal.html\n"
                    "        Group 3: button.css, card.css, modal.css\n"
                    "        Group 4: header.html, footer.html\n"
                    "        Group 5: header.css, footer.css\n"
                    "    - React:\n"
                    "        Group 1: theme.scss (ONLY global styles)\n"
                    "        Group 2: Button.jsx, Card.jsx, Modal.jsx\n"
                    "        Group 3: Button.module.scss, Card.module.scss, Modal.module.scss\n"
                    "        Group 4: Header.jsx, Footer.jsx\n"
                    "        Group 5: Header.module.scss, Footer.module.scss\n"
                    "    - Vue:\n"
                    "        Group 1: theme.scss (ONLY global styles)\n"
                    "        Group 2: Button.vue (template/script), Card.vue (template/script)\n"
                    "        Group 3: Button.vue (style), Card.vue (style)\n"
                    "        Group 4: Header.vue (template/script), Footer.vue (template/script)\n"
                    "        Group 5: Header.vue (style), Footer.vue (style)\n"
                    "    - Angular:\n"
                    "        Group 1: theme.scss (ONLY global styles)\n"
                    "        Group 2: button.component.ts/html, card.component.ts/html\n"
                    "        Group 3: button.component.scss, card.component.scss\n"
                    "        Group 4: header.component.ts/html, footer.component.ts/html\n"
                    "        Group 5: header.component.scss, footer.component.scss\n"
                    "Response Format:\n"
                    '{\n'
                    '    "groups": [\n'
                    '        {\n'
