...
class ShortIdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            "CRITICAL: Every UI file MUST have its own dedicated style file:\n\n"
            "1. Required Style Files:\n"
            "src/\n"
            "└── styles/\n"
            "    ├── global.css                # Global styles only (reset, typography, variables)\n"
            "    └── main.css                  # Main application styles\n\n"
            "2. Each UI file MUST have:\n"
            "   - Its own dedicated style file with matching name\n"
            "   - Styles scoped to that specific component/page\n"
            "   - Clear separation from other component styles\n\n"
            "STYLING RULES:\n"
            ...
            "   - Layout structure\n"
            "   - Common patterns\n"
            "5. Component styles MUST be scoped/modular\n"
            "6. Follow naming convention matching the component/page name\n\n"
