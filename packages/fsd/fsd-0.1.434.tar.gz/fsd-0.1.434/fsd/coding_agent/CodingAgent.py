    ...
    async def get_coding_request(self, file, techStack):
        ...
        if is_svg:
            ...
            user_prompt += (
                ...
                "- ABSOLUTELY CRITICAL: Component Integration & Path Resolution:\n"
                "  • Web Frameworks:\n"
                "    - React/Next.js: Use proper import paths from src/, components/, pages/\n"
                "      * MUST import all components from development plan (Header, Footer, ProductCard etc)\n"
                "      * MUST import all associated styles (.module.css, .scss etc)\n"
                "      * MUST use correct relative/absolute paths based on project structure\n"
                "      * MUST implement every single component mentioned in development plan\n"
                "      * MUST connect all styles and themes as specified\n"
                "      * MUST integrate all navigation elements (Header, Nav, Footer etc)\n"
                "      * MUST include all UI components (Buttons, Cards, Forms etc)\n"
                "      * MUST implement proper component composition\n"
                "      * Example component connections:\n"
                "        - pages/_app.js: import Layout from '@/components/Layout'\n"
                "        - components/Layout/index.js: import Navbar from '@/components/Navbar'\n"
                "        - components/Navbar/index.js: import Link from 'next/link'\n"
                "        - components/ProductCard/index.js: import Image from 'next/image'\n"
                "    - Vue: Follow Nuxt/Vue directory structure for components, layouts\n"
                "      * MUST import all planned components from components/ directory\n"
                "      * MUST import styles from assets/ directory\n"
                "      * MUST use proper path aliases (@/components, ~/assets etc)\n"
                "      * MUST implement every component from development plan\n"
                "      * MUST connect all specified styles and themes\n"
                "      * MUST integrate all navigation components\n"
                "      * MUST include all planned UI elements\n"
                "      * Example component connections:\n"
                "        - layouts/default.vue: import TheHeader from '@/components/TheHeader'\n"
                "        - components/TheHeader.vue: import TheNavigation from '@/components/TheNavigation'\n"
                "        - pages/index.vue: import ProductGrid from '@/components/ProductGrid'\n"
                "    - Angular: Use correct module imports and lazy loading\n"
                "      * MUST import all planned components and declare in module\n"
                "      * MUST import component styles with styleUrls\n"
                "      * MUST use correct path mapping from tsconfig\n"
                "      * MUST implement every component from development plan\n"
                "      * MUST connect all specified styles and themes\n"
                "      * MUST integrate all navigation elements\n"
                "      * MUST include all planned UI components\n"
                "      * Example component connections:\n"
                "        - app.module.ts: import { HeaderComponent } from './components/header'\n"
                "        - header.component.ts: import { NavigationModule } from './navigation'\n"
                "        - product.module.ts: import { ProductCardComponent } from './product-card'\n"
                "    - Svelte: Follow SvelteKit routing and store patterns\n"
                "      * MUST import all planned components with $lib alias\n"
                "      * MUST import styles with proper svelte:css\n"
                "      * MUST implement every component from development plan\n"
                "      * MUST connect all specified styles and themes\n"
                "      * MUST integrate all navigation elements\n"
                "      * MUST include all planned UI components\n"
                "      * Example component connections:\n"
                "        - routes/+layout.svelte: import Header from '$lib/components/Header.svelte'\n"
                "        - lib/components/Header.svelte: import Nav from '$lib/components/Nav.svelte'\n"
                "        - routes/products/+page.svelte: import ProductCard from '$lib/components/ProductCard.svelte'\n"
                "  • Pure HTML/CSS:\n"
                "    - MUST link all component CSS files in correct order\n"
                "    - MUST include all planned components (header.html, footer.html etc)\n"
                "    - MUST use correct relative paths to assets/styles\n"
                "    - MUST maintain proper directory structure:\n"
                "      * components/header/header.{html,css}\n"
                "      * components/footer/footer.{html,css}\n"
                "      * components/product-card/product-card.{html,css}\n"
                "    - MUST use proper JavaScript for component integration:\n"
                "      * Example component connections:\n"
                "        - js/components.js:\n"
                "          ```javascript\n"
                "          document.addEventListener('DOMContentLoaded', () => {\n"
                "            const components = document.querySelectorAll('include');\n"
                ...
                "          });\n"
                "          ```\n"
                "        - Or using HTML imports (with polyfill):\n"
                "          ```javascript\n"
                "          import 'html-imports-polyfill';\n"
                ...
                "          ```\n"
                "  • Mobile:\n"
                "    - iOS (Swift/ObjC): Use proper storyboard references, XIB loading\n"
                "      * MUST include all planned UI components\n"
                "      * MUST link all associated .xib files\n"
                "      * MUST implement every component from development plan\n"
                "      * MUST connect all specified styles and themes\n"
                "      * Example component connections:\n"
                "        - MainViewController.swift: loadNibNamed('HeaderView', owner: self)\n"
                "        - HeaderView.xib + HeaderView.swift custom class\n"
                "    - Android (Java/Kotlin): Correct layout inflation, fragment management\n"
                "      * MUST include all planned layouts/components\n"
                "      * MUST reference correct R.layout IDs\n"
                "      * MUST implement every component from development plan\n"
                "      * MUST connect all specified styles and themes\n"
                "      * Example component connections:\n"
                "        - activity_main.xml: <include layout='@layout/header'/>\n"
                "        - MainActivity.kt: supportFragmentManager.beginTransaction()\n"
                "    - React Native: Proper navigation stack and screen registration\n"
                "      * MUST import all planned components\n"
                "      * MUST import associated StyleSheet\n"
                "      * MUST implement every component from development plan\n"
                "      * MUST connect all specified styles and themes\n"
                "      * Example component connections:\n"
                "        - App.js: import { NavigationContainer } from '@react-navigation/native'\n"
                "        - navigation/index.js: import HomeScreen from '../screens/HomeScreen'\n"
                "    - Flutter: Widget tree organization and route management\n"
                "      * MUST import all planned widgets\n"
                "      * MUST include associated ThemeData\n"
                "      * MUST implement every widget from development plan\n"
                "      * MUST connect all specified styles and themes\n"
                "      * Example component connections:\n"
                "        - lib/main.dart: import 'package:myapp/widgets/header.dart'\n"
                "        - lib/widgets/header.dart: class Header extends StatelessWidget\n"
                "  • Desktop:\n"
                "    - Electron: IPC communication, window management\n"
                "      * MUST import all planned UI components\n"
                "      * MUST include associated styles\n"
                "      * MUST implement every component from development plan\n"
                "      * MUST connect all specified styles and themes\n"
                "      * Example component connections:\n"
                "        - main.js: require('./components/header')\n"
                "        - preload.js: contextBridge.exposeInMainWorld()\n"
                "    - Tauri: Proper Rust backend integration, window configs\n"
                "      * MUST import all planned frontend components\n"
                "      * MUST include associated styles\n"
                "      * MUST implement every component from development plan\n"
                "      * MUST connect all specified styles and themes\n"
                "      * Example component connections:\n"
                "        - src-tauri/main.rs: tauri::Builder::default()\n"
                "        - src/components/Header.tsx: import { invoke } from '@tauri-apps/api'\n"
                "    - Qt: Widget hierarchy and signal/slot connections\n"
                "      * MUST include all planned widgets\n"
                "      * MUST load associated .qss styles\n"
                "      * MUST implement every widget from development plan\n"
                "      * MUST connect all specified styles and themes\n"
                "      * Example component connections:\n"
                "        - mainwindow.cpp: ui->setupUi(this)\n"
                "        - header.h: class Header : public QWidget\n"
                "    - WPF: XAML resource dictionary organization\n"
                "      * MUST include all planned controls\n"
                "      * MUST merge all style dictionaries\n"
                "      * MUST implement every control from development plan\n"
                "      * MUST connect all specified styles and themes\n"
                "      * Example component connections:\n"
                "        - App.xaml: <ResourceDictionary Source='Themes/Default.xaml'/>\n"
                "        - MainWindow.xaml: <local:HeaderControl/>\n"
                "- MANDATORY: Asset Integration:\n"
                "  • Web:\n"
                "    - Use correct public/ or static/ paths\n"
                "    - Implement proper CDN configurations\n"
                "    - Handle image optimization and lazy loading\n"
                "  • iOS:\n"
                "    - Asset catalogs (.xcassets) for images\n"
                "    - Bundle resources access\n"
                "    - SF Symbols integration\n"
                "  • Android:\n"
                "    - res/drawable organization\n"
                "    - Vector drawables\n"
                "    - Resource qualifiers\n"
                "  • Desktop:\n"
                "    - Bundle resources\n"
