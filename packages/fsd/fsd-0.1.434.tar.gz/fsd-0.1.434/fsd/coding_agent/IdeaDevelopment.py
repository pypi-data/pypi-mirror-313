...
class IdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            "src/\n"
            "├── styles/\n"
            "│   ├── global.css            # Global styles, CSS reset, typography, variables\n"
            ...
            "   - Grid systems\n"
            "   - Common patterns\n"
            "3. Each UI file MUST have its own CSS file\n"
            "4. Follow naming convention matching the component/page name\n"
            "5. Keep styles modular and scoped to their component\n\n"
