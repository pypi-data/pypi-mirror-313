        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "5. ESSENTIAL: Each group should contain ONLY tasks that can be worked on concurrently without ANY dependencies or context sharing between files in the same group.\n"
                    ...
                    "14. REQUIRED: Group 'follower' files from the same stack together ONLY when they can be executed concurrently without needing ANY context from each other.\n"
