...
class ShortIdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            "   - Layout principles and whitespace usage\n\n"
            ...
            "   - Content sections\n\n"
            "7. Design Elements:\n"
            "   - Detailed color scheme with hex codes\n"
            ...
            "2. CSS File Linking:\n"
            "   - Each CSS file MUST be explicitly linked in its HTML file\n"
            "   - Example: <link rel='stylesheet' href='./styles/index.css'>\n"
            "   - Verify all paths are correct and files exist\n\n"
            "3. CSS Organization:\n"
            "   - Each CSS file MUST only contain styles for its specific HTML file\n"
            "   - NO sharing styles between files except through global.css\n"
            "   - Document which HTML file each CSS belongs to in comments\n\n"
            "4. CSS Dependencies:\n"
            "   - List all CSS files needed for each HTML file\n"
            "   - Specify correct loading order\n"
            "   - Document any shared dependencies\n\n"
            "5. CSS Validation:\n"
            "   - Confirm each HTML file has its CSS linked\n"
            "   - Verify CSS files match HTML file names\n"
            "   - Check for missing or extra CSS files\n\n"
            "CRITICAL RULES:\n"
            "1. NEVER combine styles for multiple components\n"
            "2. ALWAYS create dedicated CSS for each component/page\n"
            "3. Use BEM or similar naming convention\n"
