        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "11. ABSOLUTELY CRITICAL: Lead-Follow Principle Implementation:\n"
                    "    - Frontend Example:\n"
                    "        1. Lead HTML File First:\n"
                    "           - index.html as lead file for pages (defines page structure pattern)\n"
                    "           - button.html as lead file for components (defines component pattern)\n"
                    "        2. Follower HTML Files Next:\n"
                    "           - about.html, contact.html following index.html pattern\n"
                    "           - checkbox.html, input.html following button.html pattern\n"
                    "        3. Lead CSS File After Its HTML:\n"
                    "           - index.css after index.html is complete\n"
                    "           - button.css after button.html is complete\n"
                    "        4. Follower CSS Files:\n"
                    "           - about.css, contact.css following index.css pattern\n"
                    "           - checkbox.css, input.css following button.css pattern\n"
                    "    - Backend Example:\n"
                    "        1. Lead Model First:\n"
                    "           - user.py as lead model (defines model structure)\n"
                    "        2. Follower Models Next:\n"
                    "           - product.py, order.py following user.py pattern\n"
                    "        3. Lead Controller After Models:\n"
                    "           - user_controller.py (defines controller pattern)\n"
                    "        4. Follower Controllers:\n"
                    "           - product_controller.py, order_controller.py following pattern\n"
                    "    - Database Example:\n"
                    "        1. Lead Migration First:\n"
                    "           - create_users_table.sql (defines table structure pattern)\n"
                    "        2. Follower Migrations:\n"
                    "           - create_products_table.sql, create_orders_table.sql following pattern\n"
