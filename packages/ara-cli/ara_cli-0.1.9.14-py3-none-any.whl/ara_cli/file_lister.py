import os
import fnmatch
from ara_cli.list_filter import ListFilter, ListFilterMonad


def filter_list(list_to_filter, list_filter: ListFilter | None = None):
    if filter is None:
    ...
    filter_monad = ListFilterMonad(list_to_filter)
