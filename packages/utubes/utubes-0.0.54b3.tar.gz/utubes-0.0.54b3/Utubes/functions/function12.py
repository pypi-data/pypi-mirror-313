...
class Spotify:
    ...
    async def clinton(client=Creds.DATA01, secret=Creds.DATA01, config=Spotifyconfig):
        try:
...
#=====================================================================================================
    ...
    async def download(mains, sid):
        looed = asyncio.get_event_loop()
        moonus = asyncio.to_thread(mains.search_and_download, sid[0])
        return moonus
