...
print("Adding TopasGraphSim to context menu...")

topasgraphsim = os.path.join(os.path.dirname(os.path.realpath(__file__)),"..","..","topasgraphsim.py")

print(f"{sys.executable} -m topasgraphsim \"%1\"")

define_action_on("*", "OpenWithTopasGraphSim", f"C:\\Users\\sebas\\AppData\\Roaming\\Microsoft\\Windows\\'Start Menu'\\Programs\\TopasGraphSim.exe \"%1\"", title="Open with TopasGraphSim")
