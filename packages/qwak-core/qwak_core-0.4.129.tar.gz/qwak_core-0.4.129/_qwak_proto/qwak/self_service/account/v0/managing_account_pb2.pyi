...
class CreateAccountOptions(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["cloud_provider_spec", b"cloud_provider_spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["account_name", b"account_name", "cloud_provider", b"cloud_provider", "cloud_provider_spec", b"cloud_provider_spec"]) -> None: ...
