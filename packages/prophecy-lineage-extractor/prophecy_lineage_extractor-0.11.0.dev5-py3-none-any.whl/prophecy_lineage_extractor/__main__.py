...
from prophecy_lineage_extractor.constants import (
    ...
    BRANCH, OUTPUT_DIR, MONITOR_TIME_ENV,
)
...
def monitor_ws(ws):
    ...
    global last_meaningful_message_time
    time.sleep(10)
    monitor_time = int(os.environ.get(MONITOR_TIME_ENV, MONITOR_TIME_DEFAULT))
    logging.info(f"Monitor Time: {monitor_time} seconds")
