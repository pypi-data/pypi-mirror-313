...
class DataLoadInput(BaseModel):
    data_source: Optional["DataSourceLoadGenericInput"] = Field(
...
class DataSourceLoadGenericInput(BaseModel):
    data_source_identifier: "DataSourceIdentifierInput" = Field(
        serialization_alias="dataSourceIdentifier"
    )
    data_source_load: "DataSourceLoadSpecificInput" = Field(
        serialization_alias="dataSourceLoad"
    )


class DataSourceLoadSpecificInput(BaseModel):
...
class JdbcDataSourceLoadInput(BaseModel):
    parameters: List[Constant] = Field(default_factory=lambda: [])
    query: str
...
DataSourceLoadGenericInput.model_rebuild()
DataSourceLoadSpecificInput.model_rebuild()
