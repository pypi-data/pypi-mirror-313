...
def putSolicitacaoFunction(solicitacao: str, enumProcesso: EnumProcesso, enumBanco: EnumBanco):
    data = {
...
def postRequestFunction(enumStatusSolicitacao: EnumStatusSolicitacao, solicitacao: str, enumBanco: EnumBanco) -> int:
    data = {
        'enumDetalheSolicitacoesStatus': enumStatusSolicitacao.value,
        'numeroSolicitacao': solicitacao,
        "acompanhamentoDomain": {
            "acompanhamentoId": enumBanco.value
        }
    }
    headers = {
        "Content-Type": "application/json"
