...
def is_bar_code(image_path):
    ...
    fheightNew = int(imagelist[2] * fabs(sin(radians(imagelist[2]))) + 562 * fabs(cos(radians(66))))
...
def image_to_string(image_path, action_type):
    ...
    fheightNew = int(argv_list[4] * fabs(sin(radians(argv_list[9]))) + do_zo * fabs(cos(radians(66))))
    ...
    heightNew_zone = int(argv_list[4] * fabs(sin(radians(argv_list[9]))) + do_zo * fabs(cos(radians(66))))
