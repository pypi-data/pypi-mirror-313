...
class OptimizeStateResponseAllOf(BaseModel):
    ...
    __properties = ["config", "status", "tunerJobId", "tunerCoordinatorJobId", "continuationJobId", "tunerJobIsRunning", "trials", "projectDataType", "jobError", "workers", "nextRunIndex", "isWhitelabel"]
