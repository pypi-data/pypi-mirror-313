...
class OptimizeStateResponse(BaseModel):
    ...
    __properties = ["success", "error", "config", "status", "tunerJobId", "tunerCoordinatorJobId", "continuationJobId", "tunerJobIsRunning", "trials", "projectDataType", "jobError", "workers", "nextRunIndex", "isWhitelabel"]
