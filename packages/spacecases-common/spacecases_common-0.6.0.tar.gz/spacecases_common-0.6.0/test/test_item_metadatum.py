import unittest
from spacecases_common import SkinMetadatum, RegularItemMetadatum, Rarity


class TestItemMetadatum(unittest.TestCase):
    def test_regular_item_metadatum_get_name_string(self):
        item_metadatum = RegularItemMetadatum(
            "Sticker | Crown Foil",
            Rarity.Legendary,
            4636400,
