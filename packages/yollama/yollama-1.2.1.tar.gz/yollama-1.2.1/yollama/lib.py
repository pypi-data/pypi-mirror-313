...
def get_llm(use_case: Literal["default", "long-context", "reasoning", "sql"] = "default", output_json: bool = True, check_model_exists: bool = False):
    if use_case not in ["default", "long-context", "reasoning", "sql"]:
        raise ValueError("Invalid use case. Please choose from 'default', 'long-context', 'reasoning', or 'sql'.")
