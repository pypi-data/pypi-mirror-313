    ...
    def get_tools(
        ...
        Args:
            ...
            tools_to_include: List of tool names to include. If None, all tools are included. Defaults to None.
                Available tools:
                    - `botmailroom.create_inbox`
                    - `botmailroom.send_email`
                    - `botmailroom.get_email`
                    - `botmailroom.get_email_content`
                    - `botmailroom.get_email_attachment`
                    - `botmailroom.get_domains`
                    - `botmailroom.get_inboxes`
                    - `botmailroom.wait_for_email`
