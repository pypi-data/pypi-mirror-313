...
@registry.audio_preprocessors.register("fbank_extractor")
class FbankExtractor(BaseAudioPreprocessor):
    ...
    def process_waveform(self, waveform: np.ndarray, device: str = "cpu") -> np.ndarray:
        with torch.device(device):
            feats = self.apply_fbank(waveform)
