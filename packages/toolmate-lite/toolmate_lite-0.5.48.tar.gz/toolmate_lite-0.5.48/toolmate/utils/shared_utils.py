...
def getOllamaServerClient(server="tool"):
    if server=="chat" and config.ollamaChatServer_url == "127.0.0.1" and not config.ollamaChatHost_localIp and not isServerAlive(config.ollamaChatServer_url, config.ollamaChatServer_port):
        config.ollamaChatHost_localIp = True
    elif server=="tool" and config.ollamaToolServer_url == "127.0.0.1" and not config.ollamaToolHost_localIp and not isServerAlive(config.ollamaToolServer_url, config.ollamaToolServer_port):
