...
from pipefy.factories import KEYWORD_FACTORY_MAP
from pipefy.log import logger_factory
from pipefy.processors import get_processor
from pipefy.processors.base import BaseProcessor
from pipefy.processors.chain_processors import ChainAllProcessor, ChainAnyProcessor
from pipefy.processors.retry_processor import RetryProcessor
...
class BaseOpEnum(str, Enum):
    ...
    downloading = "pipefy.etl.extract.http.HttpDataExtractProcessor"
    stream_downloading = "pipefy.etl.extract.http.HttpxStreamDownloadProcessor"
    unzip = "pipefy.etl.transform.unzip.BaseUnzipProcessor"
    csv_parsing = "pipefy.etl.transform.csv.CsvParser"
    json_parsing = "pipefy.etl.transform.json.JsonParser"
    retrying = "pipefy.processors.retry_processor.RetryProcessor"
    splitting = "pipefy.processors.splitter_processor.SplitterProcessor"
