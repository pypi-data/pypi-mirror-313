...
USMemorialDay = HolidayDayOfMonth(
    name="Memorial Day",
    month=5,
    day_of_month=31,
...
USColumbusDay = HolidayDayOfMonth(
    name="Columbus Day",
    month=10,
    day_of_month=1,
    nearest_workday=True,
...
USThanksgivingDay = HolidayDayOfMonth(
...
EasterMonday = HolidayDayOfMonth(
    name="Easter Monday",
    month=1,
    day_of_month=1,
    nearest_workday=True,
