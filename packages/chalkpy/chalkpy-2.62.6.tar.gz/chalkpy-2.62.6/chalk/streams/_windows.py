...
class MaterializationWindowConfig(TypedDict, total=False):
    ...
    backfill_resolver: str | ResolverProtocol | None
    ...
    """The schedule on which to run the backfill resolver. For example, `"* * * * *"` or `"1h"`."""
    ...
    continuous_resolver: str | ResolverProtocol | None
