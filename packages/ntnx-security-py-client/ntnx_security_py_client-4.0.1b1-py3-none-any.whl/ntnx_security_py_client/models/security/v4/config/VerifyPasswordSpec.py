...
class VerifyPasswordSpec(object):
    ...
    :type current_password: required
    ...
    def __init__(self, current_password=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'security.v4.config.VerifyPasswordSpec'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VerifyPasswordSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VerifyPasswordSpec):
            return False
