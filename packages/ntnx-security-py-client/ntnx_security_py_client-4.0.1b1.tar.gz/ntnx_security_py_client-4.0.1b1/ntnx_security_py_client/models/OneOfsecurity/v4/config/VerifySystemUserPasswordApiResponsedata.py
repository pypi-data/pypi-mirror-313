...
class VerifySystemUserPasswordApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'security.v4.config.VerifyPassword': 'security.v4.config.VerifyPassword',
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.config.VerifySystemUserPasswordApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in VerifySystemUserPasswordApiResponsedata.discriminator_value_class_map.values():
            return list(VerifySystemUserPasswordApiResponsedata.discriminator_value_class_map.keys())[list(VerifySystemUserPasswordApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VerifySystemUserPasswordApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VerifySystemUserPasswordApiResponsedata):
            return False
