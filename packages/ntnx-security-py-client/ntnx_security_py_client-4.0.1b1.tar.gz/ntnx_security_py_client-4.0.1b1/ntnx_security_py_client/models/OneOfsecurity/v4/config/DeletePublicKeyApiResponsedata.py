...
class DeletePublicKeyApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfsecurity.v4.config.DeletePublicKeyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeletePublicKeyApiResponsedata.discriminator_value_class_map.values():
            return list(DeletePublicKeyApiResponsedata.discriminator_value_class_map.keys())[list(DeletePublicKeyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeletePublicKeyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeletePublicKeyApiResponsedata):
            return False
