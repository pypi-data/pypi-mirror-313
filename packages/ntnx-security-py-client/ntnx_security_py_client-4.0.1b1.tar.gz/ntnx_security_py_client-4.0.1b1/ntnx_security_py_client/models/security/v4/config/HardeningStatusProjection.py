...
from ntnx_security_py_client.models.security.v4.config.HardeningStatus import HardeningStatus  # noqa: F401,E501
from ntnx_security_py_client.models.security.v4.config.Schedule import Schedule  # noqa: F401,E501

class HardeningStatusProjection(HardeningStatus):
    ...
    def __init__(self, cluster_projection=None, cluster_ext_id=None, is_high_strength_password_enabled=None, is_aide_enabled=None, is_secure_boot_enabled=None, is_cluster_lockdown_enabled=None, is_log_forwarding_enabled=None, scma_schedule=None, ahv_scma_schedule=None, is_ahv_defense_consent_banner_enabled=None, is_cvm_defense_consent_banner_enabled=None, is_network_segmentation_enabled=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        HardeningStatus.__init__(self, cluster_ext_id, is_high_strength_password_enabled, is_aide_enabled, is_secure_boot_enabled, is_cluster_lockdown_enabled, is_log_forwarding_enabled, scma_schedule, ahv_scma_schedule, is_ahv_defense_consent_banner_enabled, is_cvm_defense_consent_banner_enabled, is_network_segmentation_enabled, ext_id, links, tenant_id, *args, **kwargs)
    ...
    def _initialize_object_type(self):
        return 'security.v4.config.HardeningStatusProjection'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(HardeningStatusProjection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HardeningStatusProjection):
            return False
