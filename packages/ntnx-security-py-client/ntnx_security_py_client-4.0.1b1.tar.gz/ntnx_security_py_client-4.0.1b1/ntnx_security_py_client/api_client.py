...
class ApiClient(object):
    ...
    # Populated if multiple schemas exist with the same name
        ...
        'OneOfsecurity.v4.config.ChangeSystemUserPasswordApiResponsedata' : 'ChangeSystemUserPasswordApiResponsedata',
        ...
        'OneOfsecurity.v4.config.UpdateHardeningStatusesApiResponsedata' : 'UpdateHardeningStatusesApiResponsedata',
        'security.v4.management.SecuredEntityType' : 'SecuredEntityType',
        'OneOfcommon.v1.config.KVPairvalue' : 'KVPairvalue',
        'OneOfsecurity.v4.config.UpdateHardeningVisibilitySettingApiResponsedata' : 'UpdateHardeningVisibilitySettingApiResponsedata',
        'security.v4.config.PasswordVerificationStatus' : 'PasswordVerificationStatus',
        'security.v4.report.SummaryProjection' : 'SummaryProjection',
        'security.v4.report.StigSummaryProjection' : 'StigSummaryProjection',
        'common.v1.config.Flag' : 'Flag',
        'security.v4.config.ChangePasswordSpec' : 'ChangePasswordSpec',
        'security.v4.error.SchemaValidationError' : 'SchemaValidationError',
        'security.v4.config.ChangeSystemUserPasswordApiResponse' : 'ChangeSystemUserPasswordApiResponse',
        'security.v4.error.ErrorResponse' : 'ErrorResponse',
        'security.v4.config.HardeningStatusProjection' : 'HardeningStatusProjection',
        'security.v4.config.SystemType' : 'SystemType',
        'security.v4.report.StigSummary' : 'StigSummary',
        'security.v4.report.TrendValue' : 'TrendValue',
        'security.v4.config.AddPublicKeyApiResponse' : 'AddPublicKeyApiResponse',
        'security.v4.report.Summary' : 'Summary',
        ...
        'security.v4.config.HardeningVisibilitySetting' : 'HardeningVisibilitySetting',
        'security.v4.management.ApprovalPolicy' : 'ApprovalPolicy',
        'security.v4.common.ClusterProjection' : 'ClusterProjection',
        'security.v4.config.VerifySystemUserPasswordApiResponse' : 'VerifySystemUserPasswordApiResponse',
        'security.v4.management.PolicyType' : 'PolicyType',
        'iam.v4.authn.BucketsAccessKey' : 'BucketsAccessKey',
        'security.v4.config.DeletePublicKeyApiResponse' : 'DeletePublicKeyApiResponse',
        'security.v4.config.PublicKey' : 'PublicKey',
        ...
        'OneOfsecurity.v4.management.TriggerScanApiResponsedata' : 'TriggerScanApiResponsedata',
        'security.v4.common.Cluster' : 'Cluster',
        'security.v4.report.StigStatus' : 'StigStatus',
        'security.v4.config.SystemUserPassword' : 'SystemUserPassword',
        'OneOfsecurity.v4.management.ListApprovalPoliciesApiResponsedata' : 'ListApprovalPoliciesApiResponsedata',
        'security.v4.config.Schedule' : 'Schedule',
        'security.v4.config.UpdateHardeningStatusesApiResponse' : 'UpdateHardeningStatusesApiResponse',
        'iam.v4.authn.CreationType' : 'CreationType',
        'security.v4.report.IssueSummary' : 'IssueSummary',
        'security.v4.config.VerifyPassword' : 'VerifyPassword',
        'security.v4.config.PublicKeyProjection' : 'PublicKeyProjection',
        'security.v4.management.TriggerApprovalPolicyValidationApiResponse' : 'TriggerApprovalPolicyValidationApiResponse',
        'OneOfsecurity.v4.management.TriggerApprovalPolicyValidationApiResponsedata' : 'TriggerApprovalPolicyValidationApiResponsedata',
        'security.v4.config.SystemUserPasswordProjection' : 'SystemUserPasswordProjection',
        'OneOfsecurity.v4.config.DeletePublicKeyApiResponsedata' : 'DeletePublicKeyApiResponsedata',
        ...
        'OneOfsecurity.v4.config.VerifySystemUserPasswordApiResponsedata' : 'VerifySystemUserPasswordApiResponsedata',
        'common.v1.config.MapOfStringWrapper' : 'MapOfStringWrapper',
        'security.v4.management.TriggerScanApiResponse' : 'TriggerScanApiResponse',
        ...
        'security.v4.config.HardeningStatus' : 'HardeningStatus',
        'security.v4.management.SecuredPolicy' : 'SecuredPolicy',
        'security.v4.report.VulnerabilitySummaryProjection' : 'VulnerabilitySummaryProjection',
        'common.v1.response.ApiResponseMetadata' : 'ApiResponseMetadata',
        'OneOfsecurity.v4.config.AddPublicKeyApiResponsedata' : 'AddPublicKeyApiResponsedata',
        ...
        'security.v4.config.UpdateHardeningVisibilitySettingApiResponse' : 'UpdateHardeningVisibilitySettingApiResponse',
        ...
        'security.v4.config.VerifyPasswordSpec' : 'VerifyPasswordSpec',
        'common.v1.response.ExternalizableAbstractModel' : 'ExternalizableAbstractModel',
        'security.v4.config.PasswordStatus' : 'PasswordStatus',
