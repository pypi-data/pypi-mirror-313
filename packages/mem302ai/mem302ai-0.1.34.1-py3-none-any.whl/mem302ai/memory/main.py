...
from mem302ai.configs.base import MemoryConfig, MemoryItem
from mem302ai.configs.prompts import get_update_memory_messages
from mem302ai.memory.base import MemoryBase
from mem302ai.memory.setup import setup_config
from mem302ai.memory.storage import SQLiteManager
from mem302ai.memory.telemetry import capture_event
from mem302ai.memory.utils import get_fact_retrieval_messages, parse_messages
from mem302ai.utils.factory import EmbedderFactory, LlmFactory, VectorStoreFactory
...
class Memory(MemoryBase):
    def __init__(self, config: MemoryConfig = MemoryConfig()):
        ...
        if self.api_version == "v1.1" and self.config.graph_store.config:
            from mem302ai.memory.graph_memory import MemoryGraph
