...
def main(model: Model, question: str, file_path: str) -> None:
    ...
    deployments: dict[Model, Deployment] = {
        ...
        "gpt-4o": Deployment(
            ...
            api_key="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",
            endpoint="",
        ),
