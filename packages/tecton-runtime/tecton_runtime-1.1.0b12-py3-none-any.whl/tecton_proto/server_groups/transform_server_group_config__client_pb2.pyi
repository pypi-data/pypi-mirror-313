...
class TransformServerGroupConfiguration(_message.Message):
    __slots__ = ["computed_time", "resource_providers_config", "secrets_config", "server_group_id", "workspace", "workspace_state_id"]
