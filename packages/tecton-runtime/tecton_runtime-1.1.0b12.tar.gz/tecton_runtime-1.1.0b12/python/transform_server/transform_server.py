...
class TransformServer(transform_service_pb2_grpc.TransformServiceServicer):
    def __init__(self):
        ...
        if transform_server_groups_enabled and (secrets_enabled or resource_providers_enabled):
            config_file_path = os.environ.get("TRANSFORM_SERVER_GROUP_CONFIGURATION_PATH", None)
...
def main():
    ...
    if transform_server_groups_enabled:
        ...
        max_concurrent_rpcs = os.environ.get("TRANSFORM_SERVER_MAX_CONCURRENT_RPCS", 20)
        try:
