...
from ...models.hubspot_oauth_config_in import HubspotOauthConfigIn
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: HubspotOauthConfigIn,
) -> Dict[str, Any]:
    url = "{}/api/v1/app/{app_id}/endpoint/{endpoint_id}/transformation-template/oauth/hubspot".format(
