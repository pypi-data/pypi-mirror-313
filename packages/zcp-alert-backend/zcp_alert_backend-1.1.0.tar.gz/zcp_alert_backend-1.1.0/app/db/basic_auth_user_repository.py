...
class BasicAuthUserRepository(BaseRepository):
    ...
    def update(self, basic_auth_user: BasicAuthUser) -> BasicAuthUser:
        ...
        basic_auth_user_dict = basic_auth_user.model_dump(by_alias=True, exclude=['id', 'created_at'])
    ...
    def delete_by_id(self, basic_auth_user_id: str) -> bool:
        ...
        if result is None:
            raise ObjectNotFoundException(f"BasicAuthUser not found: {basic_auth_user_id}")
