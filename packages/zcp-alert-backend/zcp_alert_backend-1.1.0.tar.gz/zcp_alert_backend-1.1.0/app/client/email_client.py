...
class EmailClient:
    ...
    def send_email(
        ...
        *,
        ...
        message["Subject"] = self._get_email_subject(action=action, alert=alert, modifier=modifier)
        
        message.attach(MIMEText(self._get_email_html_body(action=action, alert=alert, modifier=modifier), "html"))
    ...
    def _get_email_subject(
        ...
        *,
        ...
        if action is None:
            ...
            subject = (
                f"[{status_tilte} by {modifier if modifier else ""}] {alert.annotations['summary'] 
                    if alert.annotations.get('summary') 
                    else 'N/A'}"
            )
    ...
    def send_test_email(
        ...
        *,
        ...
        message.attach(MIMEText("<p>This is a test email from ZCP Alert Manager.</p>", "html"))
