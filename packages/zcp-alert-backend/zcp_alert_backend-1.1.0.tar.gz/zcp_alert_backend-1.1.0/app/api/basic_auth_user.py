...
from app.schema.basicauth_request_model import BasicAuthUserCreateRequest, BasicAuthUserUpdateRequest
...
async def create_basic_auth_user(
    ...
    return ResponseModel(data={"inserted_id": __service.create_basic_auth_user(basic_auth_user)})
