...
from app.model.alert_model import AlertBaseModel
...
class KakaoTalkToken(AlertBaseModel):
    ...
    def _serialize_refresh_token_updated_at(self, dt: Optional[datetime]) -> Optional[str]:
    ...
    def is_expired_access_token(self):
        ...
        expired_time = (
            self.access_token_updated_at if self.access_token_updated_at else self.created_at
    ...
    def is_expired_refresh_token(self):
        current_time = datetime.now(DEFAULT_TIME_ZONE)
        expired_time = (
            self.refresh_token_updated_at if self.refresh_token_updated_at else self.created_at
