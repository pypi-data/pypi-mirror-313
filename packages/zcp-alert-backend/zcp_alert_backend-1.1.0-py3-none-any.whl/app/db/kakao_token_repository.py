...
class KakaoTaklTokenRepository(BaseRepository):
    ...
    def insert(self, kakaotalk_token: KakaoTalkToken) -> str:
        ...
        return str(
            self._collection.insert_one(kakaotalk_token_dict).inserted_id
        )
        # return str(
    ...
    def update(self, kakaotalk_token: KakaoTalkToken) -> KakaoTalkToken:
        ...
        kakaotalk_token.access_token = decrypt(bytes.fromhex(kakaotalk_token.access_token))
        kakaotalk_token.refresh_token = decrypt(bytes.fromhex(kakaotalk_token.refresh_token))
