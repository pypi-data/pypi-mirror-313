import copy
import logging
from workflow.utils.verify import validate_dict
from workflow.utils.find import has_target_by_attr, find_by_attr, find
from workflow.utils.chunk_helper import create_connection_symbol
from workflow.Chunk import SchemaChunk
from workflow.lib.constants import DEFAULT_INPUT_HANDLE_VALUE, DEFAULT_OUTPUT_HANDLE_VALUE, DEFAULT_OUTPUT_HANDLE, DEFAULT_INPUT_HANDLE, EXECUTOR_TYPE_NORMAL
