...
llevar estrictamente las palabras Dice: y debe decir:')
    ...
    @property
    def TotalPeriodo(self):
        if not hasattr(self, '_total_periodo'):
            return self.MntTotal + self.MontoNF
        return self._total_periodo

    @TotalPeriodo.setter
    def TotalPeriodo(self, val):
        self._total_periodo = int(val)
    ...
    def Totales(self):
        ...
        if self.MontoNF:
            ...
            if self.es_boleta():
                Totales['TotalPeriodo'] = self.TotalPeriodo
            else:
