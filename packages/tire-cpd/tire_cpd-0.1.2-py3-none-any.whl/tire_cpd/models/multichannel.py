...
def train_model(windows, loss_weight_share_AS=1e-2, loss_weight_share_B=1e-2, loss_weight_uncor=0.1, n_filter=2,
                verbose=1, enable_summary=False, rank=1, nr_epochs=200, nr_patience=10):
