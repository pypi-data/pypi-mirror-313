...
def root(context, missing=missing):
    ...
    pass
    for l_1_aaa_server_group in t_1((undefined(name='aaa_server_groups') if l_0_aaa_server_groups is missing else l_0_aaa_server_groups), 'name'):
        _loop_vars = {}
        pass
        if (environment.getattr(l_1_aaa_server_group, 'type') == 'ldap'):
            pass
            yield '!\naaa group server '
