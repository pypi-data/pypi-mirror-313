...
_SCHEMAINFERENCEERROR = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='log_label', full_name='fault.SchemaInferenceError.log_label', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CONNECTION_CONFIGOPTIONS_TRY = _descriptor.Descriptor(
  name='Try',
  full_name='fault.Connection.ConfigOptions.Try',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='success', full_name='fault.Connection.ConfigOptions.Try.success', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='failure', full_name='fault.Connection.ConfigOptions.Try.failure', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='try', full_name='fault.Connection.ConfigOptions.Try.try',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_CONNECTION_CONFIGOPTIONS = _descriptor.Descriptor(
  name='ConfigOptions',
  full_name='fault.Connection.ConfigOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  ...
  nested_types=[_CONNECTION_CONFIGOPTIONS_TRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_CONNECTION = _descriptor.Descriptor(
  ...
  nested_types=[_CONNECTION_ASSETS, _CONNECTION_CONFIGOPTIONS, _CONNECTION_OBJECTS, _CONNECTION_ID, _CONNECTION_TRY, _CONNECTION_TYPE, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_CONNECTION_CONFIGOPTIONS_TRY.fields_by_name['success'].message_type = ascend_dot_protos_dot_external_dot_external__pb2._CONNECTION_CONFIGOPTIONS
_CONNECTION_CONFIGOPTIONS_TRY.fields_by_name['failure'].message_type = _FAULT
_CONNECTION_CONFIGOPTIONS_TRY.containing_type = _CONNECTION_CONFIGOPTIONS
_CONNECTION_CONFIGOPTIONS_TRY.oneofs_by_name['try'].fields.append(
  _CONNECTION_CONFIGOPTIONS_TRY.fields_by_name['success'])
_CONNECTION_CONFIGOPTIONS_TRY.fields_by_name['success'].containing_oneof = _CONNECTION_CONFIGOPTIONS_TRY.oneofs_by_name['try']
_CONNECTION_CONFIGOPTIONS_TRY.oneofs_by_name['try'].fields.append(
  _CONNECTION_CONFIGOPTIONS_TRY.fields_by_name['failure'])
_CONNECTION_CONFIGOPTIONS_TRY.fields_by_name['failure'].containing_oneof = _CONNECTION_CONFIGOPTIONS_TRY.oneofs_by_name['try']
...
Connection = _reflection.GeneratedProtocolMessageType('Connection', (_message.Message,), {
  ...
  'ConfigOptions' : _reflection.GeneratedProtocolMessageType('ConfigOptions', (_message.Message,), {
    ...
    'Try' : _reflection.GeneratedProtocolMessageType('Try', (_message.Message,), {
      'DESCRIPTOR' : _CONNECTION_CONFIGOPTIONS_TRY,
      '__module__' : 'ascend.protos.fault.fault_pb2'
      # @@protoc_insertion_point(class_scope:fault.Connection.ConfigOptions.Try)
      })
    ,
    'DESCRIPTOR' : _CONNECTION_CONFIGOPTIONS,
    '__module__' : 'ascend.protos.fault.fault_pb2'
    # @@protoc_insertion_point(class_scope:fault.Connection.ConfigOptions)
    })
  ,
...
_sym_db.RegisterMessage(Connection.ConfigOptions.Try)
