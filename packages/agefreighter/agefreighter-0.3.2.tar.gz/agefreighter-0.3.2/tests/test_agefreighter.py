...
async def test_loadFromGremlin(
    ...
    print(
        f"test_loadFromGremlin : time, {time.time() - start_time:.2f}, chunk_size: {chunk_size}, direct_loading: {direct_loading}, use_copy: {use_copy}"
    )


# load test data via Gremlin
# file downloaded from https://www.kaggle.com/datasets/darinhawley/imdb-films-by-actor-for-10k-actors
...
async def main() -> None:
    ...
    try:
        ...
        if do:
            ...
            print("test_loadFromGremlin done\n")
