...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('ax', 'plotrates', 'tol', 'display', 'atol', 'printrates', 'sol', 'mat', 'ress', 'residuals', 'maxiter', 'callback_sol', 'fig', 'its', 'clear_output', '_final_residual', 'plt', 'pre', 'iterations', 'callback')
