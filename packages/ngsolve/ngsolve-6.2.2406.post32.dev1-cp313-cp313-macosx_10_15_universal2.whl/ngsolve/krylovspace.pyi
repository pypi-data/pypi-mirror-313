...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('plotrates', 'callback', 'tol', 'residuals', 'printrates', 'ress', 'clear_output', 'atol', 'callback_sol', 'ax', 'plt', 'mat', 'display', 'iterations', 'sol', 'pre', '_final_residual', 'fig', 'maxiter', 'its')
