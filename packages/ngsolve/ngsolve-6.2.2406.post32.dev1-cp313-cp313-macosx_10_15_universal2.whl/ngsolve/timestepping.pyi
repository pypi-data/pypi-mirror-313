...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_lin_solver_args', 'dt', 'time', 'gfu_old', '_lin_solver_cls', 'c', 'bfmstar')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_lin_solver_args', 'dt', 'time', 'gfu_old', 'bfmstar', '_lin_solver_cls', 'c', 'gfv_old', 'gfa_old')
