import { g as X, w as E } from "./Index-POZXZCxI.js";
const m = window.ms_globals.React, B = window.ms_globals.React.forwardRef, J = window.ms_globals.React.useRef, Y = window.ms_globals.React.useState, Q = window.ms_globals.React.useEffect, O = window.ms_globals.ReactDOM.createPortal, Z = window.ms_globals.antd.Empty;
var G = {
  exports: {}
}, R = {};
/**
...
function Ee(n) {
  ...
  return {
    c() {
      t = M("react-portal-target"), o = me(), e && e.c(), l = N(), this.h();
    },
    l(s) {
      t = K(s, "REACT-PORTAL-TARGET", {
        class: !0
      }), H(t).forEach(h), o = ie(s), e && e.l(s), l = N(), this.h();
    },
    h() {
      q(t, "class", "svelte-1rt0kpf");
    },
    ...
    p(s, [a]) {
      ...
      16 && C(e, 1)) : (e = D(s), e.c(), C(e, 1), e.m(l.parentNode, l)) : e && (fe(), k(e, 1, 1, () => {
        e = null;
      }), le());
    },
    i(s) {
...
const F = B(({
  ...
  return Q(() => {
    ...
    if (t && window.MutationObserver) {
      let d = function() {
        ...
        return i = S, a(p), i.style.display = "contents", g(), (b = e.current) == null || b.appendChild(i), p.length > 0;
      };
  ...
  ...o,
  description: n.description ? /* @__PURE__ */ x.jsx(F, {
    slot: n.description
  }) : o.description,
  imageStyle: {
  ...
  image: n.image ? /* @__PURE__ */ x.jsx(F, {
    slot: n.image
  }) : o.image
}));
export {
