...
from ebat.data.retrievers import MedbaRetriever
from ebat.evaluation.evaluator import Evaluator
...
if __name__ == "__main__":
    ...
    # evaluator.evaluate(rfc, test, adver)
    evaluator.compare((rfc, nnc), test, adver, plots=True)
