...
class DelegationDto(BaseModel):
    ...
    date_updated: Optional[datetime] = Field(default=None, description="When has the position last changed (ISO Date).", alias="dateUpdated")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relatedRequests": [RelatedRequestDto.from_dict(_item) for _item in obj["relatedRequests"]] if obj.get("relatedRequests") is not None else None
        })
        return _obj
