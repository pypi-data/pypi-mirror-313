...
class OptionManager():
    ...
    def init_lists(self): 
        ...
        for service in self._service_modes:
            ...
            self._data["selected_graph"].set("Best Cost Stacked")
            self._data["graph_theme"].set("Dark")
            self._data["selected_csv"].set("No files found...")
            self._data["selected_csv2"].set("No files found...")
            self._data["selected_x"].set("time")
            self._data["selected_y1"].set("NONE")
            self._data["selected_y2"].set("NONE")
            self._data["figure_style"].set("Scatter")
            self._data["matrix_values"].append(sv())
            self._data["matrix_values"][0].set("NONE")
