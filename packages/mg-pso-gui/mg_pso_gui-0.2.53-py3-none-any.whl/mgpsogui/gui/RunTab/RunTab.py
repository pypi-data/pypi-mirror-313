...
def create_tab(self, tab):
    ...
    self.optimal_param_frame = opv.OptimalParameterView(tab, option_manager=self.option_manager)
    ...
    self.open_folder.grid(row=4, column=0, padx=(20, 20), pady=(5, 10), sticky="ew")