...
class GrpcUpdateLeadRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account, policy, status, code, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            should_trigger_workflow (bool): [optional] if omitted the server will use the default value of True  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, account, policy, status, code, *args, **kwargs):  # noqa: E501
        """GrpcUpdateLeadRequestDto - a model defined in OpenAPI
