...
from open_spiel.python.games import go
...
class GoArena:
    def __init__(self, bot_urls: Dict[str, str], board_size: int = 19):
        ...
        self.timeout = 5
        self.game = go.GoGame(board_size)
    ...
    def get_bot_move(self, bot_url: str, game_state: Dict) -> int:
        try:
            response = requests.post(
                f"{bot_url}/get_move",
                json=game_state,
