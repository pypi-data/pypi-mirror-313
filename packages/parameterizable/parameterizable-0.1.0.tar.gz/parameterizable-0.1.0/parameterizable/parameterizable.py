...
class ParameterizableClass:
    ...
    def __get_default_metaparams__(self) -> dict[str, Any]:
        """ Get the default meta-parameters of the object as a dictionary.
        ...
        """
        metaparams = self.get_default_params()
        metaparams[CLASSNAME_METAPARAM_KEY] = self.__class__.__name__
        return metaparams
    ...
    def get_default_params(self) -> dict[str, Any]:
        """ Get the default parameters of the object as a dictionary.
