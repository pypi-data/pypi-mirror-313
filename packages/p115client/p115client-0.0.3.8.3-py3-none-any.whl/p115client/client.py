...
class P115Client:
        ...
        **request_kwargs, 
        ...
        :payload:
            - flag: int = 0 💡 标识，用于对应某种情况
              ...
              - 5: 全部+删除源文件
        """
        api = complete_lixian_api("/lixian/?ct=lixian&ac=task_clear", base_url=base_url)
        if isinstance(payload, int):
            flag = payload
            if flag < 0:
                flag = 0
    ...
    def offline_list(
        ...
        **request_kwargs, 
        ...
        :payload:
            - page: int | str
        """
        api = complete_lixian_api("/lixian/?ct=lixian&ac=task_lists", base_url=base_url)
        if isinstance(payload, int):
    ...
    def offline_quota_info(
        ...
        **request_kwargs, 
        ...
        """
        api = complete_lixian_api("/lixian/?ct=lixian&ac=get_quota_info", base_url=base_url)
        return self.request(url=api, async_=async_, **request_kwargs)
    ...
    def offline_quota_package_info(
        ...
        **request_kwargs, 
        ...
        """
        api = complete_lixian_api("/lixian/?ct=lixian&ac=get_quota_package_info", base_url=base_url)
        return self.request(url=api, async_=async_, **request_kwargs)
    ...
    def offline_torrent_info(
        ...
        **request_kwargs, 
        ...
        :payload:
            - sha1: str
        """
        api = complete_lixian_api("/lixian/?ct=lixian&ac=torrent", base_url=base_url)
        if isinstance(payload, str):
            payload = {"sha1": payload}
        return self.request(url=api, method="POST", data=payload, async_=async_, **request_kwargs)
