...
class SchemeBaseRewardProgram(RewardProgramBase):
    ...
    def get_balacne_of_reward_amount_limit(self, customer_acct, transaction_details):
...
class VoucherRewardProgramBase(GiveawayRewardBaseProgram):
    ...
    def construct_giveaway_voucher_details_list(self, transaction_details):
        ...
        if is_not_empty(self.voucher_details_list):
            ...
            for voucher in self.voucher_details_list:
                ...
                voucher_details         = {
                                            ...
                                            'voucher_amount'    : voucher_amount * reward_unit,
