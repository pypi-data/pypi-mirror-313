...
MATCHERS: Tuple[List[UserAgentMatcher], List[OSMatcher], List[DeviceMatcher]] = ([
    ...
    UserAgentMatcher('Mozilla.{1,100}Mobile.{1,100}AspiegelBot', 'Spider'),
    UserAgentMatcher('AspiegelBot', 'Spider'),
    ...
    UserAgentMatcher('(Java)[/ ]?\\d+\\.(\\d+)\\.(\\d+)[_-]*([a-zA-Z0-9]+|)'),
    ...
    OSMatcher('(Ubuntu|Kubuntu|Arch Linux|CentOS|Slackware|Gentoo|openSUSE|SUSE|Red Hat|Fedora|PCLinuxOS|Mageia|(?:Free|Open|Net|\\b)BSD)'),
    ...
    DeviceMatcher('Mozilla.{1,100}Mobile.{1,100}AspiegelBot', None, 'Spider', 'Spider', 'Smartphone'),
    DeviceMatcher('Mozilla.{0,200}AspiegelBot', None, 'Spider', 'Spider', 'Desktop'),
    ...
    DeviceMatcher('; {0,2}Dell ([^;/]{1,100}?)(?: Build|\\) AppleWebKit)', None, 'Dell $1', 'Dell', '$1'),
    ...
    DeviceMatcher('; {0,2}(Pixel.{0,200}?)(?: Build|\\) AppleWebKit)', None, '$1', 'Google', '$1'),
