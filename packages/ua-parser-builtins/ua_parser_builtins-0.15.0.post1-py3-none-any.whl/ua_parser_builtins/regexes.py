...
USER_AGENT_PARSERS = [
    ...
    UserAgentParser('Mozilla.{1,100}Mobile.{1,100}AspiegelBot', 'Spider'),
    UserAgentParser('AspiegelBot', 'Spider'),
    ...
    UserAgentParser('(Java)[/ ]?\\d+\\.(\\d+)\\.(\\d+)[_-]*([a-zA-Z0-9]+|)'),
...
OS_PARSERS = [
    ...
    OSParser('(Ubuntu|Kubuntu|Arch Linux|CentOS|Slackware|Gentoo|openSUSE|SUSE|Red Hat|Fedora|PCLinuxOS|Mageia|(?:Free|Open|Net|\\b)BSD)'),
...
DEVICE_PARSERS = [
    ...
    DeviceParser('Mozilla.{1,100}Mobile.{1,100}AspiegelBot', None, 'Spider', 'Spider', 'Smartphone'),
    DeviceParser('Mozilla.{0,200}AspiegelBot', None, 'Spider', 'Spider', 'Desktop'),
    ...
    DeviceParser('; {0,2}Dell ([^;/]{1,100}?)(?: Build|\\) AppleWebKit)', None, 'Dell $1', 'Dell', '$1'),
    ...
    DeviceParser('; {0,2}(Pixel.{0,200}?)(?: Build|\\) AppleWebKit)', None, '$1', 'Google', '$1'),
