...
class RCMCNT_Client(RCMCNT_api):
    ...
    def SEL2(self, ezpath, *, upperLevel:int|None=None, lowerLevel:int|None=None,append:str|None=None, drop:str|None=None,transaction_id:TransactionId|None=None, user_info_id:str|None=None, debug:bool=False)->tuple[bool,Elem|None]:
