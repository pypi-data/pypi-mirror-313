    ...
    def __eval_once(self):
        ...
        with torch.no_grad():
            ...
            if accuracy > self.__best_acc:
                ...
                self.__best_model_state_dict = self.model.state_dict().copy()
                self.__best_optimizer_state_dict = self.optimizer.state_dict().copy()
                self.__best_lrScheduler_state_dict = self.lrScheduler.state_dict().copy() if self.lrScheduler else None
