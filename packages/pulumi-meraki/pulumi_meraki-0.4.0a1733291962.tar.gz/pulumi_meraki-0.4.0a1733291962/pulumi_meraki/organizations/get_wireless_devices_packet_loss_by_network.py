...
def get_wireless_devices_packet_loss_by_network(bands: Optional[Sequence[str]] = None,
...
def get_wireless_devices_packet_loss_by_network_output(bands: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
