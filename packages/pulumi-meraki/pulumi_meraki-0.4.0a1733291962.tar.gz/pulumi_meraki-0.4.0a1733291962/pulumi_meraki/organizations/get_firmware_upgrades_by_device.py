...
class GetFirmwareUpgradesByDeviceResult:
    ...
    def firmware_upgrade_batch_ids(self) -> Optional[Sequence[str]]:
        """
    ...
    @property
    @pulumi.getter
    def upgradestatuses(self) -> Optional[Sequence[str]]:
        """
...
def get_firmware_upgrades_by_device(ending_before: Optional[str] = None,
    ...
    :param Sequence[str] firmware_upgrade_batch_ids: firmwareUpgradeBatchIds query parameter. Optional parameter to filter by firmware upgrade batch ids.
    :param Sequence[str] macs: macs query parameter. Optional parameter to filter by one or more MAC addresses belonging to devices. All devices returned belong to MAC addresses that are an exact match.
    :param Sequence[str] network_ids: networkIds query parameter. Optional parameter to filter by network
    ...
    :param Sequence[str] serials: serials query parameter. Optional parameter to filter by serial number.  All returned devices will have a serial number that is an exact match.
