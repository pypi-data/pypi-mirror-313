...
class GetInventoryDevicesResult:
    ...
    def order_numbers(self) -> Optional[Sequence[str]]:
        """
    ...
    def used_state(self) -> Optional[str]:
        """
...
def get_inventory_devices(ending_before: Optional[str] = None,
    ...
    :param Sequence[str] macs: macs query parameter. Search for devices in inventory based on mac addresses.
    :param Sequence[str] models: models query parameter. Search for devices in inventory based on model.
    :param Sequence[str] network_ids: networkIds query parameter. Search for devices in inventory based on network ids. Use explicit 'null' value to get available devices only.
    :param Sequence[str] order_numbers: orderNumbers query parameter. Search for devices in inventory based on order numbers.
    ...
    :param Sequence[str] product_types: productTypes query parameter. Filter devices by product type. Accepted values are appliance, camera, cellularGateway, sensor, switch, systemsManager, and wireless.
    :param str search: search query parameter. Search for devices in inventory based on serial number, mac address, or model.
    :param str serial: serial path parameter.
    :param Sequence[str] serials: serials query parameter. Search for devices in inventory based on serials.
    :param str starting_after: startingAfter query parameter. A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
    :param Sequence[str] tags: tags query parameter. Filter devices by tags. The filtering is case-sensitive. If tags are included, 'tagsFilterType' should also be included (see below).
...
def get_inventory_devices_output(ending_before: Optional[pulumi.Input[Optional[str]]] = None,
                                 ...
                                 order_numbers: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
