...
def get_sensor_readings_history(ending_before: Optional[str] = None,
    ...
    :param str t0: t0 query parameter. The beginning of the timespan for the data. The maximum lookback period is 365 days and 6 hours from today.
...
def get_sensor_readings_history_output(ending_before: Optional[pulumi.Input[Optional[str]]] = None,
                                       ...
                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSensorReadingsHistoryResult]:
    """
    ## Example Usage
