...
def get_devices_provisioning_statuses(ending_before: Optional[str] = None,
    ...
    :param Sequence[str] network_ids: networkIds query parameter. Optional parameter to filter device by network ID. This filter uses multiple exact matches.
    ...
    :param Sequence[str] product_types: productTypes query parameter. Optional parameter to filter device by device product types. This filter uses multiple exact matches.
    ...
    :param str status: status query parameter. An optional parameter to filter devices by the provisioning status. Accepted statuses: unprovisioned, incomplete, complete.
...
def get_devices_provisioning_statuses_output(ending_before: Optional[pulumi.Input[Optional[str]]] = None,
                                             ...
                                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDevicesProvisioningStatusesResult]:
    """
    ## Example Usage
