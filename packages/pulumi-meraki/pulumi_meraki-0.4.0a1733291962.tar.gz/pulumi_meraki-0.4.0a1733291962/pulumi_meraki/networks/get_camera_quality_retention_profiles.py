...
class GetCameraQualityRetentionProfilesResult:
    ...
    def quality_retention_profile_id(self) -> Optional[str]:
        """
...
def get_camera_quality_retention_profiles(network_id: Optional[str] = None,
    ...
    :param str quality_retention_profile_id: qualityRetentionProfileId path parameter. Quality retention profile ID
    """
    __args__ = dict()
...
def get_camera_quality_retention_profiles_output(network_id: Optional[pulumi.Input[Optional[str]]] = None,
                                                 quality_retention_profile_id: Optional[pulumi.Input[Optional[str]]] = None,
                                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCameraQualityRetentionProfilesResult]:
    """
    ## Example Usage
