...
def get_wireless_usage_history(ap_tag: Optional[str] = None,
    ...
    :param str ap_tag: apTag query parameter. Filter results by AP tag; either :clientId or :deviceSerial must be jointly specified.
    ...
    :param str client_id: clientId query parameter. Filter results by network client to return per-device AP usage over time inner joined by the queried client's connection history.
    :param str device_serial: deviceSerial query parameter. Filter results by device. Requires :band.
    :param str network_id: networkId path parameter. Network ID
    :param int resolution: resolution query parameter. The time resolution in seconds for returned data. The valid resolutions are: 300, 600, 1200, 3600, 14400, 86400. The default is 86400.
    :param int ssid: ssid query parameter. Filter results by SSID number.
...
def get_wireless_usage_history_output(ap_tag: Optional[pulumi.Input[Optional[str]]] = None,
                                      ...
                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetWirelessUsageHistoryResult]:
    """
    ## Example Usage
