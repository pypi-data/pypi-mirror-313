...
def get_wireless_clients_latency_stats(ap_tag: Optional[str] = None,
...
def get_wireless_clients_latency_stats_output(ap_tag: Optional[pulumi.Input[Optional[str]]] = None,
                                              ...
                                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetWirelessClientsLatencyStatsResult]:
    """
    ## Example Usage
