...
class GetWirelessDevicesPacketLossByDeviceResult:
    ...
    @property
    @pulumi.getter
    def ssids(self) -> Optional[Sequence[str]]:
        """
...
def get_wireless_devices_packet_loss_by_device(bands: Optional[Sequence[str]] = None,
    ...
    :param Sequence[str] bands: bands query parameter. Filter results by band. Valid bands are: 2.4, 5, and 6.
    :param str ending_before: endingBefore query parameter. A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
    :param Sequence[str] network_ids: networkIds query parameter. Filter results by network.
    ...
    :param Sequence[str] serials: serials query parameter. Filter results by device.
    :param Sequence[str] ssids: ssids query parameter. Filter results by SSID number.
    ...
    :param str t1: t1 query parameter. The end of the timespan for the data. t1 can be a maximum of 90 days after t0.
    :param float timespan: timespan query parameter. The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be greater than or equal to 5 minutes and be less than or equal to 90 days. The default is 7 days.
    """
    __args__ = dict()
...
def get_wireless_devices_packet_loss_by_device_output(bands: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                                      ...
                                                      ssids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                                      ...
                                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetWirelessDevicesPacketLossByDeviceResult]:
    """
    ## Example Usage
