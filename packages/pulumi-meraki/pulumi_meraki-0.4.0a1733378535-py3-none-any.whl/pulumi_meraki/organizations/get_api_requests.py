...
def get_api_requests(admin_id: Optional[str] = None,
    ...
    :param str admin_id: adminId query parameter. Filter the results by the ID of the admin who made the API requests
    :param str ending_before: endingBefore query parameter. A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
    :param str method: method query parameter. Filter the results by the method of the API requests (must be 'GET', 'PUT', 'POST' or 'DELETE')
    :param Sequence[str] operation_ids: operationIds query parameter. Filter the results by one or more operation IDs for the API request
    :param str organization_id: organizationId path parameter. Organization ID
    :param str path: path query parameter. Filter the results by the path of the API requests
    ...
    :param int response_code: responseCode query parameter. Filter the results by the response code of the API requests
    :param str source_ip: sourceIp query parameter. Filter the results by the IP address of the originating API request
...
def get_api_requests_output(admin_id: Optional[pulumi.Input[Optional[str]]] = None,
                            ...
                            response_code: Optional[pulumi.Input[Optional[int]]] = None,
