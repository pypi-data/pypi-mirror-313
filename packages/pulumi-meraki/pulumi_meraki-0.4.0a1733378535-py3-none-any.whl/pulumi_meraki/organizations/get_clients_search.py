...
def get_clients_search(ending_before: Optional[str] = None,
    ...
    :param str mac: mac query parameter. The MAC address of the client. Required.
    :param str organization_id: organizationId path parameter. Organization ID
    :param int per_page: perPage query parameter. The number of entries per page returned. Acceptable range is 3 5. Default is 5.
...
def get_clients_search_output(ending_before: Optional[pulumi.Input[Optional[str]]] = None,
                              mac: Optional[pulumi.Input[str]] = None,
                              organization_id: Optional[pulumi.Input[str]] = None,
                              per_page: Optional[pulumi.Input[Optional[int]]] = None,
                              starting_after: Optional[pulumi.Input[Optional[str]]] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetClientsSearchResult]:
    """
    ## Example Usage
