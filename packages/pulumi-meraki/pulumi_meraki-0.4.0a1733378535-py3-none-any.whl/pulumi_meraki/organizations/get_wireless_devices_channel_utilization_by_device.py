...
def get_wireless_devices_channel_utilization_by_device(ending_before: Optional[str] = None,
...
def get_wireless_devices_channel_utilization_by_device_output(ending_before: Optional[pulumi.Input[Optional[str]]] = None,
                                                              ...
                                                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetWirelessDevicesChannelUtilizationByDeviceResult]:
    """
    ## Example Usage
