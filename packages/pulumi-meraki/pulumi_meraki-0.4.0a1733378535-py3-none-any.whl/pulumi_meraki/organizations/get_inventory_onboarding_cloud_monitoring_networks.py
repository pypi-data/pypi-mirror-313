...
def get_inventory_onboarding_cloud_monitoring_networks(device_type: Optional[str] = None,
    ...
    :param str device_type: deviceType query parameter. Device Type switch or wireless controller
    ...
    :param str search: search query parameter. Optional parameter to search on network name
