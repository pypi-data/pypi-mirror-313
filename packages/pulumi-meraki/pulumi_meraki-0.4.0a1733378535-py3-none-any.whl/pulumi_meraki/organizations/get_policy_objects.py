...
class GetPolicyObjectsResult:
    ...
    def policy_object_id(self) -> Optional[str]:
        """
...
def get_policy_objects(ending_before: Optional[str] = None,
    ...
    :param int per_page: perPage query parameter. The number of entries per page returned. Acceptable range is 10 5000. Default is 5000.
    :param str policy_object_id: policyObjectId path parameter. Policy object ID
...
def get_policy_objects_output(ending_before: Optional[pulumi.Input[Optional[str]]] = None,
