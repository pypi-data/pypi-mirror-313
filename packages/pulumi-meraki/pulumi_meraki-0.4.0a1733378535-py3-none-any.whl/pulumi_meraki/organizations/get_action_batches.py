...
class GetActionBatchesResult:
    ...
    def action_batch_id(self) -> Optional[str]:
        """
...
def get_action_batches(action_batch_id: Optional[str] = None,
    ...
    :param str action_batch_id: actionBatchId path parameter. Action batch ID
...
def get_action_batches_output(action_batch_id: Optional[pulumi.Input[Optional[str]]] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetActionBatchesResult]:
    """
    ## Example Usage
