...
def get_wireless_devices_ethernet_statuses(ending_before: Optional[str] = None,
    ...
    :param Sequence[str] network_ids: networkIds query parameter. A list of Meraki network IDs to filter results to contain only specified networks. E.g.: networkIds[]=N*12345678&networkIds[]=L*3456
...
def get_wireless_devices_ethernet_statuses_output(ending_before: Optional[pulumi.Input[Optional[str]]] = None,
                                                  ...
                                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetWirelessDevicesEthernetStatusesResult]:
    """
    ## Example Usage
