...
def get_wireless_devices_packet_loss_by_client(bands: Optional[Sequence[str]] = None,
    ...
    :param Sequence[str] macs: macs query parameter. Filter results by client mac address(es).
...
def get_wireless_devices_packet_loss_by_client_output(bands: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                                      ...
                                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetWirelessDevicesPacketLossByClientResult]:
    """
    ## Example Usage
