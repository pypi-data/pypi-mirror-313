...
def get_wireless_client_count_history(ap_tag: Optional[str] = None,
    ...
    :param str client_id: clientId query parameter. Filter results by network client to return per-device client counts over time inner joined by the queried client's connection history.
...
def get_wireless_client_count_history_output(ap_tag: Optional[pulumi.Input[Optional[str]]] = None,
                                             ...
                                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetWirelessClientCountHistoryResult]:
    """
    ## Example Usage
