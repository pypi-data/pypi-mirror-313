...
def get_pii_sm_devices_for_key(bluetooth_mac: Optional[str] = None,
    ...
    :param str bluetooth_mac: bluetoothMac query parameter. The MAC of a Bluetooth client
    :param str email: email query parameter. The email of a network user account or a Systems Manager device
    :param str imei: imei query parameter. The IMEI of a Systems Manager device
    :param str mac: mac query parameter. The MAC of a network client device or a Systems Manager device
...
def get_pii_sm_devices_for_key_output(bluetooth_mac: Optional[pulumi.Input[Optional[str]]] = None,
                                      ...
                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetPiiSmDevicesForKeyResult]:
    """
    ## Example Usage
