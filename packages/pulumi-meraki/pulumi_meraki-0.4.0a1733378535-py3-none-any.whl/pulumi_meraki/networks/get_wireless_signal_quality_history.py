...
def get_wireless_signal_quality_history(ap_tag: Optional[str] = None,
    ...
    :param str client_id: clientId query parameter. Filter results by network client.
    :param str device_serial: deviceSerial query parameter. Filter results by device.
...
def get_wireless_signal_quality_history_output(ap_tag: Optional[pulumi.Input[Optional[str]]] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetWirelessSignalQualityHistoryResult]:
    """
    ## Example Usage
