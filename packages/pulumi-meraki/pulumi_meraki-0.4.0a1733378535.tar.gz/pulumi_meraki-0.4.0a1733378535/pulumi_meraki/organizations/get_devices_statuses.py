...
def get_devices_statuses(ending_before: Optional[str] = None,
    ...
    :param Sequence[str] models: models query parameter. Optional parameter to filter devices by models.
    :param Sequence[str] network_ids: networkIds query parameter. Optional parameter to filter devices by network ids.
    ...
    :param Sequence[str] serials: serials query parameter. Optional parameter to filter devices by serials.
    :param str starting_after: startingAfter query parameter. A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
    :param Sequence[str] statuses: statuses query parameter. Optional parameter to filter devices by statuses. Valid statuses are ["online", "alerting", "offline", "dormant"].
