...
class GetLicensingSubscriptionSubscriptionsResult:
    ...
    def organization_ids(self) -> Optional[Sequence[str]]:
        """
...
def get_licensing_subscription_subscriptions(end_date: Optional[str] = None,
    ...
    :param str end_date: endDate query parameter. Filter subscriptions by end date, ISO 8601 format. To filter with a range of dates, use 'endDate[
           ]=?' in the request. Accepted options include lt, gt, lte, gte.
    :param str ending_before: endingBefore query parameter. A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
    :param Sequence[str] organization_ids: organizationIds query parameter. Organizations to get associated subscriptions for
    ...
    :param Sequence[str] product_types: productTypes query parameter. List of product types that returned subscriptions need to have entitlements for.
    :param str start_date: startDate query parameter. Filter subscriptions by start date, ISO 8601 format. To filter with a range of dates, use 'startDate[
           ]=?' in the request. Accepted options include lt, gt, lte, gte.
