...
def get_wireless_mesh_statuses(ending_before: Optional[str] = None,
    ...
    :param int per_page: perPage query parameter. The number of entries per page returned. Acceptable range is 3 500. Default is 50.
...
def get_wireless_mesh_statuses_output(ending_before: Optional[pulumi.Input[Optional[str]]] = None,
                                      network_id: Optional[pulumi.Input[str]] = None,
                                      per_page: Optional[pulumi.Input[Optional[int]]] = None,
                                      starting_after: Optional[pulumi.Input[Optional[str]]] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetWirelessMeshStatusesResult]:
    """
    ## Example Usage
