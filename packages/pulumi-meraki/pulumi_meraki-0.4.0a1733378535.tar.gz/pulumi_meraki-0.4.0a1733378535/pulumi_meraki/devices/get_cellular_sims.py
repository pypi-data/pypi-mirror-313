...
def get_cellular_sims(serial: Optional[str] = None,
...
def get_cellular_sims_output(serial: Optional[pulumi.Input[str]] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCellularSimsResult]:
    """
    ## Example Usage
