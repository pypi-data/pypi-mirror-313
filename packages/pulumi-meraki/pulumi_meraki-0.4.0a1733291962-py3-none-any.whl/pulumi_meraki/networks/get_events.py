...
class GetEventsResult:
    ...
    def excluded_event_types(self) -> Optional[Sequence[str]]:
        """
    ...
    def sm_device_mac(self) -> Optional[str]:
        """
    ...
    def sm_device_name(self) -> Optional[str]:
        """
...
def get_events(client_ip: Optional[str] = None,
    ...
    :param str client_ip: clientIp query parameter. The IP of the client which the list of events will be filtered with. Only supported for track-by-IP networks.
    :param str client_mac: clientMac query parameter. The MAC address of the client which the list of events will be filtered with. Only supported for track-by-MAC networks.
    :param str client_name: clientName query parameter. The name, or partial name, of the client which the list of events will be filtered with
    :param str device_mac: deviceMac query parameter. The MAC address of the Meraki device which the list of events will be filtered with
    :param str device_name: deviceName query parameter. The name of the Meraki device which the list of events will be filtered with
    :param str device_serial: deviceSerial query parameter. The serial of the Meraki device which the list of events will be filtered with
    :param str ending_before: endingBefore query parameter. A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
    :param Sequence[str] excluded_event_types: excludedEventTypes query parameter. A list of event types. The returned events will be filtered to exclude events with these types.
    :param Sequence[str] included_event_types: includedEventTypes query parameter. A list of event types. The returned events will be filtered to only include events with these types.
    :param str network_id: networkId path parameter. Network ID
    :param int per_page: perPage query parameter. The number of entries per page returned. Acceptable range is 3 1000. Default is 10.
    :param str product_type: productType query parameter. The product type to fetch events for. This parameter is required for networks with multiple device types. Valid types are wireless, appliance, switch, systemsManager, camera, and cellularGateway
    :param str sm_device_mac: smDeviceMac query parameter. The MAC address of the Systems Manager device which the list of events will be filtered with
...
def get_events_output(client_ip: Optional[pulumi.Input[Optional[str]]] = None,
                      ...
                      device_mac: Optional[pulumi.Input[Optional[str]]] = None,
                      device_name: Optional[pulumi.Input[Optional[str]]] = None,
                      device_serial: Optional[pulumi.Input[Optional[str]]] = None,
                      ending_before: Optional[pulumi.Input[Optional[str]]] = None,
                      excluded_event_types: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                      included_event_types: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
