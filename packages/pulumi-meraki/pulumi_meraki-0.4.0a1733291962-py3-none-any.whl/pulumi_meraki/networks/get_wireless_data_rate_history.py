...
def get_wireless_data_rate_history_output(ap_tag: Optional[pulumi.Input[Optional[str]]] = None,
                                          ...
                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetWirelessDataRateHistoryResult]:
    """
    ## Example Usage
