...
class GetWirelessLatencyHistoryResult:
    ...
    def access_category(self) -> Optional[str]:
        """
...
def get_wireless_latency_history(access_category: Optional[str] = None,
    ...
    :param str access_category: accessCategory query parameter. Filter by access category.
...
def get_wireless_latency_history_output(access_category: Optional[pulumi.Input[Optional[str]]] = None,
                                        ap_tag: Optional[pulumi.Input[Optional[str]]] = None,
