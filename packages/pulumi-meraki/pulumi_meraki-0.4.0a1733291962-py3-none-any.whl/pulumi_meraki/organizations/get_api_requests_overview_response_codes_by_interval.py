...
class GetApiRequestsOverviewResponseCodesByIntervalResult:
    ...
    def admin_ids(self) -> Optional[Sequence[str]]:
        """
    ...
    def operation_ids(self) -> Optional[Sequence[str]]:
        """
...
def get_api_requests_overview_response_codes_by_interval(admin_ids: Optional[Sequence[str]] = None,
    ...
    :param Sequence[str] admin_ids: adminIds query parameter. Filter by admin ID of user that made the API request
    :param int interval: interval query parameter. The time interval in seconds for returned data. The valid intervals are: 120, 3600, 14400, 21600. The default is 21600. Interval is calculated if time params are provided.
    :param Sequence[str] operation_ids: operationIds query parameter. Filter by operation ID of the endpoint
    :param str organization_id: organizationId path parameter. Organization ID
    :param Sequence[str] source_ips: sourceIps query parameter. Filter by source IP that made the API request
...
def get_api_requests_overview_response_codes_by_interval_output(admin_ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                                                ...
                                                                source_ips: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
