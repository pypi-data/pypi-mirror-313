...
class GetDevicesResult:
    ...
    def configuration_updated_after(self) -> Optional[str]:
        """
    ...
    def sensor_alert_profile_ids(self) -> Optional[Sequence[str]]:
        """
    ...
    def sensor_metrics(self) -> Optional[Sequence[str]]:
        """
    ...
    def tags_filter_type(self) -> Optional[str]:
        """
...
def get_devices(configuration_updated_after: Optional[str] = None,
    ...
    :param str configuration_updated_after: configurationUpdatedAfter query parameter. Filter results by whether or not the device's configuration has been updated after the given timestamp
    :param str ending_before: endingBefore query parameter. A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
    :param str mac: mac query parameter. Optional parameter to filter devices by MAC address. All returned devices will have a MAC address that contains the search term or is an exact match.
    :param Sequence[str] macs: macs query parameter. Optional parameter to filter devices by one or more MAC addresses. All returned devices will have a MAC address that is an exact match.
    :param str model: model query parameter. Optional parameter to filter devices by model. All returned devices will have a model that contains the search term or is an exact match.
    :param Sequence[str] models: models query parameter. Optional parameter to filter devices by one or more models. All returned devices will have a model that is an exact match.
    :param str name: name query parameter. Optional parameter to filter devices by name. All returned devices will have a name that contains the search term or is an exact match.
    :param Sequence[str] network_ids: networkIds query parameter. Optional parameter to filter devices by network.
    ...
    :param Sequence[str] product_types: productTypes query parameter. Optional parameter to filter devices by product type. Valid types are wireless, appliance, switch, systemsManager, camera, cellularGateway, and sensor.
    :param Sequence[str] sensor_alert_profile_ids: sensorAlertProfileIds query parameter. Optional parameter to filter devices by the alert profiles that are bound to them. Only applies to sensor devices.
    :param Sequence[str] sensor_metrics: sensorMetrics query parameter. Optional parameter to filter devices by the metrics that they provide. Only applies to sensor devices.
    :param str serial: serial query parameter. Optional parameter to filter devices by serial number. All returned devices will have a serial number that contains the search term or is an exact match.
    :param Sequence[str] serials: serials query parameter. Optional parameter to filter devices by one or more serial numbers. All returned devices will have a serial number that is an exact match.
...
def get_devices_output(configuration_updated_after: Optional[pulumi.Input[Optional[str]]] = None,
                       ...
                       sensor_alert_profile_ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                       sensor_metrics: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
