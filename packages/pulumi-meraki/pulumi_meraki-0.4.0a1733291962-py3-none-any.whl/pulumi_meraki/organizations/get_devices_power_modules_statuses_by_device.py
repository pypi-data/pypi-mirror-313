...
def get_devices_power_modules_statuses_by_device(ending_before: Optional[str] = None,
    ...
    :param Sequence[str] network_ids: networkIds query parameter. Optional parameter to filter device availabilities by network ID. This filter uses multiple exact matches.
    ...
    :param Sequence[str] product_types: productTypes query parameter. Optional parameter to filter device availabilities by device product types. This filter uses multiple exact matches.
...
def get_devices_power_modules_statuses_by_device_output(ending_before: Optional[pulumi.Input[Optional[str]]] = None,
                                                        ...
                                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDevicesPowerModulesStatusesByDeviceResult]:
    """
    ## Example Usage
