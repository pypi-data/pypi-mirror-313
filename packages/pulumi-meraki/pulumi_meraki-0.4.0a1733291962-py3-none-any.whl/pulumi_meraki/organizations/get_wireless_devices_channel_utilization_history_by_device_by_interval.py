...
def get_wireless_devices_channel_utilization_history_by_device_by_interval(ending_before: Optional[str] = None,
...
def get_wireless_devices_channel_utilization_history_by_device_by_interval_output(ending_before: Optional[pulumi.Input[Optional[str]]] = None,
                                                                                  ...
                                                                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetWirelessDevicesChannelUtilizationHistoryByDeviceByIntervalResult]:
    """
    ## Example Usage
