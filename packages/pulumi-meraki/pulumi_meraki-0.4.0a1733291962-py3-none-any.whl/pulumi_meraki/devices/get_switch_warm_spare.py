...
def get_switch_warm_spare(serial: Optional[str] = None,
...
def get_switch_warm_spare_output(serial: Optional[pulumi.Input[str]] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSwitchWarmSpareResult]:
    """
    ## Example Usage
