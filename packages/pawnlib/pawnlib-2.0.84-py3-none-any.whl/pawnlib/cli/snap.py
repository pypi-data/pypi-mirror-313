...
def main():
    ...
    # config_handler.print_all_sections_tree()
...
def run_generating_metadata():
    ...
    # if config_args.network_name and config_args.store_metadata:
    #     generate_network_info_meta(
    #         network_name=config_args.network_name,
    #         prefix_url=config_args.prefix,
    #         backup_type=config_args.backup_type
    #     )
