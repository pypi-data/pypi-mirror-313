...
def get_arguments(parser):
    ...
    sync_parser.add_argument('--profile', type=str, help='AWS CLI profile name')
    sync_parser.add_argument('--max-workers', type=int, help='Max workers', default=10)
    sync_parser.add_argument('-v', '--verbose', action='count', help='Verbose mode', default=1)
    sync_parser.add_argument('-q', '--quiet', action='store_true', help='Quiet mode. Overrides verbosity to 0.')
    ...
    sync_parser.add_argument('--config-file', type=str, default="config.ini", help="Path to the configuration file")
    ...
    cp_parser.add_argument('--profile', type=str, help='AWS CLI profile name')
    cp_parser.add_argument('--max-workers', type=int, help='Max workers', default=10)
    cp_parser.add_argument('-v', '--verbose', action='count', help='Verbose mode', default=1)
    cp_parser.add_argument('-q', '--quiet', action='store_true', help='Quiet mode. Overrides verbosity to 0.')
    ...
    cp_parser.add_argument('--config-file', type=str, default="config.ini", help="Path to the configuration file")

    # List command
    ls_parser = subparsers.add_parser('ls', help='List S3 bucket or prefix')
    ls_parser.add_argument('path', type=str, help='S3 path to list')
    ls_parser.add_argument('--profile', type=str, help='AWS CLI profile name')
    ls_parser.add_argument('-v', '--verbose', action='count', help='Verbose mode', default=1)
    ls_parser.add_argument('-q', '--quiet', action='store_true', help='Quiet mode. Overrides verbosity to 0.')
    ls_parser.add_argument('--recursive', action='store_true', help='List recursively')
    ls_parser.add_argument('--config-file', type=str, default="config.ini", help="Path to the configuration file")
    ...
    rm_parser.add_argument('--profile', type=str, help='AWS CLI profile name')
    rm_parser.add_argument('-v', '--verbose', action='count', help='Verbose mode', default=1)
    rm_parser.add_argument('-q', '--quiet', action='store_true', help='Quiet mode. Overrides verbosity to 0.')
    ...
    rm_parser.add_argument('--config-file', type=str, default="config.ini", help="Path to the configuration file")
    rm_parser.add_argument('--max-workers', type=int, help='Max workers', default=10)
    rm_parser.add_argument('--pattern', type=str, help='pattern', default=10)
    return parser
