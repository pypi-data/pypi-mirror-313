...
class ProcessedRequest(BaseModel):
    ...
    ProcessedRequest
    """ # noqa: E501
    context_tokens: Optional[StrictInt] = Field(default=None, alias="contextTokens")
    ...
    input_text: Optional[StrictStr] = Field(default=None, description="Information about the `user_input_text`. The raw input is truncated if it exceeds a certain token length so we do not denial of service downstream logging and data systems.", alias="inputText")
    ...
    __properties: ClassVar[List[str]] = ["contextTokens", "contexts", "inputText", "inputTokens", "outputText", "outputTokens"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contextTokens": obj.get("contextTokens"),
