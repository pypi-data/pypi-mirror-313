...
class FirewallInstanceManagerApi:
    ...
    def create_instance(
        ...
        Creates a new Firewall Instance with the desired user configuration. It will take time for the new instance to become available; use the `GetFirewallInstance` API to track the status of the deployment.
    ...
    def delete_instance(
        ...
        Deletes a Firewall Instance from the cluster. Be careful with this API because it will interrupt in-flight validation.
    ...
    def _delete_instance_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1-beta/firewalls/{firewallInstanceId.uuid}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_instance(
        ...
        Updates an existing FirewallInstance. This redeploys the firewall instance. The status will be REDEPLOYING until the new version of the firewall instance reaches READY.
        ...
        :param description: Human-readable description of the firewall instance.
        :type description: str
    ...
    def _update_instance_serialize(
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/v1-beta/firewalls/{firewallInstance.firewallInstanceId.uuid}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
