"""This module contains the HuluArgument class which parses and validates the arguments."""
...
class HuluArgument(BaseModel):
    """Class to parse and validate the arguments for the Hulu finetuning script."""
    ...
    def validate_tasks(cls, v):
        """Validate that the tasks are valid."""
