...
class CopaPreprocessPipeline:
    ...
    def load_and_preprocesss(self):
        ...
        dev_data = load_dataset("json", data_files=str(data.get("dev_dataset_url")))[
            "train"
        ]
        train_data = load_dataset(
            "json", data_files=str(data.get("train_dataset_url"))
        )["train"]
        test_data = load_dataset("json", data_files=str(data.get("test_dataset_url")))[
            "train"
        ]
