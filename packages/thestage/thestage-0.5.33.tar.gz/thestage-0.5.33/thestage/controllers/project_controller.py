...
def run_inference_simulator(
    ...
    if slug and not re.match(r"^[a-zA-Z0-9-]+$", slug):
...
def task_logs(
    ...
    if logs_number is None:
        ...
        if not get_inference_simulator_response:
            ...
            logging_service.print_last_inference_simulator_logs(config=config, inferecen_simulator_id=inference_simulator_id, logs_number=logs_number)
