...
class ActionTracker:
    ...
    def __init__(self, action_id=None):
        ...
        try:
            ...
            if action_id is not None:
                ...
                self.is_exported = False if self.action_details.get("exportFormat").lower() in ["pytorch", "tensorflow"] else True
            ...
            if model_type == "exported":
                presigned_url = self.rpc.post(
                    ...
                    payload={
                        ...
                        "modelType": model_type,
                        "expiryTimeInMinutes": 59,
                        "exportFormat": self.action_details["exportFormat"],
                    },
                )["data"]
    ...
    def save_benchmark_results(self, latency_ms, batch_size=1):
        ...
        payload = {
            ...
            "exportFormat": self.action_details.get("exportFormat",
