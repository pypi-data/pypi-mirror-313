...
* test on ubuntu
  * test if app works with custom models and audio dirs etc

* upload new pypi package
...
```console
2024-12-01 04:25:44 - ERROR - asyncio - Exception in callback _ProactorBasePipeTransport._call_connection_lost(None)
