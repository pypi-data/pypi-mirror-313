...
async def save_posts(chat_id, lz, username, bot, posts, is_sub, tz, ENT_TID, BASE_ENT):
...
async def post_pub(bot, lz, chat_id, ENT_TID, item, is_private=True, message_id=None, current=1):
    result = False
    try:
