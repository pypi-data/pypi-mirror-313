...
class AzureUserDelegationSAS(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AzureUserDelegationSAS:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AzureUserDelegationSAS:
        """Create an instance of AzureUserDelegationSAS from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AzureUserDelegationSAS.parse_obj(obj)

        _obj = AzureUserDelegationSAS.parse_obj({
