...
class GcpOauthToken(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GcpOauthToken:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GcpOauthToken:
        """Create an instance of GcpOauthToken from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GcpOauthToken.parse_obj(obj)

        _obj = GcpOauthToken.parse_obj({
