...
import unitycatalog_client_preview.models
from unitycatalog_client_preview import rest
from unitycatalog_client_preview.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(unitycatalog_client_preview.models, klass)
