...
class CreateCatalog(BaseModel):
    ...
    CreateCatalog
    """
    name: StrictStr = Field(default=..., description="Name of catalog.")
    ...
    __properties = ["name", "comment", "properties"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCatalog:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCatalog:
        """Create an instance of CreateCatalog from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCatalog.parse_obj(obj)

        _obj = CreateCatalog.parse_obj({
            "name": obj.get("name"),
