...
def br(data_operand, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(BranchOp(dataOperand=data_operand, loc=loc, ip=ip))
...
def buffer(operand, slots, buffer_type, *, init_values=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(BufferOp(operand=operand, slots=slots, bufferType=buffer_type, initValues=init_values, loc=loc, ip=ip))
...
def cond_br(condition_operand, data_operand, *, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(ConditionalBranchOp(conditionOperand=condition_operand, dataOperand=data_operand, loc=loc, ip=ip))
...
def constant(result, value, ctrl, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ConstantOp(result=result, value=value, ctrl=ctrl, loc=loc, ip=ip))
...
def control_merge(result, index, data_operands, *, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(ControlMergeOp(result=result, index=index, dataOperands=data_operands, loc=loc, ip=ip))
...
def func(function_type, *, arg_attrs=None, res_attrs=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(FuncOp(function_type=function_type, arg_attrs=arg_attrs, res_attrs=res_attrs, loc=loc, ip=ip))
...
def join(data, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(JoinOp(data=data, loc=loc, ip=ip))
...
def merge(data_operands, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(MergeOp(dataOperands=data_operands, loc=loc, ip=ip))
...
def mux(select_operand, data_operands, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(MuxOp(selectOperand=select_operand, dataOperands=data_operands, loc=loc, ip=ip))
...
def never(result, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(NeverOp(result=result, loc=loc, ip=ip))
...
def pack(result, inputs, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(PackOp(result=result, inputs=inputs, loc=loc, ip=ip))
...
def return_(op_operands, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ReturnOp(opOperands=op_operands, loc=loc, ip=ip))
...
def sink(operand, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(SinkOp(operand=operand, loc=loc, ip=ip))
...
def source(result, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(SourceOp(result=result, loc=loc, ip=ip))
