...
def service_std_hostmem(sym_name, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(HostMemServiceDeclOp(sym_name=sym_name, loc=loc, ip=ip))
...
def manifest_impl_conn(rel_app_id_path, service_port, type_id, *, channel_assignments=None, impl_details=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ServiceImplClientRecordOp(relAppIDPath=rel_app_id_path, servicePort=service_port, typeID=type_id, channelAssignments=channel_assignments, implDetails=impl_details, loc=loc, ip=ip))
