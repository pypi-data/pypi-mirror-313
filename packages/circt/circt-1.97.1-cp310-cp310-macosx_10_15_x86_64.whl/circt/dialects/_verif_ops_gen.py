...
def bmc(result, bound, num_regs, initial_values, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(BoundedModelCheckingOp(result=result, bound=bound, num_regs=num_regs, initial_values=initial_values, loc=loc, ip=ip))
...
def ensure(property, *, clock=None, enable=None, label=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(EnsureOp(property=property, clock=clock, enable=enable, label=label, loc=loc, ip=ip))
...
def formal(sym_name, parameters, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(FormalOp(sym_name=sym_name, parameters=parameters, loc=loc, ip=ip))
...
def require(property, *, clock=None, enable=None, label=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(RequireOp(property=property, clock=clock, enable=enable, label=label, loc=loc, ip=ip))
...
def symbolic_value(result, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(SymbolicValueOp(result=result, loc=loc, ip=ip))
