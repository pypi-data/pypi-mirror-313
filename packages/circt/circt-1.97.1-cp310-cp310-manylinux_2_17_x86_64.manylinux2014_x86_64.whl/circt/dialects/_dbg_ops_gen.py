...
def scope(instance_name, module_name, *, scope=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ScopeOp(instanceName=instance_name, moduleName=module_name, scope=scope, loc=loc, ip=ip))
...
def variable(name, value, *, scope=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(VariableOp(name=name, value=value, scope=scope, loc=loc, ip=ip))
