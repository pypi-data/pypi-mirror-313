...
class BrokerStatus(BaseModel):
    ...
    error_message: Optional[StrictStr] = Field(default=None, description="Last error message in case detector is in the Error state This matters especially for async functions (start/initialize), where API won't return reason for the error during async operation. ")
    __properties: ClassVar[List[str]] = ["state", "progress", "error_message"]
