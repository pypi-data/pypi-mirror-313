...
<script lang="ts">
  ...
  import "./output.css";
  import QuickSearch from "./src/QuickSearch/QuickSearch.svelte";
  import BlockTitle from "./src/BlockTile/BlockTitle.svelte";

  import type { QuickSearchType } from "./src/QuickSearch/Types";
