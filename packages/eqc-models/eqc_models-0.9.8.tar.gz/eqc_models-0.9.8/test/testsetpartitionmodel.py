...
class SetPartitionModelTestCase(TestCase):
    ...
    def test_polynomial_terms(self):
        ...
        assert model.coefficients == expected_coefficients, "Polynomial coefficients do not match expected values"
        assert model.indices == expected_indices, "Polynomial indices do not match expected values"
