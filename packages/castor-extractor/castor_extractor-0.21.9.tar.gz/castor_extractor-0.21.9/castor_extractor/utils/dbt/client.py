...
class DbtClient:
    ...
    def list_job_identifiers(self) -> Set[int]:
        ...
        """
        url = f"{self._account_url}/{self._account_id}/jobs/"
        jobs = self._call(url)
    ...
    def last_run(
        ...
        """
        url = f"{self._account_url}/{self._account_id}/runs/"
    ...
    def _fetch_run_artifact(
        ...
        """
        url = f"{self._account_url}/{self._account_id}/runs/{run_id}/artifacts/{artifact}"
        logger.info(
    ...
    def fetch_run_results(self, run_id: int) -> Optional[dict]:
        """
