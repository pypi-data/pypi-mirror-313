...
class TraceCallbackTests(unittest.TestCase):
    ...
    @unittest.skipIf(sqlite.sqlite_version_info < (3, 3, 9), "CryptoSqlite_prepare_v2 is not available")
    def CheckTraceCallbackContent(self):
        ...
        # Avoid invoking the CryptoSqlite_trace() callback multiple times when a
