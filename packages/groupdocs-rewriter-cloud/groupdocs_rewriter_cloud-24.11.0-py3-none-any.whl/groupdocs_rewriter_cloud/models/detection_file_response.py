...
class DetectionFileResponse(BaseModel):
    ...
    is_paraphrased: Optional[StrictBool] = Field(default=None, alias="isParaphrased")
    per_paragraph_probability: Optional[List[Union[StrictFloat, StrictInt]]] = Field(default=None, alias="perParagraphProbability")
    __properties: ClassVar[List[str]] = ["status", "message", "probability", "isParaphrased", "perParagraphProbability"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isParaphrased": obj.get("isParaphrased"),
