...
.swagger-ui .b--white-025 {
  border-color: hsla(0deg, 0%, 100%, 0.03);
}

.swagger-ui .b--white-0125 {
  border-color: hsla(0deg, 0%, 100%, 0.01);
}
