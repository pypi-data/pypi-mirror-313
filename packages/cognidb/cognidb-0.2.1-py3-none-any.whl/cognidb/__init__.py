...
class CogniDB:
    def __init__(self, 
        ...
        self.host = host or os.getenv("COGNIDB_HOST", "localhost")
        self.port = port or int(os.getenv("COGNIDB_PORT", 3306 if db_type == "mysql" else 5432))
        self.dbname = dbname or os.getenv("COGNIDB_DATABASE")
        self.user = user or os.getenv("COGNIDB_USER")
        self.password = password or os.getenv("COGNIDB_PASSWORD")
        self.api_key = api_key or os.getenv("COGNIDB_API_KEY")
