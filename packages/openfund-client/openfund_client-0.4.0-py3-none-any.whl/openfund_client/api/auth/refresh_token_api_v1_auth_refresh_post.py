...
) -> Optional[Union[HTTPValidationError, RefreshTokenResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, RefreshTokenResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, RefreshTokenResponse]
    """
