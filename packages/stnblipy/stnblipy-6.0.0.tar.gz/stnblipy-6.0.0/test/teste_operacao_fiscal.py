...
def atualiza_fatos_siseco(conn_stg, conn_prd):
    ...
    cols_saida = [  
        ...
        # ["DS_TIPO_PAGAMENTO", tp.STRING, ft.DePara(de_para={None: None,
        #                                                     1: "Integrado",
        #                                                     2: "Manual"},
        ...
        ["DT_REFERENCIA", tp.DATE, ft.LookupViaTabela(conn_stg,
                                                        "DEMANDA_LINHA",
                                                        "NR_DATA_REFERENCIA",
                                                        "ID_DEMANDA"
                                                    )],
...
if __name__ == "__main__":
    try:
        ...
        #atualiza_fatos_siseco(conn_stg_siseco, conn_prd)
