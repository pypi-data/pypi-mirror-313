...
class EndpointElement(metaclass=BugCatcherMeta):
    ...
    def post(
        ...
        Returns:
            The response content if the request is successful.
        """
        return self.__request("POST", data=data, json=json, headers=headers, cookies=cookies)
    ...
    def put(
        ...
        Returns:
            The response content if the request is successful
        """
        return self.__request("PUT", data=data, json=json, headers=headers, cookies=cookies)
