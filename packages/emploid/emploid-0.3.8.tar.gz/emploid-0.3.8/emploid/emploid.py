...
from emploid.taskman import Taskman
...
class Emploid:
    ...
    def resolve_imports(self):
        ...
        if(self.driver_type==SETTINGS_USE_APPIUM):
            ...
            from appium.options.android import UiAutomator2Options # Import Appium UiAutomator2 driver for Android platforms (AppiumOptions)
            from appium.options.common import AppiumOptions
            # from appium.webdriver.common.touch_action import TouchAction as AppiumAction #deprectaed
            from appium.webdriver.extensions.android.nativekey import AndroidKey as ak
    ...
    def press(self, _btn: int =0) -> None:
        ...
        if(self.driver_type==SETTINGS_USE_PYAUTOGUI):
            ...
            btn = btns[_btn]
        if(self.driver_type==SETTINGS_USE_APPIUM):
            raise Exception("AppiumAction is deprecated https://stackoverflow.com/questions/75881566/appium-python-client-touchaction-class-is-being-deprecated-how-do-i-perform-pre")
