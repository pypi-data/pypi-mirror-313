...
class TestUltralyticsFeatureExtractor:
    ...
    def test_init(self, model_name: str) -> None:
        ...
        for name, module in model.named_modules():
            # Make sure we didn't add Identity layers to the original model.
            # This is a sanity check that nothing weng wrong in the skip_cv2_bn_act
            # functions.
            assert not isinstance(module, Identity)
