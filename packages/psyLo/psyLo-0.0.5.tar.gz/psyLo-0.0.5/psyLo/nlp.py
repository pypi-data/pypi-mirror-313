...
List of Available Functions:
    ...
    Text Preprocessing:
        ...
        5.  rmPunctuation(text)
        6.  rmNumbers(text)
        7.  tokenize(text, tokenizeType = ('word', 'sentence' or 'char'))
        8.  rmStopWords(list_tokens)
        9.  wordNetLemmatize(list_tokens)
        10. porterStemmer(list_tokens)
        11. example()
