...
class ModelColumnInfo(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            data_type (str): An opaque column contains more complex data that relies on an extension to be interpreted. It is not used directly to create predictions.. [optional] if omitted the server will use the default value of "opaque"  # noqa: E501
