...
class LeetcodeWrapper:
    ...
    def __init__(self, username, base_url="https://alfa-leetcode-api.onrender.com"):
    ...
    def get_full_profile(self):
        ...
        Returns:
            dict: The user's full profile data.
        """
        return self._request(f"/userProfile/{self.username}")
