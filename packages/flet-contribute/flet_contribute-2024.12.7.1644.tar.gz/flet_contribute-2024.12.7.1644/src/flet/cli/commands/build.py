...
class Command(BaseCommand):
    ...
    def handle(self, options: argparse.Namespace) -> None:
       ...
       # Obtiene la carpeta anterior al directorio actual
        ...
        # Define el directorio actual y la carpeta anterior
        ...
        # Archivos de origen
        yaml_path =  os.path.join(parent_dir, 'mi_template', 'docs_adicionales','pubspec.yaml')
        ...
        flutter_yaml = os.path.join(self.flutter_dir, 'pubspec.yaml')
        ...
        copiar_archivo(yaml_path, flutter_yaml)
