    ...
    def upload_taxlot_portfolio(self, as_of_date, asset_id, portfolio_id='BasePortfolio',
        ...
        Args:
            ...
            taxlot_df (dataFrame): Taxlot data in pandas dataframe format with mandatory columns
                ...
                Example is pd.DataFrame([{"openTradeDate": "2016-12-30", "ISIN": "US02079K3059", "quantity": 1000, "openCostBasis": 792.45, "tradingRule": "keepLot"},
                {"openTradeDate": "2016-12-30", "ISIN": "US0231351067", "quantity": 450, "openCostBasis": 749.87, "tradingRule": "sellLot"},
